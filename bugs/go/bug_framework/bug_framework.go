...
// TODO(rmistry): There is a bug with 400 results topping off.
...
// Similarly, the unassigned paramter is not used. Specificy this in your query with '-has:owner'.
func (m *Monorail) Search(ctx context.Context, _, _ bool) ([]*Issue, error) {
