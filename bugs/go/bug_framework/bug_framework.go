...
type BugFramework interface {
	...
	Search(ctx context.Context) ([]Issue, error)
...
type IssueTrackerResults struct {
	QueryResults map[string][]IssueTrackerIssue
}
...
func (it *IssueTracker) Search(ctx context.Context) ([]Issue, error) {
