...
curl --silent -X PUT -d "{\"Hash\": \"16ad39aeae389aa70cc4c6764c1d94ae7ffdac5b0c1fe56c635caa57ca57b757\", \"Description\": \"Shader Inputs\"}" -H 'Content-Type: application/json' http://localhost:9000/_/names/sksl/@iImage
