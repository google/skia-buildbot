...
curl --silent -X PUT -d "{\"Hash\": \"83dbd573bf89865109122ee1baf01a94481e4cc1dbe9a1e99375d2d10bd5a11d\", \"Description\": \"Shader Inputs\"}" -H 'Content-Type: application/json' http://localhost:9000/_/names/sksl/@defaultChildShader
