    ...
    kitReady.then(async (ck: CanvasKit) => {
      ...
      try {
        ...
        elements.forEach((ele) => {
          this.inputImageShaders.push(this.kit!.MakeImageFromCanvasImageSource(ele).makeShaderOptions(this.kit!.TileMode.Clamp, this.kit!.TileMode.Clamp, this.kit!.FilterQuality.Medium, this.kit!.MipmapMode.None));
        });
      } catch (error) {
        errorMessage(error);
      }
