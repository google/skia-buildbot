...
export class ShaderNode {
    ...
    compile(): void {
      // If there are child shaders we need to find their names and prepend uniform declarations
      // to the code we are compiling.

      // Also need to surface that set of uniforms to be displayed to the user.

      // And getShader() needs to be modified to also pass along all the maching shaders from the children.
