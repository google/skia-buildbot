...
export class ShaderNode {
    ...
    private _totalPredefinedUniformValues: number = 0;
    ...
    compile(): void {
      ...
      this._totalPredefinedUniformValues = this.getTotalPredefinedUniformValues();

      // Fix up currentUserUniformValues if it's the wrong length.
      const userUniformValuesLength = uniformFloatCount - this._totalPredefinedUniformValues;
    ...
    getShader(predefinedUniformsValues: number[]): Shader | null {
      ...
      const offsetOfUserDefinedUniforms = this.getTotalPredefinedUniformValues();
    ...
    get totalPredefinedUniformValues():number {
      return this._totalPredefinedUniformValues;
    }

    /** The number of floats that are defined by predefined uniforms. */
    private getTotalPredefinedUniformValues(): number {
      let ret = 0;
      if (!this.effect) {
        return 0;
      }
