...
export class ShaderNode {
    ...
    runEditedCode(): void {
      ...
      // Only overwrite _currentUserUniformValues we may have loaded from the
      // scrap store if they are the wrong length.
      if (this._currentUserUniformValues.length !== uniformFloatCount) {
        this._currentUserUniformValues = new Array(uniformFloatCount).fill(0);
      }
    }
