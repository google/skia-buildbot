...
export class ShaderNode {
    ...
    compile(): void {
      ...
      const errorLineFixup = numPredefinedUniformLines + 2 + this.currentChildShaders.length;
    ...
    needsCompile(): boolean {
      return (this._shaderCode !== this.runningCode)
       ...
       || this.childShaderArraysDiffer(this.currentChildShaders, this.runningChildShaders);
    }
    ...
    needsSave(): boolean {
      return (this._shaderCode !== this.body!.Body)
       ...
       || this.childShaderArraysDiffer(this.currentChildShaders, this.body?.SKSLMetaData?.Children || [])
    ...
    private childShaderArraysDiffer(a: ChildShader[], b: ChildShader[]): boolean {
