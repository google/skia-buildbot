...
module.exports = function (config) {
  config.set({
    ...
    files: [
      ...
      {
        pattern: `${bazelRunfilesDir}/_main/${canvasKitWASMFile}`,
        included: false,
        served: true,
      },
      // We want the canvasKitJS file to be run before the tests so CanvasKitInit is defined.
      { pattern: `${bazelRunfilesDir}/_main/${canvasKitJSFile}` },
      { pattern: `${bazelRunfilesDir}/_main/${versionFile}` },
      {
    ...
    proxies: {
      ...
      '/canvaskit_assets/canvaskit.wasm': `${bazelRunfilesDir}/_main/${canvasKitWASMFile}`,
    },
