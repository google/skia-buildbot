...
def setup_test_and_perf_builders(helper, do_upload_render_results,
  ...
  builder_specs = [
      ...
      ('Perf', 'Mac10.6',  'MacMini4.1', 'GeForce320M', 'x86',    'Release', None,           GYP_10_6,  f_factory, MAC,    S_COMMIT_OR_SKP, {}),
...
def setup_canaries(helper, do_upload_render_results, do_upload_bench_results):
  ...
  #
  canaries = [
      ('Chrome', 'Ubuntu12', 'Ninja', 'x86_64', 'LKGR',           'chrome', 'src',  None,       f_canary, LINUX,  S_PERCOMMIT, {'flavor': 'chrome', 'build_targets': chrome_build_targets, 'path_to_skia': ['third_party', 'skia']}),
