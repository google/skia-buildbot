...
Builder = collections.namedtuple('Builder',
    ['role', 'os', 'model', 'gpu', 'arch', 'configuration', 'extra_config',
     'gyp_defines', 'factory_args', 'factory_type', 'target_platform'])
...
def setup_test_and_perf_builders(helper, do_upload_results):
  ...
  builder_specs = [
      ...
      ('Test', 'Ubuntu12', 'ShuttleA',   'ATI5770',     'x86_64', 'Release', 'Valgrind',     VALGRIND,  {'flavor': 'valgrind'}, f_factory, LINUX),
      ('Test', 'Ubuntu12', 'ShuttleA',   'NoGPU',       'x86_64', 'Debug',   None,           NO_GPU,    {}, f_factory, LINUX),
      ('Test', 'Ubuntu13', 'ShuttleA',   'HD2000',      'x86_64', 'Debug',   'ASAN',         None,      {'sanitizer': 'address'}, f_xsan, LINUX),
      ...
      ('Test', 'Win7',     'ShuttleA',   'HD2000',      'x86',    'Debug',   'ANGLE',        GYP_ANGLE, {'gm_args': ['--config', 'angle'], 'bench_args': ['--config', 'ANGLE'], 'bench_pictures_cfg': 'angle'}, f_factory, WIN32),
      ('Test', 'Win7',     'ShuttleA',   'HD2000',      'x86',    'Release', 'ANGLE',        GYP_ANGLE, {'gm_args': ['--config', 'angle'], 'bench_args': ['--config', 'ANGLE'], 'bench_pictures_cfg': 'angle'}, f_factory, WIN32),
      ('Perf', 'Win7',     'ShuttleA',   'HD2000',      'x86',    'Release', 'ANGLE',        GYP_ANGLE, {'gm_args': ['--config', 'angle'], 'bench_args': ['--config', 'ANGLE'], 'bench_pictures_cfg': 'angle'}, f_factory, WIN32),
      ...
      ('Test', 'Win8',     'ShuttleA',   'GTX660',      'x86',    'Debug',   None,           GYP_WIN8,  {'build_targets': ['most'], 'bench_pictures_cfg': 'default_msaa16'}, f_factory, WIN32),
      ('Test', 'Win8',     'ShuttleA',   'GTX660',      'x86',    'Release', None,           GYP_WIN8,  {'build_targets': ['most'], 'bench_pictures_cfg': 'default_msaa16'}, f_factory, WIN32),
      ('Perf', 'Win8',     'ShuttleA',   'GTX660',      'x86',    'Release', None,           GYP_WIN8,  {'build_targets': ['most'], 'bench_pictures_cfg': 'default_msaa16'}, f_factory, WIN32),
      ('Test', 'Win8',     'ShuttleA',   'GTX660',      'x86_64', 'Debug',   None,           GYP_WIN8,  {'build_targets': ['most'], 'bench_pictures_cfg': 'default_msaa16'}, f_factory, WIN32),
      ('Test', 'Win8',     'ShuttleA',   'GTX660',      'x86_64', 'Release', None,           GYP_WIN8,  {'build_targets': ['most'], 'bench_pictures_cfg': 'default_msaa16'}, f_factory, WIN32),
      ('Perf', 'Win8',     'ShuttleA',   'GTX660',      'x86_64', 'Release', None,           GYP_WIN8,  {'build_targets': ['most'], 'bench_pictures_cfg': 'default_msaa16'}, f_factory, WIN32),
      ('Test', 'Win8',     'ShuttleA',   'GTX660',      'x86',    'Release', 'NVPR',         NVPR_WIN8, {'build_targets': ['most'], 'bench_pictures_cfg': 'nvpr'}, f_factory, WIN32),
      ('Perf', 'Win8',     'ShuttleA',   'GTX660',      'x86',    'Release', 'NVPR',         NVPR_WIN8, {'build_targets': ['most'], 'bench_pictures_cfg': 'nvpr'}, f_factory, WIN32),
      ('Test', 'Win8',     'ShuttleA',   'HD7770',      'x86',    'Debug',   None,           GYP_WIN8,  {'build_targets': ['most'], 'bench_pictures_cfg': 'default_msaa16'}, f_factory, WIN32),
      ('Test', 'Win8',     'ShuttleA',   'HD7770',      'x86',    'Release', None,           GYP_WIN8,  {'build_targets': ['most'], 'bench_pictures_cfg': 'default_msaa16'}, f_factory, WIN32),
      ('Perf', 'Win8',     'ShuttleA',   'HD7770',      'x86',    'Release', None,           GYP_WIN8,  {'build_targets': ['most'], 'bench_pictures_cfg': 'default_msaa16'}, f_factory, WIN32),
      ('Test', 'Win8',     'ShuttleA',   'HD7770',      'x86_64', 'Debug',   None,           GYP_WIN8,  {'build_targets': ['most'], 'bench_pictures_cfg': 'default_msaa16'}, f_factory, WIN32),
      ('Test', 'Win8',     'ShuttleA',   'HD7770',      'x86_64', 'Release', None,           GYP_WIN8,  {'build_targets': ['most'], 'bench_pictures_cfg': 'default_msaa16'}, f_factory, WIN32),
      ('Perf', 'Win8',     'ShuttleA',   'HD7770',      'x86_64', 'Release', None,           GYP_WIN8,  {'build_targets': ['most'], 'bench_pictures_cfg': 'default_msaa16'}, f_factory, WIN32),
      ('Test', 'Android',  'NexusS',     'SGX540',      'Arm7',   'Debug',   None,           None,      {'device': 'nexus_s'}, f_android, LINUX),
      ('Test', 'Android',  'NexusS',     'SGX540',      'Arm7',   'Release', None,           None,      {'device': 'nexus_s'}, f_android, LINUX),
      ('Perf', 'Android',  'NexusS',     'SGX540',      'Arm7',   'Release', None,           None,      {'device': 'nexus_s'}, f_android, LINUX),
      ('Test', 'Android',  'Nexus4',     'Adreno320',   'Arm7',   'Debug',   None,           None,      {'device': 'nexus_4'}, f_android, LINUX),
      ('Test', 'Android',  'Nexus4',     'Adreno320',   'Arm7',   'Release', None,           None,      {'device': 'nexus_4'}, f_android, LINUX),
      ('Perf', 'Android',  'Nexus4',     'Adreno320',   'Arm7',   'Release', None,           None,      {'device': 'nexus_4'}, f_android, LINUX),
      ('Test', 'Android',  'Nexus7',     'Tegra3',      'Arm7',   'Debug',   None,           None,      {'device': 'nexus_7'}, f_android, LINUX),
      ('Test', 'Android',  'Nexus7',     'Tegra3',      'Arm7',   'Release', None,           None,      {'device': 'nexus_7'}, f_android, LINUX),
      ('Perf', 'Android',  'Nexus7',     'Tegra3',      'Arm7',   'Release', None,           None,      {'device': 'nexus_7'}, f_android, LINUX),
      ('Test', 'Android',  'Nexus10',    'MaliT604',    'Arm7',   'Debug',   None,           None,      {'device': 'nexus_10'}, f_android, LINUX),
      ('Test', 'Android',  'Nexus10',    'MaliT604',    'Arm7',   'Release', None,           None,      {'device': 'nexus_10'}, f_android, LINUX),
      ('Perf', 'Android',  'Nexus10',    'MaliT604',    'Arm7',   'Release', None,           None,      {'device': 'nexus_10'}, f_android, LINUX),
      ('Test', 'Android',  'GalaxyNexus','SGX540',      'Arm7',   'Debug',   None,           None,      {'device': 'galaxy_nexus'}, f_android, LINUX),
      ('Test', 'Android',  'GalaxyNexus','SGX540',      'Arm7',   'Release', None,           None,      {'device': 'galaxy_nexus'}, f_android, LINUX),
      ('Perf', 'Android',  'GalaxyNexus','SGX540',      'Arm7',   'Release', None,           None,      {'device': 'galaxy_nexus'}, f_android, LINUX),
      ('Test', 'Android',  'Xoom',       'Tegra2',      'Arm7',   'Debug',   None,           None,      {'device': 'xoom'}, f_android, LINUX),
      ('Test', 'Android',  'Xoom',       'Tegra2',      'Arm7',   'Release', None,           None,      {'device': 'xoom'}, f_android, LINUX),
      ('Perf', 'Android',  'Xoom',       'Tegra2',      'Arm7',   'Release', None,           None,      {'device': 'xoom'}, f_android, LINUX),
      ('Test', 'Android',  'IntelRhb',   'SGX544',      'x86',    'Debug',   None,           None,      {'device': 'intel_rhb'}, f_android, LINUX),
      ('Test', 'Android',  'IntelRhb',   'SGX544',      'x86',    'Release', None,           None,      {'device': 'intel_rhb'}, f_android, LINUX),
      ('Perf', 'Android',  'IntelRhb',   'SGX544',      'x86',    'Release', None,           None,      {'device': 'intel_rhb'}, f_android, LINUX),
      ('Test', 'ChromeOS', 'Alex',       'GMA3150',     'x86',    'Debug',   None,           None,      {'board': 'x86-alex', 'bench_pictures_cfg': 'no_gpu'}, f_cros, LINUX),
      ('Test', 'ChromeOS', 'Alex',       'GMA3150',     'x86',    'Release', None,           None,      {'board': 'x86-alex', 'bench_pictures_cfg': 'no_gpu'}, f_cros, LINUX),
      ('Perf', 'ChromeOS', 'Alex',       'GMA3150',     'x86',    'Release', None,           None,      {'board': 'x86-alex', 'bench_pictures_cfg': 'no_gpu'}, f_cros, LINUX),
      ('Test', 'ChromeOS', 'Link',       'HD4000',      'x86_64', 'Debug',   None,           None,      {'board': 'link', 'bench_pictures_cfg': 'no_gpu'}, f_cros, LINUX),
      ('Test', 'ChromeOS', 'Link',       'HD4000',      'x86_64', 'Release', None,           None,      {'board': 'link', 'bench_pictures_cfg': 'no_gpu'}, f_cros, LINUX),
      ('Perf', 'ChromeOS', 'Link',       'HD4000',      'x86_64', 'Release', None,           None,      {'board': 'link', 'bench_pictures_cfg': 'no_gpu'}, f_cros, LINUX),
      ('Test', 'ChromeOS', 'Daisy',      'MaliT604',    'Arm7',   'Debug',   None,           None,      {'board': 'daisy', 'bench_pictures_cfg': 'no_gpu'}, f_cros, LINUX),
      ('Test', 'ChromeOS', 'Daisy',      'MaliT604',    'Arm7',   'Release', None,           None,      {'board': 'daisy', 'bench_pictures_cfg': 'no_gpu'}, f_cros, LINUX),
      ('Perf', 'ChromeOS', 'Daisy',      'MaliT604',    'Arm7',   'Release', None,           None,      {'board': 'daisy', 'bench_pictures_cfg': 'no_gpu'}, f_cros, LINUX),
  ]
