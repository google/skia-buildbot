...
def setup_compile_builders(helper, do_upload_render_results,
  ...
  builder_specs = [
      ...
      ('Ubuntu13.10', 'GCC4.8', 'Debug',   'Arm7',   'NexusS',      None,      True,  f_android, LINUX,  S_PERCOMMIT, {'device': 'nexus_s'}),
      ('Ubuntu13.10', 'GCC4.8', 'Release', 'Arm7',   'NexusS',      None,      True,  f_android, LINUX,  S_PERCOMMIT, {'device': 'nexus_s'}),
      ('Ubuntu13.10', 'GCC4.8', 'Debug',   'Arm7',   'Nexus4',      None,      True,  f_android, LINUX,  S_PERCOMMIT, {'device': 'nexus_4'}),
      ('Ubuntu13.10', 'GCC4.8', 'Release', 'Arm7',   'Nexus4',      None,      True,  f_android, LINUX,  S_PERCOMMIT, {'device': 'nexus_4'}),
      ('Ubuntu13.10', 'GCC4.8', 'Debug',   'Arm7',   'Nexus7',      None,      True,  f_android, LINUX,  S_PERCOMMIT, {'device': 'nexus_7'}),
      ('Ubuntu13.10', 'GCC4.8', 'Release', 'Arm7',   'Nexus7',      None,      True,  f_android, LINUX,  S_PERCOMMIT, {'device': 'nexus_7'}),
      ('Ubuntu13.10', 'GCC4.8', 'Debug',   'Arm7',   'Nexus10',     None,      True,  f_android, LINUX,  S_PERCOMMIT, {'device': 'nexus_10'}),
      ('Ubuntu13.10', 'GCC4.8', 'Release', 'Arm7',   'Nexus10',     None,      True,  f_android, LINUX,  S_PERCOMMIT, {'device': 'nexus_10'}),
      ('Ubuntu13.10', 'GCC4.8', 'Debug',   'Arm7',   'GalaxyNexus', None,      True,  f_android, LINUX,  S_PERCOMMIT, {'device': 'galaxy_nexus'}),
      ('Ubuntu13.10', 'GCC4.8', 'Release', 'Arm7',   'GalaxyNexus', None,      True,  f_android, LINUX,  S_PERCOMMIT, {'device': 'galaxy_nexus'}),
      ('Ubuntu13.10', 'GCC4.8', 'Debug',   'Arm7',   'Xoom',        None,      True,  f_android, LINUX,  S_PERCOMMIT, {'device': 'xoom'}),
      ('Ubuntu13.10', 'GCC4.8', 'Release', 'Arm7',   'Xoom',        None,      True,  f_android, LINUX,  S_PERCOMMIT, {'device': 'xoom'}),
      ('Ubuntu13.10', 'GCC4.8', 'Debug',   'x86',    'IntelRhb',    None,      True,  f_android, LINUX,  S_PERCOMMIT, {'device': 'intel_rhb'}),
      ('Ubuntu13.10', 'GCC4.8', 'Release', 'x86',    'IntelRhb',    None,      True,  f_android, LINUX,  S_PERCOMMIT, {'device': 'intel_rhb'}),
      ('Ubuntu13.10', 'GCC4.8', 'Debug',   'Mips',   'Mips',        None,      True,  f_android, LINUX,  S_PERCOMMIT, {'device': 'mips'}),
      ('Ubuntu13.10', 'GCC4.8', 'Debug',   'Arm7',   'NvidiaLogan', None,      True,  f_android, LINUX,  S_PERCOMMIT, {'device': 'nvidia_logan'}),
      ('Ubuntu13.10', 'GCC4.8', 'Release', 'Arm7',   'NvidiaLogan', None,      True,  f_android, LINUX,  S_PERCOMMIT, {'device': 'nvidia_logan'}),
      ('Ubuntu13.10', 'GCC4.8', 'Debug',   'x86',    'Alex',        None,      True,  f_cros,    LINUX,  S_PERCOMMIT, {'board': 'x86-alex', 'bench_pictures_cfg': 'no_gpu'}),
      ('Ubuntu13.10', 'GCC4.8', 'Release', 'x86',    'Alex',        None,      True,  f_cros,    LINUX,  S_PERCOMMIT, {'board': 'x86-alex', 'bench_pictures_cfg': 'no_gpu'}),
      ('Ubuntu13.10', 'GCC4.8', 'Debug',   'x86_64', 'Link',        None,      True,  f_cros,    LINUX,  S_PERCOMMIT, {'board': 'link', 'bench_pictures_cfg': 'no_gpu'}),
      ('Ubuntu13.10', 'GCC4.8', 'Release', 'x86_64', 'Link',        None,      True,  f_cros,    LINUX,  S_PERCOMMIT, {'board': 'link', 'bench_pictures_cfg': 'no_gpu'}),
      ('Ubuntu13.10', 'GCC4.8', 'Debug',   'Arm7',   'Daisy',       None,      True,  f_cros,    LINUX,  S_PERCOMMIT, {'board': 'daisy', 'bench_pictures_cfg': 'no_gpu'}),
      ('Ubuntu13.10', 'GCC4.8', 'Release', 'Arm7',   'Daisy',       None,      True,  f_cros,    LINUX,  S_PERCOMMIT, {'board': 'daisy', 'bench_pictures_cfg': 'no_gpu'}),
