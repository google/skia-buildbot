...
def setup_compile_builders(helper, do_upload_render_results,
  ...
  builder_specs = [
      ...
      ('Ubuntu13.10', 'GCC4.8', 'Debug',   'Arm7',   'Android_Neon',    None,  True,  f_android, LINUX,  S_PERCOMMIT, {'device': 'nexus4'}),
      ('Ubuntu13.10', 'GCC4.8', 'Release', 'Arm7',   'Android_Neon',    None,  True,  f_android, LINUX,  S_PERCOMMIT, {'device': 'nexus4'}),
