...
from master_builders_cfg import f_android, LINUX, S_PERCOMMIT, S_COMMIT_OR_SKP
...
def setup_test_and_perf_builders(helper, do_upload_render_results,
  ...
  builder_specs = [
      ...
      ('Perf', 'Android',  'Nexus4',     'Adreno320',   'Arm7',   'Release', None,           None,      f_android, LINUX,  S_COMMIT_OR_SKP, {'device': 'nexus_4'}),
      ...
      ('Perf', 'Android',  'Nexus7',     'Tegra3',      'Arm7',   'Release', None,           None,      f_android, LINUX,  S_COMMIT_OR_SKP, {'device': 'nexus_7'}),
