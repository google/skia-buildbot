/*
	G3 Compile Server for Skia Bots.
*/
...
var (
	...
	storageBucket  = flag.String("bucket", "g3-compile-tasks", "Storage bucket where g3 compile task JSON files will be kept.")
	subscriberName = flag.String("subscriber", "g3-compile-tasks", "ID of the pubsub subscriber.")
	topic          = flag.String("topic", "g3-compile-tasks", "Google Cloud PubSub topic of the eventbus.")

	// Datastore params
	namespace   = flag.String("namespace", "g3-compile-staging", "The Cloud Datastore namespace, such as 'g3-compile'.")
	projectName = flag.String("project_name", "skia-corp", "The Google Cloud project name.")
)
