...
(function(){
  ...
  function addChangesSection(title, changes, table) {
    ...
    changes.forEach(function(change) {
      ...
      labelAnchor.href = 'https://skia-review.googlesource.com/c/' + change._number;
      labelAnchor.target = '_blank';
      labelAnchor.textContent = 'skrev/' + change._number;
      label.appendChild(labelAnchor);  // ADD IT IN A BETTER WAY
      label.textContent = change.subject;
    });
  }
