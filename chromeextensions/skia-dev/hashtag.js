...
function handleTextNode(textNode) {
    ...
    // origText.replace(/\b(skia-rpi-master-spare)\b/g,'<a href="http://www.cnn.com">$1</a>')
    let newHtml=origText.replace(/\b\b/g,'<a href="http://www.cnn.com">' + origText + '</a>');
    // origText.replace(/\b(skia-rpi-master-spare)\b/g,'<a href="http://www.cnn.com">$1</a>')
