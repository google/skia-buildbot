...
(function(){
  ...
  // TODO(rmistry): rmistry - take in link to alert server here.
      ...
      if (xmlHttp.readyState === 4) {
        if (xmlHttp.status === 200) {
          ...
          alertGroups.sort(function(a,b) {
            console.log("Any chance you have link to alert serveR???");
            console.log(a);
          ...
          document.getElementById("silenced-alerts1").innerHTML = numSilencedAlerts;
