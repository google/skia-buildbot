...
GrBackendTexture backEndTexture; // GPU Only.</pre
      ...
      : html`
          <div id="submit">
            ...
            <a
              ...
              ?hidden=${!ele.bug_link}
              target="_blank"
              href=${ele.bugLink(ele.runResults.fiddleHash)}
              >File Bug</a
            >
            <details hidden$="[[_basic_mode]]">
              ...
              <input
                ...
                readonly
                size="150"
                value="&lt;a href='https://fiddle.skia.org/c/${ele.runResults
                  .fiddleHash}'>&lt;img src='https://fiddle.skia.org/i/${ele
                  .runResults.fiddleHash}_raster.png'>&lt;/a>"
              />
              ...
              <input
                ...
                readonly
                size="150"
                value="&lt;fiddle-embed name='${ele.runResults
    ...
    return html`
      ...
      <div class="layout horizontal">
        ...
        <div ?hidden=${!ele.embedded}>
          ...
          <spinner-sk></spinner-sk>
          <a
            href="https://fiddle.skia.org/c/${ele.runResults.fiddleHash}"
            target="_blank"
            >Pop-out</a
          >
        </div>
      ...
      <div id="results" class="horizontal layout self-start">
        <div ?hidden=${!ele.showCPU()} class="vertical layout center-justified">
          <img
            ...
            title="CPU"
            src="${ele.domain}/i/${ele.runResults.fiddleHash}_raster.png"
          ...
          <video
            ...
            autoplay
            loop=${ele.loop}
            src="${ele.domain}/i/${ele.runResults.fiddleHash}_cpu.webm"
            width=${ele._options.width}
            height=${ele._options.height}
          >
          </video>
        ...
        <div ?hidden=${!ele.showGPU()} class="vertical layout center-justified">
          <img
            ?hidden=${ele._options.animated}
            title="GPU"
            src="${ele.domain}/i/${ele.runResults.fiddleHash}_gpu.png"
            width=${ele._options.width}
            height=${ele._options.height}
          />
          <video
            ...
            loop=${ele.loop}
            autoplay
            src="${ele.domain}/i/${ele.runResults.fiddleHash}_gpu.webm"
            width=${ele._options.width}
            height=${ele._options.height}
          ></video>
        ...
        <div ?hidden=${!ele.showLinks()}>
          <div class="vertical layout center">
            <a href="${ele.domain}/i/${ele.runResults.fiddleHash}.pdf">PDF</a>
          </div>
          <div class="vertical layout center">
            <a href="${ele.domain}/i/${ele.runResults.fiddleHash}.skp">SKP</a>
          </div>
          <div class="vertical layout center">
            <a
              href="https://debugger.skia.org/loadfrom?url=https://fiddle.skia.org/i/${ele
                .runResults.fiddleHash}.skp"
              >Debug</a
            >
          </div>
        </div>
  ...
  <div ?hidden=${!ele.runResults.runtime_error}>
    <h2>Runtime Errors</h2>
    <div>${ele.runResults.runtime_error}</div>
  </template>
