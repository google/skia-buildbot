          ...
          <details open=${ele.options_open}>
            ...
            <div class="options">
              ...
              <checkbox-sk
                id="srgb"
                label="sRGB"
                ?checked=${ele.options.srgb}
                ?disabled=${ele.options.f16}
                ?hidden=${ele.basic_mode}
              ></checkbox-sk>
              ...
              <checkbox-sk
                id="f16"
                title="Half floats"
                label=${ele.options.f16}
                ?disabled=${!ele.options.srgb}
                ?hidden=${ele.basic_mode}
              >
              </checkbox-sk>
              ...
              <checkbox-sk
                id="animated"
                label="Animation"
                ?checked=${ele.options.animated}
              ></checkbox-sk>

              <div ?hidden=${!ele.options.animated} class="offset">
                <label>
                  duration (seconds)
                  <input
                    type="number"
                    min="1"
                    max="300"
                    .value=${ele.options.duration}
                    ?disabled=${!ele.options.animated}
                    @click=${ele.animatedClick}
                  />
                </label>

                <div ?hidden=${!ele.options.animated}>
...
double frame;    // A value in [0, 1] of where we are in the animation.</pre
              ...
              <div>
                <checkbox-sk
                  ...
                  ?checked=${ele.options.offscreen}
                  @click=${ele.offscreenClick}
                  ?hidden=${ele.basic_mode}
                >
                </checkbox-sk>
                <div ?hidden=${!ele.options.offscreen} class="offset">
                  <div>
                    <label>
                      Width
                      <input
                        ...
                        min="4"
                        max="2048"
                        value=${ele.options.offscreen_width}
                      />
                    </label>
                    <label>
                      Height
                      <input
                        ...
                        min="4"
                        max="2048"
                        value=${ele.options.offscreen_height}
                      />
                    </label>
                    <label>
                      Sample Count
                      <input
                        type="number"
                        value=${ele.options.offscreen_sample_count}
                      />
                    </label>
                  </div>
                  <checkbox-sk
                    ...
                    ?checked=${ele.options.offscreen_texturable}
                  ...
                  <div class="indent">
                    <checkbox-sk
                      ...
                      ?checked=${ele.options.offscreen_mipmap}
                      ?disabled=${!ele.options.offscreen_texturable}
                    ></checkbox-sk>
                  </div>
                  ...
                  <pre
                    class="source-select"
                    ?hidden=${ele.options.offscreen_texturable}
                  >
                ...
                ${ele.sources.map((source, index) => {
                  html`
                    <img
                      width="64"
                      height="64"
                      ?selected=${source === ele.options.source}
                      name=${source}
                      src="${ele.domain}/s/${ele.options.source}"
                      class="imgsrc"
                    />
                  `;
                })}
              </select-sk>
              <div ?hidden=${!ele.options.source} class="offset">
                <checkbox-sk
                  title="The backEndTexture is mipmapped."
                  ?checked=${ele.options.source_mipmap}
                  >MipMap</checkbox-sk
                >
                <h4>These globals are now defined:</h4>
                <pre class="source-select">
    ...
    return html`
      <div id="results" class="horizontal layout self-start">
        <div ?hidden=${!ele.showCPU()} class="vertical layout center-justified">
          <img
            ?hidden=${ele.options.animated}
            title="CPU"
            src="${ele.domain}/i/${ele.fiddlehash}_raster.png"
            width=${ele.options.width}
            height=${ele.options.height}
          />
          <video
            ?hidden=${!ele.options.animated}
            title="CPU"
