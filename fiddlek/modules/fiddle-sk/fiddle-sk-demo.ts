...
document.querySelector('#mode_after_run_errors')!.addEventListener('click', () => {
  beforeMode();
  fiddle.config = {
    display_options: true,
    embedded: false,
...
document.querySelector('#mode_after_run_success')!.addEventListener('click', () => {
  beforeMode();
