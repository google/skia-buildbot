...
Named fiddles come predominately (TODO check with jcgregorio if exclusively) from the Skia repo.
They are currently checked in to [$SKIA_ROOT/docs/examples](https://skia.googlesource.com/skia/+/refs/heads/main/docs/examples).
