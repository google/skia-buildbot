...
import (
	...
	codereview "go.skia.org/infra/docsy/go/codereview"
...
// MainIssue provides a mock function with given fields:
func (_m *CodeReview) MainIssue() codereview.Issue {
	ret := _m.Called()

	var r0 codereview.Issue
	if rf, ok := ret.Get(0).(func() codereview.Issue); ok {
		r0 = rf()
	} else {
		r0 = ret.Get(0).(codereview.Issue)
	}
