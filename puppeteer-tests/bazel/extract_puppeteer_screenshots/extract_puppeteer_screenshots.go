...
var outputDir = flag.String("output_dir", "", "Directory inside which to extract screenshots.")
...
func extractFileFromZipArchive(file *zip.File, outputPath string) error {
