"""This module contains a Gazelle-generated go_repositories macro that mirrors our go.mod file."""

load("@bazel_gazelle//:deps.bzl", "go_repository")

def go_repositories():
    """This Gazelle-generated macro defines repositories for the Go modules in our go.mod file."""
    ...
    go_repository(
        ...
        sum = "h1:qmrsmPqL7jK5f7dwLc4oDBZu/3pzB19tvhnP4TngNYY=",
        version = "v0.0.0-20201026145851-73411c8fa237",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:/gZVO/TtBZ9jVAf8P5ZySajCofEId/8jR1PjkdSoqQ4=",
        version = "v0.0.0-20201030010431-2feb2bb1ff51",
    )
    go_repository(
