...
def go_repositories():
    ...
    go_repository(
        name = "com_github_jwilder_dockerize",
    ...
    go_repository(
        ...
        sum = "h1:HUC3fAoepH3RpcQXiJhXWWYizjQ5r7YjI7SO9ZbHf9s=",
        version = "v1.15.1",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:MvEeYmzkzk0Rsw+ceqy28aIJN7Mum+4aYqBwCMqYNug=",
        version = "v1.6.8-0.20221117013220-504804fb50de",
    )
