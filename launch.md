...
- Metrics available at port 20000 of a pod will automatically be gathered and be
available on [prom2.skia.org](https://prom2.skia.org/). Legacy apps report metrics
