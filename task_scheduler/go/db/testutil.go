...
func TestCommentDB(t testutils.TestingT, db CommentDB) {
	...
	tc4 := types.MakeTaskComment(4, 1, 1, 2, now.Add(time.Millisecond))
	tc5 := types.MakeTaskComment(5, 1, 2, 2, now.Add(2*time.Millisecond))
	tc6 := types.MakeTaskComment(6, 2, 3, 3, now.Add(3*time.Millisecond))
	...
	sc4 := types.MakeTaskSpecComment(4, 1, 2, now.Add(time.Millisecond))
	sc5 := types.MakeTaskSpecComment(5, 2, 3, now.Add(2*time.Millisecond))
	...
	cc4 := types.MakeCommitComment(4, 1, 2, now.Add(time.Millisecond))
	cc5 := types.MakeCommitComment(5, 2, 3, now.Add(2*time.Millisecond))
...
func TestModifiedComments(t testutils.TestingT, m ModifiedComments) {
	...
	c2 := types.MakeTaskComment(2, 2, 2, 2, time.Unix(0, 1470674376000000))
	m.TrackModifiedTaskComment(c2)
	c3 := types.MakeTaskComment(3, 3, 3, 3, time.Unix(0, 1470674884000000))
	...
	// Insert two more comments.
	c4 := types.MakeTaskSpecComment(4, 4, 4, time.Unix(0, 1470674976000000))
	m.TrackModifiedTaskSpecComment(c4)
	c5 := types.MakeCommitComment(5, 5, 5, time.Unix(0, 1470675884000000))
