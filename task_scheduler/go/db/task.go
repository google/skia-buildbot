...
// MiniTask is a subset of the information found in a Task.
...
// MakeMiniTask creates a MiniTask from the Task instance.
func (t *Task) MakeMiniTask() *MiniTask {
	return &MiniTask{
		Id:             t.Id,
		Status:         t.Status,
		SwarmingTaskId: t.SwarmingTaskId,
...
// Copy returns a copy of the MiniTask.
func (t *MiniTask) Copy() *MiniTask {
	return &MiniTask{
		Id:             t.Id,
		Status:         t.Status,
		SwarmingTaskId: t.SwarmingTaskId,
