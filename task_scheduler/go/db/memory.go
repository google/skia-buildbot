...
// NewInMemoryFederatedDB returns an extremely simple, inefficient, in-memory
// UnifiedDB implementation.
func NewInMemoryFederatedDB() UnifiedDB {
	return NewFederatedDB(NewInMemoryTaskDB(), NewInMemoryJobDB(), &CommentBox{})
}
