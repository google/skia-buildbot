...
type CommentDB interface {
	...
	// Context is canceled. The channel will immediately produce a slice of
	// TaskComments which may or may not be empty.
	...
	// closed when the given Context is canceled. The channel will
	// immediately produce a slice of TaskSpecComments which may or may not
	// be empty.
	...
	// when the given Context is canceled. The channel will immediately
	// produce a slice of CommitComments which may or may not be empty.
