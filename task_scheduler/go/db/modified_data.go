...
// See docs for ModifiedTasks interface.
func (m *ModifiedTasksImpl) TrackModifiedTask(t *Task) error {
...
// See docs for ModifiedTasks interface.
func (m *ModifiedTasksImpl) TrackModifiedTasksGOB(gobs map[string][]byte) error {
...
// See docs for ModifiedJobs interface.
func (m *ModifiedJobsImpl) TrackModifiedJob(j *Job) error {
	var buf bytes.Buffer
...
// See docs for ModifiedJobs interface.
func (m *ModifiedJobsImpl) TrackModifiedJobsGOB(gobs map[string][]byte) error {
	m.m.TrackModifiedEntries(gobs)
	return nil
}
