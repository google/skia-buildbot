...
func NewClient(serverRoot string, c *http.Client, modTasks db.ModifiedTasks, modJobs db.ModifiedJobs) (db.RemoteDB, error) {
	if modTasks == nil {
		return nil, errors.New("ModifiedTasks is required.")
	}
	if modJobs == nil {
		return nil, errors.New("ModifiedJobs is required.")
	}
	return &client{
