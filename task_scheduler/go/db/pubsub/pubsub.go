...
func NewTaskSubscriber(c *pubsub.Client, topic, subscriberLabel string, callback func(*db.Task) error) (*TaskSubscriber, error) {
...
// otherwise cannot ever be processed, the callback should return nil to prevent
// the message from being re-sent.
func NewJobSubscriber(c *pubsub.Client, topic, subscriberLabel string, callback func(*db.Job) error) (*JobSubscriber, error) {
	s, err := newSubscriber(c, topic, subscriberLabel, func(m *pubsub.Message) error {
		var j db.Job
