...
func (d *InMemoryTaskDB) SearchTasks(ctx context.Context, _ string, _ ...firestore.Where) (string, []*types.Task, error) {
...
func (d *InMemoryJobDB) SearchJobs(ctx context.Context, _ string, _ ...firestore.Where) (string, []*types.Job, error) {
