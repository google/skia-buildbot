...
type JobCache interface {
	...
	// TriggeredJobsForCommit indicates whether or not we triggered any jobs
	// for the given repo/commit.
	TriggeredJobsForCommit(string, string) (bool, error)
...
// See documentation for JobCache interface.
func (c *jobCache) TriggeredJobsForCommit(repo, rev string) (bool, error) {
	c.mtx.RLock()
	defer c.mtx.RUnlock()
