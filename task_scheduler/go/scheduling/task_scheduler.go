...
func testednessIncrease(c *taskCandidate, stoleFrom *types.Task) float64 {
	...
	if stoleFrom == nil {
		...
		// This is a bisect/backfill or a retry.
		...
		if stoleFrom.Status == types.TASK_STATUS_FAILURE {
			...
			// To illustrate:
			// Retry task at c1:
			// Actual:                 Pretend       +---------+  Pretend      +---------+
			//         c2              before:   c2  | success |  after:   c2  | success |
			//            +---------+                |         |               +---------+
			//         c1 | mishap  |            c1  |         |           c1  | running |
			//            +---------+                +---------+               +---------+
			//
			// Bisect task with blamelist {c1, c2} at c1:
			// Actual:                 Pretend       +---------+  Pretend      +---------+
			//         c3              before    c3  | success |  after:   c3  | success |
			//            +---------+                |         |               |         |
			//         c2 | mishap  |            c2  |         |           c2  |         |
			//            |         |                |         |               +---------+
			//         c1 |         |            c1  |         |           c1  | running |
