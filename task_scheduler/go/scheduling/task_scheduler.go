...
// Process the task candidates. Caller must hold tCacheMtx.
...
// them, and prepares them to be triggered. Caller must hold tCacheMtx.
...
// to relative priorities in the queue. Caller must hold tCacheMtx.
...
// their status in the DB. Caller must hold tCacheMtx.
...
// state has changed. Caller must hold tCacheMtx.
...
// in a map keyed by name. Caller must hold tCacheMtx.
