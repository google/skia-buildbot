...
var (
	...
	PUBSUB_TOPIC_SWARMING_TASKS_INTERNAL_FULL = fmt.Sprintf(PUBSUB_FULLY_QUALIFIED_TOPIC_TMPL, common.PROJECT_ID, PUBSUB_TOPIC_SWARMING_TASKS_INTERNAL)

	PUSH_URL_SWARMING_TASKS = fmt.Sprintf("/pubsub/%s", PUBSUB_TOPIC_SWARMING_TASKS)
)
