...
func TestFindTaskCandidatesForJobs(t *testing.T) {
	...
	tc1 := &taskCandidate{
		...
		TaskSpec: ts[rs1][tcc_testutils.BuildTaskName].Copy(),
	}
	tc2 := &taskCandidate{
		Jobs: jobSet(j1),
		TaskKey: types.TaskKey{
		...
		TaskSpec: ts[rs1][tcc_testutils.TestTaskName].Copy(),
	}
	...
	tc3 := &taskCandidate{
		...
		TaskSpec: ts[rs2][tcc_testutils.BuildTaskName].Copy(),
	}
	tc4 := &taskCandidate{
		Jobs: jobSet(j2),
		TaskKey: types.TaskKey{
		...
		TaskSpec: ts[rs2][tcc_testutils.TestTaskName].Copy(),
	}
	tc5 := &taskCandidate{
		Jobs: jobSet(j3),
		TaskKey: types.TaskKey{
		...
		TaskSpec: ts[rs2][tcc_testutils.PerfTaskName].Copy(),
	}
