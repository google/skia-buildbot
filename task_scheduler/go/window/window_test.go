...
func TestWindowNoRepos(t *testing.T) {
	...
	assert.False(t, w.TestTime(time.Unix(0, startTs))) // Non-inclusive.
...
func TestWindowRepoAndDuration2(t *testing.T) {
	...
	// commits (index 9-19) will be in range.
	test(0, false)
	test(8, false) // Non-inclusive.
	test(9, true)
	test(19, true)
}
