...
func TestCopyTaskKey(t *testing.T) {
	...
	deepequal_testutils.AssertCopy(t, v, v.Copy())
}
...
func TestUpdateFromSwarmingInvalid(t *testing.T) {
	...
	// Unchanged.
	deepequal_testutils.AssertDeepEqual(t, task, copy)
}
...
func TestUpdateFromSwarmingInit(t *testing.T) {
	...
	deepequal_testutils.AssertDeepEqual(t, task1, &Task{
		Id: "A",
		TaskKey: TaskKey{
			RepoState: RepoState{
				Repo:     "C",
	...
	deepequal_testutils.AssertDeepEqual(t, task2, &Task{
		Id: "A",
		TaskKey: TaskKey{
			RepoState: RepoState{
				Repo:     "C",
...
func TestUpdateFromSwarmingUpdate(t *testing.T) {
	...
	deepequal_testutils.AssertDeepEqual(t, task, &Task{
		Id: "A",
		TaskKey: TaskKey{
			RepoState: RepoState{
				Repo:     "C",
...
func TestTaskSort(t *testing.T) {
	...
	deepequal_testutils.AssertDeepEqual(t, expected, tasks)
}
