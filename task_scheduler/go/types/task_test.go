...
func TestUpdateFromTaskResultMismatched(t *testing.T) {
	...
	s := &TaskResult{
		...
		Tags: map[string][]string{
			SWARMING_TAG_ID:       []string{"B"},
			SWARMING_TAG_NAME:     []string{"A"},
			SWARMING_TAG_REPO:     []string{"A"},
			SWARMING_TAG_REVISION: []string{"A"},
		},
	}
...
func TestUpdateFromTaskResultInit(t *testing.T) {
	...
	s := &TaskResult{
		...
		Status:   TASK_STATUS_SUCCESS,
		Tags: map[string][]string{
			SWARMING_TAG_ID:             []string{"A"},
			SWARMING_TAG_NAME:           []string{"B"},
			SWARMING_TAG_REPO:           []string{"C"},
			SWARMING_TAG_REVISION:       []string{"D"},
			SWARMING_TAG_PARENT_TASK_ID: []string{"E", "F"},
			SWARMING_TAG_FORCED_JOB_ID:  []string{"G"},
		},
