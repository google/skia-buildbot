...
func setup(t testing.TestingT) (context.Context, *TryJobIntegrator, *git_testutils.GitBuilder, *mockhttpclient.URLMock, func()) {
...
func Params(t testing.TestingT, builder, project, revision, server, issue, patchset string) buildbucket.Parameters {
...
func Build(t testing.TestingT, now time.Time) *buildbucket_api.ApiCommonBuildMessage {
...
func MockHeartbeats(t testing.TestingT, mock *mockhttpclient.URLMock, now time.Time, jobs []*types.Job, resps map[string]*heartbeatResp) {
