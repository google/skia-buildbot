...
tryjobs in a while. Check the logs and determine what is going on. If the git
servers are down or having problems, make sure that the team is aware by filing
a bug or pinging IRC:
http://go/gob-oncall
...
for in-progress tryjobs or sent status updates to Buildbucket for completed tryjobs in a while. Check the logs and determine what is going on.
