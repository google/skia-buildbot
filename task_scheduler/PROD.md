...
period of time. The configuration can be set by running `gcloud storage buckets update
--lifecycle-file=bucket-lifecycle-config.json gs://skia-task-scheduler`.
