...
// The configBuilder function generates a common configuration for webpack.
...
//
//        let common = configBuilder(__dirname);
...
module.exports.configBuilder = function(dirname) {
  let common = {
    entry: {
