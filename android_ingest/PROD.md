...
and look at the "Recent Bad Requests" section and see why they are failing.
Historical issue have been bad serializing of the data that is POSTed to the
server where all the data was actually just encoded as one long string.