...
func UploadHandler(w http.ResponseWriter, r *http.Request) {
	...
	//
	// Create a unique filename using the hash and the benchData keys.
	keyparts := []string{}
	...
	writer := bucket.Object(filepath.Join(gcsPath, time.Now().Format("2006/01/02/15/"), filename)).NewWriter(context.Background())
