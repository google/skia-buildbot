...
// Continuous periodically queries the android build api and looks for new
...
// New returns a new *Continuous.
func New(branch, repoUrl, workdir string, client *http.Client, local bool) (*Continuous, error) {
...
// and error occurred.
func (c *Continuous) Last() (int64, int64, error) {
