...
func getEvictedPods(ctx context.Context, clientset *kubernetes.Clientset, metrics map[metrics2.Int64Metric]struct{}) error {
	...
	// TODO(rmistry): Should this be container something? look at the logs again for p.
	// Make a struct for EvictedPod and then do map from appToEvictedPods
	// Loop through this at the end to create a single alert for this!.
