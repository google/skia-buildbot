...
build-frontend-ci:
	...
	# The following apps are commented out because they require running a Docker container as part of
	# their build process, which currently produces an authorization error when run from the
	# Infra-PerCommit-Build tryjob, e.g.:
	#
