...
#
# We build build-frontend-ci first because it invokes "npm ci", needed by the latter Make targets.
.PHONY: all
all: build-frontend-ci infra-sk autoroll datahopper perf sharedgo ct ctfe cq_watcher status task_scheduler
