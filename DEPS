...
vars = {
  ...
  'skia_tools_version': 'git_revision:59aa56349f0e0e7e51773a0cc976d4a1c29da626',
  'tools_git_version':  'version:3@2.51.2.chromium.11',
}

deps = {
  'depot_tools': {
    'url': 'https://chromium.googlesource.com/chromium/tools/depot_tools.git@8f894deeff969a354daf95ba5b788b0921e7a55f',
    'condition': 'False',
  },
  'cipd_bin_packages': {
    'packages': [
