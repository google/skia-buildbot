...
vars = {
  ...
  'skia_tools_version': 'git_revision:4fb5945421046bfe4d893d2013934e03dd1580cd',
  'tools_git_version':  'version:3@2.47.0.chromium.11',
}

deps = {
  'depot_tools': {
    'url': 'https://chromium.googlesource.com/chromium/tools/depot_tools.git@a6ce588715870728740717ab2ff34b606ffc3e50',
    'condition': 'False',
  },
  'cipd_bin_packages': {
    'packages': [
