...
vars = {
  ...
  'skia_tools_version': 'git_revision:ad5ea87faf245aeb5783ce281a4fdad5f8f239b8',
  'tools_git_version':  'version:2@2.45.2.chromium.11',
}

deps = {
  'depot_tools': {
    'url': 'https://chromium.googlesource.com/chromium/tools/depot_tools.git@43c6415bced9310c0aefabadaac2d405fbd5043d',
    'condition': 'False',
  },
  'cipd_bin_packages': {
    'packages': [
