...
vars = {
  ...
  'skia_tools_version': 'git_revision:e13d18f9806caa18956596f6801052c14a845553',
  'tools_git_version':  'version:3@2.51.2.chromium.11',
}

deps = {
  'depot_tools': {
    'url': 'https://chromium.googlesource.com/chromium/tools/depot_tools.git@2d3d65c04ba94fe8697a4d0a63f198cf8f24bcc2',
    'condition': 'False',
  },
  'cipd_bin_packages': {
    'packages': [
