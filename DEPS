...
vars = {
  ...
  'skia_tools_version': 'git_revision:6177e0e75569f94081533fc90495aaa62d12b0d3',
  'tools_git_version':  'version:3@2.46.0.chromium.11',
}

deps = {
  'depot_tools': {
    'url': 'https://chromium.googlesource.com/chromium/tools/depot_tools.git@2f8e1e499d376e907e71c251188484ae67db5055',
    'condition': 'False',
  },
  'cipd_bin_packages': {
    'packages': [
