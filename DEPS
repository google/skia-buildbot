...
vars = {
  ...
  'skia_tools_version': 'git_revision:08c9231f9613cdadf55277d1a280461aef5c2820',
  'tools_git_version':  'version:3@2.46.2.chromium.11',
}

deps = {
  'depot_tools': {
    'url': 'https://chromium.googlesource.com/chromium/tools/depot_tools.git@c109945e729cb3d8c17f306c9cae9d3f98d7d323',
    'condition': 'False',
  },
  'cipd_bin_packages': {
    'packages': [
