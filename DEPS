...
vars = {
  ...
  'skia_tools_version': 'git_revision:5dfe34f67d5cbc8433ba75818baa8de520c48517',
  'tools_git_version':  'version:3@2.46.0.chromium.11',
}

deps = {
  'depot_tools': {
    'url': 'https://chromium.googlesource.com/chromium/tools/depot_tools.git@9ddf1780c6285cc043af88e7378a93f133cd7d4b',
    'condition': 'False',
  },
  'cipd_bin_packages': {
    'packages': [
