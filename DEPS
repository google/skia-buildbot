...
vars = {
  ...
  'skia_tools_version': 'git_revision:064137920a75e8ac75beead23713707e2e286e8f',
  'tools_git_version':  'version:3@2.47.0.chromium.11',
}

deps = {
  'depot_tools': {
    'url': 'https://chromium.googlesource.com/chromium/tools/depot_tools.git@37c0cf910022b2d75816b0f9f77c53d69a0b2d9f',
    'condition': 'False',
  },
  'cipd_bin_packages': {
    'packages': [
