...
vars = {
  ...
  'skia_tools_version': 'git_revision:f31cdce7e49946aaa4e7ae5e0d2a507eff8e8af4',
  'tools_git_version':  'version:3@2.49.0.chromium.11',
}

deps = {
  'depot_tools': {
    'url': 'https://chromium.googlesource.com/chromium/tools/depot_tools.git@e68bbfc57229f6c1e366f456b92f25a7a2473c37',
    'condition': 'False',
  },
  'cipd_bin_packages': {
    'packages': [
