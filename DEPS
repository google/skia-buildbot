...
vars = {
  ...
  'skia_tools_version': 'git_revision:430369d8e75b6a757c02f74527b79f59f78b3b3b',
  'tools_git_version':  'version:3@2.49.0.chromium.11',
}

deps = {
  'depot_tools': {
    'url': 'https://chromium.googlesource.com/chromium/tools/depot_tools.git@a7571b1596305d6a6fe26c788f24e40c579fcda8',
    'condition': 'False',
  },
  'cipd_bin_packages': {
    'packages': [
