...
vars = {
  ...
  'skia_tools_version': 'git_revision:9602f241b417dfd4d46655dffa6ea1c69939bbd6',
  'tools_git_version':  'version:3@2.51.0.chromium.11',
}

deps = {
  'depot_tools': {
    'url': 'https://chromium.googlesource.com/chromium/tools/depot_tools.git@e3839a11c26be4e68a0df205d2165c2794215207',
    'condition': 'False',
  },
  'cipd_bin_packages': {
    'packages': [
