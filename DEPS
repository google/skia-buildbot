...
vars = {
  ...
  'skia_tools_version': 'git_revision:b556369fb9749ebdd5f60ea4bf4b7a632df00d69',
  'tools_git_version':  'version:3@2.51.2.chromium.11',
}

deps = {
  'depot_tools': {
    'url': 'https://chromium.googlesource.com/chromium/tools/depot_tools.git@8efa575d754b8703d99b0f827528e45aeaa167aa',
    'condition': 'False',
  },
  'cipd_bin_packages': {
    'packages': [
