...
vars = {
  ...
  'skia_tools_version': 'git_revision:e88094ac23d2b7a87ada7c924534ea5e65413744',
  'tools_git_version':  'version:3@2.51.2.chromium.11',
}

deps = {
  'depot_tools': {
    'url': 'https://chromium.googlesource.com/chromium/tools/depot_tools.git@883e6b91c09a762feb16c10c9fba967dfb570882',
    'condition': 'False',
  },
  'cipd_bin_packages': {
    'packages': [
