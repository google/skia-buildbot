...
vars = {
  ...
  'skia_tools_version': 'git_revision:26783aba32cdc789ad8db694fdf2e6c8e5825f58',
  'tools_git_version':  'version:3@2.48.1.chromium.11',
}

deps = {
  'depot_tools': {
    'url': 'https://chromium.googlesource.com/chromium/tools/depot_tools.git@f61e11c19f0d8847b2b6d0dc725871f88be00e4d',
    'condition': 'False',
  },
  'cipd_bin_packages': {
    'packages': [
