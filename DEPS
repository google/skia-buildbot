...
vars = {
  ...
  'skia_tools_version': 'git_revision:72fd79ddaace5f24bb1ce1abeec756261bbc3458',
  'tools_git_version':  'version:2@2.45.2.chromium.11',
}

deps = {
  'depot_tools': {
    'url': 'https://chromium.googlesource.com/chromium/tools/depot_tools.git@334a3acddb21f4acf9c12d2bc47ea84c08a8cff2',
    'condition': 'False',
  },
  'cipd_bin_packages': {
    'packages': [
