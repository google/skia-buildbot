...
vars = {
  ...
  'skia_tools_version': 'git_revision:400de76a98c4bf1481a41b193c9f1a25a37d198a',
  'tools_git_version':  'version:3@2.45.2.chromium.11',
}

deps = {
  'depot_tools': {
    'url': 'https://chromium.googlesource.com/chromium/tools/depot_tools.git@b4102e43a02805cf7bcb100446d27caef1b4e51d',
    'condition': 'False',
  },
  'cipd_bin_packages': {
    'packages': [
