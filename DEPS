...
vars = {
  ...
  'skia_tools_version': 'git_revision:1a29d4378c5a860f699424daae4410a6e8d97a89',
  'tools_git_version':  'version:3@2.49.0.chromium.11',
}

deps = {
  'depot_tools': {
    'url': 'https://chromium.googlesource.com/chromium/tools/depot_tools.git@a55a42f55b59e70daaab2bcc414d0567d7dd375d',
    'condition': 'False',
  },
  'cipd_bin_packages': {
    'packages': [
