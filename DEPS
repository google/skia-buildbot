...
vars = {
  ...
  'skia_tools_version': 'git_revision:6b1e4d74700b32acd710364ae40ea81fe43bd21f',
  'tools_git_version':  'version:3@2.51.0.chromium.11',
}

deps = {
  'depot_tools': {
    'url': 'https://chromium.googlesource.com/chromium/tools/depot_tools.git@88e06ae96e4ffcdfeb412c1e1a5c25948ef50e96',
    'condition': 'False',
  },
  'cipd_bin_packages': {
    'packages': [
