...
vars = {
  ...
  'skia_tools_version': 'git_revision:2a35388fb5f09afb4a184e9db12f38ef63c9d4c1',
  'tools_git_version':  'version:3@2.47.0.chromium.11',
}

deps = {
  'depot_tools': {
    'url': 'https://chromium.googlesource.com/chromium/tools/depot_tools.git@20b9bdcace7ed561d6a75728c85373503473cb6b',
    'condition': 'False',
  },
  'cipd_bin_packages': {
    'packages': [
