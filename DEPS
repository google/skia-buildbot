...
vars = {
  ...
  'skia_tools_version': 'git_revision:56239a1e581ed27f68ff38db260816f41e56f82b',
  'tools_git_version':  'version:3@2.45.2.chromium.11',
}

deps = {
  'depot_tools': {
    'url': 'https://chromium.googlesource.com/chromium/tools/depot_tools.git@9e9fc992803c0c95402c190fb0bd15b787966855',
    'condition': 'False',
  },
  'cipd_bin_packages': {
    'packages': [
