...
vars = {
  ...
  'skia_tools_version': 'git_revision:0457b8183fa6f642fce0c7863ad3cd76bc02ea6c',
  'tools_git_version':  'version:3@2.46.0.chromium.11',
}

deps = {
  'depot_tools': {
    'url': 'https://chromium.googlesource.com/chromium/tools/depot_tools.git@b89b4403516e5bf09bfdc94821453414eca168b4',
    'condition': 'False',
  },
  'cipd_bin_packages': {
    'packages': [
