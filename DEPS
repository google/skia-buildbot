...
vars = {
  ...
  'skia_tools_version': 'git_revision:353c8b4196e449f3d0e0a47aead5af7ff168840e',
  'tools_git_version':  'version:3@2.47.0.chromium.11',
}

deps = {
  'depot_tools': {
    'url': 'https://chromium.googlesource.com/chromium/tools/depot_tools.git@03d405a15ff4935ce750b868d3c586578a586b2a',
    'condition': 'False',
  },
  'cipd_bin_packages': {
    'packages': [
