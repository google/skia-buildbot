...
vars = {
  ...
  'luci_tools_version': 'git_revision:89f6b5944c6a68ec52a989c71b7463a34e07f147',
  'skia_tools_version': 'git_revision:2d420a4dcfc4a12bde29a656249bc2795652c016',
  'tools_git_version':  'version:3@2.47.1.chromium.11',
}

deps = {
  'depot_tools': {
    'url': 'https://chromium.googlesource.com/chromium/tools/depot_tools.git@fb6f75dd38b6eea7cfc5d326c58d9f6968ef2db5',
    'condition': 'False',
  },
  'cipd_bin_packages': {
    'packages': [
