...
vars = {
  ...
  'skia_tools_version': 'git_revision:deca65c224a47e0c24ff99287fd445ffe3145b4a',
  'tools_git_version':  'version:3@2.49.0.chromium.11',
}

deps = {
  'depot_tools': {
    'url': 'https://chromium.googlesource.com/chromium/tools/depot_tools.git@f73c587323cae09c7b82f149b9d30c70218fff01',
    'condition': 'False',
  },
  'cipd_bin_packages': {
    'packages': [
