...
vars = {
  ...
  'skia_tools_version': 'git_revision:9e9b5c63a6f8e970a81510ef3522fa3527ebef80',
  'tools_git_version':  'version:3@2.47.1.chromium.11',
}

deps = {
  'depot_tools': {
    'url': 'https://chromium.googlesource.com/chromium/tools/depot_tools.git@a90906c74d9da1ed0d55b0452c3e00c35fc82c1f',
    'condition': 'False',
  },
  'cipd_bin_packages': {
    'packages': [
