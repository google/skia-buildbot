...
vars = {
  ...
  'skia_tools_version': 'git_revision:649451a11ab200a3d9b7dd2fafae93877a99a67f',
  'tools_git_version':  'version:3@2.51.2.chromium.11',
}

deps = {
  'depot_tools': {
    'url': 'https://chromium.googlesource.com/chromium/tools/depot_tools.git@4ee113471dafc4a4079c41916a743195af388436',
    'condition': 'False',
  },
  'cipd_bin_packages': {
    'packages': [
