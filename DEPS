...
vars = {
  ...
  'skia_tools_version': 'git_revision:e39719a1c0e7fda0d0914e502fff9770fe62a954',
  'tools_git_version':  'version:3@2.46.1.chromium.11',
}

deps = {
  'depot_tools': {
    'url': 'https://chromium.googlesource.com/chromium/tools/depot_tools.git@4b9413003436466d374a306d879338680c54b467',
    'condition': 'False',
  },
  'cipd_bin_packages': {
    'packages': [
