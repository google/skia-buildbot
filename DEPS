...
vars = {
  ...
  'skia_tools_version': 'git_revision:e04dcb74a5231fc4296d3ab4a1e0755164619a10',
  'tools_git_version':  'version:3@2.46.0.chromium.11',
}

deps = {
  'depot_tools': {
    'url': 'https://chromium.googlesource.com/chromium/tools/depot_tools.git@b46b033bd71f548d9e28bc55f878cd4e29f76ad1',
    'condition': 'False',
  },
  'cipd_bin_packages': {
    'packages': [
