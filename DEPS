...
vars = {
  ...
  'luci_tools_version': 'git_revision:922b8b65f3d1e318664755d2634bc5dd87692877',
  'skia_tools_version': 'git_revision:7beaca95d5beb63533d0116f933133f3cfb1e84e',
  'tools_git_version':  'version:3@2.50.0.chromium.11',
}

deps = {
  'depot_tools': {
    'url': 'https://chromium.googlesource.com/chromium/tools/depot_tools.git@ab22114f1f5ccb2d34462f0632e57446cc8858f2',
    'condition': 'False',
  },
  'cipd_bin_packages': {
    'packages': [
