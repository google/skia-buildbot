...
vars = {
  ...
  'skia_tools_version': 'git_revision:25c0effab2145c7eb1190db4b7ffeb794c025505',
  'tools_git_version':  'version:3@2.50.1.chromium.11',
}

deps = {
  'depot_tools': {
    'url': 'https://chromium.googlesource.com/chromium/tools/depot_tools.git@28358f4020ad58b86301a723807f8254326863c1',
    'condition': 'False',
  },
  'cipd_bin_packages': {
    'packages': [
