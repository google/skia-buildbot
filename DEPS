...
vars = {
  ...
  'skia_tools_version': 'git_revision:a5570b3b45a23abad5ac2e571827e99d325c3319',
  'tools_git_version':  'version:3@2.49.0.chromium.11',
}

deps = {
  'depot_tools': {
    'url': 'https://chromium.googlesource.com/chromium/tools/depot_tools.git@974e8762174da32886286c36b85650a943a4b5c1',
    'condition': 'False',
  },
  'cipd_bin_packages': {
    'packages': [
