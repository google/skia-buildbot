...
vars = {
  ...
  'skia_tools_version': 'git_revision:06aaff66658780b682311ab476cc206adfbe0ad9',
  'tools_git_version':  'version:3@2.49.0.chromium.11',
}

deps = {
  'depot_tools': {
    'url': 'https://chromium.googlesource.com/chromium/tools/depot_tools.git@e5cd6f84f00d87af1a69e58d97ecccf66d48e284',
    'condition': 'False',
  },
  'cipd_bin_packages': {
    'packages': [
