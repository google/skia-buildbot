...
vars = {
  ...
  'skia_tools_version': 'git_revision:df2251eb6f2ae78692f6a1331da1133fec396a4c',
  'tools_git_version':  'version:3@2.46.0.chromium.11',
}

deps = {
  'depot_tools': {
    'url': 'https://chromium.googlesource.com/chromium/tools/depot_tools.git@c5df152f103a02f60a2d4d5e8bb6cb5e270c3a47',
    'condition': 'False',
  },
  'cipd_bin_packages': {
    'packages': [
