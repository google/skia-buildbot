...
vars = {
  ...
  'skia_tools_version': 'git_revision:8aa13c17414cfc5a6d64dfa91a7eb0ce723bb685',
  'tools_git_version':  'version:3@2.51.2.chromium.11',
}

deps = {
  'depot_tools': {
    'url': 'https://chromium.googlesource.com/chromium/tools/depot_tools.git@fb0b652edba70f5c4ac867f3beca9e535f905b4c',
    'condition': 'False',
  },
  'cipd_bin_packages': {
    'packages': [
