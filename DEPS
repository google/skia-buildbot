...
vars = {
  ...
  'skia_tools_version': 'git_revision:cf848e50c10017bb0336d9b1f0665106212b252f',
  'tools_git_version':  'version:3@2.47.0.chromium.11',
}

deps = {
  'depot_tools': {
    'url': 'https://chromium.googlesource.com/chromium/tools/depot_tools.git@106363735045d4f81d0a67962d4513ec95dbf7ec',
    'condition': 'False',
  },
  'cipd_bin_packages': {
    'packages': [
