...
vars = {
  ...
  'skia_tools_version': 'git_revision:417d9315f5b9ce50382da3240e4817ed0f27fc93',
  'tools_git_version':  'version:3@2.47.1.chromium.11',
}

deps = {
  'depot_tools': {
    'url': 'https://chromium.googlesource.com/chromium/tools/depot_tools.git@77a800d7294d29ded899af9685c65babb3a62821',
    'condition': 'False',
  },
  'cipd_bin_packages': {
    'packages': [
