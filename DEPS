...
vars = {
  ...
  'luci_tools_version': 'git_revision:bc3b1d21144b010d91632329513cffc357b5ce1a',
...
deps = {
  'depot_tools': {
    'url': 'https://chromium.googlesource.com/chromium/tools/depot_tools.git@e473b90df1020c5d938bb363c6ab91ef4fca896b',
    'condition': 'False',
  },
  'cipd_bin_packages': {
    'packages': [
