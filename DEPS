...
vars = {
  ...
  'skia_tools_version': 'git_revision:e080995c5d213c9ef02ae595d11de06fc4002010',
  'tools_git_version':  'version:2@2.45.2.chromium.11',
}

deps = {
  'depot_tools': {
    'url': 'https://chromium.googlesource.com/chromium/tools/depot_tools.git@6daca505974e4efe9df926521daca261f25f1994',
    'condition': 'False',
  },
  'cipd_bin_packages': {
    'packages': [
