...
vars = {
  ...
  'skia_tools_version': 'git_revision:3c89288303c98247a04392c4eae2aef26569bdd7',
  'tools_git_version':  'version:3@2.47.1.chromium.11',
}

deps = {
  'depot_tools': {
    'url': 'https://chromium.googlesource.com/chromium/tools/depot_tools.git@6cbd7a824340c50ef1aa5cdddf94e14114ade41f',
    'condition': 'False',
  },
  'cipd_bin_packages': {
    'packages': [
