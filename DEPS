...
vars = {
  ...
  'skia_tools_version': 'git_revision:925d3cac96a51152e3404094e2a27a10b7c8cb51',
  'tools_git_version':  'version:3@2.45.2.chromium.11',
}

deps = {
  'depot_tools': {
    'url': 'https://chromium.googlesource.com/chromium/tools/depot_tools.git@791894e4c44fae379faae9b4ca8388577f212a03',
    'condition': 'False',
  },
  'cipd_bin_packages': {
    'packages': [
