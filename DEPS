...
vars = {
  ...
  'skia_tools_version': 'git_revision:4a7db687eea125d4e12f6b659c040df5a335f413',
  'tools_git_version':  'version:3@2.50.1.chromium.11',
}

deps = {
  'depot_tools': {
    'url': 'https://chromium.googlesource.com/chromium/tools/depot_tools.git@e193d0f558ea6cdf25f854b392550562f0404fb2',
    'condition': 'False',
  },
  'cipd_bin_packages': {
    'packages': [
