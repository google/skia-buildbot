...
vars = {
  ...
  'skia_tools_version': 'git_revision:b41233e94d138a278e323ad3f1ce983ff4537920',
  'tools_git_version':  'version:3@2.49.0.chromium.11',
}

deps = {
  'depot_tools': {
    'url': 'https://chromium.googlesource.com/chromium/tools/depot_tools.git@977c37458fda472d8822a8b57e4a83a7bc747471',
    'condition': 'False',
  },
  'cipd_bin_packages': {
    'packages': [
