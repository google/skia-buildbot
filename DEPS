...
vars = {
  ...
  'skia_tools_version': 'git_revision:667c4e94b4a58fa379602f9d7dc0c5851370471a',
  'tools_git_version':  'version:3@2.47.1.chromium.11',
}

deps = {
  'depot_tools': {
    'url': 'https://chromium.googlesource.com/chromium/tools/depot_tools.git@d215a68912de26d84752e56880827c856486e62d',
    'condition': 'False',
  },
  'cipd_bin_packages': {
    'packages': [
