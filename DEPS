...
vars = {
  ...
  'skia_tools_version': 'git_revision:e3ddb182d581fef76fb2cdeaf27cde247d9c517a',
  'tools_git_version':  'version:3@2.49.0.chromium.11',
}

deps = {
  'depot_tools': {
    'url': 'https://chromium.googlesource.com/chromium/tools/depot_tools.git@d4c627ed62f3380adb08909d3600413e81afbcd8',
    'condition': 'False',
  },
  'cipd_bin_packages': {
    'packages': [
