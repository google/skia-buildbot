...
vars = {
  ...
  'skia_tools_version': 'git_revision:c13e7159cdd1dc89fda65f7fc4bb370632364577',
  'tools_git_version':  'version:3@2.46.2.chromium.11',
}

deps = {
  'depot_tools': {
    'url': 'https://chromium.googlesource.com/chromium/tools/depot_tools.git@950ee67c1275e4f1f7ebf1a03908fe853bbed1ed',
    'condition': 'False',
  },
  'cipd_bin_packages': {
    'packages': [
