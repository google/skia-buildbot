...
vars = {
  ...
  'skia_tools_version': 'git_revision:c2f5bb885ba424375ad0f0dd7f1dbdb881079ab1',
  'tools_git_version':  'version:3@2.46.0.chromium.11',
}

deps = {
  'depot_tools': {
    'url': 'https://chromium.googlesource.com/chromium/tools/depot_tools.git@f52dad97479e3d18b55d03134c8c301393df8843',
    'condition': 'False',
  },
  'cipd_bin_packages': {
    'packages': [
