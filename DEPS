...
vars = {
  ...
  'skia_tools_version': 'git_revision:d861560d85cdf1037111d2cbec5191fcca261b29',
  'tools_git_version':  'version:3@2.48.1.chromium.11',
}

deps = {
  'depot_tools': {
    'url': 'https://chromium.googlesource.com/chromium/tools/depot_tools.git@c4e7c8717cbd057339731e8b629c2e29fcba9c42',
    'condition': 'False',
  },
  'cipd_bin_packages': {
    'packages': [
