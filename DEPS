...
vars = {
  ...
  'skia_tools_version': 'git_revision:e1d5da316bdf6c94424e6c453484968c26792bb6',
  'tools_git_version':  'version:3@2.45.2.chromium.11',
}

deps = {
  'depot_tools': {
    'url': 'https://chromium.googlesource.com/chromium/tools/depot_tools.git@1c81122f695a406fa7d113f5c67c8bde7ba3c873',
    'condition': 'False',
  },
  'cipd_bin_packages': {
    'packages': [
