...
vars = {
  ...
  'skia_tools_version': 'git_revision:8acd0e40f584f016ca404e9c07629b82cf97915e',
  'tools_git_version':  'version:3@2.50.0.chromium.11',
}

deps = {
  'depot_tools': {
    'url': 'https://chromium.googlesource.com/chromium/tools/depot_tools.git@4f1723dd1fb9b890b2ab8af2c5a070067ac9d45a',
    'condition': 'False',
  },
  'cipd_bin_packages': {
    'packages': [
