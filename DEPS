...
vars = {
  ...
  'skia_tools_version': 'git_revision:3c9cca49b866e94975c36511a1f1f0896f6ac99b',
  'tools_git_version':  'version:3@2.45.2.chromium.11',
}

deps = {
  'depot_tools': {
    'url': 'https://chromium.googlesource.com/chromium/tools/depot_tools.git@01e29c8b5d6064389f3d3a3ff5c4272e049103b9',
    'condition': 'False',
  },
  'cipd_bin_packages': {
    'packages': [
