...
vars = {
  ...
  'skia_tools_version': 'git_revision:fc2a4298ce83f5c72d3a47fcf827d1162a316580',
  'tools_git_version':  'version:3@2.50.1.chromium.11',
}

deps = {
  'depot_tools': {
    'url': 'https://chromium.googlesource.com/chromium/tools/depot_tools.git@b12a6cc03cf7838d3ea320a5a8b0c2c8d4a6151e',
    'condition': 'False',
  },
  'cipd_bin_packages': {
    'packages': [
