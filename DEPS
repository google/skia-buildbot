...
vars = {
  ...
  'skia_tools_version': 'git_revision:5efd24c25423e2b1a09a7db1c0905032f6a9293c',
  'tools_git_version':  'version:3@2.51.2.chromium.11',
}

deps = {
  'depot_tools': {
    'url': 'https://chromium.googlesource.com/chromium/tools/depot_tools.git@7b0c1c1a39747d16f595fe6300508c128ea1cdd6',
    'condition': 'False',
  },
  'cipd_bin_packages': {
    'packages': [
