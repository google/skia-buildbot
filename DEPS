...
vars = {
  ...
  'skia_tools_version': 'git_revision:ef6b3564f12e322ce7da19967d06f2d4b8938ffa',
  'tools_git_version':  'version:3@2.50.0.chromium.11',
}

deps = {
  'depot_tools': {
    'url': 'https://chromium.googlesource.com/chromium/tools/depot_tools.git@5cc29c7a217801cfa7b7b0aa23144300b49b750d',
    'condition': 'False',
  },
  'cipd_bin_packages': {
    'packages': [
