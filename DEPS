...
vars = {
  ...
  'skia_tools_version': 'git_revision:40eb79dec2d627738fa5c70c61e3a89bc7e43104',
  'tools_git_version':  'version:2@2.45.2.chromium.11',
}

deps = {
  'depot_tools': {
    'url': 'https://chromium.googlesource.com/chromium/tools/depot_tools.git@f4e8e13e8bc5673347f86e1be3ec4ccbf1a440c2',
    'condition': 'False',
  },
  'cipd_bin_packages': {
    'packages': [
