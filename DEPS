...
vars = {
  ...
  'skia_tools_version': 'git_revision:fb93bdd859572124a6e36a9d1499ef3d7f650aea',
  'tools_git_version':  'version:3@2.46.0.chromium.11',
}

deps = {
  'depot_tools': {
    'url': 'https://chromium.googlesource.com/chromium/tools/depot_tools.git@22f6c9d8e942a687cd4294068a5abede94b34eff',
    'condition': 'False',
  },
  'cipd_bin_packages': {
    'packages': [
