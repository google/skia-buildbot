...
vars = {
  ...
  'skia_tools_version': 'git_revision:793884c7084d6a2c0b7a417940a033d91651af2d',
  'tools_git_version':  'version:3@2.50.0.chromium.11',
}

deps = {
  'depot_tools': {
    'url': 'https://chromium.googlesource.com/chromium/tools/depot_tools.git@838762e3aeb6e8bf03ab1a3ea79f9fe2a104df37',
    'condition': 'False',
  },
  'cipd_bin_packages': {
    'packages': [
