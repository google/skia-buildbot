...
vars = {
  ...
  'skia_tools_version': 'git_revision:6e2a6f34d12439f1d44020d8afd362e19ff8bc8b',
  'tools_git_version':  'version:3@2.48.1.chromium.11',
}

deps = {
  'depot_tools': {
    'url': 'https://chromium.googlesource.com/chromium/tools/depot_tools.git@b123624ac67cea6c6b3e629bae5da9ffd33f58e3',
    'condition': 'False',
  },
  'cipd_bin_packages': {
    'packages': [
