...
vars = {
  ...
  'skia_tools_version': 'git_revision:1e4466d51783da30404edb935b788868a146e289',
  'tools_git_version':  'version:3@2.46.0.chromium.11',
}

deps = {
  'depot_tools': {
    'url': 'https://chromium.googlesource.com/chromium/tools/depot_tools.git@c1457823a0f713e5a81dd899868e10d5af1a4c5b',
    'condition': 'False',
  },
  'cipd_bin_packages': {
    'packages': [
