...
vars = {
  ...
  'skia_tools_version': 'git_revision:a06878f25d8757c07423f536a74ee5409a207916',
  'tools_git_version':  'version:2@2.45.2.chromium.11',
}

deps = {
  'depot_tools': {
    'url': 'https://chromium.googlesource.com/chromium/tools/depot_tools.git@ca091f0d16788912df7efa1884207fed84c30239',
    'condition': 'False',
  },
  'cipd_bin_packages': {
    'packages': [
