...
vars = {
  ...
  'skia_tools_version': 'git_revision:da60460a940c2d31c5746ba44a962460db3a0285',
  'tools_git_version':  'version:3@2.46.0.chromium.11',
}

deps = {
  'depot_tools': {
    'url': 'https://chromium.googlesource.com/chromium/tools/depot_tools.git@776298987617eb544c5ef03bc8e67c7f2d0fdcbc',
    'condition': 'False',
  },
  'cipd_bin_packages': {
    'packages': [
