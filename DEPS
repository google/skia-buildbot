...
vars = {
  ...
  'skia_tools_version': 'git_revision:e0480d491b7bbe37f9745c3da33de12fecf416c6',
  'tools_git_version':  'version:3@2.47.1.chromium.11',
}

deps = {
  'depot_tools': {
    'url': 'https://chromium.googlesource.com/chromium/tools/depot_tools.git@c672b3410fbd92beef94f9288bc2c942e5142f21',
    'condition': 'False',
  },
  'cipd_bin_packages': {
    'packages': [
