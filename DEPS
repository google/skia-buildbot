...
vars = {
  ...
  'skia_tools_version': 'git_revision:0f45bef5b019be097b8df49b3272b1d1b3cbb65d',
  'tools_git_version':  'version:3@2.51.2.chromium.11',
}

deps = {
  'depot_tools': {
    'url': 'https://chromium.googlesource.com/chromium/tools/depot_tools.git@85116f17109bbd1e5545aa9c12308a19684cf792',
    'condition': 'False',
  },
  'cipd_bin_packages': {
    'packages': [
