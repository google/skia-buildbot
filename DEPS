...
vars = {
  ...
  'skia_tools_version': 'git_revision:dd753d8252ac993ebf2fa23bfecc2c1f0064446a',
  'tools_git_version':  'version:3@2.48.1.chromium.11',
}

deps = {
  'depot_tools': {
    'url': 'https://chromium.googlesource.com/chromium/tools/depot_tools.git@ab387d1ddc530d405f662904f2df292f700e4b0f',
    'condition': 'False',
  },
  'cipd_bin_packages': {
    'packages': [
