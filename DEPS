...
vars = {
  ...
  'skia_tools_version': 'git_revision:4c3759b8afefd036b5434579f33749516960be2f',
  'tools_git_version':  'version:3@2.46.0.chromium.11',
}

deps = {
  'depot_tools': {
    'url': 'https://chromium.googlesource.com/chromium/tools/depot_tools.git@be5ff1a6c4b227ba9325408dc8b74cbce8105a1e',
    'condition': 'False',
  },
  'cipd_bin_packages': {
    'packages': [
