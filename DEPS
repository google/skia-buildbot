...
vars = {
  ...
  'skia_tools_version': 'git_revision:70e3e4feed088277314718aa7e64121d5e2c46ff',
  'tools_git_version':  'version:3@2.47.0.chromium.11',
}

deps = {
  'depot_tools': {
    'url': 'https://chromium.googlesource.com/chromium/tools/depot_tools.git@c4d75a151973a872ec74e33afb90acde64c48644',
    'condition': 'False',
  },
  'cipd_bin_packages': {
    'packages': [
