...
vars = {
  ...
  'skia_tools_version': 'git_revision:fc6bd168cd2d7871c02eaa6ec384838712fb3549',
  'tools_git_version':  'version:3@2.47.1.chromium.11',
}

deps = {
  'depot_tools': {
    'url': 'https://chromium.googlesource.com/chromium/tools/depot_tools.git@9f48a4ca85ccbd091c99760083c7b5e60367daa9',
    'condition': 'False',
  },
  'cipd_bin_packages': {
    'packages': [
