...
vars = {
  ...
  'skia_tools_version': 'git_revision:c142bd7808f00ea1fee2ebd5e1258d95c7098501',
  'tools_git_version':  'version:3@2.51.0.chromium.11',
}

deps = {
  'depot_tools': {
    'url': 'https://chromium.googlesource.com/chromium/tools/depot_tools.git@35982166cc6ed8b6e9e3ff37ac419bae28e4951f',
    'condition': 'False',
  },
  'cipd_bin_packages': {
    'packages': [
