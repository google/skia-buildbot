...
vars = {
  ...
  'skia_tools_version': 'git_revision:7d908ddd9277caea552df901c4435adc0053690f',
  'tools_git_version':  'version:2@2.45.2.chromium.11',
}

deps = {
  'depot_tools': {
    'url': 'https://chromium.googlesource.com/chromium/tools/depot_tools.git@66df2a3ec70d0628d47df1fdba69838a870a1303',
    'condition': 'False',
  },
  'cipd_bin_packages': {
    'packages': [
