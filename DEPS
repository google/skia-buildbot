...
vars = {
  ...
  'skia_tools_version': 'git_revision:2b8368b69575f34dacf81271c9d5ed0d969efbf6',
  'tools_git_version':  'version:3@2.51.0.chromium.11',
}

deps = {
  'depot_tools': {
    'url': 'https://chromium.googlesource.com/chromium/tools/depot_tools.git@3008b57e5d18ee9c92baf851dd33c61cfd6fad21',
    'condition': 'False',
  },
  'cipd_bin_packages': {
    'packages': [
