...
vars = {
  ...
  'skia_tools_version': 'git_revision:bcb79dd2bd80307b880eea74d64d3f5422d00f8e',
  'tools_git_version':  'version:3@2.51.2.chromium.11',
}

deps = {
  'depot_tools': {
    'url': 'https://chromium.googlesource.com/chromium/tools/depot_tools.git@729f99cb1df9a427f9a64bba0abc62f6b86f9c70',
    'condition': 'False',
  },
  'cipd_bin_packages': {
    'packages': [
