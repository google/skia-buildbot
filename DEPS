...
vars = {
  ...
  'skia_tools_version': 'git_revision:98a334bd44af738ae08e05c826a99c59f09ed377',
  'tools_git_version':  'version:3@2.47.0.chromium.11',
}

deps = {
  'depot_tools': {
    'url': 'https://chromium.googlesource.com/chromium/tools/depot_tools.git@1b58dc68659445b1d97d8341f8158be25eab4957',
    'condition': 'False',
  },
  'cipd_bin_packages': {
    'packages': [
