...
vars = {
  ...
  'skia_tools_version': 'git_revision:e52d3609018611478d40ceb6518dbc80d5cb8314',
  'tools_git_version':  'version:3@2.49.0.chromium.11',
}

deps = {
  'depot_tools': {
    'url': 'https://chromium.googlesource.com/chromium/tools/depot_tools.git@6b2b0240d99e63229587ff5318eec8b1fcbbbdf5',
    'condition': 'False',
  },
  'cipd_bin_packages': {
    'packages': [
