...
vars = {
  ...
  'skia_tools_version': 'git_revision:0804ba8ec3a5b3e69c15e2d6ca3466101c1d9985',
  'tools_git_version':  'version:3@2.50.1.chromium.11',
}

deps = {
  'depot_tools': {
    'url': 'https://chromium.googlesource.com/chromium/tools/depot_tools.git@f88b25b610eb24fdf240a1a7b4baa18f83e95146',
    'condition': 'False',
  },
  'cipd_bin_packages': {
    'packages': [
