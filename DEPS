...
vars = {
  ...
  'skia_tools_version': 'git_revision:90fa48bf59cb6af11428e731aed613b5719d9e01',
  'tools_git_version':  'version:3@2.47.1.chromium.11',
}

deps = {
  'depot_tools': {
    'url': 'https://chromium.googlesource.com/chromium/tools/depot_tools.git@fd65288d4a1445bfff1f54185a166cc6c4818427',
    'condition': 'False',
  },
  'cipd_bin_packages': {
    'packages': [
