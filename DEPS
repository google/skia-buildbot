...
vars = {
  ...
  'skia_tools_version': 'git_revision:4dc1a0710e7da8dbf679ac9f1acdcdfe8304d0cc',
  'tools_git_version':  'version:3@2.51.2.chromium.11',
}

deps = {
  'depot_tools': {
    'url': 'https://chromium.googlesource.com/chromium/tools/depot_tools.git@fe9b05bca6fe48fda19c51f4939f20b59c9bfd48',
    'condition': 'False',
  },
  'cipd_bin_packages': {
    'packages': [
