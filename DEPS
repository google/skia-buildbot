...
vars = {
  ...
  'skia_tools_version': 'git_revision:9e907cc17f5def3d5600a52e811138b8efdfb246',
  'tools_git_version':  'version:3@2.51.0.chromium.11',
}

deps = {
  'depot_tools': {
    'url': 'https://chromium.googlesource.com/chromium/tools/depot_tools.git@5b7fcc4bb71bbbf952a5283fbd621256905be31b',
    'condition': 'False',
  },
  'cipd_bin_packages': {
    'packages': [
