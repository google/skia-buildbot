...
vars = {
  ...
  'skia_tools_version': 'git_revision:79660091fabaad99469766f1950368069eae385b',
  'tools_git_version':  'version:2@2.45.2.chromium.11',
}

deps = {
  'depot_tools': {
    'url': 'https://chromium.googlesource.com/chromium/tools/depot_tools.git@bdcdd7c2288bc835a314aaaba2909978bc37157f',
    'condition': 'False',
  },
  'cipd_bin_packages': {
    'packages': [
