...
vars = {
  ...
  'skia_tools_version': 'git_revision:b0b119b30f421f510a2ffde86f9a451bb32b6e72',
  'tools_git_version':  'version:3@2.48.1.chromium.11',
}

deps = {
  'depot_tools': {
    'url': 'https://chromium.googlesource.com/chromium/tools/depot_tools.git@feeac124f25235044d687bd84326a0e558951424',
    'condition': 'False',
  },
  'cipd_bin_packages': {
    'packages': [
