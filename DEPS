...
vars = {
  ...
  'skia_tools_version': 'git_revision:e441bd30cbdcd008886c7eb084c560e2812edbae',
  'tools_git_version':  'version:3@2.51.2.chromium.11',
}

deps = {
  'depot_tools': {
    'url': 'https://chromium.googlesource.com/chromium/tools/depot_tools.git@c4109803d74f90f05344e9441ac0ff577acb820f',
    'condition': 'False',
  },
  'cipd_bin_packages': {
    'packages': [
