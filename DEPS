...
vars = {
  ...
  'skia_tools_version': 'git_revision:2fdfa81e82dcb1b1e9aa6b7aae2b1ee761e2c5c4',
  'tools_git_version':  'version:3@2.50.1.chromium.11',
}

deps = {
  'depot_tools': {
    'url': 'https://chromium.googlesource.com/chromium/tools/depot_tools.git@5ce80c825163a9545f9c7d3f5446d0795a0c25fe',
    'condition': 'False',
  },
  'cipd_bin_packages': {
    'packages': [
