...
vars = {
  ...
  'skia_tools_version': 'git_revision:8f80a4b72d9f02792f977fa2cd9c4d6a9a3f6d62',
  'tools_git_version':  'version:3@2.51.2.chromium.11',
}

deps = {
  'depot_tools': {
    'url': 'https://chromium.googlesource.com/chromium/tools/depot_tools.git@6f83fce8652bbde3873c6f486179a93c9b6f9421',
    'condition': 'False',
  },
  'cipd_bin_packages': {
    'packages': [
