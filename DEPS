...
vars = {
  ...
  'skia_tools_version': 'git_revision:2ad74dabbee51ffb7ee76eb13574c3351564b769',
  'tools_git_version':  'version:3@2.47.1.chromium.11',
}

deps = {
  'depot_tools': {
    'url': 'https://chromium.googlesource.com/chromium/tools/depot_tools.git@5327157a5fce9ab180a9f4935012329ae4118b08',
    'condition': 'False',
  },
  'cipd_bin_packages': {
    'packages': [
