...
vars = {
  ...
  'skia_tools_version': 'git_revision:b6f29eefb704bb8d4cec3782fbc7da8873f6e6c3',
  'tools_git_version':  'version:3@2.46.1.chromium.11',
}

deps = {
  'depot_tools': {
    'url': 'https://chromium.googlesource.com/chromium/tools/depot_tools.git@278a90917622f61ff7a703380f6426ba701b9563',
    'condition': 'False',
  },
  'cipd_bin_packages': {
    'packages': [
