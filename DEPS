...
vars = {
  ...
  'skia_tools_version': 'git_revision:821c531f75146616da0bf2ec8dac95e7af289511',
  'tools_git_version':  'version:3@2.45.2.chromium.11',
}

deps = {
  'depot_tools': {
    'url': 'https://chromium.googlesource.com/chromium/tools/depot_tools.git@8dde9800ee2b8326ab11a87abd67d3bd9f8c8773',
    'condition': 'False',
  },
  'cipd_bin_packages': {
    'packages': [
