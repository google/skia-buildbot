...
vars = {
  ...
  'skia_tools_version': 'git_revision:523dc313e7a2a002a3280db8286bde07472c2a58',
  'tools_git_version':  'version:3@2.47.0.chromium.11',
}

deps = {
  'depot_tools': {
    'url': 'https://chromium.googlesource.com/chromium/tools/depot_tools.git@728e704add46ccc31607fc2265e8ef518b9650fe',
    'condition': 'False',
  },
  'cipd_bin_packages': {
    'packages': [
