...
vars = {
  ...
  'skia_tools_version': 'git_revision:9b001b3fada5640e09eec508a0f6217463d293e7',
  'tools_git_version':  'version:3@2.48.1.chromium.11',
}

deps = {
  'depot_tools': {
    'url': 'https://chromium.googlesource.com/chromium/tools/depot_tools.git@0445e00a089e163c4dcf1659b9fe38edec2d5adc',
    'condition': 'False',
  },
  'cipd_bin_packages': {
    'packages': [
