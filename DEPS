...
vars = {
  ...
  'skia_tools_version': 'git_revision:d26f762aa0607dc674bcc6d7d509cd8a02c11e58',
  'tools_git_version':  'version:3@2.50.1.chromium.11',
}

deps = {
  'depot_tools': {
    'url': 'https://chromium.googlesource.com/chromium/tools/depot_tools.git@eddc72dce5e68bf04026070495a92650ac4948fe',
    'condition': 'False',
  },
  'cipd_bin_packages': {
    'packages': [
