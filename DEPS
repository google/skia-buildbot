...
vars = {
  ...
  'skia_tools_version': 'git_revision:9e5b3d985a5f80ade77cbd369c2e60054c9df6ba',
  'tools_git_version':  'version:3@2.51.2.chromium.11',
}

deps = {
  'depot_tools': {
    'url': 'https://chromium.googlesource.com/chromium/tools/depot_tools.git@dcdf028ce40c56c8ea95625c021ad3659352264c',
    'condition': 'False',
  },
  'cipd_bin_packages': {
    'packages': [
