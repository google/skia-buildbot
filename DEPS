...
vars = {
  ...
  'skia_tools_version': 'git_revision:ca6066d7097cf6a175b48c03d5e9c24c1ee0262f',
  'tools_git_version':  'version:3@2.47.1.chromium.11',
}

deps = {
  'depot_tools': {
    'url': 'https://chromium.googlesource.com/chromium/tools/depot_tools.git@8d20c1e0b56c68b14878b597080484f9445962b4',
    'condition': 'False',
  },
  'cipd_bin_packages': {
    'packages': [
