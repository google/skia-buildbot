...
vars = {
  ...
  'skia_tools_version': 'git_revision:47e0bdae10c9aa0167661f6b7ec4b111e714c428',
  'tools_git_version':  'version:3@2.47.1.chromium.11',
}

deps = {
  'depot_tools': {
    'url': 'https://chromium.googlesource.com/chromium/tools/depot_tools.git@138f15432a69ba7081c895cd109abf0175c9926b',
    'condition': 'False',
  },
  'cipd_bin_packages': {
    'packages': [
