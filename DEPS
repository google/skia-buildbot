...
vars = {
  ...
  'skia_tools_version': 'git_revision:4820c0b4ea250a9bcfca97211471ed45aeda7d38',
  'tools_git_version':  'version:3@2.51.0.chromium.11',
}

deps = {
  'depot_tools': {
    'url': 'https://chromium.googlesource.com/chromium/tools/depot_tools.git@3ca8f4784d58c6a6d9958b71c191390a8854fb55',
    'condition': 'False',
  },
  'cipd_bin_packages': {
    'packages': [
