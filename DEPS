...
vars = {
  ...
  'skia_tools_version': 'git_revision:fb8dd36529f63db18b1523907ca84fe15f89d60b',
  'tools_git_version':  'version:3@2.47.1.chromium.11',
}

deps = {
  'depot_tools': {
    'url': 'https://chromium.googlesource.com/chromium/tools/depot_tools.git@3c68cd01f4728df4f696d396857e4f85cc091ecc',
    'condition': 'False',
  },
  'cipd_bin_packages': {
    'packages': [
