...
vars = {
  ...
  'skia_tools_version': 'git_revision:2b2d3ae5900c6133300eecd13856c87edcb8b01d',
  'tools_git_version':  'version:3@2.47.0.chromium.11',
}

deps = {
  'depot_tools': {
    'url': 'https://chromium.googlesource.com/chromium/tools/depot_tools.git@9dd0755b691fc70ed28e9ce2b287c73f5289561f',
    'condition': 'False',
  },
  'cipd_bin_packages': {
    'packages': [
