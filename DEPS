...
vars = {
  ...
  'skia_tools_version': 'git_revision:6934ac81212ea97e7aa3ea8202045a100c98e53f',
  'tools_git_version':  'version:3@2.51.2.chromium.11',
}

deps = {
  'depot_tools': {
    'url': 'https://chromium.googlesource.com/chromium/tools/depot_tools.git@3d559609b4cb84c258ad907cc72630d3591c8bac',
    'condition': 'False',
  },
  'cipd_bin_packages': {
    'packages': [
