...
vars = {
  ...
  'skia_tools_version': 'git_revision:a3f4e114d37b4b995e1f0c439e90a8944ea683b4',
  'tools_git_version':  'version:3@2.51.0.chromium.11',
}

deps = {
  'depot_tools': {
    'url': 'https://chromium.googlesource.com/chromium/tools/depot_tools.git@150db331780e685bf1c6a0000a0e98cfe4eb6344',
    'condition': 'False',
  },
  'cipd_bin_packages': {
    'packages': [
