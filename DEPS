...
vars = {
  ...
  'skia_tools_version': 'git_revision:244b54c99d6e7cd8c74ab10460ecdadd2a628831',
  'tools_git_version':  'version:3@2.46.0.chromium.11',
}

deps = {
  'depot_tools': {
    'url': 'https://chromium.googlesource.com/chromium/tools/depot_tools.git@04a2e71a925ee4df863d6973df488dac0e087505',
    'condition': 'False',
  },
  'cipd_bin_packages': {
    'packages': [
