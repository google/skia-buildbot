...
vars = {
  ...
  'skia_tools_version': 'git_revision:8ff522b74b01b88620f2823d2a936eb065cab990',
  'tools_git_version':  'version:3@2.51.2.chromium.11',
}

deps = {
  'depot_tools': {
    'url': 'https://chromium.googlesource.com/chromium/tools/depot_tools.git@425882d8c0acaab53bf2f8abbe7efcf5db5b168b',
    'condition': 'False',
  },
  'cipd_bin_packages': {
    'packages': [
