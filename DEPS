...
vars = {
  ...
  'skia_tools_version': 'git_revision:e10f90ab29404d65871112b293e6e0ea0b70f7ee',
  'tools_git_version':  'version:3@2.51.2.chromium.11',
}

deps = {
  'depot_tools': {
    'url': 'https://chromium.googlesource.com/chromium/tools/depot_tools.git@6e87d87cd50eb052a5d3de176172b54a2ae905d6',
    'condition': 'False',
  },
  'cipd_bin_packages': {
    'packages': [
