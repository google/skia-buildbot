...
vars = {
  ...
  'skia_tools_version': 'git_revision:dd316da8de6bc1869827c91e5f1ebdf5047f53fd',
  'tools_git_version':  'version:3@2.51.2.chromium.11',
}

deps = {
  'depot_tools': {
    'url': 'https://chromium.googlesource.com/chromium/tools/depot_tools.git@0609278803cac51ec9a2a0640c1c090906c49481',
    'condition': 'False',
  },
  'cipd_bin_packages': {
    'packages': [
