...
vars = {
  ...
  'skia_tools_version': 'git_revision:7e62f1428813851a801a44c88c490fe9a961b7ee',
  'tools_git_version':  'version:3@2.46.0.chromium.11',
}

deps = {
  'depot_tools': {
    'url': 'https://chromium.googlesource.com/chromium/tools/depot_tools.git@40cece20d0eaae6fd41fcbc008480e71f2e3aed9',
    'condition': 'False',
  },
  'cipd_bin_packages': {
    'packages': [
