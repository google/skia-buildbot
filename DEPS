...
vars = {
  ...
  'skia_tools_version': 'git_revision:8b12c3aa2ef92926bea32ebf197f7f70e671bcb7',
  'tools_git_version':  'version:3@2.47.0.chromium.11',
}

deps = {
  'depot_tools': {
    'url': 'https://chromium.googlesource.com/chromium/tools/depot_tools.git@c22f4dc74fed3850bfa9f0775f0d026419bab980',
    'condition': 'False',
  },
  'cipd_bin_packages': {
    'packages': [
