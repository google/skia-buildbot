...
vars = {
  ...
  'skia_tools_version': 'git_revision:fb1930c766c49b33fb8bded842923eab53a87cf8',
  'tools_git_version':  'version:3@2.51.0.chromium.11',
}

deps = {
  'depot_tools': {
    'url': 'https://chromium.googlesource.com/chromium/tools/depot_tools.git@13964577cd899081ea7e526ffbe58df1065bc3d7',
    'condition': 'False',
  },
  'cipd_bin_packages': {
    'packages': [
