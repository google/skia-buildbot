...
vars = {
  ...
  'luci_tools_version': 'git_revision:71d83a9d673852b632b7fa4bffc38b94a4ea1dab',
  'skia_tools_version': 'git_revision:7d7fae9ecad4e13d8720847657eeda4dfbfc0154',
  'tools_git_version':  'version:2@2.45.2.chromium.11',
}

deps = {
  'depot_tools': {
    'url': 'https://chromium.googlesource.com/chromium/tools/depot_tools.git@441cd5c465c10ff0d322be60e3fb92cb18e60fe6',
    'condition': 'False',
  },
  'cipd_bin_packages': {
    'packages': [
