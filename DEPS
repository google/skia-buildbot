...
vars = {
  ...
  'skia_tools_version': 'git_revision:808d8a5c3b8780879d93c0ff5bb5058b97982ec5',
  'tools_git_version':  'version:3@2.47.0.chromium.11',
}

deps = {
  'depot_tools': {
    'url': 'https://chromium.googlesource.com/chromium/tools/depot_tools.git@2515d3513f7b15bf0cf40994599989b5dd7128ac',
    'condition': 'False',
  },
  'cipd_bin_packages': {
    'packages': [
