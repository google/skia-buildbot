...
vars = {
  ...
  'luci_tools_version': 'git_revision:5d7e5904d8f9e9f1e291d2784115395ea2c52b88',
  'skia_tools_version': 'git_revision:4b91a08a04cd0d11ff2e9cbc6a7999d2b3140cd8',
  'tools_git_version':  'version:3@2.49.0.chromium.11',
}

deps = {
  'depot_tools': {
    'url': 'https://chromium.googlesource.com/chromium/tools/depot_tools.git@3be09c6d74ab3e69c99a4dfef5cac79d075b7142',
    'condition': 'False',
  },
  'cipd_bin_packages': {
    'packages': [
