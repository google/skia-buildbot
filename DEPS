...
vars = {
  ...
  'skia_tools_version': 'git_revision:5d432ed50f7d79b717eb0924057035ed73590ee5',
  'tools_git_version':  'version:3@2.48.1.chromium.11',
}

deps = {
  'depot_tools': {
    'url': 'https://chromium.googlesource.com/chromium/tools/depot_tools.git@50eedb1b5a74772dd77f9fe6b1cd82e3c4c1d9a7',
    'condition': 'False',
  },
  'cipd_bin_packages': {
    'packages': [
