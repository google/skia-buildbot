...
vars = {
  ...
  'skia_tools_version': 'git_revision:d401f0aea6895a1fd93af976188b9739cb556621',
  'tools_git_version':  'version:3@2.51.2.chromium.11',
}

deps = {
  'depot_tools': {
    'url': 'https://chromium.googlesource.com/chromium/tools/depot_tools.git@967382fdcd1477dab3a7fec8eec3e3d5368bb0fe',
    'condition': 'False',
  },
  'cipd_bin_packages': {
    'packages': [
