...
vars = {
  ...
  'skia_tools_version': 'git_revision:f26a853e1821a778da2735efebcfa7a15b8dcccf',
  'tools_git_version':  'version:3@2.50.1.chromium.11',
}

deps = {
  'depot_tools': {
    'url': 'https://chromium.googlesource.com/chromium/tools/depot_tools.git@dd8909f2123922b1d2c5e6a9a717d0a1f5250bf0',
    'condition': 'False',
  },
  'cipd_bin_packages': {
    'packages': [
