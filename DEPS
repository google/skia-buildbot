...
vars = {
  ...
  'skia_tools_version': 'git_revision:59a1027cb5bd7e098587682d3f47b1976295b231',
  'tools_git_version':  'version:3@2.51.0.chromium.11',
}

deps = {
  'depot_tools': {
    'url': 'https://chromium.googlesource.com/chromium/tools/depot_tools.git@18fc4e55077476d34babd23baf61881df71a9e8c',
    'condition': 'False',
  },
  'cipd_bin_packages': {
    'packages': [
