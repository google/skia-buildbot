...
vars = {
  ...
  'skia_tools_version': 'git_revision:1f820824dd5da21aac21c7d721441ec4ebab36f8',
  'tools_git_version':  'version:3@2.51.2.chromium.11',
}

deps = {
  'depot_tools': {
    'url': 'https://chromium.googlesource.com/chromium/tools/depot_tools.git@cc672a52c6fdbafec7bb5086894fba4dc5231c90',
    'condition': 'False',
  },
  'cipd_bin_packages': {
    'packages': [
