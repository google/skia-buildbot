...
vars = {
  ...
  'skia_tools_version': 'git_revision:7fb17334e75675cbb29309da22836185f700659d',
  'tools_git_version':  'version:3@2.47.0.chromium.11',
}

deps = {
  'depot_tools': {
    'url': 'https://chromium.googlesource.com/chromium/tools/depot_tools.git@2be7ee975d27c328763998888a55db89c46aecd4',
    'condition': 'False',
  },
  'cipd_bin_packages': {
    'packages': [
