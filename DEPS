...
vars = {
  ...
  'skia_tools_version': 'git_revision:2dd0704d2aeadab5b4dba848ce13cd373894e54d',
  'tools_git_version':  'version:3@2.51.2.chromium.11',
}

deps = {
  'depot_tools': {
    'url': 'https://chromium.googlesource.com/chromium/tools/depot_tools.git@ac1e4a9bb7f92355829dc5725fa5d5a12a909c89',
    'condition': 'False',
  },
  'cipd_bin_packages': {
    'packages': [
