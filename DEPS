...
vars = {
  ...
  'skia_tools_version': 'git_revision:736d19678782b369c7ec15c07bd14a5be0f8b1f6',
  'tools_git_version':  'version:3@2.45.2.chromium.11',
}

deps = {
  'depot_tools': {
    'url': 'https://chromium.googlesource.com/chromium/tools/depot_tools.git@88f793b4be43cd880a4e1041bfcd65bc688c23cb',
    'condition': 'False',
  },
  'cipd_bin_packages': {
    'packages': [
