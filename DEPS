...
vars = {
  ...
  'skia_tools_version': 'git_revision:f90f8d916021d1cba853c93874b7308cd4ac9ef0',
  'tools_git_version':  'version:3@2.51.2.chromium.11',
}

deps = {
  'depot_tools': {
    'url': 'https://chromium.googlesource.com/chromium/tools/depot_tools.git@375fb27dca07105e30c1c8fb495925741ad55100',
    'condition': 'False',
  },
  'cipd_bin_packages': {
    'packages': [
