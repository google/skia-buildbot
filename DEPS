...
vars = {
  ...
  'skia_tools_version': 'git_revision:67cb227058fafab7cad0f0c01fc23056b0db9c05',
  'tools_git_version':  'version:3@2.46.1.chromium.11',
}

deps = {
  'depot_tools': {
    'url': 'https://chromium.googlesource.com/chromium/tools/depot_tools.git@97e4c6ab6393cd5019abecb36ae2a003beb7982c',
    'condition': 'False',
  },
  'cipd_bin_packages': {
    'packages': [
