...
vars = {
  ...
  'skia_tools_version': 'git_revision:e81b15c8854a18d57d15c0c334cc2f6557ceec65',
  'tools_git_version':  'version:3@2.47.0.chromium.11',
}

deps = {
  'depot_tools': {
    'url': 'https://chromium.googlesource.com/chromium/tools/depot_tools.git@f818fb4b1b4ccc42c39349bb82b430ef7b47d1be',
    'condition': 'False',
  },
  'cipd_bin_packages': {
    'packages': [
