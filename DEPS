...
vars = {
  ...
  'skia_tools_version': 'git_revision:0b3b8a8cbc26d6758c36d977690270b8f6243898',
  'tools_git_version':  'version:3@2.51.2.chromium.11',
}

deps = {
  'depot_tools': {
    'url': 'https://chromium.googlesource.com/chromium/tools/depot_tools.git@45aaf4f713f882fe2532704b99944e1a8f0936c1',
    'condition': 'False',
  },
  'cipd_bin_packages': {
    'packages': [
