...
vars = {
  ...
  'skia_tools_version': 'git_revision:b96a50f0c8f0337daf8aca292c51b054d357da1e',
  'tools_git_version':  'version:3@2.46.0.chromium.11',
}

deps = {
  'depot_tools': {
    'url': 'https://chromium.googlesource.com/chromium/tools/depot_tools.git@ab105459cbee9bb6bc8a3fb179fcfb65f1fdedf1',
    'condition': 'False',
  },
  'cipd_bin_packages': {
    'packages': [
