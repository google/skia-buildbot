...
vars = {
  ...
  'skia_tools_version': 'git_revision:c039e45e5b7e97d0cee89aa81557af1ed9d8a204',
  'tools_git_version':  'version:3@2.49.0.chromium.11',
}

deps = {
  'depot_tools': {
    'url': 'https://chromium.googlesource.com/chromium/tools/depot_tools.git@9a1c23767ac6e2e31559a6cc24a888e380b6d623',
    'condition': 'False',
  },
  'cipd_bin_packages': {
    'packages': [
