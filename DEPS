...
vars = {
  ...
  'skia_tools_version': 'git_revision:212eb244d402b092cc020101ab7f0eb8e71515e1',
  'tools_git_version':  'version:3@2.49.0.chromium.11',
}

deps = {
  'depot_tools': {
    'url': 'https://chromium.googlesource.com/chromium/tools/depot_tools.git@3ce438f7f0ba505ed055b0b0c0b2eb725357c84e',
    'condition': 'False',
  },
  'cipd_bin_packages': {
    'packages': [
