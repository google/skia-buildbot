...
vars = {
  ...
  'skia_tools_version': 'git_revision:c3a2252d4d94ff1d7785388c59428b032c2705f2',
  'tools_git_version':  'version:3@2.51.1.chromium.11',
}

deps = {
  'depot_tools': {
    'url': 'https://chromium.googlesource.com/chromium/tools/depot_tools.git@33eb99bb23c5a7c26f85faa4e89020ab345b1c5d',
    'condition': 'False',
  },
  'cipd_bin_packages': {
    'packages': [
