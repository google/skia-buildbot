...
vars = {
  ...
  'skia_tools_version': 'git_revision:86bd00388c3e70cce1245d7ca84602c88bffd7c2',
  'tools_git_version':  'version:3@2.50.0.chromium.11',
}

deps = {
  'depot_tools': {
    'url': 'https://chromium.googlesource.com/chromium/tools/depot_tools.git@405df0756a747d34ef20ac160ab17efbed606f0f',
    'condition': 'False',
  },
  'cipd_bin_packages': {
    'packages': [
