...
vars = {
  ...
  'luci_tools_version': 'git_revision:3a1830e42263b558860a711cec3f5dc6ae916112',
...
deps = {
  'depot_tools': {
    'url': 'https://chromium.googlesource.com/chromium/tools/depot_tools.git@c2a6159a0d39caa1686977317d6f1c8891d2c83e',
    'condition': 'False',
  },
  'cipd_bin_packages': {
    'packages': [
