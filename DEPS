...
vars = {
  ...
  'skia_tools_version': 'git_revision:8f1191a68210f3d2cea5f5ccef9e37ae1e3846d7',
  'tools_git_version':  'version:3@2.51.0.chromium.11',
}

deps = {
  'depot_tools': {
    'url': 'https://chromium.googlesource.com/chromium/tools/depot_tools.git@16dfe4717b0ef0214c66dc2e575a7c0feebfea3c',
    'condition': 'False',
  },
  'cipd_bin_packages': {
    'packages': [
