...
vars = {
  ...
  'skia_tools_version': 'git_revision:bc650ffe70f60e561f28269f799a65764d22999b',
  'tools_git_version':  'version:3@2.51.0.chromium.11',
}

deps = {
  'depot_tools': {
    'url': 'https://chromium.googlesource.com/chromium/tools/depot_tools.git@9d51f8dcb4a79421139bc77566c1635f8890da1e',
    'condition': 'False',
  },
  'cipd_bin_packages': {
    'packages': [
