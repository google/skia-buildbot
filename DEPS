...
vars = {
  ...
  'skia_tools_version': 'git_revision:9b09b0a9dfa9c6b72a5e2e5e747cf5195395bdaf',
  'tools_git_version':  'version:3@2.46.0.chromium.11',
}

deps = {
  'depot_tools': {
    'url': 'https://chromium.googlesource.com/chromium/tools/depot_tools.git@68c038603f05f0b797e67b308597d67845fa2a6a',
    'condition': 'False',
  },
  'cipd_bin_packages': {
    'packages': [
