...
vars = {
  ...
  'skia_tools_version': 'git_revision:7edf9b0fb2813c5f21db54d777d9c41ae21f77d3',
  'tools_git_version':  'version:3@2.47.1.chromium.11',
}

deps = {
  'depot_tools': {
    'url': 'https://chromium.googlesource.com/chromium/tools/depot_tools.git@2451ee476dfa0f94b3443455af612a56fc06c2c9',
    'condition': 'False',
  },
  'cipd_bin_packages': {
    'packages': [
