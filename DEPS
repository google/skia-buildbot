...
vars = {
  ...
  'skia_tools_version': 'git_revision:5be5d028f2b5fd2be5d807d604a9d6d7b0c006fe',
  'tools_git_version':  'version:3@2.51.0.chromium.11',
}

deps = {
  'depot_tools': {
    'url': 'https://chromium.googlesource.com/chromium/tools/depot_tools.git@0f565fa8583d599d4e96736e36e397dc6e671382',
    'condition': 'False',
  },
  'cipd_bin_packages': {
    'packages': [
