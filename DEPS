...
vars = {
  ...
  'skia_tools_version': 'git_revision:c6b336984953c2c7fb781b7ba17a4fc1e32146ad',
  'tools_git_version':  'version:3@2.46.0.chromium.11',
}

deps = {
  'depot_tools': {
    'url': 'https://chromium.googlesource.com/chromium/tools/depot_tools.git@4c050c6f1a34c7b1aaf503d97b871afb8540e54f',
    'condition': 'False',
  },
  'cipd_bin_packages': {
    'packages': [
