...
vars = {
  ...
  'skia_tools_version': 'git_revision:f69f215a2ce4e14c8ff0fc28e1675df37e552a6f',
  'tools_git_version':  'version:3@2.47.1.chromium.11',
}

deps = {
  'depot_tools': {
    'url': 'https://chromium.googlesource.com/chromium/tools/depot_tools.git@c88ad7af1a5c20b6788d52beb54f33203de492a8',
    'condition': 'False',
  },
  'cipd_bin_packages': {
    'packages': [
