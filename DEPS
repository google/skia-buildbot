...
vars = {
  ...
  'skia_tools_version': 'git_revision:a8d2297cac0823a7c4fa9916b71ea9cdfe070ddd',
  'tools_git_version':  'version:3@2.51.0.chromium.11',
}

deps = {
  'depot_tools': {
    'url': 'https://chromium.googlesource.com/chromium/tools/depot_tools.git@312d6a03138fd55c4e79c554313d21abfd3716ac',
    'condition': 'False',
  },
  'cipd_bin_packages': {
    'packages': [
