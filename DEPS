...
vars = {
  ...
  'skia_tools_version': 'git_revision:3c369985ab80eb890610b27f5aedd82c6c06aea3',
  'tools_git_version':  'version:3@2.47.1.chromium.11',
}

deps = {
  'depot_tools': {
    'url': 'https://chromium.googlesource.com/chromium/tools/depot_tools.git@8c858fc98cfac56f34211a31988fd19c462c0c53',
    'condition': 'False',
  },
  'cipd_bin_packages': {
    'packages': [
