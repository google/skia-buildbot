...
vars = {
  ...
  'skia_tools_version': 'git_revision:09baf58309a3eb25460267fe3e720818bee5f679',
  'tools_git_version':  'version:3@2.46.2.chromium.11',
}

deps = {
  'depot_tools': {
    'url': 'https://chromium.googlesource.com/chromium/tools/depot_tools.git@cd2f5c45b2f6cc06fa22fa9a572e018e4c240e06',
    'condition': 'False',
  },
  'cipd_bin_packages': {
    'packages': [
