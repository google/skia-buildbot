...
vars = {
  ...
  'luci_tools_version': 'git_revision:aaf80ec8202c91ad9c7aa20ee3841d00d4a7d51c',
  'skia_tools_version': 'git_revision:199e640f88d70076bb28d0a23d31bbafc4961382',
  'tools_git_version':  'version:3@2.51.0.chromium.11',
}

deps = {
  'depot_tools': {
    'url': 'https://chromium.googlesource.com/chromium/tools/depot_tools.git@eda3b48f2e32304d4ea20fee7ac1d37c9b060b3b',
    'condition': 'False',
  },
  'cipd_bin_packages': {
    'packages': [
