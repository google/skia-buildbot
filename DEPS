...
vars = {
  ...
  'luci_tools_version': 'git_revision:ca20346b3e3d0ac7f06cded05d8d06625b01867e',
  'skia_tools_version': 'git_revision:6f813c4f67a927c701fb2e2d75b5d61894ec6da9',
  'tools_git_version':  'version:3@2.48.1.chromium.11',
}

deps = {
  'depot_tools': {
    'url': 'https://chromium.googlesource.com/chromium/tools/depot_tools.git@f53d073a6ddc74a164a92bae510b733f399cc9ed',
    'condition': 'False',
  },
  'cipd_bin_packages': {
    'packages': [
