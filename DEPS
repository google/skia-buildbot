...
vars = {
  ...
  'skia_tools_version': 'git_revision:7345fb1bf10b957f5b79c46ebb996f7f057058aa',
  'tools_git_version':  'version:3@2.49.0.chromium.11',
}

deps = {
  'depot_tools': {
    'url': 'https://chromium.googlesource.com/chromium/tools/depot_tools.git@a8900cc0f023d6a662eb66b317e8ddceeb113490',
    'condition': 'False',
  },
  'cipd_bin_packages': {
    'packages': [
