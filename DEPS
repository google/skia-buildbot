...
vars = {
  ...
  'skia_tools_version': 'git_revision:4cda212e9e16a847d9783d0e1665f8a1f9126037',
  'tools_git_version':  'version:3@2.51.1.chromium.11',
}

deps = {
  'depot_tools': {
    'url': 'https://chromium.googlesource.com/chromium/tools/depot_tools.git@8a1ec6a0213ae033f6749f261e1c528488349991',
    'condition': 'False',
  },
  'cipd_bin_packages': {
    'packages': [
