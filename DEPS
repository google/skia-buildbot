...
vars = {
  ...
  'skia_tools_version': 'git_revision:8ad83b90be3ca0da993068b11b2b3c98be4915a2',
  'tools_git_version':  'version:3@2.49.0.chromium.11',
}

deps = {
  'depot_tools': {
    'url': 'https://chromium.googlesource.com/chromium/tools/depot_tools.git@196d9416106a6ace0729b09acda46546c4a12ce1',
    'condition': 'False',
  },
  'cipd_bin_packages': {
    'packages': [
