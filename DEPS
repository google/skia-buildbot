...
vars = {
  ...
  'skia_tools_version': 'git_revision:20c36c70094fd23fedaf307107231d15358bd63d',
  'tools_git_version':  'version:2@2.45.2.chromium.11',
}

deps = {
  'depot_tools': {
    'url': 'https://chromium.googlesource.com/chromium/tools/depot_tools.git@c117716649045d216a2f664564ce043bb26d6573',
    'condition': 'False',
  },
  'cipd_bin_packages': {
    'packages': [
