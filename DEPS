...
vars = {
  ...
  'skia_tools_version': 'git_revision:e6a8868d0eddabca4a8baa20d34bf60f3b61c720',
  'tools_git_version':  'version:3@2.51.0.chromium.11',
}

deps = {
  'depot_tools': {
    'url': 'https://chromium.googlesource.com/chromium/tools/depot_tools.git@8ab2a5350f71bb76f9fbc049e40e3504e79f3661',
    'condition': 'False',
  },
  'cipd_bin_packages': {
    'packages': [
