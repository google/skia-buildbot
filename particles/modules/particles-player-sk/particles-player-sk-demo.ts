...
$$('#effect_uniforms')!.addEventListener('click', () => { player.initialize(effect_uniforms); });
$$('#particle_uniforms')!.addEventListener('click', () => { player.initialize(particle_uniforms); });
