...
export class ParticlesConfigSk extends ElementSk {
  ...
  private resolve: ((p: ParticleConfig)=> void) | null = null;
  ...
  show(config: ParticleConfig): Promise<ParticleConfig> {
    return new Promise<ParticleConfig>((resolve, reject) => {
