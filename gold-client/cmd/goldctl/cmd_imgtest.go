...
Does not upload anything nor queue anything for upload.`,
	...
	env.addKeysFlags(imgTestAddCmd, "" /* =flagsPrefix */)
...
func (i *imgTest) addKeysFlags(cmd *cobra.Command, flagsPrefix string) {
	cmd.Flags().StringVar(&i.testKeysFile, flagsPrefix+"keys-file", "", "A file with test-specific keys encoded as a JSON dictionary.")
	...
	cmd.Flags().StringVar(&i.testKeysFile, flagsPrefix+"optional-keys-file", "", "A file with test-specific optional keys encoded as a JSON dictionary.")
