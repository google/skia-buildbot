...
test results.`,
		Run: env.runImgTestFinalizeCommand,
	}
...
Check against Gold or local baseline whether the results match the expectations`,
		Run: env.runImgTestPassFailCommand,
	}
...
func (i *imgTestEnv) addCommonFlags(cmd *cobra.Command, optional bool) {
	...
	cmd.Flags().StringVarP(&i.flagKeysFile, "keys-file", "", "", "File containing key/value pairs commmon to all tests")
...
// TODO(stephana): Implement as necessary.
func (i *imgTestEnv) runImgTestInitCommand(cmd *cobra.Command, args []string)     { notImplemented(cmd) }
func (i *imgTestEnv) runImgTestFinalizeCommand(cmd *cobra.Command, args []string) { notImplemented(cmd) }
func (i *imgTestEnv) runImgTestPassFailCommand(cmd *cobra.Command, args []string) { notImplemented(cmd) }

// runImgTestCommand processes and uploads test results to Gold.
func (i *imgTestEnv) runImgTestAddCommand(cmd *cobra.Command, args []string) {
