...
`,
	...
	imgTestAddCmd.Flags().StringVar(&env.testKeysFile, "add-test-keys-file", "", "File with a JSON dictionary of test-specific keys.")
	...
	imgTestAddCmd.Flags().StringVar(&env.testKeysFile, "add-test-optional-key-file", "", "File with a JSON dictionary of test-specific optional keys.")
