...
// diffEnv provides the environment for the auth command.
type diffEnv struct {
	inputFile  string
	test       string
	corpus     string
...
// getDiffCmd returns the definition of the auth command.
...
`,
	...
	// add the workdir flag and make everything required
...
// runDiffCmd executes the dump logic - it loads the previous setup
