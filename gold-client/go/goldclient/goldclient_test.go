...
func TestCloudClient_GetDigestFromCacheOrGCS_NotOnCache_DownloadsCorruptedImageFromGCS_Failure(t *testing.T) {
	unittest.MediumTest(t) // This tests reads/writes a small amount of data from/to disk.
...
func TestCloudClient_GetDigestFromCacheOrGCS_OnCache_ReadsImageFromDisk_Success(t *testing.T) {
	unittest.MediumTest(t) // This tests reads/writes a small amount of data from/to disk.
...
func TestCloudClient_GetDigestFromCacheOrGCS_OnCache_ReadsCorruptedImageFromDisk_Failure(t *testing.T) {
	unittest.MediumTest(t) // This tests reads/writes a small amount of data from/to disk.
