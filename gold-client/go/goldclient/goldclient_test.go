...
//	err := auth.InitServiceAccountAuth(serviceLoc, wd)
//	assert.NoError(t, err)
//	auth, err := auth.LoadAuthOpt(wd)
//	assert.NoError(t, err)
//
//	assert.Equal(t, serviceLoc, auth.ServiceAccount)
//	assert.NoError(t, auth.Validate())
//	// ensure the file exists
//	assert.True(t, fileutil.FileExists(filepath.Join(wd, auth.authFile)))
//
//	auth, err = auth.LoadAuthOpt(wd)
...
//}
//
//func makeMocks() (auth.AuthOpt, *mocks.HTTPClient, *mocks.GCSUploader, *mocks.ImageDownloader) {
//	mh := mocks.HTTPClient{}
...
//}
//
//func (a *fakeAuthOpt) GetHTTPClient() (httpclient.HTTPClient, error) {
//	return a.httpClient, nil
//}
//
//func (a *fakeAuthOpt) GetGCSUploader() (gcsuploader.GCSUploader, error) {
//	return a.gcsUploader, nil
//}
//
//func (a *fakeAuthOpt) GetImageDownloader() (imagedownloader.ImageDownloader, error) {
...
//func loadGoldClient(auth auth.AuthOpt, workDir string) (*CloudClient, error) {
...
//func makeGoldClient(auth auth.AuthOpt, passFail bool, uploadOnly bool, workDir string) (*CloudClient, error) {
//	config := GoldClientConfig{
