...
type GoldClient interface {
	...
	TriageAsPositive(testName types.TestName, digest types.Digest, algorithmName string, changeListId string) error
...
func (c *CloudClient) TriageAsPositive(testName types.TestName, digest types.Digest, algorithmName string, changeListId string) error {
