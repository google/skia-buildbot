...
func NewCloudClient(workDir, instanceID string, passFailStep bool, goldResult *jsonio.GoldResults) (GoldClient, error) {
	...
	if workDir == "" {
		return nil, sklog.FmtErrorf("No 'workDir' provided to NewCloudClient")
	}
...
func (c *tCloudClient) setResultState(instanceID string, passFailStep bool, goldResult *jsonio.GoldResults) error {
	...
	c.resultState, err = newResultState(goldResult, passFailStep, instanceID, c.workDir)
	if err != nil {
		return err
	}
...
func newResultState(goldResult *jsonio.GoldResults, passFailStep bool, instanceID, workDir string) (*tResultState, error) {
