...
func (m *SobelFuzzyMatcher) Match(expected, actual image.NRGBA) bool {
	// TODO(lovisolo): Implement.
	return false
}

// Make sure SobelFuzzyMatcher fulfills the imagmatching.Matcher interface.
var _ imgmatching.Matcher = (*SobelFuzzyMatcher)(nil)
