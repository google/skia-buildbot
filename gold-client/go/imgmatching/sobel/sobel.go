...
// in the input image.
//
// The returned image has the same size as the input image. Border pixels will be black, as
// computing the Sobel operator requires all 8 neighboring pixels. The value of the Sobel operator
// is clipped at 255 before being converted into an 8-bit grayscale pixel.
//
// [1] https://en.wikipedia.org/wiki/Sobel_operator
