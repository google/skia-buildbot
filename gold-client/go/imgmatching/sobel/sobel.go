...
// EdgeThreshold is the optional key used to specify the "edginess" threshold above which
// sobel.Matcher should zero-out pixels.
const EdgeThreshold = imgmatching.AlgorithmParamOptKey("sobel_edge_threshold")
