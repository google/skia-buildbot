...
// AbstractMatcherFactory represents an Matcher factory that builds a Matcher from a map of
// optional keys. It is implemented by MatcherFactory.
//
// The purpose of this interface is to make testing easier.
type AbstractMatcherFactory interface {
...
// MatcherFactory implements the AbstractMatcherFactory interface.
type MatcherFactory struct{}

// Make implements the AbstractMatcherFactory interface.
func (m MatcherFactory) Make(optionalKeys map[string]string) (AlgorithmName, Matcher, error) {
...
// Make sure MatcherFactory fulfills the AbstractMatcherFactory interface.
var _ AbstractMatcherFactory = (*MatcherFactory)(nil)
