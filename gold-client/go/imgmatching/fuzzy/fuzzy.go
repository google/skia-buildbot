...
const (
	// TODO(lovisolo): Add documentation.
	MaxDifferentPixels = imgmatching.AlgorithmParameterOptionalKey("fuzzy_max_different_pixels")

	// TODO(lovisolo): Add documentation.
	PixelDeltaThreshold = imgmatching.AlgorithmParameterOptionalKey("fuzzy_pixel_delta_threshold")
)
