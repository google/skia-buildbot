...
type Matcher interface {
	...
	Match(expected, actual image.NRGBA) bool
}

// MakeMatcher takes a map of optional keys and returns the specified image matching algorithm name
// and the corresponding Matcher instance, or nil if none is specified.
//
