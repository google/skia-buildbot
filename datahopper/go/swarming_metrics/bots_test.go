	...
	ex := []expectations{
		{
			...
			dimensions: map[string][]string{
				swarming.DIMENSION_OS_KEY:          []string{"Android"},
				swarming.DIMENSION_DEVICE_TYPE_KEY: []string{"Nexus5x"},
				swarming.DIMENSION_DEVICE_OS_KEY:   []string{"P", "PPR1.180610.009"},
				swarming.DIMENSION_QUARANTINED_KEY: []string{"Device Missing"},
			},
		},
		{
			botID:         "bot-b",
			...
			dimensions: map[string][]string{
				swarming.DIMENSION_OS_KEY: []string{"Linux", "Debian-9.8"},
			},
		},
		{
			botID:         "bot-c",
			...
			dimensions: map[string][]string{
				swarming.DIMENSION_OS_KEY: []string{"Windows", "Windows-10"},
			},
		},
	}
