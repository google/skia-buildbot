...
func loadSwarmingTasks(s swarming.ApiClient, edb events.EventDB, perfClient perfclient.PerfClient, bnp taskname.TaskNameParser, lastLoad, now time.Time, revisit []string) ([]string, error) {
...
func reportDurationToPerf(t *swarming_api.SwarmingRpcsTaskRequestMetadata, perfClient perfclient.PerfClient, now time.Time, bnp taskname.TaskNameParser) {
...
func startLoadingTasks(swarm swarming.ApiClient, ctx context.Context, edb events.EventDB, perfClient perfclient.PerfClient, bnp taskname.TaskNameParser) {
...
func StartSwarmingTaskMetrics(workdir string, swarm swarming.ApiClient, ctx context.Context, perfClient perfclient.PerfClient, bnp taskname.TaskNameParser) error {
