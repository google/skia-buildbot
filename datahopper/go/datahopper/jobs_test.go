...
// jobTypeString is an enum to specify the type of Job that makeJob will create. Value is the same
// as the job_type tag value returned by computeAvgDuration.
