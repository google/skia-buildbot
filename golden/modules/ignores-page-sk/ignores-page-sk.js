...
<dialog id=edit-ignore-rule-dialog>
  ...
  <button @click=${ele._closeEditIgnoreRuleDialog}>Cancel</button>
  <button id=ok class=action @click=${ele._saveIgnoreRule}>${ele._ruleID ? 'Update' : 'Create'}</button>
</dialog>
