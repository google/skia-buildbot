...
const defaultValue: FilterDialogSkValue = {
  diffConfig: {
...
function updateValues() {
  ...
  $$<HTMLSpanElement>('.max-diff')!.innerText = currentValue.maxDiff.toString();
  $$<HTMLSpanElement>('.metric')!.innerText = currentValue.metric.toString();
...
filterDialogSk.addEventListener('edit', (e: Event) => {
  const value: FilterDialogSkValue = (e as CustomEvent<FilterDialogSkValue>).detail;
  currentValue = value;
  updateValues();
});
