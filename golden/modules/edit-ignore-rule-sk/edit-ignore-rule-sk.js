...
define('edit-ignore-rule-sk', class extends ElementSk {
  ...
  /**
   * @prop paramset {Object} A map of String -> Array<String> containing the available key/value pairs
   *       from which ignore rules may be built. For example, {'os': ['linux', 'windows']}
   */
   ...
   *       with a date, it will be converted into shorthand notation for display to the user.
  ...
  /**
   * @prop note {String} A note, usually a comment, to accompany the ignore ruel.
   */
