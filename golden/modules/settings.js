 ...
 * @param corpus {string}
 */
export function testOnlySetDefaultCorpus(corpus) {
  window.GoldSettings = window.GoldSettings || {};
  window.GoldSettings.defaultCorpus = corpus;
}
 ...
 * @param repo {string}
 */
export function testOnlySetBaseRepoURL(repo) {
  window.GoldSettings = window.GoldSettings || {};
  window.GoldSettings.baseRepoURL = repo;
}
