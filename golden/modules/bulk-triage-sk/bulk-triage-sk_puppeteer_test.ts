...
describe('bulk-triage-sk', () => {
  ...
  let bulkTriageSkWithCL: ElementHandle;

  let bulkTriageSkPO: BulkTriageSkPO;
  let bulkTriageSkWithCLPO: BulkTriageSkPO;
  ...
  beforeEach(async () => {
    ...
    bulkTriageSkWithCL = (await testBed.page.$('#changelist'))!;

    bulkTriageSkPO = new BulkTriageSkPO(bulkTriageSk);
    bulkTriageSkWithCLPO = new BulkTriageSkPO(bulkTriageSkWithCL);
  });
