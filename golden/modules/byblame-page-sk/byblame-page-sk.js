...
<corpus-selector-sk
    ...
    @corpus-selected=${(e) => el._handleCorpusChange(e.detail.corpus)}>
</corpus-selector-sk>
  ...
  _fetchEntries() {
    ...
    fetch(url, options)
        ...
        .then((json) => {
          ...
          //                 commit messages in its response, and removing
          //                 the /json/gitlog endpoint, which isn't used
          //                 anywhere else.
