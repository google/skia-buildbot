...
describe('byblame-page-sk', () => {
  ...
  it('shows loading indicator', async () => {
    ...
    // Wait for the page to finish loading. This ensures all RPCs are finished
    // before the RPC assertions in afterEach() are executed.
    await event;
  });
  ...
  describe('RPC failures', () => {
    it('handles /json/trstatus RPC failure', async () => {
      ...
      // fetch-error event. We want to catch this error before making any RPC
      // assertions to make sure all RPCs had a chance to finish.
