...
// shorterTraces represents the same data as traces, but in a newer, more compact way.
// At last check, shorterTraces was 1212 bytes when sent through JSON.stringify, traces was
// 2003 bytes. This is a 40% reduction for traces that were only 20 commits long!
// -1 means "missing digest".
export const shorterTraces = {
  tileSize: 20,
  traces: [{
    // Note: the backend tops out at s=8, which equals MAX_UNIQUE_DIGESTS.
