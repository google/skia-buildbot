...
describe('changelists-page-sk', () => {
  ...
  describe('navigation', () => {
    it('responds to the browser back/forward buttons', async () => {
      ...
      fetchMock.get('/json/v2/changelists?offset=0&size=5&active=true', changelistSummaries_5);
...
function expectFirstPage(changelistsPageSk: ChangelistsPageSk) {
  expect($<HTMLTableDataCellElement>('td.owner', changelistsPageSk)[0].innerText).to.contain(
    'alpha'
  );
}
