 ...
 *
 * @evt layout-complete; fired when the force layout has stabilized and is complete.
 *
 */
...
define('cluster-digests-sk', class extends ElementSk {
  ...
  _layout() {
    ...
    const chargeForce = d3Force.forceManyBody()
      ...
      .distanceMax((this._width + this._height) / 4); // This can help performance.

    // See https://github.com/d3/d3-force#forceLink
