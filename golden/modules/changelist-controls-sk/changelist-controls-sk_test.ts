...
describe('changelist-controls-sk', () => {
  ...
  describe('html layout', () => {
    ...
    it('shows the latest patchset by default', async () => {
      ...
      expect(await changelistControlsSkPO.isIncludeResultsFromPrimaryRadioChecked()).to.be.true;
    ...
    it('flips the radio buttons on include_master', async () => {
      ...
      expect(await changelistControlsSkPO.isIncludeResultsFromPrimaryRadioChecked()).to.be.false;
      expect(await changelistControlsSkPO.isShowAllResultsRadioChecked()).to.be.true;
    });
  }); // end describe('html layout')

  describe('events', () => {
    it('generates a cl-control-change event on master toggle', async () => {
