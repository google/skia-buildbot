  ...
  describe('keyboard shortcuts', () => {
    ...
    describe('triaging', () => {
      ...
      it('can triage the selected digest with keys "A", "S" and "D"', async () => {
        ...
        // It should be positive, and label should stick after losing focus.
        await expectLabelsForFirstSecondAndThirdDigestsToBe('positive', 'positive', 'untriaged');
        await searchPageSkPO.typeKey('k'); // Go one digest up.
        await searchPageSkPO.typeKey('j'); // Go back down.
        await expectLabelsForFirstSecondAndThirdDigestsToBe('positive', 'positive', 'untriaged');
        ...
        // It should be negative, and label should stick after losing focus.
        await expectLabelsForFirstSecondAndThirdDigestsToBe('positive', 'negative', 'untriaged');
        await searchPageSkPO.typeKey('k'); // Go one digest up.
        await searchPageSkPO.typeKey('j'); // Go back down.
        await expectLabelsForFirstSecondAndThirdDigestsToBe('positive', 'negative', 'untriaged');
        ...
        // It should be untriaged, and label should stick after losing focus.
