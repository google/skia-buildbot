...
<div class=previews_and_toggles>
  ${thumbnailAndToggle(digestImagePath(ele._leftDigest), ele._leftLabel, 0, ele)}
  ${thumbnailAndToggle(digestDiffImagePath(ele._leftDigest, ele._rightDigest), 'Diff', 1, ele)}
  ${thumbnailAndToggle(digestImagePath(ele._rightDigest), ele._rightLabel, 2, ele)}
</div>
...
// thumbnailAndToggle dynamically creates an image and a canvas with id "img-N" and "canvas-N"
// respectively. These will be used to have the thumbnail and the crosshair over it, showing the
// user where in the image they are zoomed into.
