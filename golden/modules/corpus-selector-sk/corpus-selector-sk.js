 ...
 *
 * @attr default-corpus {string} corpus selected by default upon loading.
 *
...
${!el.corpora ? html`<p>Loading corpora...</p>` : html`
  <ul>
...
define('corpus-selector-sk', class extends ElementSk {
  ...
  connectedCallback() {
    ...
    // We can only read custom attributes (such as "default-corpus") after the
    // component has been attached to the DOM, thus we do so here rather than
    // in the constructor.
    this._selectedCorpus = this._defaultCorpus;
