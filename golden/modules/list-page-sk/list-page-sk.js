...
<sort-toggle-sk id=sort_table .data=${ele._byTestCounts} @sort-changed=${ele._render}>
  <table>
    ...
    <tbody id=rows>
      <!-- map here was tested and is about twice as fast as using the repeat directive
...
define('list-page-sk', class extends ElementSk {
  ...
  _fetch() {
    ...
    const hack = 'https://public-gold.skia.org';
    fetch(hack + url, extra)
      .then(jsonOrThrow)
      .then((jsonList) => {
        ...
        console.log('by test counts', this._byTestCounts);
        this._render();
    ...
    fetch(`${hack}/json/paramset`, extra)
      .then(jsonOrThrow)
      .then((paramset) => {
