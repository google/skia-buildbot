...
describe('details-page-sk', () => {
  ...
  describe('screenshots', () => {
    ...
    it('should show the invalid request page if grouping params are not present', async () => {
      await navigateTo(testBed.page, testBed.baseUrl, '?digest=99c58c7002073346ff55f446d47d6311');
      await testBed.page.setViewport({
        width: 1300,
        height: 700,
      });
      await takeScreenshot(testBed.page, 'gold', 'details-page-sk-invalid-request');
    });
