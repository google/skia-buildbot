...
describe('diff-page-sk', () => {
  ...
  // The demo page pushes a "default" query string to the URL when no query string is provided. The
  // below query string is different from said default, which allows this test to verify that the
  // page correctly parses out the query parameters.
  const baseParams =
