...
import { setImageEndpointsForDemos, digestImagePath, digestDiffImagePath } from '../common';
...
ele.left = {
  src: digestImagePath(aDigest),
  title: 'a digest title',
  detail: 'example.com#aDigest',
};
ele.diff = {
  src: digestDiffImagePath(aDigest, bDigest),
};
ele.right = {
  src: digestImagePath(bDigest),
