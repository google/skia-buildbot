  ...
  private static _template = (el: SearchControlsSk) => html`
    ...
    <div class=digests>
      ...
      ${SearchControlsSk._checkBoxTemplate(
          ...
          el._searchCriteria.includePositiveDigests,
          (val) => el._searchCriteria.includePositiveDigests = val)}

      ${SearchControlsSk._checkBoxTemplate(
          el,
          'Negative',
          'include-negative-digests',
          el._searchCriteria.includeNegativeDigests,
          (val) => el._searchCriteria.includeNegativeDigests = val)}

      ${SearchControlsSk._checkBoxTemplate(
          el,
          'Untriaged',
          'include-untriaged-digests',
          el._searchCriteria.includeUntriagedDigests,
          (val) => el._searchCriteria.includeUntriagedDigests = val)}

      ${SearchControlsSk._checkBoxTemplate(
          el,
          'Include not at HEAD',
          'include-digests-not-at-head',
          el._searchCriteria.includeDigestsNotAtHead,
          (val) => el._searchCriteria.includeDigestsNotAtHead = val)}

      ${SearchControlsSk._checkBoxTemplate(
          el,
          'Include ignored',
          'include-ignored-digests',
          el._searchCriteria.includeIgnoredDigests,
          (val) => el._searchCriteria.includeIgnoredDigests = val)}
