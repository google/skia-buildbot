 ...
 * requires custom elements demo pages. The returned function stopDemoPageServer
 * should be called at the end of the test suite, otherwise the Node interpreter
 * will hang.
 *
