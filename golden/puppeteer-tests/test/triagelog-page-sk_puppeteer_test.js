...
describe('triagelog-page-sk', function() {
  const debug = false; // Set to true to test with a headful Chromium instance.
  ...
  it('has the expected number of items', async () => {
    ...
    // Pre-screenshot sanity check: number of entries in the logs table.
  ...
  it('details hidden', async () => {
    ...
    await diffScreenshot(page, 'details-hidden');
  });
  ...
  it('details visible', async () => {
    ...
    await diffScreenshot(page, 'details-visible');
  });
