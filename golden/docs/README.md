...
[File a bug](https://bugs.chromium.org/p/skia/issues/entry?template=Infrastructure+Bug) and we'll
get back to you.
...
and the following assumes you do too.
 ...
 3. Make a Big Table Table - this will house some of the data after being processed by Gold.
 4. Make a service account that can write to the GCS bucket. This will be how your authenticate to
    goldctl (see below).
 4. Create a kubernetes deployment of ingestion. This will read the data out of GCS and put it into
...
```console
    ...
    # got drawn. Commonly, you might specify the OS, the GPU, etc.
