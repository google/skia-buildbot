...
// prompt prints out a question to stdin and scans a y/n answer from stdin.
...
// printOutGitStatus runs "git status -s" on the given checkout and prints out its output to stdout.
