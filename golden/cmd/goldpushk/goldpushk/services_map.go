...
// returned by BuildProductionDeployableUnitSet().
...
// BuildProductionDeployableUnitSet returns the DeployableUnitSet that will be used as the source of truth
// across all of goldpushk.
func BuildProductionDeployableUnitSet() DeployableUnitSet {
...
// BuildTestingDeployableUnitSet returns the DeployableUnitSet to be used when flag --testing is
// provided.
func BuildTestingDeployableUnitSet() DeployableUnitSet {
	s := DeployableUnitSet{
		knownInstances: []Instance{
			TestInstance1,
			TestInstance2,
