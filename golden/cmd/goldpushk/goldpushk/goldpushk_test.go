...
func TestNew(t *testing.T) {
	...
	g := New(deployableUnits, canariedDeployableUnits, "path/to/buildbot", false, false, "http://skia-public.com", "http://skia-corp.com")
...
func TestGetClusterCredentials(t *testing.T) {
	...
	// Create the goldpushk instance under test.
	g := New([]DeployableUnit{}, []DeployableUnit{}, "", false, false,"", "")
