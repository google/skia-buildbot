...
func TestMonitor(t *testing.T) {
	...
	assert.Equal(t, 10, timesMockUptimesFnWasCalled)
	...
	assert.NoError(t, err)
	assert.Equal(t, monitorExpectedStdout, string(stdoutBytes))
}
