...
////////////////////////////////////////////////////////////////////////////////////////////////////
// Test invariants of the DeployableUnitSet returned by BuildProductionDeployableUnitSet().       //
////////////////////////////////////////////////////////////////////////////////////////////////////
...
func TestBuildProductionDeployableUnitSetOnlyContainsKnownInstancesAndServices(t *testing.T) {
	unittest.SmallTest(t)
	deployableUnitSet := BuildProductionDeployableUnitSet()
...
func TestBuildProductionDeployableUnitSetContainsAllKnownInstances(t *testing.T) {
	unittest.SmallTest(t)
	deployableUnitSet := BuildProductionDeployableUnitSet()
...
func TestBuildProductionDeployableUnitSetAllInstancesHaveCommonServices(t *testing.T) {
	unittest.SmallTest(t)
	deployableUnitSet := BuildProductionDeployableUnitSet()
...
func TestBuildProductionDeployableUnitSetAllExactlyFuchsiaServicesAreInternal(t *testing.T) {
	unittest.SmallTest(t)
	deployableUnitSet := BuildProductionDeployableUnitSet()
	for _, unit := range deployableUnitSet.deployableUnits {
...
func TestBuildProductionDeployableUnitSetAllIngestionServiceDeploymentsRequireAConfigMap(t *testing.T) {
	unittest.SmallTest(t)
	deployableUnitSet := BuildProductionDeployableUnitSet()
	for _, unit := range deployableUnitSet.deployableUnits {
...
func TestBuildProductionDeployableUnitSetAllPublicSkiaCorrectnessDeploymentsRequireAConfigMap(t *testing.T) {
	unittest.SmallTest(t)
	deployableUnitSet := BuildProductionDeployableUnitSet()
	for _, unit := range deployableUnitSet.deployableUnits {
...
func TestBuildProductionDeployableUnitSetConfigMapNamesAreCorrect(t *testing.T) {
	unittest.SmallTest(t)
	deployableUnitSet := BuildProductionDeployableUnitSet()
...
func TestBuildProductionDeployableUnitSetConfigMapInvariantsHold(t *testing.T) {
	unittest.SmallTest(t)
	deployableUnitSet := BuildProductionDeployableUnitSet()
