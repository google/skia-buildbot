...
// Returns its canonical name used e.g. to name its corresponding .yaml file.
...
// Adds a deployment to the services map, and makes sure the relevant fields in
// the deployment match its keys in the map.
...
// Iterates over all instance/service pairs.
