...
type DeploymentOptions struct {
	...
	configMapName     string // If set, it will create a ConfigMap using the contents of field as its name.
	...
	configMapTemplate string // If set, it will generate a ConfigMap file from this template (relative to $SKIA_INFRA_ROOT), and save it to configMapFile.
}
...
// getDeploymentFileTemplatePath returns the path to the deployment file for
// this DeployableUnit.
...
// getConfigMapTemplatePath returns the path to the .yaml template file used to
// generate the ConfigMap file for this DeployableUnit.
func (u *DeployableUnit) getConfigMapTemplatePath(skiaInfraRootPath string) string {
