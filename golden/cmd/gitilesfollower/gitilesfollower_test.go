...
func TestUpdateCycle_EmptyDB_UsesInitialCommit_cdb(t *testing.T) {
...
func TestUpdateCycle_CommitsInDB_IncrementalUpdate_cdb(t *testing.T) {
	ctx := context.Background()
	db := sqltest.NewCockroachDBForTestsWithProductionSchema(ctx, t)
...
func TestUpdateCycle_NoNewCommits_NothingChanges_cdb(t *testing.T) {
	ctx := context.Background()
	db := sqltest.NewCockroachDBForTestsWithProductionSchema(ctx, t)
	existingData := schema.Tables{GitCommits: []schema.GitCommitRow{{
		GitHash:     "4444444444444444444444444444444444444444",
...
func TestCheckForLandedCycle_EmptyDB_UsesInitialCommit_cdb(t *testing.T) {
	ctx := context.Background()
	db := sqltest.NewCockroachDBForTestsWithProductionSchema(ctx, t)
...
func TestCheckForLandedCycle_UpToDate_Success_cdb(t *testing.T) {
	ctx := context.Background()
	db := sqltest.NewCockroachDBForTestsWithProductionSchema(ctx, t)
...
func TestCheckForLandedCycle_UnparsableCL_Success_cdb(t *testing.T) {
	ctx := context.Background()
	db := sqltest.NewCockroachDBForTestsWithProductionSchema(ctx, t)
...
func TestCheckForLandedCycle_CLsWithNoExpectationsLand_MarkedAsLanded_cdb(t *testing.T) {
	ctx := context.Background()
	db := sqltest.NewCockroachDBForTestsWithProductionSchema(ctx, t)
	existingData := schema.Tables{
		TrackingCommits: []schema.TrackingCommitRow{{
...
Commit-Queue: User One <user1@google.com>`,
	...
	cls := sqltest.GetAllRows(ctx, t, db, "Changelists", &schema.ChangelistRow{}).([]schema.ChangelistRow)
	assert.ElementsMatch(t, []schema.ChangelistRow{{
		ChangelistID:     "gerrit_000003",
		System:           "gerrit",
...
func TestCheckForLandedCycle_CLExpectations_MergedIntoPrimaryBranch_cdb(t *testing.T) {
	ctx := context.Background()
	db := sqltest.NewCockroachDBForTestsWithProductionSchema(ctx, t)
...
func TestCheckForLandedCycle_ExtractsCLFromSubject_Success_cdb(t *testing.T) {
	ctx := context.Background()
	db := sqltest.NewCockroachDBForTestsWithProductionSchema(ctx, t)
	existingData := schema.Tables{
		TrackingCommits: []schema.TrackingCommitRow{{
...
func TestCheckForLandedCycle_LegacyMode_StatusNotChanged_cdb(t *testing.T) {
	ctx := context.Background()
	db := sqltest.NewCockroachDBForTestsWithProductionSchema(ctx, t)
	existingData := schema.Tables{
		TrackingCommits: []schema.TrackingCommitRow{{
...
func TestCheckForLandedCycle_TriageExistingData_Success_cdb(t *testing.T) {
	ctx := context.Background()
	db := sqltest.NewCockroachDBForTestsWithProductionSchema(ctx, t)
	existingData := dks.Build()
