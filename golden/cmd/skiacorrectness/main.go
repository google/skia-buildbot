...
func main() {
	...
	expChangeNotifier := expstorage.EventHandler{}
	expStore, err := fs_expstore.New(ctx, fsClient, expChangeNotifier, fs_expstore.ReadWrite)
	if err != nil {
	...
	ic := indexer.IndexerConfig{
		DiffStore:            diffStore,
		ExpectationsNotifier: expChangeNotifier,
