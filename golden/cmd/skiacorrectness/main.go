...
var (
	...
	authoritative       = flag.Bool("authoritative", false, "Indicates that this instance should changes that could be triggered on multiple instances running in parallel.")
