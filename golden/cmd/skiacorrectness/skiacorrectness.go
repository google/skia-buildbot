...
func addAuthenticatedJSONRoutes(loggedRouter *mux.Router, fsc *frontendServerConfig, handlers *web.Handlers) {
...
func addUnauthenticatedJSONRoutes(rootRouter *mux.Router, fsc *frontendServerConfig, handlers *web.Handlers) {
