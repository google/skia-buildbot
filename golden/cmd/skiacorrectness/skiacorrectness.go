...
func mustMakeRootRouter(fsc *frontendServerConfig, handlers *web.Handlers, diffStore diff.DiffStore) *mux.Router {
	...
	addJSONRoutes(fsc, handlers, rootRouter, loggedRouter)
...
// addJSONRoutes adds Gold's JSON RPC routes (/json/*) to the given router.
func addJSONRoutes(fsc *frontendServerConfig, handlers *web.Handlers, rootRouter, loggedRouter *mux.Router) {
