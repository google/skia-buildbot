...
func writeSample(outputFileName string, tile *tiling.Tile, expectations types.ExpectationsHandler, ignoreStore ignore.IgnoreStore) {
	sample := &serialize.Sample{
		Tile:                tile,
		ExpectationsHandler: expectations,
	}
	...
	if !reflect.DeepEqual(sample.ExpectationsHandler, foundSample.ExpectationsHandler) {
...
func load(ctx context.Context, dsNamespace string) (*tiling.Tile, types.ExpectationsHandler, ignore.IgnoreStore) {
