...
func TestGatherFromPrimaryBranch_NoExistingWork_AllWorkAdded_cdb(t *testing.T) {
...
func TestGatherFromPrimaryBranch_SomeExistingWork_AllWorkAdded_cdb(t *testing.T) {
	ctx := context.Background()
	db := sqltest.NewCockroachDBForTestsWithProductionSchema(ctx, t)
...
func TestGatherFromPrimaryBranch_NoNewWork_NothingChanged_cdb(t *testing.T) {
	ctx := context.Background()
	db := sqltest.NewCockroachDBForTestsWithProductionSchema(ctx, t)
	sentinelTime := ts("2021-02-02T02:15:00Z")
	existingData := dks.Build()
...
func TestGatherFromChangelists_OnlyReportsGroupingsWithDataNotOnPrimaryBranch_cdb(t *testing.T) {
...
func TestGatherFromChangelists_UpdatesExistingWork_cdb(t *testing.T) {
...
/*
// TODO(b/415382324): Renable once the postgres emulator bug is fixed.
	...
	func TestGatherFromChangelists_UpdatesExistingWork(t *testing.T) {
		...
		require.NoError(t, sqltest.BulkInsertDataTables(ctx, db, existingData))
		alreadyPresent := sqltest.GetAllRows(ctx, t, db, "SecondaryBranchDiffCalculationWork", &schema.SecondaryBranchDiffCalculationRow{}).([]schema.SecondaryBranchDiffCalculationRow)
		sklog.Infof("Values in DB Already")
		for i := range alreadyPresent {
			sklog.Infof(" %s %v %v", alreadyPresent[i].BranchName, alreadyPresent[i].GroupingID, alreadyPresent[i].LastCalculated)
		}

		g := diffWorkGatherer{
			windowSize:       100,
			db:               db,
			mostRecentCLScan: beginningOfTime, // Setting this at time.Zero will get us data from all CLS
		}
		require.NoError(t, g.gatherFromChangelists(ctx))

		actualWork := sqltest.GetAllRows(ctx, t, db, "SecondaryBranchDiffCalculationWork", &schema.SecondaryBranchDiffCalculationRow{}).([]schema.SecondaryBranchDiffCalculationRow)
		sklog.Infof("Values in DB Now")
		for i := range actualWork {
			sklog.Infof(" %s %v %v", actualWork[i].BranchName, actualWork[i].GroupingID, actualWork[i].LastCalculated)
		}
		assert.ElementsMatch(t, []schema.SecondaryBranchDiffCalculationRow{
			{
				BranchName:           "gerrit_CL_fix_ios",
...
*/
func TestGatherFromChangelists_DeletesOldWork_cdb(t *testing.T) {
...
func TestGetAllRecentDigests_ReturnsAllRecentDigestsFromPrimaryBranch_cdb(t *testing.T) {
	ctx := context.Background()
	db := sqltest.NewCockroachDBForTestsWithProductionSchema(ctx, t)
	require.NoError(t, sqltest.BulkInsertDataTables(ctx, db, dks.Build()))
	waitForSystemTime()
...
func TestGetTuplesOfKeysToQuery_MultipleKeysAndCorpora_Success_cdb(t *testing.T) {
	ctx := context.Background()
	db := sqltest.NewCockroachDBForTestsWithProductionSchema(ctx, t)
	require.NoError(t, sqltest.BulkInsertDataTables(ctx, db, dks.Build()))
	waitForSystemTime()
...
func TestGetTuplesOfKeysToQuery_KeysAreSometimesNull_TracesWithNullValuesNotReturned_cdb(t *testing.T) {
	ctx := context.Background()
	db := sqltest.NewCockroachDBForTestsWithProductionSchema(ctx, t)
	data := dks.Build()
...
func TestGetTuplesOfKeysToQuery_IgnoredValuesCauseTracesToBeSkipped_cdb(t *testing.T) {
	ctx := context.Background()
	db := sqltest.NewCockroachDBForTestsWithProductionSchema(ctx, t)
	require.NoError(t, sqltest.BulkInsertDataTables(ctx, db, dks.Build()))
	waitForSystemTime()
...
func TestGetOldestCommitInWindow_Success_cdb(t *testing.T) {
	ctx := context.Background()
	db := sqltest.NewCockroachDBForTestsWithProductionSchema(ctx, t)
	require.NoError(t, sqltest.BulkInsertDataTables(ctx, db, dks.Build()))
	waitForSystemTime()
...
func TestGetTriageStatus_FillsInPositiveNegativeUntriagedAndCommitID_cdb(t *testing.T) {
	ctx := context.Background()
	db := sqltest.NewCockroachDBForTestsWithProductionSchema(ctx, t)
	require.NoError(t, sqltest.BulkInsertDataTables(ctx, db, dks.Build()))
	waitForSystemTime()
...
func TestGetTriageStatus_RespectsPassedInCommitID_cdb(t *testing.T) {
	ctx := context.Background()
	db := sqltest.NewCockroachDBForTestsWithProductionSchema(ctx, t)
	require.NoError(t, sqltest.BulkInsertDataTables(ctx, db, dks.Build()))
	waitForSystemTime()
...
func TestGetIgnoredCount_ReturnsCorrectAnswer_cdb(t *testing.T) {
	ctx := context.Background()
	db := sqltest.NewCockroachDBForTestsWithProductionSchema(ctx, t)
	require.NoError(t, sqltest.BulkInsertDataTables(ctx, db, dks.Build()))
	waitForSystemTime()
...
func TestSummarizeTraces_Success_cdb(t *testing.T) {
	ctx := context.Background()
	db := sqltest.NewCockroachDBForTestsWithProductionSchema(ctx, t)
	require.NoError(t, sqltest.BulkInsertDataTables(ctx, db, dks.Build()))
	waitForSystemTime()
