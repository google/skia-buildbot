...
func main() {
	// Command line flags.
	var (
		commonConfig   = flag.String("common_config", "", "Path to the json5 file containing the shared instance config.")
		specificConfig = flag.String("specific_config", "", "Path to the json5 file containing the configuration specific to baseline server.")
	...
	if err := config.LoadFromJSON5(&bsc, commonConfig, specificConfig); err != nil {
