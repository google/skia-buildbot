...
CREATE TABLE IF NOT EXISTS TraceValues (
  ...
  subject STRING
	...
	--digests []BYTES NOT NULL, -- The left and right digest for easier queries
	...
	-- INVERTED INDEX ix_digests (digests)
...
func writeExpectations(ctx context.Context, db *sql.DB) {
