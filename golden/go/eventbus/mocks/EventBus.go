...
import (
	...
	eventbus2 "go.skia.org/infra/golden/go/eventbus"
)
...
func (_m *EventBus) PublishStorageEvent(evtData *eventbus2.StorageEvent) {
	_m.Called(evtData)
}
...
func (_m *EventBus) SubscribeAsync(channelID string, callback eventbus2.CallbackFn) {
