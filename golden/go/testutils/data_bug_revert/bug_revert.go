...
// MakeTestSummaryMap returns the SummaryMap for the whole tile.
func MakeTestSummaryMap() summary.SummaryMap {
	return summary.SummaryMap{
		TestOne: {
			Name:      TestOne,
			Pos:       1,
			Untriaged: 1,
			UntHashes: types.DigestSlice{UntriagedDigestBravo},
			Num:       2,
			Corpus:    "gm",
		...
		TestTwo: {
			...
			Pos:       2,
			Untriaged: 2,
			UntHashes: types.DigestSlice{UntriagedDigestDelta, UntriagedDigestFoxtrot},
			Num:       4,
			Corpus:    "gm",
			Blame: []*blame.WeightedBlame{
				{
...
// MakeTestSummaryMap returns the SummaryMap for "head", that is,
// the most recent commit only.
func MakeTestSummaryMapHead() summary.SummaryMap {
	return summary.SummaryMap{
		TestOne: {
			Name:      TestOne,
			Pos:       1,
		...
		TestTwo: {
			...
			Pos:       2,
			Untriaged: 1,
			UntHashes: types.DigestSlice{UntriagedDigestFoxtrot},
			Num:       3,
			Corpus:    "gm",
			Blame: []*blame.WeightedBlame{
				{
