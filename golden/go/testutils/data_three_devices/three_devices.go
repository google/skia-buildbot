...
func MakeTestExpectations() expectations.Expectations {
	...
	e.AddDigest(AlphaTest, AlphaGood1Digest, expectations.Positive)
	e.AddDigest(AlphaTest, AlphaUntriaged1Digest, expectations.Untriaged)
	e.AddDigest(AlphaTest, AlphaBad1Digest, expectations.Negative)

	e.AddDigest(BetaTest, BetaGood1Digest, expectations.Positive)
	e.AddDigest(BetaTest, BetaUntriaged1Digest, expectations.Untriaged)
	return e
}
