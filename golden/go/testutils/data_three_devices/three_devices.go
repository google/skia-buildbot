	...
	return &tiling.Tile{
		...
		Traces: map[tiling.TraceId]tiling.Trace{
			...
			"angler:test_alpha:gm": &types.GoldenTrace{
				Digests: []types.Digest{AlphaBad1Digest, AlphaBad1Digest, AlphaGood1Digest},
			...
			"angler:test_beta:gm": &types.GoldenTrace{
				Digests: []types.Digest{BetaGood1Digest, BetaGood1Digest, BetaGood1Digest},
				Keys: map[string]string{
					"device":                "angler",
			...
			"bullhead:test_alpha:gm": &types.GoldenTrace{
				Digests: []types.Digest{AlphaBad1Digest, AlphaBad1Digest, AlphaUntriaged1Digest},
				Keys: map[string]string{
					"device":                "bullhead",
					types.PRIMARY_KEY_FIELD: string(AlphaTest),
					types.CORPUS_FIELD:      "gm",
			...
			"crosshatch:test_beta:gm": &types.GoldenTrace{
				Digests: []types.Digest{BetaUntriaged1Digest, types.MISSING_DIGEST, types.MISSING_DIGEST},
				Keys: map[string]string{
					"device":                "crosshatch",
					types.PRIMARY_KEY_FIELD: string(BetaTest),
					types.CORPUS_FIELD:      "gm",
