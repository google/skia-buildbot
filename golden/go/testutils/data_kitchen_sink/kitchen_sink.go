...
func MakeTraces() []tiling.TracePair {
	return []tiling.TracePair{
		...
		{ // This trace was drawing incorrectly until commit index 7.
			...
			Trace: tiling.NewTrace(
				[]types.Digest{
					DigestB03Neg, DigestB03Neg, DigestB03Neg, DigestB03Neg, DigestB03Neg,
					DigestB03Neg, DigestB03Neg, DigestB01Pos, DigestB01Pos, DigestB01Pos,
				},
				map[string]string{
					OSKey:                 iOS,
					DeviceKey:             IPadDevice,
		...
		{ // This trace was drawing incorrectly until commit index 7.
			...
			Trace: tiling.NewTrace(
				[]types.Digest{
					DigestB03Neg, DigestB03Neg, DigestB03Neg, DigestB03Neg, DigestB03Neg,
					DigestB03Neg, DigestB03Neg, DigestB02Pos, DigestB02Pos, DigestB02Pos,
				},
				map[string]string{
					OSKey:                 iOS,
					DeviceKey:             IPadDevice,
		...
		{ // This trace was drawing incorrectly until commit index 7.
			...
			Trace: tiling.NewTrace(
				[]types.Digest{
					DigestB03Neg, DigestNoData, DigestB03Neg, DigestNoData, DigestB03Neg,
		...
		{ // This trace was drawing incorrectly until commit index 7.
			...
			Trace: tiling.NewTrace(
				[]types.Digest{
					DigestNoData, DigestB03Neg, DigestNoData, DigestNoData, DigestB03Neg,
...
func MakeExpectations() expectations.Classifier {
	...
	e.Set(TriangleTest, DigestC01Pos, expectations.Positive)
	e.Set(TriangleTest, DigestC02Pos, expectations.Positive)
	return &e
}
...
const (
	...
	DigestB03Neg = types.Digest("b03b03b03b03b03b03b03b03b03b03b0") // big diff from B01 (i.e. blank)
	...
	// TODO(kjlubick) add a blank test where it is correct to be blank, but only for that test (not, for example, for the triangle test).
	//   It would be good to test that we handle this case for untriaged and triaged positive.
