...
// updateTracesAndCommit gets all current ignore rules and apply them to all Traces and ValuesAtHead.
// This is done in the passed in transaction, so if it fails, we can rollback. If successful,
