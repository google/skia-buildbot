...
func (_m *Store) CreateComment(_a0 context.Context, _a1 trace.Comment) (comment.ID, error) {
	ret := _m.Called(_a0, _a1)

	var r0 comment.ID
	if rf, ok := ret.Get(0).(func(context.Context, trace.Comment) comment.ID); ok {
		r0 = rf(_a0, _a1)
	} else {
		r0 = ret.Get(0).(comment.ID)
	}
...
func (_m *Store) DeleteComment(ctx context.Context, id comment.ID) error {
	ret := _m.Called(ctx, id)

	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, comment.ID) error); ok {
		r0 = rf(ctx, id)
	} else {
		r0 = ret.Error(0)
	}
