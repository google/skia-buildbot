...
type GarbageCollector interface {
	// UpdateLastUsed will bulk update the given deltas as last used on the given time. This will
	...
	// MarkOlderEntriesForGC marks entries matching the given label as Untriaged, provided they
	...
	MarkOlderEntriesForGC(context.Context, expectations.Label, time.Time) (int, error)
