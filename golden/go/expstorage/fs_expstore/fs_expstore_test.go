...
// TestAddChange_MasterBranch_NotifierEventsCorrect makes sure the notifier is called
...
// TestAddUndo_NotifierEventsCorrect tests that the notifier calls are correct during Undo operations.
