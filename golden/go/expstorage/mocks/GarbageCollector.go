...
// MarkOlderEntriesForGC provides a mock function with given fields: _a0, _a1, _a2
func (_m *GarbageCollector) MarkOlderEntriesForGC(_a0 context.Context, _a1 expectations.Label, _a2 time.Time) (int, error) {
