...
func (s *SQLExpectationsStore) Get() (exp types.ExpectationsHandler, err error) {
	...
	return types.NewExpectationsHandler(result), nil
}
...
// See ExpectationsStore interface.
func (c *CachingExpectationStore) Get() (exp types.ExpectationsHandler, err error) {
	if c.refresh {
		c.refresh = false
