...
func TestUpdate_NoMaxAgesSet_OnlyUntriagedPruned(t *testing.T) {
	...
	// Make sure we call cleaner.UntriageOldEntries as expected.
	mc := &mocks.Cleaner{}
	defer mc.AssertExpectations(t)

	mc.On("PruneUntriagedEntries", testutils.AnyContext).Return(0, nil)
...
func TestUpdate_MaxPosAgeSet_OnlyUntriagedPruned(t *testing.T) {
	...
	mc.On("UntriageOldEntries", testutils.AnyContext, expectations.Positive, oneHourAgo).Return(0, nil)
	mc.On("PruneUntriagedEntries", testutils.AnyContext).Return(0, nil)
...
func TestUpdate_MaxNegAgeSet_OnlyUntriagedPruned(t *testing.T) {
	...
	mc.On("UntriageOldEntries", testutils.AnyContext, expectations.Negative, twoHoursAgo).Return(0, nil)
	mc.On("PruneUntriagedEntries", testutils.AnyContext).Return(0, nil)
