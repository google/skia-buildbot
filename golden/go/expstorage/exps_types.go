...
//
// Each digest is 32 characters and the label is a maximum of 8 characters.
// If we assume an average size of 275 characters for the test name we get
//    nDigestsPerRec = 1000000/(275 + 32 + 8) ~ 3175
