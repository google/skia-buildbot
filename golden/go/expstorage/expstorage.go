...
type ExpectationsStore interface {
	...
	Get() (exp types.ExpectationsHandler, err error)
...
type MemExpectationsStore struct {
	expectations types.ExpectationsHandler
	readCopy     types.ExpectationsHandler
...
func (m *MemExpectationsStore) Get() (types.ExpectationsHandler, error) {
	m.mutex.RLock()
...
func (m *MemExpectationsStore) AddChange(changedTests types.TestExp, userId string) error {
	...
	m.readCopy = types.NewExpectationsHandler(m.expectations.TestExp().DeepCopy())
	return nil
}
...
func (m *MemExpectationsStore) RemoveChange(changedDigests types.TestExp) error {
	...
	m.expectations = types.NewExpectationsHandler(testExp)
...
func (m *MemExpectationsStore) Clear() error {
	m.mutex.Lock()
	defer m.mutex.Unlock()
	m.expectations = types.NewExpectationsHandler(nil)
	m.readCopy = types.NewExpectationsHandler(nil)
	return nil
}
