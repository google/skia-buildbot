...
func ClosestDigest(test string, digest string, exp types.TestExpBuilder, digestCount digest_counter.DigestCount, diffStore diff.DiffStore, label types.Label) *Closest {
	ret := newClosest()
