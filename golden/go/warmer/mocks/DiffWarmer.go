...
func (_m *DiffWarmer) PrecomputeDiffs(ctx context.Context, summaries []*summary.DigestsForTest, testNames types.TestNameSet, dCounter digest_counter.DigestCounter, diffFinder digesttools.ClosestDiffFinder) error {
	ret := _m.Called(ctx, summaries, testNames, dCounter, diffFinder)

	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, []*summary.DigestsForTest, types.TestNameSet, digest_counter.DigestCounter, digesttools.ClosestDiffFinder) error); ok {
