...
type DiffWarmer interface {
	...
	PrecomputeDiffs(summaries summary.SummaryMap, dCounter digest_counter.DigestCounter, diffFinder digesttools.ClosestDiffFinder)
}
...
func (w *WarmerImpl) PrecomputeDiffs(summaries summary.SummaryMap, dCounter digest_counter.DigestCounter, diffFinder digesttools.ClosestDiffFinder) {
