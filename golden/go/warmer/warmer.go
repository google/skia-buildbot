...
type DiffWarmer interface {
	...
	// precomputed.
	PrecomputeDiffs(ctx context.Context, summaries []*summary.DigestsForTest, testNames types.TestNameSet, dCounter digest_counter.DigestCounter, diffFinder digesttools.ClosestDiffFinder) error
}
...
func (w *WarmerImpl) PrecomputeDiffs(ctx context.Context, summaries []*summary.DigestsForTest, testNames types.TestNameSet, dCounter digest_counter.DigestCounter, diffFinder digesttools.ClosestDiffFinder) error {
