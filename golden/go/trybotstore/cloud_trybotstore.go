...
func (c *cloudTrybotStore) DeleteIssue(issueID int64) error {
	...
	// Delete any trybots that are still there.
...
func (c *cloudTrybotStore) AddChange(issueID int64, changes map[string]types.TestClassification, userID string) (err error) {
...
func (c *cloudTrybotStore) deleteExpChanges(keys []*datastore.Key) error {
	return c.client.DeleteMulti(context.Background(), keys)
}

func (c *cloudTrybotStore) deleteExpectationsForIssue(issueID int64) error {
...
func (c *cloudTrybotStore) getExpChangesForIssue(issueID int64) ([]*datastore.Key, error) {
...
func (c *cloudTrybotStore) getTestDigestExps(changeKey *datastore.Key, keysOnly bool) ([]*datastore.Key, []*TestDigestExp, error) {
...
func (c *cloudTrybotStore) getIncompleteKey(kind string, ancenstor *datastore.Key) *datastore.Key {
