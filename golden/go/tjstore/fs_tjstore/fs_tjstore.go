...
func (s *StoreImpl) GetResults(ctx context.Context, psID tjstore.CombinedPSID) ([]tjstore.TryJobResult, error) {
	...
	// TODO(kjlubick): if performance is slow, try
	//  https://godoc.org/cloud.google.com/go/firestore#Client.GetAll or fetch them in parallel
	// with shards.
...
// fetchParamMap fetches the Param with the given hash
func (s *StoreImpl) fetchParamMap(ctx context.Context, hash string) (paramtools.Params, error) {
