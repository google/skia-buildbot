...
func (s *StoreImpl) GetResults(ctx context.Context, clID, psID string) ([]tjstore.TryJobResult, error) {
	return []tjstore.TryJobResult{}, errors.New("not impl")
}

// PutTryJob implements the tjstore.Store interface.
func (s *StoreImpl) PutTryJob(ctx context.Context, clID, psID string, tj ci.TryJob) error {
	return errors.New("not impl")
}

// PutResults implements the tjstore.Store interface.
func (s *StoreImpl) PutResults(ctx context.Context, clID, psID string, r []tjstore.TryJobResult) error {
	return errors.New("not impl")
}
