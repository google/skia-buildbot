...
We should have three Firestore Collections (i.e. tables), one for TryJob, PatchSet, and Params.
Params is its own table to avoid duplicated data and reduce
	...
	Params
		ID     string # hex encoded sha256 hash of Map
