...
type Store interface {
	...
	// to the the associated ChangeList and PatchSet. sharedParams is a map of
...
type TryJobResult struct {
	...
	// things that change for each result.
...
type CombinedPSID string

// MakeCombinedID creates a probably unique id for a given
...
func MakeCombinedID(clID, psID, crsSystem string) CombinedPSID {
	return CombinedPSID(fmt.Sprintf("%s__%s__%s", clID, crsSystem, psID))
}
