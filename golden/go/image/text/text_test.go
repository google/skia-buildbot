...
func TestDecode_ValidImage_Success(t *testing.T) {
	...
	assertImageContainsExpectedPixels(t, img.(*image.NRGBA), 2, 2, validImageExpectedPixels)
}
...
func TestDecode_ValidImageWithGrayscaleNotation_Success(t *testing.T) {
	...
	assertImageContainsExpectedPixels(t, img.(*image.NRGBA), 2, 2, grayscaleNotationImageExpectedPixels)
}
...
func TestMustToNRGBA_ValidImage_Success(t *testing.T) {
	...
	assertImageContainsExpectedPixels(t, img, 2, 2, validImageExpectedPixels)
}
...
func assertImageContainsExpectedPixels(t *testing.T, nrgba *image.NRGBA, expectedWidth, expectedHeight int, expectedPixels []expectedPixel) {
