...
func TestSearchIndex_MostRecentPositiveImage_AllDigestsIdenticalAndPositive_Success(t *testing.T) {
	unittest.SmallTest(t)
...
func TestSearchIndex_MostRecentPositiveImage_MultiplePositiveDigests_Success(t *testing.T) {
	unittest.SmallTest(t)
...
func TestSearchIndex_MostRecentPositiveImage_LastPositiveNotAtHead_Success(t *testing.T) {
	unittest.SmallTest(t)
...
func TestSearchIndex_MostRecentPositiveImage_NoRecentPositive_ReturnsMissingDigest(t *testing.T) {
	unittest.SmallTest(t)
	...
	assert.NoError(t, err)
	assert.Equal(t, types.MISSING_DIGEST, digest)
}

func TestSearchIndex_MostRecentPositiveImage_TraceNotFound_ReturnsMissingDigest(t *testing.T) {
	unittest.SmallTest(t)
...
func TestSearchIndex_MostRecentPositiveImage_ExpectationsStoreFailure_ReturnsError(t *testing.T) {
	unittest.SmallTest(t)
