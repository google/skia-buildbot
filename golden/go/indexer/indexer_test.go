...
func TestSearchIndex_MostRecentPositiveDigest_LastPositiveNotAtHead_Success(t *testing.T) {
	...
	complexTile, traceID, mockExpStore := makeSingleTraceComplexTile(goodDigest1, badDigest1, goodDigest2, badDigest2, untriagedDigest1)
...
func TestSearchIndex_MostRecentPositiveDigest_NoRecentPositive_ReturnsMissingDigest(t *testing.T) {
	...
	complexTile, traceID, mockExpStore := makeSingleTraceComplexTile(untriagedDigest1, badDigest1, untriagedDigest2, badDigest2)
