...
func TestSearchIndex_MostRecentPositiveDigest_AllDigestsIdenticalAndPositive_Success(t *testing.T) {
	...
	complexTile, traceID, mockExpStore := makeSingleTraceComplexTile(goodDigest1, goodDigest1, goodDigest1)
...
func TestSearchIndex_MostRecentPositiveDigest_MultiplePositiveDigests_Success(t *testing.T) {
	...
	complexTile, traceID, mockExpStore := makeSingleTraceComplexTile(goodDigest1, goodDigest2, goodDigest3)
...
func TestSearchIndex_MostRecentPositiveDigest_LastPositiveNotAtHead_Success(t *testing.T) {
	...
	complexTile, traceID, mockExpStore := makeSingleTraceComplexTile(goodDigest1, badDigest1, goodDigest2, badDigest2, untriagedDigest1, types.MissingDigest)
...
func TestSearchIndex_MostRecentPositiveDigest_NoRecentPositive_ReturnsMissingDigest(t *testing.T) {
	...
	complexTile, traceID, mockExpStore := makeSingleTraceComplexTile(untriagedDigest1, types.MissingDigest, badDigest1, untriagedDigest2, types.MissingDigest, badDigest2)
...
func TestSearchIndex_MostRecentPositiveDigest_ExpectationsStoreFailure_ReturnsError(t *testing.T) {
	...
	complexTile, traceID, _ := makeSingleTraceComplexTile(goodDigest1)
...
const (
	...
	// Digests to be used in conjunction with makeSingleTraceComplexTile().
...
// digests, and a companion expectations.Store with expectations for the test associated with the
// trace and the good/badDigest* constants defined above.
func makeSingleTraceComplexTile(digests ...types.Digest) (types.ComplexTile, tiling.TraceID, *mock_expectations.Store) {
	device := "my_device"
	corpus := "my_corpus"
