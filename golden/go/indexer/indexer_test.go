...
func TestIndexer_CalcChangeListIndices_HasPreviousIndices_Success(t *testing.T) {
	...
	// After that index was computed, the user triaged AlphaPostiiveDigest and AlphaNegativeDigest,
	...
	// Additionally, the secondPatchets index should be updated to show the 1 correct untriaged
	// digest.
