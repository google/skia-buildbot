...
func SearchIndexForTesting(cpxTile types.ComplexTile, dc [2]digest_counter.DigestCounter, pm [2]paramsets.ParamSummary, exp expectations.ExpectationsStore, b blame.Blamer) (*SearchIndex, error) {
	s := &SearchIndex{
