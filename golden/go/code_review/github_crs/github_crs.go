...
func (c *CRSImpl) GetChangeList(ctx context.Context, id string) (code_review.ChangeList, error) {
	...
	if err != nil {
		return code_review.ChangeList{}, skerr.Wrapf(err, "getting ChangeList from url %s", u)
	}
...
func (c *CRSImpl) GetPatchSets(ctx context.Context, clID string) ([]code_review.PatchSet, error) {
	...
	resp, err := c.client.Get(u)
	if err != nil {
		return nil, skerr.Wrapf(err, "getting commits on PR %s with url %s", clID, u)
	}
	defer util.Close(resp.Body)
	...
	if err != nil {
		return nil, skerr.Wrapf(err, "received invalid JSON from GitHub")
	}
...
func (c *CRSImpl) GetChangeListForCommit(ctx context.Context, commit *vcsinfo.LongCommit) (code_review.ChangeList, error) {
	...
	if err != nil {
		return code_review.ChangeList{}, skerr.Wrapf(err, "finding github pr in %s", commit.Subject)
	}
