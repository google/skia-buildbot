...
func (c *CRSImpl) GetPatchSets(ctx context.Context, clID string) ([]code_review.PatchSet, error) {
	...
	// 250 commits. Just to be safe, we should bail out of page gets too high, just to cover for
	// some unanticipated response. Usually we break when the API gives us 0 responses for a page.
