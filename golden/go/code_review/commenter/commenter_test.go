...
// TestCommentOnCLsCommentOnce tests the case where all open CLs have already been commented on.
func TestCommentOnCLsCommentOnce(t *testing.T) {
	unittest.SmallTest(t)
...
// TestCommentOnCLsPatchSetsOnce tests the case where fetching PatchSets from clstore fails.
// The whole process should fail.
func TestCommentOnCLsPatchSetsOnce(t *testing.T) {
	unittest.SmallTest(t)
