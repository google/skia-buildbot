...
func (s *Storage) PushIssueBaseline(issueID int64, tile *tiling.Tile) error {
	...
	baseLine := baseline.GetBaselineForIssue(issueID, tryjobs, tryjobResults, exp, tile.Commits)
