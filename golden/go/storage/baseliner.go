...
// TODO(stephana): Baseliner needs to merged into the baseline package and refactored.

// Baseliner is a helper type that handles baselines.
...
func (b *Baseliner) FetchBaseline(issueID int64, patchsetID int64) (*baseline.CommitableBaseLine, error) {
