...
type TryjobStore interface {
	...
	// If project is true the builders are project forward so earlier runs of a builder
	// are ignored in favor of the run against the latest patchset.
	GetTryjobResults(issueID int64, patchsetID []int64, project bool) ([]*Tryjob, [][]*TryjobResult, error)
...
func (c *cloudTryjobStore) GetTryjobResults(issueID int64, patchsetIDs []int64, project bool) ([]*Tryjob, [][]*TryjobResult, error) {
