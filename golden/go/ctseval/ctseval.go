...
func NewCTSEvalator(bucket, dataDir string, httpClient *http.Client, sources []ingestion.Source, ingestFreq time.Duration, timeWindowDays int, ixr *indexer.Indexer, storages *storage.Storage) (*CTSEvaluator, error) {
