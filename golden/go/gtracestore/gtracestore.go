...
type TraceStore interface {
	Put(commit vcsinfo.LongCommit, entries []*Entry) error
}
...
func NewBTTraceStore() (TraceStore, error) {
	ret := &btTraceStore{}

	return ret, nil
}

func (b *btTraceStore) Put(commit vcsinfo.LongCommit, entries []*Entry) error {
	return nil
}
