...
// the ones provided by the passed in parameter overwrite any existing data. Modifying other
// while passing it into MergeExpectations will cause a race condition.
