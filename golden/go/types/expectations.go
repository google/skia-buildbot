...
// Expectations is a map[test_name][digest]Label that captures the expectations or baselines
// for a set of tests and digests as labels (POSITIVE/NEGATIVE/UNTRIAGED).
// It is used throughout Gold to hold expectations (or just baselines, which
// are a subset of expectations that is just the positive values.)
