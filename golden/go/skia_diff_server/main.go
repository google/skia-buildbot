...
var (
	...
	gsBaseDirs         = flag.String("gs_basedirs", "dm-images-v1", "String that represents the google storage directory/directories following the GS bucket")
...
func main() {
	...
	memDiffStore, err := diffstore.NewMemDiffStore(client, nil, *imageDir, strings.Split(*gsBucketNames, ","), *gsBaseDirs, *cacheSize, nil)
	if err != nil {
