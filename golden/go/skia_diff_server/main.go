...
var (
	...
	gsBaseDirs         = flag.String("gs_basedirs", "dm-images-v1", "String that represents the GS image path following the GS bucket")
...
func main() {
	...
	memDiffStore, err := diffstore.NewMemDiffStore(client, *imageDir, strings.Split(*gsBucketNames, ","), *gsBaseDirs, *cacheSize, nil, nil, nil)
	if err != nil {
