	...
	return &tiling.Tile{
		...
		Traces: map[tiling.TraceId]tiling.Trace{
			...
			x86TestAlphaTraceID: &types.GoldenTrace{
				Digests: []types.Digest{FirstDigest, FirstDigest, SecondDigest},
			...
			x64TestAlphaTraceID: &types.GoldenTrace{
				Digests: []types.Digest{ThirdDigest, FirstDigest, types.MISSING_DIGEST},
				Keys: map[string]string{
					"config":                "x86_64",
					types.PRIMARY_KEY_FIELD: string(AlphaTest),
...
func makePartialTileTwo() *tiling.Tile {
	return &tiling.Tile{
		...
		Traces: map[tiling.TraceId]tiling.Trace{
			...
			// all the values in alphabetical order of the keys.
			x86TestAlphaTraceID: &types.GoldenTrace{
				Digests: []types.Digest{FirstDigest, FirstDigest, SecondDigest, SecondDigest},
				Keys: map[string]string{
					"config":                "x86",
					types.PRIMARY_KEY_FIELD: string(AlphaTest),
					types.CORPUS_FIELD:      "gm",
			...
			x64TestBetaTraceID: &types.GoldenTrace{
				Digests: []types.Digest{ThirdDigest, FirstDigest, ThirdDigest, FirstDigest},
				Keys: map[string]string{
					"config":                "x86_64",
