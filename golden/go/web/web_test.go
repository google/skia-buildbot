...
// TestNewHandlers_BaselineSubsetHasAllPieces_Success makes sure we can create a web.Handlers
// using the BaselineSubset of inputs.
func TestNewHandlers_BaselineSubsetHasAllPieces_Success(t *testing.T) {
	unittest.SmallTest(t)
...
// TestNewHandlers_BaselineSubsetMissingPieces_Failure makes sure that if we omit values from
// HandlersConfig, NewHandlers returns an error.
func TestNewHandlers_BaselineSubsetMissingPieces_Failure(t *testing.T) {
	unittest.SmallTest(t)
...
// TestNewHandlers_FullFrontEndMissingPieces_Failure makes sure that if we omit values from
// HandlersConfig, NewHandlers returns an error.
// TODO(kjlubick) Add a case for FullFrontEnd with all pieces when we have mocks for all
//   remaining services.
func TestNewHandlers_FullFrontEndMissingPieces_Failure(t *testing.T) {
	unittest.SmallTest(t)
