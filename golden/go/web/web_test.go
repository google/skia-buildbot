...
// TestComputeByBlame_BugRevert_SunnyDay_Success calculates the "byBlameEntries" for the entire
// BugRevert test data corpus, which has one seen untriaged digest. A byBlameEntry ("blame" or
// "blames" for short) points out which commits introduced untriaged digests.
func TestComputeByBlame_BugRevert_SunnyDay_Success(t *testing.T) {
	unittest.SmallTest(t)
...
// TestComputeByBlame_BugRevertSubset_SunnyDay_Success calculates the "byBlameEntries" for a
// truncated version of the bug_revert test data corpus.  This subset was chosen to have several
// untriaged digests that are easy to manually compute blames for to verity.
func TestComputeByBlame_BugRevertSubset_SunnyDay_Success(t *testing.T) {
	unittest.SmallTest(t)
...
// TestIgnoresAddHandler_SunnyDay_Success tests a typical case of adding an ignore rule (which ends
// up in the IgnoreStore).
func TestIgnoresAddHandler_SunnyDay_Success(t *testing.T) {
	unittest.SmallTest(t)
...
// TestIgnoresAddHandler_StoreFailure_InternalServerError tests the exceptional case where a rule
// fails to be added to the IgnoreStore).
func TestIgnoresAddHandler_StoreFailure_InternalServerError(t *testing.T) {
	unittest.SmallTest(t)
...
// TestIgnoresUpdateHandler_SunnyDay_Success tests a typical case of updating an ignore rule in
// IgnoreStore.
func TestIgnoresUpdateHandler_SunnyDay_Success(t *testing.T) {
	unittest.SmallTest(t)
...
// TestIgnoresUpdateHandler_NoID_BadRequestError tests an exceptional case of attempting to update
// an ignore rule without providing an id for that ignore rule.
func TestIgnoresUpdateHandler_NoID_BadRequestError(t *testing.T) {
	unittest.SmallTest(t)
...
// TestIgnoresUpdateHandler_StoreFailure_InternalServerError tests an exceptional case of attempting
// to update an ignore rule in which there is an error returned by the IgnoreStore.
func TestIgnoresUpdateHandler_StoreFailure_InternalServerError(t *testing.T) {
	unittest.SmallTest(t)
	mis := &mock_ignore.Store{}
	defer mis.AssertExpectations(t)
...
// TestIgnoresDeleteHandler_RuleExists_SunnyDay_Success tests a typical case of deleting an ignore
// rule which exists in the IgnoreStore.
func TestIgnoresDeleteHandler_RuleExists_SunnyDay_Success(t *testing.T) {
	unittest.SmallTest(t)
...
// TestIgnoresDeleteHandler_NoID_InternalServerError tests an exceptional case of attempting to
// delete an ignore rule without providing an id for that ignore rule.
func TestIgnoresDeleteHandler_NoID_InternalServerError(t *testing.T) {
	unittest.SmallTest(t)
...
// TestIgnoresDeleteHandler_StoreFailure_InternalServerError tests an exceptional case of attempting
...
func TestIgnoresDeleteHandler_StoreFailure_InternalServerError(t *testing.T) {
	unittest.SmallTest(t)
