...
func TestChangelistSummaryHandler_ValidInput_CorrectJSONReturned(t *testing.T) {
	...
	const expectedJSON = `{"changelist_id":"my_cl","patchsets":[{"new_images":1,"new_untriaged_images":2,"total_untriaged_images":3,"patchset_id":"patchset1","patchset_order":1},{"new_images":5,"new_untriaged_images":6,"total_untriaged_images":7,"patchset_id":"patchset8","patchset_order":8}]}`
	assertJSONResponseWas(t, http.StatusOK, expectedJSON, w)
}
