...
// for a given CL. It will be sure to redirect to a corpus that has at least one observed digest.
// It may be too slow to
...
// As is, it can take 3-4 seconds on a large instance like Skia.
