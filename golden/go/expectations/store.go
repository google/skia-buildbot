...
type Store interface {
	...
	// ForChangeList returns a new Store that will deal with the Expectations for a
	// ChangeList with the given id (aka a CLExpectations). Any Expectations added to the returned
	// Store will be kept separate from the master branch. Any Expectations returned should be
