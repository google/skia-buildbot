...
expstore_expectations_v2   | label: ASC updated: ASC  # this will go away, see MarkOlderEntriesForGC
...
That same process then calls MarkOlderEntriesForGC, which sets the `label` to untriaged for all
