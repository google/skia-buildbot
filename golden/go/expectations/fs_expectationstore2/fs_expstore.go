...
func New2(client *ifirestore.Client, cn expectations.ChangeNotifier, mode AccessMode) *Store {
	return &Store{
		client:     client,
		notifier:   cn,
...
// extractExpectationEntries2 retrieves all []expectationEntry from a given QuerySnapshot, logging
// any errors (which should be exceedingly rare).
func extractExpectationEntries2(qs *firestore.QuerySnapshot) []expectationEntry {
