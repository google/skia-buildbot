...
// returned by ForChangeList are, in general, not going to have this called since they will not
// persist very long.
...
func (s *Store2) MarkUnusedEntriesForGC(ctx context.Context, label expectations.Label, ts time.Time) (int, error) {
	if s.partition != masterPartition {
...
func (s *Store2) GarbageCollect(ctx context.Context) (int, error) {
