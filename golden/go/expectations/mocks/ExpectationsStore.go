...
func (_m *ExpectationsStore) AddChange(ctx context.Context, changes []expectations.Delta, userId string) error {
...
func (_m *ExpectationsStore) ForChangeList(id string, crs string) expectations.ExpectationsStore {
	ret := _m.Called(id, crs)

	var r0 expectations.ExpectationsStore
	if rf, ok := ret.Get(0).(func(string, string) expectations.ExpectationsStore); ok {
		r0 = rf(id, crs)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(expectations.ExpectationsStore)
		}
	}
...
func (_m *ExpectationsStore) QueryLog(ctx context.Context, offset int, n int, details bool) ([]expectations.TriageLogEntry, int, error) {
