...
CREATE TABLE IF NOT EXISTS TraceValues (
  ...
  INDEX grouping_commit_idx (grouping_id, commit_id DESC, digest), -- Allows for easier joins with DiffMetrics
...
CREATE TABLE IF NOT EXISTS Expectations (
  ...
  INDEX by_group_idx (grouping_id, label) STORING (expectation_record_id),
