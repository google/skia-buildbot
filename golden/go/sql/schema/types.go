...
type TriStateField int

const (
	NotSet   TriStateField = 0
	SetFalse TriStateField = 1
	SetTrue  TriStateField = 2
)
...
type TraceRow struct {
	...
	// searches and joins.
	Corpus string `sql:"corpus STRING NOT NULL"`
	...
	// unset (i.e. NULL).
	MatchesAnyIgnoreRule TriStateField `sql:"matches_any_ignore_rule BOOL"`
}
