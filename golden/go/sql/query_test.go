...
// Locally, this ran at about 28ms per operation for 36400 Traces. It can use the indexes and
...
// Locally, this ran at about 26ms per operation for 36400 Traces. It can use the indexes and
// appears to do so in parallel.
...
// Locally, this ran at about 97ms per operation for 36400 Traces. It has to do a full table scan.
...
// Locally, this ran at about 82ms per operation for 36400 Traces. It did a zig-zag join on the
...
// Locally, this ran at about 67ms per operation for 36400 Traces. It did a zig-zag join on the
