...
func Build() schema.Tables {
	...
	b.CommitsWithData().
		...
		Append(UserTwo, "commit 101", "2020-12-04T00:00:00Z").
		Append(UserOne, "commit 102", "2020-12-05T00:00:00Z").
		Insert(106, UserTwo, "commit 106", "2020-12-07T00:00:00Z").
		Append(UserThree, "commit 107", "2020-12-08T00:00:00Z").
		Append(UserTwo, "commit 108", "2020-12-09T00:00:00Z").
		Append(UserOne, "commit 109", "2020-12-10T00:00:00Z").
	...
	b.SetDigests(map[rune]types.Digest{
		...
		// but not the others. When it shows up in other groupings, it should be untraiged
		'@': DigestBlank,
	})
	...
	b.AddTracesWithCommonKeys(paramtools.Params{
		...
		"---rrrrrrr", // The new driver in 10.3 changed the antialiases for circles a little.
...
const (
	...
	WindowsFile4  = "gcs://skia-gold-test/dm-json-v1/2020/12/04/00/0101010101010101010101010101010101010101/waterfall/windowsfile3.json"
	WindowsFile5  = "gcs://skia-gold-test/dm-json-v1/2020/12/05/00/0102010201020102010201020102010201020102/waterfall/windowsfile3.json"
	WindowsFile6  = "gcs://skia-gold-test/dm-json-v1/2020/12/07/00/0106010601060106010601060106010601060106/waterfall/windowsfile3.json"
	WindowsFile7  = "gcs://skia-gold-test/dm-json-v1/2020/12/08/00/0107010701070107010701070107010701070107/waterfall/windowsfile3.json"
	WindowsFile8  = "gcs://skia-gold-test/dm-json-v1/2020/12/09/00/0108010801080108010801080108010801080108/waterfall/windowsfile3.json"
	WindowsFile9  = "gcs://skia-gold-test/dm-json-v1/2020/12/10/00/0109010901090109010901090109010901090109/waterfall/windowsfile3.json"
	WindowsFile10 = "gcs://skia-gold-test/dm-json-v1/2020/12/11/00/0110011001100110011001100110011001100110/waterfall/windowsfile3.json"
)
