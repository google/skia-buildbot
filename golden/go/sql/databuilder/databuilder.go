...
func (b *TablesBuilder) Build() schema.Tables {
	...
	addTrace := func(t schema.TraceRow, allowDuplicates bool) schema.NullableBool {
		...
		tables.Traces = append(tables.Traces, t)
		return matches
	}
