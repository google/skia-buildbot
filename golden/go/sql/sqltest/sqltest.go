...
// NewCockroachDBForTestsWithCreateProductionSchema returns a SQL database with the production
// schema. It will be aimed at a randomly named database.
func NewCockroachDBForTestsWithCreateProductionSchema(ctx context.Context, t *testing.T) *pgxpool.Pool {
