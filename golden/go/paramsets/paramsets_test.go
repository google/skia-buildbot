...
func makePartialTestTile() *tiling.Tile {
	return &tiling.Tile{
		...
		Traces: map[tiling.TraceId]tiling.Trace{
			...
			"a": &types.GoldenTrace{
				Digests: []types.Digest{DigestA, DigestB},
			...
			"b": &types.GoldenTrace{
				Digests: []types.Digest{DigestC, DigestD, DigestA},
				Keys: map[string]string{
					"config":                "565",
					types.CORPUS_FIELD:      "gm",
					types.PRIMARY_KEY_FIELD: string(testOne),
			...
			"c": &types.GoldenTrace{
				Digests: []types.Digest{DigestE, types.MISSING_DIGEST},
				Keys: map[string]string{
					"config":                "gpu",
					types.CORPUS_FIELD:      "gm",
					types.PRIMARY_KEY_FIELD: string(testOne),
			...
			"e": &types.GoldenTrace{
				Digests: []types.Digest{DigestF, DigestG, DigestG},
				Keys: map[string]string{
					"config":                "565",
					types.CORPUS_FIELD:      "gm",
			...
			"f": &types.GoldenTrace{
				Digests: []types.Digest{DigestF, types.MISSING_DIGEST},
				Keys: map[string]string{
					"config":                "gpu",
					types.CORPUS_FIELD:      "gm",
					types.PRIMARY_KEY_FIELD: string(testTwo),
