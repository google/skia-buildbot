...
type ParamSummary struct {
	byTrace               map[types.TestName]map[types.Digest]paramtools.ParamSet
	byTraceIncludeIgnored map[types.TestName]map[types.Digest]paramtools.ParamSet
}

// byTraceForTile calculates all the paramsets from the given tile and tallies.
func byTraceForTile(tile *tiling.Tile, digestCountsByTrace map[tiling.TraceId]digest_counter.DigestCount) map[types.TestName]map[types.Digest]paramtools.ParamSet {
