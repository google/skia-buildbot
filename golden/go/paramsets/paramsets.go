...
// New creates a new ParamSummaryImpl.
func New(cpxTile types.ComplexTile, countsWithIgnoreRules digest_counter.DigestCounter, countsWithoutIgnoreRules digest_counter.DigestCounter) *ParamSummaryImpl {
