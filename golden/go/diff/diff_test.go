...
func TestDiffImages(t *testing.T) {
	unittest.MediumTest(t)
	assertDiffMatch(t, EXPECTED_NO_DIFF, one_by_five.ImageOne, one_by_five.ImageOne)
	assertDiffMatch(t, EXPECTED_NO_DIFF, one_by_five.ImageTwo, one_by_five.ImageTwo)
