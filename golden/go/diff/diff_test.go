...
func loadBenchmarkImage(fileName string) image.Image {
	var img, err = OpenNRGBAFromFile(filepath.Join(TESTDATA_DIR, fileName))
	if err != nil {
...
const (
	img1 = "4029959456464745507.png"
	img2 = "4029959456464745507-inverted.png"     // Same size as img1.
	img3 = "b716a12d5b98d04b15db1d9dd82c82ea.png" // Different size.
)
