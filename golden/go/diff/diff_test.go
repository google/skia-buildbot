...
// noDifferences should be all black transparent since there are no differences.
const noDifferences = `! SKTEXTSIMPLE
1 5
0x00000000
0x00000000
0x00000000
...
func TestDiffImages(t *testing.T) {
	unittest.MediumTest(t)
	assertDiffMatch(t, noDifferences, one_by_five.ImageOne, one_by_five.ImageOne)
	assertDiffMatch(t, noDifferences, one_by_five.ImageTwo, one_by_five.ImageTwo)
