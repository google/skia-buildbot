...
type IDPathMapper interface {
	...
	// ImagePath returns the storage paths for a given image ID. The first return
	...
	ImagePath(imageID string) (string, string)
...
func (g GoldIDPathMapper) ImagePath(imageID string) (string, string) {
...
func (p PixelDiffIDPathMapper) ImagePath(imageID string) (string, string) {
...
func (m *MemDiffStore) ImageHandler(urlPrefix string) (http.Handler, error) {
	...
	handlerFunc := func(w http.ResponseWriter, r *http.Request) {
		...
		// format.
		localRelPath, _ := m.mapper.ImagePath(imgID)
