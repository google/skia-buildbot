...
// DiffStoreMapper is an interface that defines various functions for mapping
// between IDs and storage paths.
type DiffStoreMapper interface {
	// LRUCodec definese the Encode and Decode functions.
	util.LRUCodec
...
func (g GoldDiffStoreMapper) DiffFn(*image.NRGBA, *image.NRGBA) (interface{}, *image.NRGBA) {
	return nil, nil
}
...
func (g PixelDiffStoreMapper) DiffFn(*image.NRGBA, *image.NRGBA) (interface{}, *image.NRGBA) {
	return nil, nil
}
