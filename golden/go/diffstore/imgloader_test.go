...
const (
	...
	image3GsPath = gsImageBaseDir + "/" + string(digest3) + ".png"
...
func TestImageLoaderGetSingleDigestFoundInBucket(t *testing.T) {
	...
	expectImageWillBeRead(mockClient, image1GsPath, image1Md5Hash, image1)
...
func TestImageLoaderGetMultipleDigestsAllFoundInBucket(t *testing.T) {
	...
	expectImageWillBeRead(mockClient, image1GsPath, image1Md5Hash, image1)
	expectImageWillBeRead(mockClient, image2GsPath, image2Md5Hash, image2)
