...
import (
	...
	mocks2 "go.skia.org/infra/golden/go/diffstore/mocks"
...
func setUp(t *testing.T) (*ImageLoader, *test_gcsclient.MockGCSClient, *mocks2.FailureStore) {
	...
	mockFailureStore := &mocks2.FailureStore{}
