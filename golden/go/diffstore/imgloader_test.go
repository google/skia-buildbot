...
func TestImageLoaderGet_singleDigest_foundInBucket(t *testing.T) {
	unittest.SmallTest(t)
...
func TestImageLoaderGet_singleDigest_notFound(t *testing.T) {
	unittest.SmallTest(t)
...
func TestImageLoaderGet_multipleDigests_allFoundInBucket(t *testing.T) {
	unittest.SmallTest(t)
...
func TestImageLoaderGet_multipleDigests_digest1FoundInBucket_digest2NotFound(t *testing.T) {
	unittest.SmallTest(t)
