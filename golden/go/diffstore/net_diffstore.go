...
func (n *NetDiffStore) Get(priority int64, mainDigest types.Digest, rightDigests []types.Digest) (map[types.Digest]interface{}, error) {
...
func (n *NetDiffStore) WarmDigests(priority int64, digests []types.Digest, sync bool) {
...
func (n *NetDiffStore) WarmDiffs(priority int64, leftDigests []types.Digest, rightDigests []types.Digest) {
...
func (n *NetDiffStore) PurgeDigests(digests []types.Digest, purgeGCS bool) error {
