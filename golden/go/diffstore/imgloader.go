...
func (il *ImageLoader) Warm(priority int64, images []types.Digest, synchronous bool) {
...
func (il *ImageLoader) Get(priority int64, images []types.Digest) ([]*image.NRGBA, *sync.WaitGroup, error) {
...
func (il *ImageLoader) PurgeImages(images []types.Digest, purgeGCS bool) error {
...
func (il *ImageLoader) imageLoadWorker(priority int64, imageID types.Digest) (interface{}, error) {
	...
	if fileutil.FileExists(localPath) {
		...
		util.LogErr(il.failureStore.purgeDigestFailures([]types.Digest{imageID}))
