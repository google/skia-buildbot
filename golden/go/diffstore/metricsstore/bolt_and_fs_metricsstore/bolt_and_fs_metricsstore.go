...
type storeImpl struct {
	boltStore metricsstore.MetricsStore
	fsStore   metricsstore.MetricsStore
}

// New returns a metricsstore.MetricsStore instance backed both by Bolt and Firestore. See
// package-level comments for details.
func New(boltBaseDir string, client *ifirestore.Client) (metricsstore.MetricsStore, error) {
