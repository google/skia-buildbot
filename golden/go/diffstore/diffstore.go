...
const (
	...
	MAX_DIFFMETRICS_CACHE = 100000

	// MAX_IMAGE_CACHE is the maximum number of images to cache.
	MAX_IMAGE_CACHE = 20000
)

// TODO(stephana): Modify the diff.DiffStore interface to use diff.DiffMetrics instead
...
// add the endpoints to deal with image errors.
