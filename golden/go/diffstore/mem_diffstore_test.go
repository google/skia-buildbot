...
func TestDecodeImagesSuccess(t *testing.T) {
	...
	// Expected output.
	expectedLeftImage := skTextToImage(skTextImage1)
	expectedRightImage := skTextToImage(skTextImage2)
...
func TestDecodeImagesErrorDecodingLeftImage(t *testing.T) {
	...
	rightBytes := imageToPng(skTextToImage(skTextImage1)).Bytes()
...
func TestDecodeImagesErrorDecodingRightImage(t *testing.T) {
	...
	// Inputs.
	leftBytes := imageToPng(skTextToImage(skTextImage1)).Bytes()
