...
// failureStore persists DigestFailures in bolDB database. It assumes that the
...
// newFailureStore returns an new instance of failureStore that opens a database in the given directory.
