...
func (*UnimplementedDiffServiceServer) WarmDiffs(ctx context.Context, req *WarmDiffsRequest) (*Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method WarmDiffs not implemented")
}
