...
func TestAdd(t *testing.T) {
	...
	ds.Init("google.com:skia-buildbots", "gold-localhost-jcgregorio")
	/*
	...
	*/
	...
	key = traceKey(102, "some unknown test name", ",arch=x86,compiler=GCC,config=8888,name=shadermaskfilter_image,")
	err = ds.DS.Get(ctx, key, &trace)
	assert.Error(t, err)
