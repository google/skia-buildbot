...
func TestSearchThreeDevicesChangeListSunnyDay(t *testing.T) {
	...
	attachChangeListExpectations(mes, ie, clID, crs)
...
func TestDigestDetailsThreeDevicesChangeList(t *testing.T) {
	...
	var override expectations.Expectations
	override.Set(testWeWantDetailsAbout, digestWeWantDetailsAbout, expectations.Negative)
	attachChangeListExpectations(mes, override, testCLID, testCRS)
...
func attachChangeListExpectations(mes *mocks.ExpectationsStore, issueExp expectations.Expectations, clID string, crs string) {
