...
// TestSearch_UntriagedDigestsAtHead_ReturnsTwoResults searches over the three_devices
...
func TestSearch_UntriagedDigestsAtHead_ReturnsTwoResults(t *testing.T) {
