...
type AcceptFn func(params paramtools.Params, digests []types.Digest) (bool, interface{})
...
func iterTile(query *Query, addFn AddFn, acceptFn AcceptFn, exp ExpSlice, idx *indexer.SearchIndex) error {
	...
	if acceptFn == nil {
		acceptFn = func(params paramtools.Params, digests []types.Digest) (bool, interface{}) { return true, nil }
	}
