...
type SRDigestDiff struct {
	Left  *SRDigest     `json:"left"`  // The left hand digest and it's params.
	Right *SRDiffDigest `json:"right"` // The right hand digest, it's params and the diff result.
}
