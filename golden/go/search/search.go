...
// Search(...) function of SearchImpl and intended to be
...
func (s *SearchImpl) Search(ctx context.Context, q *query.Search) (*NewSearchResponse, error) {
	if q == nil {
...
func (s *SearchImpl) GetDigestDetails(test types.TestName, digest types.Digest) (*frontend.SRDigestDetails, error) {
...
func (c *SearchImpl) DiffDigests(test types.TestName, left, right types.Digest) (*frontend.SRDigestDiff, error) {
