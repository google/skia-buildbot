...
type SearchImpl struct {
	...
	expectationsStore expectations.ExpectationsStore
...
func New(ds diff.DiffStore, es expectations.ExpectationsStore, is indexer.IndexSource, cls clstore.Store, tjs tjstore.Store, cs comment.Store, publiclyViewableParams paramtools.ParamSet) *SearchImpl {
	return &SearchImpl{
		diffStore:              ds,
