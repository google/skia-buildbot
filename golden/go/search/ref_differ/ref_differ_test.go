...
func makeExpSlice() common.ExpSlice {
	...
	expOne.AddDigest(testName, alphaPositiveDigest, expectations.Positive)
	expOne.AddDigest(testName, gammaPositiveDigest, expectations.Positive)

	var expTwo expectations.Expectations
	expTwo.AddDigest(testName, betaNegativeDigest, expectations.Negative)
