...
type SearchAPI interface {
	...
	Search(context.Context, *query.Search) (*NewSearchResponse, error)

	// GetDigestDetails returns details about a digest such as the closest
	// negative and positive images.
	GetDigestDetails(types.TestName, types.Digest) (*frontend.SRDigestDetails, error)

	// DiffDigests compares two digests that were generated by the given test.
	DiffDigests(t types.TestName, left, right types.Digest) (*frontend.SRDigestDiff, error)
	...
	GetDigestTable(*query.CompareTests) (*CTResponse, error)
}
