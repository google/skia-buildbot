...
type SearchAPI interface {
	...
	GetDigestDetails(types.TestName, types.Digest) (*frontend.DigestDetails, error)

	// DiffDigests compares two digests that were generated by the given test.
	DiffDigests(t types.TestName, left, right types.Digest) (*frontend.DigestComparison, error)
