...
//   redundant with the the index of the point and the index of the trace respectively). Estimates
//   show that the Points take up over 2/3 of the size of the response (each point takes up
//   ~20 bytes and when the tile size is 200, that means each trace adds 4k of code size).
