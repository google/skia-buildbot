...
// TestJoinedHistories_GetTriageHistory_Success tests the 4 cases of triage history existing
// or not existing on the changelist and master branch.
func TestJoinedHistories_GetTriageHistoryWithChangeList_Success(t *testing.T) {
	const crs = "github"
	const clID = "whatever"
...
func TestJoinedHistories_GetTriageHistoryNoChangeList_Success(t *testing.T) {
	const grouping = types.TestName("some_test")
