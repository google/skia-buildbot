...
func testQueryCommitRange(t assert.TestingT, api *SearchAPI, idx *indexer.SearchIndex, tile *tiling.Tile, exp types.ExpectationsHandler, startHash, endHash string) {
	var buf bytes.Buffer
	paramQuery := url.QueryEscape("source_type=gm")
