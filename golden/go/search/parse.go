...
// object.
func (v *Validation) QueryFormValue(r *http.Request, name string, val *map[string][]string) {
...
func ParseQuery(r *http.Request, query *Query) error {
	...
	validate.QueryFormValue(r, "query", (*map[string][]string)(&query.Query))
	validate.QueryFormValue(r, "rquery", (*map[string][]string)(&query.RQuery))
