...
// 'digest' is used synonymous with image, because the digests used are
...
// negative digest. But other reference diffs might make sense.
// This package intends to make it easier to add more reference diffs as
// we move forward.
