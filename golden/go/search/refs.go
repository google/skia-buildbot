...
func (r *RefDiffer) getDigestsWithLabel(test types.TestName, match []string, params paramtools.ParamSet, paramsByDigest map[types.Digest]paramtools.ParamSet, unavailable map[types.Digest]*diff.DigestFailure, rhsQuery paramtools.ParamSet, targetLabel types.Label) []types.Digest {
	ret := []types.Digest{}
...
func (r *RefDiffer) getClosestDiff(metric string, digest types.Digest, compDigests []types.Digest) *SRDiffDigest {
