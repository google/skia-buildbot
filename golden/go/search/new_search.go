...
func NewSearchAPI(diffStore diff.DiffStore, expectationsStore expstorage.ExpectationsStore, indexer indexer.IndexMaker, tryjobStore tryjobstore.TryjobStore, publiclyViewableParams paramtools.ParamSet) *SearchAPI {
	return &SearchAPI{
		DiffStore:              diffStore,
