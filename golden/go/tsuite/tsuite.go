...
func (c *CompatTestSuite) Save(filePath string) error {
...
func Load(filePath string) (*CompatTestSuite, error) {
...
func LoadMemorizer(prefix string, r *zip.ReadCloser) (*Memorizer, error) {
	ret := &Memorizer{}
...
func readPNGFromZip(r *zip.ReadCloser, filePath string) (*image.NRGBA, error) {
	var ret *image.NRGBA = nil
	err := readFileFromZip(r, filePath, func(r io.Reader) error {
		var err error = nil
		ret, err = diff.OpenNRGBAFromReader(r)
		return err
	})
	if err != nil {
		return nil, err
...
func readJsonFromZip(r *zip.ReadCloser, filePath string, target interface{}) error {
...
func readFileFromZip(r *zip.ReadCloser, filePath string, fn func(io.Reader) error) error {
