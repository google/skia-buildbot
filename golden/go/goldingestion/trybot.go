...
// ReviewSystem is a wrapper around functions shared by the Gerrit and Rietveld.
// This avoids repeated if-statements and should make the code more legible.
type ReviewSystem interface {
	Url(issueID int64) string
	ExtractIssueInfo(url string) (int64, int64)
}
...
func GetPrefixx(issueID string, reviewURL string) string {
