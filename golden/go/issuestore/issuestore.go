...
func (r *Rec) Remove(deltaRec *Rec) bool {
	...
	updated = updated || removeStrings(&r.Traces, deltaRec.Traces)
	updated = updated || removeStrings(&r.Ignores, deltaRec.Ignores)
	return updated || removeStrings(&r.TestNames, deltaRec.TestNames)
}
