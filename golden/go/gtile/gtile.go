...
func (s *SubSearchable) Search(query Query) *SubSearchable {
	return nil
}

func (g *GTile) Search(q Query) *SearchResult {
...
func (g *GTile) BaseLineForTest(testName string) *BaseLine {
	return nil
}

type BaseLine struct{}

// O(m)  m == number of digests per test.
func (b *BaseLine) Filter(match []string, params paramtools.ParamSet) []LabeledDigest {
	return nil
}
