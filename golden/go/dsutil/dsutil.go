...
// RecentKeysList stores recently added keys in an entity for a defined duration.
...
// NewRecentKeysList creates a new instance of RecentKeysList. It will store any keys
...
func (l *RecentKeysList) updateRecentKeys(tx *datastore.Transaction, key *datastore.Key, remove bool) error {
	...
	// If the new key causes an update we write it to the database
	var err error
...
// 'Added' and 'Deleted' should never be changed directly.
...
// sortable. It merges the keys of the two slices,
