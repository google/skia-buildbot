...
func (g *goldTryjobProcessor) hasUntriaged(exp expectations.Classifier, results []tjstore.TryJobResult) bool {
...
func (g *goldTryjobProcessor) getExpectations(ctx context.Context, clID string, crs string) (common.ExpSlice, error) {
