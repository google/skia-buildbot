...
import (
	...
	emocks "go.skia.org/infra/golden/go/expstorage/mocks"
...
func TestTryJobProcess_ExpectationStoreFailure(t *testing.T) {
	...
	mcls := &mockclstore.Store{}
	mtjs := &mocktjstore.Store{}
	mes := &emocks.ExpectationsStore{}
	failingExpStore := &emocks.ExpectationsStore{}
...
func makeEmptyExpectations() *emocks.ExpectationsStore {
	mes := &emocks.ExpectationsStore{}
	issueStore := &emocks.ExpectationsStore{}
...
// marked as positive.
func makeGerritExpectationsWithCL(clID, crs string) *emocks.ExpectationsStore {
	mes := &emocks.ExpectationsStore{}
	issueStore := &emocks.ExpectationsStore{}
