...
func TestTryJobProcess_ExpectationStoreFailure(t *testing.T) {
	...
	mcls := &mock_clstore.Store{}
	mtjs := &mock_tjstore.Store{}
	mes := &mock_expstorage.Store{}
	failingExpStore := &mock_expstorage.Store{}
...
func makeEmptyExpectations() *mock_expstorage.Store {
	mes := &mock_expstorage.Store{}
	issueStore := &mock_expstorage.Store{}
...
// marked as positive.
func makeGerritExpectationsWithCL(clID, crs string) *mock_expstorage.Store {
	mes := &mock_expstorage.Store{}
	issueStore := &mock_expstorage.Store{}
