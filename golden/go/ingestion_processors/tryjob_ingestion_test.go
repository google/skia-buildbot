...
import (
	...
	mock_expectation "go.skia.org/infra/golden/go/expectations/mocks"
...
func TestTryJobProcess_ExpectationStoreFailure(t *testing.T) {
	...
	mcls := &mock_clstore.Store{}
	mtjs := &mock_tjstore.Store{}
	mes := &mock_expectation.Store{}
	failingExpStore := &mock_expectation.Store{}
...
func makeEmptyExpectations() *mock_expectation.Store {
	mes := &mock_expectation.Store{}
	issueStore := &mock_expectation.Store{}
...
// marked as positive.
func makeGerritExpectationsWithCL(clID, crs string) *mock_expectation.Store {
	mes := &mock_expectation.Store{}
	issueStore := &mock_expectation.Store{}
