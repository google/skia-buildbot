...
func TestPrimarySQL_Process_AllNewData_Success_cdb(t *testing.T) {
	...
	assert.ElementsMatch(t, []schema.CommitWithDataRow{{
	...
	assert.ElementsMatch(t, []schema.ExpectationRow{{
		GroupingID: h(squareGrouping),
		Digest:     d(dks.DigestA01Pos),
...
func TestPrimarySQL_Process_CommitIDSpecified_Success_cdb(t *testing.T) {
	ctx := context.Background()
	db := sqltest.NewCockroachDBForTestsWithProductionSchema(ctx, t)
	...
	assert.ElementsMatch(t, []schema.MetadataCommitRow{{
		CommitID:       expectedCommitID,
...
func TestPrimarySQL_Process_TileAlreadyComputed_Success_cdb(t *testing.T) {
	ctx := context.Background()
	db := sqltest.NewCockroachDBForTestsWithProductionSchema(ctx, t)
...
func TestPrimarySQL_Process_PreviousTilesAreFull_NewTileCreated_cdb(t *testing.T) {
	ctx := context.Background()
	db := sqltest.NewCockroachDBForTestsWithProductionSchema(ctx, t)
...
func TestPrimarySQL_Process_BetweenTwoTiles_UseHigherTile_cdb(t *testing.T) {
	ctx := context.Background()
	db := sqltest.NewCockroachDBForTestsWithProductionSchema(ctx, t)
...
func TestPrimarySQL_Process_SurroundingCommitsHaveSameTile_UseThatTile_cdb(t *testing.T) {
	ctx := context.Background()
	db := sqltest.NewCockroachDBForTestsWithProductionSchema(ctx, t)
...
func TestPrimarySQL_Process_AtEndTileNotFull_UseThatTile_cdb(t *testing.T) {
	ctx := context.Background()
	db := sqltest.NewCockroachDBForTestsWithProductionSchema(ctx, t)
...
func TestPrimarySQL_Process_SameFileMultipleTimesInParallel_Success_cdb(t *testing.T) {
	ctx := context.Background()
	db := sqltest.NewCockroachDBForTestsWithProductionSchema(ctx, t)
...
/*
TODO(b/415382324): Uncomment one pgx bug is resolved.
...
*/
func TestPrimarySQL_Process_UnknownGitHash_ReturnsError_cdb(t *testing.T) {
	ctx := context.Background()
	db := sqltest.NewCockroachDBForTestsWithProductionSchema(ctx, t)
...
func TestPrimarySQL_Process_MissingGitHash_ReturnsError_cdb(t *testing.T) {
	ctx := context.Background()
	db := sqltest.NewCockroachDBForTestsWithProductionSchema(ctx, t)
...
func TestPrimarySQL_Process_NoResults_NoDataWritten_cdb(t *testing.T) {
	ctx := context.Background()
	db := sqltest.NewCockroachDBForTestsWithProductionSchema(ctx, t)
	validCommits := dks.Build().GitCommits
	require.NoError(t, sqltest.BulkInsertDataTables(ctx, db, schema.Tables{
...
func TestPrimarySQL_Process_MoreRecentData_ValuesAtHeadUpdated_cdb(t *testing.T) {
	ctx := context.Background()
	db := sqltest.NewCockroachDBForTestsWithProductionSchema(ctx, t)
	require.NoError(t, sqltest.BulkInsertDataTables(ctx, db, dks.Build()))
	...
	existingValuesAtHead := sqltest.GetAllRows(ctx, t, db, "ValuesAtHead", &schema.ValueAtHeadRow{}).([]schema.ValueAtHeadRow)
	for _, v := range existingValuesAtHead {
		if slices.Equal(v.TraceID, h(circleTraceKeys)) {
			sklog.Infof("Existing ValuesAtHead: %+v", v)
		}
	}
...
*/
func TestPrimarySQL_Process_MoreRecentDataWithCaches_ValuesAtHeadUpdated_cdb(t *testing.T) {
	ctx := context.Background()
	db := sqltest.NewCockroachDBForTestsWithProductionSchema(ctx, t)
	require.NoError(t, sqltest.BulkInsertDataTables(ctx, db, dks.Build()))
...
func TestPrimarySQL_Process_DataFromSameTraceWithDifferentOptions_ValuesAtHeadUpdated_cdb(t *testing.T) {
	ctx := context.Background()
	db := sqltest.NewCockroachDBForTestsWithProductionSchema(ctx, t)
	require.NoError(t, sqltest.BulkInsertDataTables(ctx, db, dks.Build()))
...
*/
func TestPrimarySQL_Process_OlderData_SomeValuesAtHeadUpdated_cdb(t *testing.T) {
	ctx := context.Background()
	db := sqltest.NewCockroachDBForTestsWithProductionSchema(ctx, t)
	require.NoError(t, sqltest.BulkInsertDataTables(ctx, db, dks.Build()))
...
func TestPrimarySQL_Process_OlderDataWithCaches_SomeValuesAtHeadUpdated_cdb(t *testing.T) {
	ctx := context.Background()
	db := sqltest.NewCockroachDBForTestsWithProductionSchema(ctx, t)
	require.NoError(t, sqltest.BulkInsertDataTables(ctx, db, dks.Build()))
...
func TestPrimarySQL_Process_DuplicateTraces_Success_cdb(t *testing.T) {
	ctx := context.Background()
	db := sqltest.NewCockroachDBForTestsWithProductionSchema(ctx, t)
	validCommits := dks.Build().GitCommits
	require.NoError(t, sqltest.BulkInsertDataTables(ctx, db, schema.Tables{
