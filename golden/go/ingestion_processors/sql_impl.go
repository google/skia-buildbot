...
func (s *sqlProcessor) storeValues(ctx context.Context, values []sqlTraceValue, commitNum int, sourceFileHash []byte) error {
	...
	// This value was determined experimentally to be where the size stopped mattering. When N was
	// 100, inserting took 7ms, at 1000, it took 27ms and at 10000, it took 267ms for a small sample
	// of data.
