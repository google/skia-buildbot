...
func TestSearch_IncludesBlameCommit_MultipleNewTraces_Success(t *testing.T) {
	...
	test("new trace", "commit08", dks.DigestA04Unt)
	test("new trace with missing data", "commit05", dks.DigestA05Unt)
	test("new trace with recent regression", "commit09", dks.DigestA06Unt)
}
