...
type API interface {
	...
	GetCluster(ctx context.Context, opts ClusterOptions) (web_frontend.ClusterDiffResult, error)
}
...
func (s *Impl) GetCluster(ctx context.Context, opts ClusterOptions) (web_frontend.ClusterDiffResult, error) {
	panic("implement me")
}
