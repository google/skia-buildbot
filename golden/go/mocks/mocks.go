...
func (m MockDiffStore) WarmDiffs(priority int64, leftDigests []types.Digest, rightDigests []types.Digest) {
}
...
// Mock the tilestore for GoldenTraces
func NewMockTileBuilder(t assert.TestingT, digests [][]types.Digest, params []map[string]string, commits []*tiling.Commit) tracedb.MasterTileBuilder {
