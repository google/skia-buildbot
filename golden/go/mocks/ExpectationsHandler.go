...
// ExpectationsHandler is an autogenerated mock type for the ExpectationsHandler type
type ExpectationsHandler struct {
	mock.Mock
}

// AddTestExp provides a mock function with given fields: testExp
func (_m *ExpectationsHandler) AddTestExp(testExp types.TestExp) {
	_m.Called(testExp)
}

// Classification provides a mock function with given fields: test, digest
func (_m *ExpectationsHandler) Classification(test string, digest string) types.Label {
...
func (_m *ExpectationsHandler) SetExpectation(test string, digest string, label types.Label) {
	_m.Called(test, digest, label)
}

// TestExp provides a mock function with given fields:
func (_m *ExpectationsHandler) TestExp() types.TestExp {
	ret := _m.Called()
