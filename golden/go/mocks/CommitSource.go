...
// CommitSource is an autogenerated mock type for the CommitSource type
type CommitSource struct {
	mock.Mock
}

// AllCommits provides a mock function with given fields:
func (_m *CommitSource) AllCommits() []*tiling.Commit {
	ret := _m.Called()
...
func (_m *CommitSource) DataCommits() []*tiling.Commit {
	ret := _m.Called()
...
func (_m *CommitSource) GetTile(includeIgnores bool) *tiling.Tile {
