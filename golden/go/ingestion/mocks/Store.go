...
func (_m *Store) SetIngested(ctx context.Context, fileName string, md5 string, ts time.Time) error {
...
func (_m *Store) WasIngested(ctx context.Context, fileName string, md5 string) (bool, error) {
