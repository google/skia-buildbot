...
type TraceStore interface {
	...
	// GetSparseTile reads at least the last n commits and returns them as a tile.
	// of length n. Commits that have no entries will be omitted.
	GetSparseTile(ctx context.Context, nCommits int) (*tiling.Tile, []*tiling.Commit, error)
}
