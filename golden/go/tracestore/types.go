...
type TraceStore interface {
	...
	// The second parameter are all commits that are in the tile.
	GetTile(ctx context.Context, nCommits int) (*tiling.Tile, []*tiling.Commit, error)

	// GetDenseTile reads at least the last n commits and returns them as a tile.
	// of length n. Commits that have no entries will be omitted.
	// The second parameter are all commits that were considered while making the tile.
	// Some of those commits may have had no data and would thus not show up in
	// tiling.Tile.
