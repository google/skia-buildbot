...
const (
	// Namespace for this package's data
	...
	// Columns in the ID counter family. There is only one row.
	idCounterColumn = "idc"
...
// Those indicies are references to the OrderedParamSet stored in EncTile.
...
// rowMap is a helper type that wraps around a bigtable.Row and allows to extract
