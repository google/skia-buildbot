...
func TestTraceMapCommitsWithData(t *testing.T) {
	unittest.SmallTest(t)
	...
	assert.Equal(t, []int{0, 2, 3, 5}, tm.CommitsWithData())
	...
	assert.Nil(t, empty.CommitsWithData())

	assert.Nil(t, traceMap{}.CommitsWithData())
}
