...
This table, along with the traces, will be stored using 2 Column Families and can
...
Blank cells will be read with a single null byte, which will be decoded to MISSING_DIGEST ("").
