...
// non-empty commits. Of note, due to this tile by tile procedure, the ParamsSet may have a set of
//  params that does not actually correspond to a trace (this shouldn't be a problem, but is
