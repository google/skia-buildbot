...
type CommitableBaseLine struct {
	...
	// Filled is the number of traces that had non-empty values at EncCommit.
...
// values in all other fiels. The Baseline field contains an empty instance of types.TestExp.
