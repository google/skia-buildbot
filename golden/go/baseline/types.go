...
type Baseline struct {
	...
	// ExpectationsMasterStr captures the "baseline expectations", that is, the expectations with only
	...
	ExpectationsMasterStr expectations.Baseline `json:"master_str,omitempty"`
