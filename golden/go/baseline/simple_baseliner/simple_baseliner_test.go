...
func TestFetchBaselineChangeListSunnyDay(t *testing.T) {
	...
	additionalTriages.AddDigest("brand-new-test", IotaNewDigest, expectations.Positive)
	additionalTriages.AddDigest("brand-new-test", KappaNewDigest, expectations.Negative)
	additionalTriages.AddDigest(three_devices.BetaTest, LambdaNewDigest, expectations.Positive)
	additionalTriages.AddDigest(three_devices.BetaTest, three_devices.BetaGood1Digest, expectations.Negative)
	additionalTriages.AddDigest(three_devices.BetaTest, three_devices.BetaUntriaged1Digest, expectations.Positive)
