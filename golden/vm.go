...
func Prod() *gce.Instance {
	vm := GoldBase("skia-gold-prod", "35.194.17.199" /* Whitelisted in skiaperf cloud DB */)
...
func Pdfium() *gce.Instance {
	vm := GoldBase("skia-gold-pdfium", "104.197.62.179" /* Whitelisted in skiaperf cloud DB */)
...
func DiffServer() *gce.Instance {
	vm := GoldBase("skia-diffserver-prod", "" /* Use ephemeral IP address */)
