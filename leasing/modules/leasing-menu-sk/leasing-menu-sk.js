/**
 * @module module/leasing-menu-sk
 * @description <h2><code>leasing-menu-sk</code></h2>
 *
 * <p>
...
const template = (ele) => html`
  <nav>
    ...
    <nav-links-sk>
      ...
      <a href="/sheriff" tab-index=0 ><star-icon-sk></star-icon-sk><span>My Leases<span></a>
      <a href="/wrangler" tab-index=0 ><gesture-icon-sk></gesture-icon-sk><span>All Leases<span></a>
...
define('leasing-menu-sk', class extends ElementSk {
  constructor() {
    super(template);
    this._main = null;
  }
  ...
  connectedCallback() {
    ...
    // leasing-menu-sk to be children of 'main'. We have to do this for the
