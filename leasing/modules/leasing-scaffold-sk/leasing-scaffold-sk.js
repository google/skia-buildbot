...
const template = (ele) => html`
  <nav>
    ...
    <nav-links-sk>
      ...
      <a href="/my_leases" tab-index=0 ><star-icon-sk></star-icon-sk><span>My Leases<span></a>
      <a href="/all_leases" tab-index=0 ><gesture-icon-sk></gesture-icon-sk><span>All Leases<span></a>
...
define('leasing-scaffold-sk', class extends ElementSk {
  constructor() {
    super(template);
    this._main = null;
  }
