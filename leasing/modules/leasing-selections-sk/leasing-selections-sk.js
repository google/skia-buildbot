...
import { device, getAKAStr } from '../leasing'
...
function _displayDeviceTypes(ele) {
  ...
  console.log("HHHHH");
  console.log(ele._selectedOsType);
  console.log(ele._osToDeviceTypes);
...
const template = (ele) => html`
    <table class="options panel">
      ...
      <tr>
        ...
        <td>
          <input id="desc" ?disabled=${ele._loadingDetails}></input>
        </td>
      </tr>

      <tr>
        <td colspan="2" class="center">
          <button raised @click=${ele._addTask}>Lease Bot</button>
        </td>
      </tr>
...
define('leasing-selections-sk', class extends ElementSk {
  ...
  _addTask() {
    ...
    detail.desription = desc;

    console.log("DETAIL LOOKS LIKE THIS!");
    console.log(detail);
    // this._doImpl('/_/add_leasing_task', detail);
  }
