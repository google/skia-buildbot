...
One can run one of those containers locally as follows:
    ...
    docker run gcr.io/skia-public/leasing:2018-06-19T17_38_25Z-username-b442da2-dirty ${args}

If you built locally then you can run the latest with:

    docker run leasing ${args}

For running locally you will need to follow the following flags:
