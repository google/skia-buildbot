...
func extendTaskHandler(w http.ResponseWriter, r *http.Request) {
	...
	newLeaseEndTime := t.LeaseEndTime.Add(time.Minute * time.Duration(durationHrs)) // CHANGE TO HOUR
...
func addTaskHandler(w http.ResponseWriter, r *http.Request) {
	...
	key := GetNewDSKey()
	swarmingTaskId, err := TriggerSwarmingTask(task.Requester, strconv.Itoa(int(key.ID)), task.OsType, serverURL)
	if err != nil {
