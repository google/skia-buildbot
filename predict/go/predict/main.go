...
var (
	...
	maxBotDuration = flag.Duration("max_bot_duration", time.Hour, "The longest any bot takes to run.")
...
func main() {
	...
	state, err = app.New(git, httpClient, taskListProvider, *period, *modelPeriod, "https://skia.googlesource.com/skia.git", fb, *gitRepoDir, *maxBotDuration)
	if err != nil {
