...
func main() {
	...
	state, err = app.New(ctx, git, httpClient, provider, *period, *modelPeriod, "https://skia.googlesource.com/skia.git", fb)
	if err != nil {
