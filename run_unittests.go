...
var (
	...
	race = flag.Bool("race", false, "Whether or not to enable the race flag when running go tests")

	goTestsOnly = flag.Bool("go_tests_only", false, "Only run the go tests, typically used with --race")
