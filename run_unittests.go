...
func main() {
	...
	if *race {
		...
		testutils.TIMEOUT_SMALL = testutils.TIMEOUT_RACE_SMALL
		testutils.TIMEOUT_MEDIUM = testutils.TIMEOUT_RACE_MEDIUM
		testutils.TIMEOUT_LARGE = testutils.TIMEOUT_RACE_LARGE
	}
