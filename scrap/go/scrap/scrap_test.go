...
const invalidScrapLang = "not-a-valid-language"
...
func TestExpand_TemplateFailsToExpand_Failure(t *testing.T) {
	unittest.SmallTest(t)
	s := &test_gcsclient.GCSClient{}
...
func TestExpand_InvalidLang_Failure(t *testing.T) {
	unittest.SmallTest(t)
...
func TestLoadScrap_FileReaderFails_Failure(t *testing.T) {
	unittest.SmallTest(t)
	s := &test_gcsclient.GCSClient{}
...
func TestLoadScrap_GetNameFails_Failure(t *testing.T) {
	unittest.SmallTest(t)
	s := &test_gcsclient.GCSClient{}
...
func TestLoadScrap_InvalidType_Fails(t *testing.T) {
	unittest.SmallTest(t)
	se, err := New(&test_gcsclient.GCSClient{})
	require.NoError(t, err)
...
func TestLoadScrap_InvalidName_Fails(t *testing.T) {
	unittest.SmallTest(t)
	se, err := New(&test_gcsclient.GCSClient{})
	require.NoError(t, err)
...
func TestDeleteScrap_GetNameFails_Failure(t *testing.T) {
	unittest.SmallTest(t)
	s := &test_gcsclient.GCSClient{}
...
func TestDeleteScrap_DeleteNameFails_Failure(t *testing.T) {
	unittest.SmallTest(t)
	s := &test_gcsclient.GCSClient{}
...
func TestDeleteScrap_DeleteFileWithHashFails_Failure(t *testing.T) {
	unittest.SmallTest(t)
	s := &test_gcsclient.GCSClient{}
...
func TestDeleteScrap_InvalidType_Failure(t *testing.T) {
	unittest.SmallTest(t)
	se, err := New(&test_gcsclient.GCSClient{})
	require.NoError(t, err)
...
func TestDeleteScrap_InvalidName_Failure(t *testing.T) {
	unittest.SmallTest(t)
	se, err := New(&test_gcsclient.GCSClient{})
	require.NoError(t, err)
