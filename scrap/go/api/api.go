...
//
//    +----------------------------------------+--------+---------+---------------+-------------------------------------------------------+-----------+
//    | URL                                    | Method | Request | Response      | Description                                           | Protected |
//    +----------------------------------------+--------+---------+---------------+-------------------------------------------------------+-----------+
...
//    |                                        |        |         | image/svg+xml |                                                       |           |
//    +----------------------------------------+--------+---------+---------------+-------------------------------------------------------+-----------+
//    | /_/tmpl/{type}/({hash}|{name})/{lang}/ | GET    |         | text/plain    | Returns the scrap in a programming language template. |           |
//    +----------------------------------------+--------+---------+---------------+-------------------------------------------------------+-----------+
...
//    +----------------------------------------+--------+---------+---------------+-------------------------------------------------------+-----------+
//    | /_/_names/{type}/                      | GET    |         | []string      | Returns all named scraps of a single type.            |           |
//    +----------------------------------------+--------+---------+---------------+-------------------------------------------------------+-----------+
//
