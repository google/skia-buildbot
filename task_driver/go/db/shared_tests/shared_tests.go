...
func TestDB(t sktest.TestingT, d db.DB) {
	...
	deepequal_testutils.AssertDeepEqual(t, r, expect)
...
func TestMessageOrdering(t sktest.TestingT, d db.DB) {
	...
	deepequal_testutils.AssertDeepEqual(t, base, rev)
	...
	deepequal_testutils.AssertDeepEqual(t, base, shuf)
	...
	deepequal_testutils.AssertDeepEqual(t, base, mult)
}
