...
// DisplayLink displays the provided link with the description in the Step's UI.
func DisplayLink(ctx context.Context, desc, link string) {
	d := &LinkData{
		Desc: desc,
		Link: link,
	}
...
// LinkData is extra Step data for displaying a link in a step.
