...
// StepText displays the provided text with the description in the Step's UI.
// If isLink is true then the text is linkified.
func StepText(ctx context.Context, desc, text string, isLink bool) {
	d := &TextData{
		Desc:   desc,
		Text:   text,
		IsLink: isLink,
