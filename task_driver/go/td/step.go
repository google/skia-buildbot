...
// Mark the step as failed, with the given error.
func FailStep(ctx context.Context, err error) {
	props := getStep(ctx)
...
func execCtx(ctx context.Context) context.Context {
	return exec.NewContext(ctx, func(cmd *exec.Command) error {
		...
		return Do(ctx, Name(name), func(ctx context.Context) error {
			props := getStep(ctx)
...
func (t *httpTransport) RoundTrip(req *http.Request) (*http.Response, error) {
	...
	return resp, Do(t.ctx, Name(req.URL.String()), func(ctx context.Context) error {
