...
type Context struct {
	...
	// execRun provides an exec.RunFn to be called by execCtx. This is used
...
// SetExecRunFn allows the exec.RunFn to be overridden for testing. Affects the
// currently-active step, along with any children.
...
// getExecRunFn retrieves any exec.RunFn which was set on the context.
