...
func TestTestFail(t *testing.T) {
	...
	d, cleanup := test2json.SetupTest(t, test2json.CONTENT_FAIL)
	defer cleanup()
...
func TestTestPass(t *testing.T) {
	...
	d, cleanup := test2json.SetupTest(t, test2json.CONTENT_PASS)
	defer cleanup()
...
func TestTestSkip(t *testing.T) {
	...
	d, cleanup := test2json.SetupTest(t, test2json.CONTENT_SKIP)
	defer cleanup()
