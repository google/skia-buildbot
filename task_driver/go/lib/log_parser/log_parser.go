...
type Step struct {
	...
	// case where the step heirarchy maps to function scopes. However,
...
func Run(ctx context.Context, cwd string, cmdLine []string, split bufio.SplitFunc, fn TokenHandler) error {
