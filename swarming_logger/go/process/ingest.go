...
func ingestLog(gcs *storage.Client, s swarming.ApiClient, t *db.Task) error {
	...
	gsObj := gcs.Bucket(GS_BUCKET).Object(gsPath)
	...
	return mass_process.WriteObj(gsObj, []byte(stdout.Output))
}
