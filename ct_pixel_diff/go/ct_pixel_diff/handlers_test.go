...
func TestJsonRunsHandler(t *testing.T) {
	...
	resultStore.Put(TEST_RUN_ID, TEST_URL, rec)
	resultStore.Put(TEST_RUN_ID_TWO, TEST_URL_TWO, rec)
...
func TestJsonRenderHandler(t *testing.T) {
	...
	resultStore.Put(TEST_RUN_ID, TEST_URL, recOne)
	resultStore.Put(TEST_RUN_ID, TEST_URL_TWO, recTwo)
