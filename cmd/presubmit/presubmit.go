...
func checkLongLines(ctx context.Context, files []fileWithChanges) bool {
	...
	ignoreFiles := []string{
		...
		// Generated by proto compiler, can have very long lines.
		"pinpoint/webui/app/gateway/gateway.ts",
	}
	ok := true
	for _, f := range files {
...
func checkTODOHasOwner(ctx context.Context, files []fileWithChanges) bool {
	ignoreFiles := []string{
		...
		// Generated by proto compiler, ignore check.
		"pinpoint/webui/app/gateway/gateway.ts",
	}
	ok := true
	for _, f := range files {
...
func runESLint(ctx context.Context, files []fileWithChanges, workspaceRoot, branchBaseCommit string) bool {
	ignoreFiles := []string{
		// Generated by proto compiler, has different style rules.
		"pinpoint/webui/app/gateway/gateway.ts",
	}
...
func runPrettier(ctx context.Context, files []fileWithChanges, workspaceRoot, branchBaseCommit string) bool {
	ignoreFiles := []string{
		// Generated by proto compiler, has different formatting rules.
		"pinpoint/webui/app/gateway/gateway.ts",
	}
