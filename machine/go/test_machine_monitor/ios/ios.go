...
// OSVersion returns the version of iOS (or iPadOS, etc.) running on the given device, e.g. "13.3.1".
...
// DeviceType returns the Apple model identifier of the indicated iDevice, e.g. "iPhone10,1".
