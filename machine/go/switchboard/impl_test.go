...
func TestAddPod_Success(t *testing.T) {
	...
	require.Equal(t, int64(1), s.counters[switchboard_add_pod].Get())
	require.Equal(t, int64(1), s.counters[switchboard_list_pod].Get())
	require.Equal(t, int64(0), s.counters[switchboard_list_pod_errors].Get())
}
...
func TestAddPod_AddWhenAlreadyExisting_ReturnsError(t *testing.T) {
	...
	require.Equal(t, int64(2), s.counters[switchboard_add_pod].Get())
}
...
func TestRemovePod_Success(t *testing.T) {
	...
	require.Equal(t, int64(1), s.counters[switchboard_add_pod].Get())
	require.Equal(t, int64(1), s.counters[switchboard_remove_pod].Get())
	require.Equal(t, int64(1), s.counters[switchboard_list_pod].Get())
	require.Equal(t, int64(0), s.counters[switchboard_list_pod_errors].Get())
}
...
func TestKeepAlivePod_Success(t *testing.T) {
	...
	require.Equal(t, int64(1), s.counters[switchboard_add_pod].Get())
	require.Equal(t, int64(1), s.counters[switchboard_keepalive_pod].Get())
	require.Equal(t, int64(0), s.counters[switchboard_keepalive_pod_errors].Get())
	require.Equal(t, int64(1), s.counters[switchboard_list_pod].Get())
	require.Equal(t, int64(0), s.counters[switchboard_list_pod_errors].Get())
}
...
func TestKeepAlivePod_PodDoesNotExist_ReturnsError(t *testing.T) {
	...
	require.Equal(t, int64(1), s.counters[switchboard_keepalive_pod].Get())
	require.Equal(t, int64(1), s.counters[switchboard_keepalive_pod_errors].Get())
}
