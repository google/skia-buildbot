...
// NewSwitchboard creates a new instance of Switchboard. It also registers a cleanup function to assert the mocks expectations.
func NewSwitchboard(t testing.TB) *Switchboard {
	mock := &Switchboard{}
