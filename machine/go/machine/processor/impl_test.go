...
func TestProcess_QuarantineDevicesIfBatteryTooLow(t *testing.T) {
	unittest.SmallTest(t)
	ctx := context.Background()
  ...
  voltage: 4248`,
	...
	assert.Equal(t, int64(9), metrics2.GetInt64Metric("machine_processor_device_battery_charge", map[string]string{"machine": "skia-rpi2-0001"}).Get())

}

func TestProcess_DoNotQuarantineDevicesIfBatteryIsChargedEnough(t *testing.T) {
	unittest.SmallTest(t)
	ctx := context.Background()
