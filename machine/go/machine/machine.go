...
// Annotation is used to record the most recent user change to
// MachineDescription. This will be in addition to the normal auditlog of user
// actions: https://pkg.go.dev/go.skia.org/infra/go/auditlog?tab=doc
