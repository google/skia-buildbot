/**
 * Utility class for adding test filtering to an array of objects.
 */
...
export class FilterArray {
  ...
  /**
    * Returns an array of indices into the array passed in via updateArray() that match the current filter.
    */
