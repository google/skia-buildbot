...
func startPoller(githubClient *github.GitHub, gerritClient *gerrit.Gerrit, dbClient *db.FirestoreDB, repoName string) {
...
Please visit [review.skia.org/%s](%s) to see it. Please CC yourself to the Gerrit change.
...
`, pr.Head.GetSHA(), gerritChangeID, gerritURL)
...
func main() {
	...
	startPoller(githubSkiaBuildbotClient, gerritClient, dbClient, "skia-buildbot")
	...
	startPoller(githubSkiaClient, gerritClient, dbClient, "skia")
