...
var (
	...
	demosDir     = flag.String("demos_dir", "./demos/public", "The directory to findnamed subdirectories for each demo. If blank ./demos/public")
...
func main() {
	...
	// PathPrefix above needs a slash to make FileServer relative paths work. For cleanliness, make sure users get to the directory listing even without the slash.
