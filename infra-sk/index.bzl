...
#
# If the nonce argument is provided, a nonce attribute will be added to all <link> and <script> tags
# in the HTML with the contents of said attribute as its value.
#
