 ...
 * after timeoutMillis. The returned promise will resolve to an array with the caugh events.
 *
 ...
 *     const sequence = eventSequencePromise(['hey', 'hey', 'hello', 'world', 'goodbye']);
 *     doSomething();
