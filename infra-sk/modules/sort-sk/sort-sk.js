 ...
 *
 * Note that all sorting is done numerically, unless the 'alpha' attribute is
 ...
 *
 * @attr alpha - If present then sorting in done alphabetically.
 *
 */
...
window.customElements.define('sort-sk', class extends ElementSk {
  ...
  _clickHandler(e) {
    ...
    let alpha = this.hasAttribute('alpha');
    ...
    arr.forEach((e) => container.appendChild(e.node));
  }
});
