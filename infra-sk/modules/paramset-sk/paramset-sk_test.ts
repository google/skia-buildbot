...
describe('paramset-sk', () => {
  ...
  describe('highlighed values', () => {
    ...
    it('should highlight values', async () => {
      ...
      expect(await paramSetSkPO.getHighlightedValues()).to.deep.equal([
        {paramSetIdx: 0, key: 'a', value: 'hello'},
        {paramSetIdx: 0, key: 'b', value: '1'},
        {paramSetIdx: 0, key: 'c', value: 'X'},
        {paramSetIdx: 1, key: 'c', value: 'X'},
        {paramSetIdx: 1, key: 'd', value: 'IV'},
        {paramSetIdx: 1, key: 'e', value: 'alpha'},
      ]);
    });
  });
  ...
  describe('clicks', () => {
    ...
    describe('not clickable', () => {
      ...
      it('does not emit an event when clicking a value', async () => {
        ...
        await paramSetSkPO.clickValue(0, 'a', 'hello');
        await noEvent;
      });
    });
