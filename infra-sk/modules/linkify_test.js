import { formatAndLinkify } from './linkify';
...
describe('formatAndLinkify', function() {
  ...
  it('replaces expands bug shorthand with anchor tags', function() {
    ...
    test('chromium:123456789101112',
         '<a href="http://crbug.com/123456789101112" target="_blank" rel="noopener">chromium:123456789101112</a>');
  ...
  it('does all of the above at once', function() {
    test('<b>Hey<b>, check out skia:9000 \n and http://www.example.com/cool/thing?special=true',
      '&lt;b&gt;Hey&lt;b&gt;, check out <a href="http://skbug.com/9000" target="_blank" rel="noopener">skia:9000</a> '+
      '<br> and <a href="http://www.example.com/cool/thing?special=true" target="_blank" rel="noopener">http://www.example.com/cool/thing?special=true</a>');
  })
});

const test = (input, output) => {
  expect(formatAndLinkify(input).innerHTML).to.equal(output);
};
