...
/**
 * Describes the extra fields that this custom element adds to the JSON data returned by the
 * server.
 */
interface UIInfo {
  expandProps?: boolean;
...
/** Convenience type for templates that accept both run and step data. */
