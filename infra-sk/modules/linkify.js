...
/**
 * Given a string (usually given by an untrustworthy user), this returns a DOM Element
 * which contains the string and has the following "improvements":
 ...
 *
 * This DOM Element can be used in a lit-html template. For example:
