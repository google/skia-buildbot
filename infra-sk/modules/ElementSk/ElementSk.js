 ...
 * }
 *
 * @todo Do we also want to capture all the attributeChangedCallback's that
 *   occor before connectedCallback is called and replay them once
 *   connectedCallback finishes?
 */
export class ElementSk extends HTMLElement {
  constructor() {
    super();
    this._template = null; // this._template = (ele) => html``;
