...
// with the latest image. This is bacause the spec for the rpi-warming pods is
//
//     spec:
//       updateStrategy:
//         type: OnDelete
...
func main() {
	...
	successfulDeletes := metrics2.GetCounter("podreader_successful_deletes")
	failedDeletes := metrics2.GetCounter("podreader_failed_deletes")
