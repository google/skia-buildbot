...
// powercycledHandler listens for reports of what bots were powercycled and reports
// it to the powerServer.
...
func main() {
	...
	r := mux.NewRouter()
	r.HandleFunc("/reportPowercycled", powercycledHandler).Methods("POST")
