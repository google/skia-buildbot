...
func TurnOffPort(client EdgeSwitchCommandRunner, port int) error {
...
func TurnOnPort(client EdgeSwitchCommandRunner, port int) error {
	_, err := client.ExecCmds([]string{
		"configure",
		"interface " + fmt.Sprintf("0/%d", port),
		"poe opmode auto",
...
func Ping(client EdgeSwitchCommandRunner) error {
