...
// mPowerClient implements the Client interface.
...
// newMPowerClient returns a new instance of Client for the mPowerPro power strip.
func newMPowerClient(mPowerConfig *mPowerConfig, connect bool) (*mPowerClient, error) {
