...
func TestMapping(t *testing.T) {
	...
	assert.Contains(t, botList, Bot{Hostname: "rpi-001", MACAddress: "12:32", Port: 10, IPV4Address: "1.1.1.1"})
	assert.Contains(t, botList, Bot{Hostname: "rpi-002", MACAddress: "AB:BA", Port: 20, IPV4Address: "2.2.2.2"})
}
...
func TestEdgeSwitchParsing(t *testing.T) {
	...
	assert.Equal(t, expectedEdgeSwitchResults, bots)
}
...
func TestEdgeSwitchDeduping(t *testing.T) {
	...
	assert.Contains(t, deduped, Bot{MACAddress: "40:40:4C:36:80:62", Port: 21})
	assert.Contains(t, deduped, Bot{MACAddress: "40:40:4C:36:83:62", Port: 19})
}
