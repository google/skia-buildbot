...
# Note: Fix the requirement that the sizelimit has to be adjusted all the time.
mount /opt/rpi.img $IMAGE_PATH -o ro,norecovery,offset=50331648,sizelimit=1772843520,noauto
