...
alias skolo_rack4_network='google-chrome https://localhost:8888; google-chrome https://localhost:8889; ssh -L 8888:192.168.1.1:443 -L 8889:192.168.1.2:443 chrome-bot@100.115.95.135'
