...
func newGitstoreUpdater(t *testing.T, gs gitstore.GitStore, gb *git_testutils.GitBuilder) repograph_testutils.RepoImplRefresher {
...
func TestGraphBTGitStore(t *testing.T) {
