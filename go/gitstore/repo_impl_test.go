...
import (
	...
	repograph_testutils "go.skia.org/infra/go/git/repograph/testutils"
...
func (gs *testGitStore) RangeN(ctx context.Context, startIndex, endIndex int, branch string) ([]*vcsinfo.IndexCommit, error) {
	return nil, errors.New("RangeN not implemented for testGitStore.")
}

// See documentation for GitStore interface.
func (gs *testGitStore) RangeByTime(ctx context.Context, start, end time.Time, branch string) ([]*vcsinfo.IndexCommit, error) {
	if branch != "" {
		return nil, errors.New("RangeByTime not implemented for single branches in testGitStore.")
	}
...
func newGitstoreUpdater(t *testing.T, gs GitStore, gb *git_testutils.GitBuilder) repograph_testutils.RepoImplRefresher {
...
func setupGitStore(t *testing.T) (context.Context, *git_testutils.GitBuilder, *repograph.Graph, repograph_testutils.RepoImplRefresher, func()) {
	ctx, g, cleanup := repograph_testutils.CommonSetup(t)
...
func TestGraphGitStore(t *testing.T) {
	...
	defer cleanup()
	repograph_testutils.TestGraph(t, ctx, g, repo, ud)
}
...
func TestRecurseGitStore(t *testing.T) {
	...
	ctx, g, repo, ud, cleanup := setupGitStore(t)
	defer cleanup()
	repograph_testutils.TestRecurse(t, ctx, g, repo, ud)
}
...
func TestRecurseAllBranchesGitStore(t *testing.T) {
	...
	ctx, g, repo, ud, cleanup := setupGitStore(t)
	defer cleanup()
	repograph_testutils.TestRecurseAllBranches(t, ctx, g, repo, ud)
}
...
func TestUpdateHistoryChangedGitStore(t *testing.T) {
	...
	ctx, g, repo, ud, cleanup := setupGitStore(t)
	defer cleanup()
	repograph_testutils.TestUpdateHistoryChanged(t, ctx, g, repo, ud)
}*/
...
func TestUpdateAndReturnCommitDiffsGitStore(t *testing.T) {
	...
	ctx, g, repo, ud, cleanup := setupGitStore(t)
	defer cleanup()
	repograph_testutils.TestUpdateAndReturnCommitDiffs(t, ctx, g, repo, ud)
}
...
func TestRevListGitStore(t *testing.T) {
	...
	ctx, g, repo, ud, cleanup := setupGitStore(t)
	defer cleanup()
	repograph_testutils.TestRevList(t, ctx, g, repo, ud)
}
