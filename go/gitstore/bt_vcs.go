...
// MultiDetails implements the vcsinfo.VCS interface
func (b *btVCS) MultiDetails(ctx context.Context, hashes []string, includeBranchInfo bool) ([]*vcsinfo.LongCommit, error) {
