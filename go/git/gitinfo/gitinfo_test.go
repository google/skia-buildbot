...
func TestDisplay(t *testing.T) {
	...
	r, err := NewGitInfo(ctx, filepath.Join(repoDir, "testrepo"), false, false)
...
func TestFrom(t *testing.T) {
	...
	r, err := NewGitInfo(context.TODO(), filepath.Join(repoDir, "testrepo"), false, false)
	assert.NoError(t, err)
	vcstu.TestFrom(t, r)
}
...
func TestRevList(t *testing.T) {
	...
	ctx := context.Background()
	r, err := NewGitInfo(ctx, filepath.Join(repoDir, "testrepo"), false, true)
	if err != nil {
		t.Fatal(err)
	}
