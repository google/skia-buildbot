...
func TestExtractDEPS(t *testing.T) {
	...
	assert.Equal(t, "f4b9bf7d9e688f1afedcf4a960a31582ddb56f4a", ExtractCommitFromDEPS(r, "4ede5bf7c9cc9eccbea0e7c088e47ab8b70aa9a8", DefaultSkiaDEPSRegexp))

	// Check an invalid git hash.
	assert.Equal(t, "", ExtractCommitFromDEPS(r, "invalid-sha-example", DefaultSkiaDEPSRegexp))

	// Check a valid git hash that has no DEPS file.
	assert.Equal(t, "", ExtractCommitFromDEPS(r, "8652a6df7dc8a7e6addee49f6ed3c2308e36bd18", DefaultSkiaDEPSRegexp))
}
