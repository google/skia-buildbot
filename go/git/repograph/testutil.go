...
// c1--c2------c4--c5--
//       \-c3-----/
func gitSetup(t sktest.TestingT, ctx context.Context, g *git_testutils.GitBuilder, repo *Graph, rf RepoImplRefresher) []*Commit {
...
func assertTopoSorted(t sktest.TestingT, commits []*Commit) {
...
func assertHashesTopoSorted(t sktest.TestingT, repo *Graph, hashes []string) {
...
func TestGraph(t sktest.TestingT, ctx context.Context, g *git_testutils.GitBuilder, repo *Graph, rf RepoImplRefresher) {
...
func TestRecurse(t sktest.TestingT, ctx context.Context, g *git_testutils.GitBuilder, repo *Graph, rf RepoImplRefresher) {
	commits := gitSetup(t, ctx, g, repo, rf)
...
func TestRecurseAllBranches(t sktest.TestingT, ctx context.Context, g *git_testutils.GitBuilder, repo *Graph, rf RepoImplRefresher) {
	commits := gitSetup(t, ctx, g, repo, rf)
...
func TestUpdateHistoryChanged(t sktest.TestingT, ctx context.Context, g *git_testutils.GitBuilder, repo *Graph, rf RepoImplRefresher) {
	commits := gitSetup(t, ctx, g, repo, rf)
...
func TestUpdateAndReturnCommitDiffs(t sktest.TestingT, ctx context.Context, g *git_testutils.GitBuilder, repo *Graph, rf RepoImplRefresher) {
...
func TestRevList(t sktest.TestingT, ctx context.Context, gb *git_testutils.GitBuilder, repo *Graph, rf RepoImplRefresher) {
