...
type Commit struct {
	*vcsinfo.LongCommit
	...
	// HistoryLen is the number of commits in the line of history of this
	// Commit. It is only used during Recurse as the maximum number of
	// commits which could be visited, to prevent excessive resizing of the
	// visited map.
	HistoryLen int
}
