...
func (r *Graph) UpdateBranchInfo() []*vcsinfo.LongCommit {
	...
	commits := r.GetAll()
	// Use a map of pointers to Commits. This is a little faster than keying
	// by commit hash and is safe because we never copy a Commit or change
	// its parent pointers after it is created.
