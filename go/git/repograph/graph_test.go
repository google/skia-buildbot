...
func TestMapUpdate(t *testing.T) {
	...
	require.Equal(t, new1, g1.Get(git.MasterBranch).Hash)
	require.Equal(t, new2, g2.Get(git.MasterBranch).Hash)
	...
	require.NotEqual(t, new1, g1.Get(git.MasterBranch).Hash)
	require.NotEqual(t, new2, g2.Get(git.MasterBranch).Hash)
