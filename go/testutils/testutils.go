...
// networks, etc.
func SmallTest(t testing.TestingT) {
...
func MediumTest(t testing.TestingT) {
...
// test suite.
func LargeTest(t testing.TestingT) {
...
func ManualTest(t testing.TestingT) {
...
// error.
func WriteFile(t testing.TestingT, filename, contents string) {
...
func MarshalJSON(t testing.TestingT, i interface{}) string {
...
func MarshalIndentJSON(t testing.TestingT, i interface{}) string {
...
func AssertErrorContains(t testing.TestingT, err error, substr string) {
	assert.NotNil(t, err)
...
// MockTestingT implements testing.TestingT by saving calls to Log and Fail. MockTestingT can
...
// Assert that MockTestingT implements the testing.TestingT interface:
var _ testing.TestingT = (*MockTestingT)(nil)

// AssertFails runs testfn with a MockTestingT and asserts that the test fails and the first failure
// logged matches the regexp. The testing.TestingT passed to testfn is not safe for concurrent use.
func AssertFails(parent testing.TestingT, regexp string, testfn func(testing.TestingT)) {
	mock := MockTestingT{}
	wg := sync.WaitGroup{}
	wg.Add(1)
	go func() {
