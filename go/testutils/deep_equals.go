...
func deepValueEqual(v1, v2 reflect.Value, visited map[visit]bool, depth int) bool {
	...
	case reflect.Struct:
		...
		// behavior.
		if equal := v1.MethodByName("Equal"); equal.IsValid() {
			retvals := equal.Call([]reflect.Value{v2})
			if len(retvals) >= 1 {
		...
		// Use unsafe.Pointer here to allow us access to compare unexported fields
		// w/o panicking and w/o use of unexported functions.
