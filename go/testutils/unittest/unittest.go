...
type emulatorScopeUnderRBE int

const (
	useTestSuiteSharedEmulatorInstanceUnderRBE = emulatorScopeUnderRBE(0)
	useTestCaseSpecificEmulatorInstanceUnderRBE = emulatorScopeUnderRBE(1)
)
...
func setUpEmulatorBazelRBEOnly(t sktest.TestingT, emulator emulators.Emulator, scope emulatorScopeUnderRBE) {
	...
	default:
		panic("Unknown emulatorScopeUnderRBE value: " + string(scope))
	}
