...
const (
	...
	// Gold
	ISSUE                  Kind = "Issue"
	ISSUE_EXP_SUMMARY      Kind = "MasterExpSummary"
	TRYJOB                 Kind = "Tryjob"
	...
	MASTER_EXP_SUMMARY     Kind = "MasterExpSummary"
	IGNORE_RULE            Kind = "IgnoreRule"
	RECENT_KEYS            Kind = "HelperRecentKeys"
...
var (
	...
	KindsToBackup = map[string][]Kind{
		...
		GOLD_SKIA_PROD_NS:      []Kind{ISSUE, TRYJOB, TRYJOB_RESULT, TRYJOB_EXP_CHANGE, TRYJOB_TEST_DIGEST_EXP, MASTER_EXP_CHANGE, MASTER_TEST_DIGEST_EXP},
