...
func TestDisplay(t *testing.T, vcs vcsinfo.VCS) {
...
func TestFrom(t *testing.T, vcs vcsinfo.VCS) {
...
func TestByIndex(t *testing.T, vcs vcsinfo.VCS) {
	ctx := context.Background()
...
func TestLastNIndex(t *testing.T, vcs vcsinfo.VCS) {
...
func TestIndexOf(t *testing.T, vcs vcsinfo.VCS) {
	ctx := context.Background()
...
func TestRange(t *testing.T, vcs vcsinfo.VCS) {
