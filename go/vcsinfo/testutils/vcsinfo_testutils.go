...
func TestDisplay(t testing.TestingT, vcs vcsinfo.VCS) {
...
func TestFrom(t testing.TestingT, vcs vcsinfo.VCS) {
...
func TestByIndex(t testing.TestingT, vcs vcsinfo.VCS) {
	// All hashes refer to the repository in ./testdata/testrepo.zip unzipped by NewTempRepo().
	ctx := context.Background()
...
func TestLastNIndex(t testing.TestingT, vcs vcsinfo.VCS) {
	// All hashes refer to the repository in ./testdata/testrepo.zip unzipped by NewTempRepo().
...
func TestIndexOf(t testing.TestingT, vcs vcsinfo.VCS) {
	// All hashes refer to the repository in ./testdata/testrepo.zip unzipped by NewTempRepo().
	ctx := context.Background()
...
func TestRange(t testing.TestingT, vcs vcsinfo.VCS) {
	// All hashes refer to the repository in ./testdata/testrepo.zip unzipped by NewTempRepo().
