...
type VCS interface {
	...
	// MultiDetails returns multiple details at once, which is a lot faster for some implementations.
	MultiDetails(ctx context.Context, hashes []string, includeBranchInfo bool) ([]*LongCommit, error)
