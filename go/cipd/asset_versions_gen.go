...
var PACKAGES = map[string]*Package{
	...
	"infra/3pp/tools/git/${platform}": {
		...
		Version: "version:3@2.56.0-rc0.chromium.11",
	},
	...
	"infra/tools/luci/vpython3/${platform}": {
		...
		Version: "git_revision:04d7e52f07cdf029474b2eb75d4b55ae717795f4",
	},
	"skia/bots/bazel": {
		Path:    "bazel",
	...
	"skia/tools/bazel_build_all/${platform}": {
		...
		Version: "git_revision:f1b83849843a36f8ab25369c27a3db64b70bda6b",
	},
	"skia/tools/bazel_test_all/${platform}": {
		Path:    ".",
		Name:    "skia/tools/bazel_test_all/${platform}",
		Version: "git_revision:6b641676d0b6f3bf4bb166f27fbb5e67bcb51d12",
	},
	...
	"skia/tools/presubmit/${platform}": {
		...
		Version: "git_revision:17bbf643195ddc4539728e5725dfd64c221d1036",
	},
}
