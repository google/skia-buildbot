...
import io "io"
import local "go.chromium.org/luci/cipd/client/cipd/local"
...
// Describe provides a mock function with given fields: ctx, pkg, instance
func (_m *CIPDClient) Describe(ctx context.Context, pkg string, instance string) (*clientcipd.InstanceDescription, error) {
	ret := _m.Called(ctx, pkg, instance)
...
func (_m *CIPDClient) EnsurePackages(ctx context.Context, pkgs common.PinSliceBySubdir, paranoia local.ParanoidMode, dryRun bool) (clientcipd.ActionMap, error) {
	ret := _m.Called(ctx, pkgs, paranoia, dryRun)

	var r0 clientcipd.ActionMap
	if rf, ok := ret.Get(0).(func(context.Context, common.PinSliceBySubdir, local.ParanoidMode, bool) clientcipd.ActionMap); ok {
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(context.Context, common.PinSliceBySubdir, local.ParanoidMode, bool) error); ok {
...
func (_m *CIPDClient) FetchInstance(ctx context.Context, pin common.Pin) (local.InstanceFile, error) {
	ret := _m.Called(ctx, pin)

	var r0 local.InstanceFile
	if rf, ok := ret.Get(0).(func(context.Context, common.Pin) local.InstanceFile); ok {
		r0 = rf(ctx, pin)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(local.InstanceFile)
		}
	}
...
// RegisterInstance provides a mock function with given fields: ctx, instance, timeout
func (_m *CIPDClient) RegisterInstance(ctx context.Context, instance local.PackageInstance, timeout time.Duration) error {
	ret := _m.Called(ctx, instance, timeout)

	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, local.PackageInstance, time.Duration) error); ok {
		r0 = rf(ctx, instance, timeout)
	} else {
		r0 = ret.Error(0)
	}
