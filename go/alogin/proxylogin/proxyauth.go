// Package proxyauth implements alogin.Login when letting a reverse proxy handle
// authentication
package proxylogin
...
// proxyAuth implements alogin.Login by relying on a reverse proxy doing the
