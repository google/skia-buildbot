...
var (
	CONTENT_FAIL TestContent = []byte(fmt.Sprintf(tmpl, PackageName, TestName, "t.FailNow()"))
	CONTENT_PASS TestContent = []byte(fmt.Sprintf(tmpl, PackageName, TestName, "// No-op tests pass!"))
	CONTENT_SKIP TestContent = []byte(fmt.Sprintf(tmpl, PackageName, TestName, "t.Skip(\"no thanks!\")"))
...
func runTest(t *testing.T, w io.Writer, content TestContent) {
	// Setup.
...
func runAndCompare(t *testing.T, expectEvents []*Event, content TestContent) {
	r, w := io.Pipe()
	go func() {
...
func TestEventStreamFail(t *testing.T) {
	...
	runAndCompare(t, EVENTS_FAIL, CONTENT_FAIL)
}

func TestEventStreamPass(t *testing.T) {
	unittest.MediumTest(t)
	runAndCompare(t, EVENTS_PASS, CONTENT_PASS)
}

func TestEventStreamSkip(t *testing.T) {
	unittest.MediumTest(t)
	runAndCompare(t, EVENTS_SKIP, CONTENT_SKIP)
}
