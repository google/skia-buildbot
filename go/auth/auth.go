...
// asClient is a transitional helper function taking the result of a New*TokenSource function and
// returning a "DefaultClient" for that TokenSource.
...
// NewDefaultLegacyTokenSource creates a new OAuth 2.0 token source with all the
...
// NewTokenSourceFromIdAndSecret creates a new OAuth 2.0 token source with all the defaults
...
// NewLegacyTokenSource creates a new OAuth 2.0 token source. If local
...
// newLegacyTokenSourceFromConfig creates an new OAuth 2.0 token source
