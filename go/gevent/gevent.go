...
func (d *distEventBus) decodeStorageMsg(msg *pubsub.Message) ([]*channelWrapper, interface{}, bool, error) {
	...
	if err := json.Unmarshal(msg.Data, objectAttrs); err != nil {
	...
	data := eventbus.NewStorageEvent(bucketID, objectID,
		objectAttrs.Updated.Unix(), hex.EncodeToString(objectAttrs.MD5))
