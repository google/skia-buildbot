...
// and returns a boolean indicating whether recursion should continue and an
// error, if any. Recursion stops if there are any errors. For example, to
// print out the entire history starting at a given commit:
//
