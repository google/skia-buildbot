...
type EventBus interface {
	...
	//
	// Note: This is only implemented by the gevent package.
	RegisterStorageEvents(bucketName string, objectPrefix string, objectRegEx *regexp.Regexp, client *storage.Client) (string, error)
}

// StorageNotification is the object that is published by Storage events, that
// have been registered via RegisterStorageEvents.
