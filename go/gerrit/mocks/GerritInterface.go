...
// NewGerritInterface creates a new instance of GerritInterface. It also registers a cleanup function to assert the mocks expectations.
func NewGerritInterface(t testing.TB) *GerritInterface {
