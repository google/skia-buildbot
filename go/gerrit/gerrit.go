...
type RelatedChangeAndCommitInfo struct {
	...
	//CurrentRevision int64  `json:"_current_revision_number"`
	Status string `json:"status"`
}
...
func (g *Gerrit) GetDependencies(changeNum, revision int64) ([]*RelatedChangeAndCommitInfo, error) {
...
func (g *Gerrit) HasOpenDependency(changeNum, revision int64) (bool, error) {
