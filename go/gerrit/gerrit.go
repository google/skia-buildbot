...
func (g *Gerrit) SendToDryRun(issue *ChangeInfo, message string) error {
	return g.setReview(issue, message, map[string]interface{}{"Commit-Queue": 1})
}

func (g *Gerrit) SendToCQ(issue *ChangeInfo, message string) error {
	return g.setReview(issue, message, map[string]interface{}{"Commit-Queue": 2})
}

func (g *Gerrit) RemoveFromCQ(issue *ChangeInfo, message string) error {
	return g.setReview(issue, message, map[string]interface{}{"Commit-Queue": 0})
}
