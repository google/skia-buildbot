...
func TestHasOpenDependency(t *testing.T) {
	...
	api, err := NewGerritWithConfig(CONFIG_CHROMIUM, GERRIT_SKIA_URL, c)
...
func TestGerritOwnerModifiedSearch(t *testing.T) {
	...
	issues, err := api.Search(context.Background(), 1, true, SearchModifiedAfter(t_delta), SearchOwner("rmistry@google.com"))
	require.NoError(t, err)
...
func TestGetAbandonReason(t *testing.T) {
	...
	tests := []struct {
		...
		{status: CHANGE_STATUS_ABANDONED, messages: []ChangeInfoMessage{msgWithAbandonFromUser, msgWithAbandonPrefixAndMsgAutogenerated}, expectedAbandonReason: "Testing testing", failureMessage: "autogenerated abandon messages with prefix should return message without prefix"},
		{status: CHANGE_STATUS_NEW, messages: []ChangeInfoMessage{msgWithAbandonFromUser, msgWithAbandonPrefixAndMsgAutogenerated}, expectedAbandonReason: "", failureMessage: "non-abandoned changes have no abandon message"},
		{status: CHANGE_STATUS_ABANDONED, messages: []ChangeInfoMessage{msgWithAbandonFromUser, msgWithAbandonAutogenerated}, expectedAbandonReason: "", failureMessage: "autogenerated abandon messages with only prefix should return an empty message"},
		{status: CHANGE_STATUS_ABANDONED, messages: []ChangeInfoMessage{msgWithAbandonFromUser, msgWithNoPrefixAndMsgAutogenerated}, expectedAbandonReason: "Something", failureMessage: "autogenerated abandon messages with no prefix should return the specified message"},
		{status: CHANGE_STATUS_ABANDONED, messages: []ChangeInfoMessage{msgWithAbandonFromUser}, expectedAbandonReason: "", failureMessage: "abandon messages from users are ignored"},
	}
		...
		_, err := fmt.Fprintln(w, `)]}'
{
  ...
  "tools/gpu/vk/GrVulkanDefines.h": {
	...
	api, err := NewGerritWithConfig(CONFIG_CHROMIUM, ts.URL, c)
		...
		_, err := fmt.Fprintln(w, `)]}'
{
  "/COMMIT_MSG": {
	...
	api, err := NewGerritWithConfig(CONFIG_CHROMIUM, tsNoBinary.URL, c)
	require.NoError(t, err)
		...
		_, err := fmt.Fprintln(w, `)]}'
{
  ...
  "site/dev/design/Test.png": {
	...
	api, err = NewGerritWithConfig(CONFIG_CHROMIUM, tsBinary.URL, c)
	require.NoError(t, err)
