...
func _BuildbotDB_GetModifiedBuilds_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error) (interface{}, error) {
	in := new(GetModifiedBuildsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	out, err := srv.(BuildbotDBServer).GetModifiedBuilds(ctx, in)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _BuildbotDB_StartTrackingModifiedBuilds_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error) (interface{}, error) {
	in := new(Empty)
	if err := dec(in); err != nil {
		return nil, err
	}
	out, err := srv.(BuildbotDBServer).StartTrackingModifiedBuilds(ctx, in)
	if err != nil {
		return nil, err
	}
	return out, nil
