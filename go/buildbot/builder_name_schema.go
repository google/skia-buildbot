...
// BuilderNameParser parses a builder/task name into its constituant parts
...
// builderNameParser fulfils the BuilderNameParser interface
type builderNameParser struct {
	schema *builderNameSchema
}

// DefaultBuilderNameParser creates a BuilderNameParser using the schema from
// builder_name_schema.json which is checked into the skia repository.
...
// See BuilderNameParser for more information
