...
// InitRequestSaltFromSpecifiedMetadata reads requestSalt using the specified project metadata
// key and returns any error encountered. Should be called once at startup.
...
// MustInitRequestSaltFromSpecifiedMetadata reads requestSalt using the specified project
// metadata key. Exits the program on error. Should be called once at startup.
...
// InitRequestSaltFromMetadata reads requestSalt using the default project metadata key and
...
// MustInitRequestSaltFromMetadata reads requestSalt using the default project metadata key.
