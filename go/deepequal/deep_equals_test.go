...
func TestAssertJSONRoundTrip(t *testing.T) {
	...
	testutils.AssertFails(t, `unsupported type: map\[\w+\.Success]struct`, func(t itesting.TestingT) {
	...
	testutils.AssertFails(t, "Objects do not match", func(t itesting.TestingT) {
