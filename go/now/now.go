...
const ContextKey = "overwriteNow"

// NowProvider is the type of function that can also be passed
// as a context value. The function will be evaluated every time
// Now() is called with that context.
