...
// TODO(borenet): We also need to test correct handling of the root.
...
func TestUploadDownload(t *testing.T) {
	...
	// Single file.
	testUploadDownload(ctx, t, client, func(wd string) {
		f(t, wd, "dummy", "dummycontents", false)
	})

	// Executable file.
	testUploadDownload(ctx, t, client, func(wd string) {
		f(t, wd, "dummy", "dummycontents", true)
	})
	...
	// Deeply nested file.
	testUploadDownload(ctx, t, client, func(wd string) {
		f(t, wd, "a/b/c/d/dummy", "dummycontents", false)
	})
	...
	testUploadDownload(ctx, t, client, func(wd string) {
		...
		d(t, wd, "subdir")
		f(t, wd, "subdir/dummy", "dummycontents", false)
		f(t, wd, "subdir/dummy2", "dummycontents2", false)
	})
}
