...
type TxStatsMetric struct {
	// Page statistics.
	PageCount metrics2.Int64MetricI // number of page allocations
	PageAlloc metrics2.Int64MetricI // total bytes allocated

	// Cursor statistics.
	CursorCount metrics2.Int64MetricI // number of cursors created

	// Node statistics
	NodeCount metrics2.Int64MetricI // number of node allocations
	NodeDeref metrics2.Int64MetricI // number of node dereferences

	// Rebalance statistics.
	Rebalance     metrics2.Int64MetricI // number of node rebalances
	RebalanceTime metrics2.Int64MetricI // total time spent rebalancing

	// Split/Spill statistics.
	Split     metrics2.Int64MetricI // number of nodes split
	Spill     metrics2.Int64MetricI // number of nodes spilled
	SpillTime metrics2.Int64MetricI // total time spent spilling

	// Write statistics.
	Write     metrics2.Int64MetricI // number of writes performed
	WriteTime metrics2.Int64MetricI // total time spent writing to disk
}

// newTxStatsMetric initializes a TxStatsMetric. tags should include "database"
// but should not include "metric".
func newTxStatsMetric(c metrics2.ClientI, tags ...map[string]string) *TxStatsMetric {
...
func deleteAll(metrics ...metrics2.Int64MetricI) error {
...
type DbStatsMetric struct {
	// Freelist stats
	FreePageN     metrics2.Int64MetricI // total number of free pages on the freelist
	PendingPageN  metrics2.Int64MetricI // total number of pending pages on the freelist
	FreeAlloc     metrics2.Int64MetricI // total bytes allocated in free pages
	FreelistInuse metrics2.Int64MetricI // total bytes used by the freelist

	// Transaction stats
	TxN     metrics2.Int64MetricI // total number of started read transactions
	OpenTxN metrics2.Int64MetricI // number of currently open read transactions
...
// but should not include "metric".
func newDbStatsMetric(c metrics2.ClientI, tags ...map[string]string) *DbStatsMetric {
...
type BucketStatsMetric struct {
	...
	BranchPageN     metrics2.Int64MetricI // number of logical branch pages
	BranchOverflowN metrics2.Int64MetricI // number of physical branch overflow pages
	LeafPageN       metrics2.Int64MetricI // number of logical leaf pages
	LeafOverflowN   metrics2.Int64MetricI // number of physical leaf overflow pages

	// Tree statistics.
	KeyN  metrics2.Int64MetricI // number of keys/value pairs
	Depth metrics2.Int64MetricI // number of levels in B+tree

	// Page size utilization.
	BranchAlloc metrics2.Int64MetricI // bytes allocated for physical branch pages
	BranchInuse metrics2.Int64MetricI // bytes actually used for branch data
	LeafAlloc   metrics2.Int64MetricI // bytes allocated for physical leaf pages
	LeafInuse   metrics2.Int64MetricI // bytes actually used for leaf data

	// Bucket statistics
	BucketN           metrics2.Int64MetricI // total number of buckets including the top bucket
	InlineBucketN     metrics2.Int64MetricI // total number of inlined buckets
	InlineBucketInuse metrics2.Int64MetricI // bytes used for inlined buckets (also accounted for in LeafInuse)
}

// newBucketStatsMetric initializes a BucketStatsMetric. tags should include
// "database" and "bucket-path" but not "metric".
func newBucketStatsMetric(c metrics2.ClientI, tags ...map[string]string) *BucketStatsMetric {
...
func NewDbMetricWithClient(c metrics2.ClientI, d *bolt.DB, bucketNames []string, tags ...map[string]string) (*DbMetric, error) {
	m := &DbMetric{
