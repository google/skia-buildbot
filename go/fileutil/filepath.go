...
// startTS and endTS are seconds since the epoch. The generated directories are based on a
// UTC being the locale.
func GetHourlyDirs(prefixDir string, startTS int64, endTS int64) []string {
	...
	// our. This guarantees that we always include the last hour because
