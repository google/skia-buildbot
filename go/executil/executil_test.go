...
func TestTestContext_SingleFakeTest_Success(t *testing.T) {
	unittest.SmallTest(t)
	ctx := executil.TestContext("Test_FakeExe_Cowsay_ReturnsASCIIArt")
...
func TestTestContext_SingleFakeTest_ReturnsErrorIfWrongArgumentsPassed(t *testing.T) {
	unittest.SmallTest(t)
	ctx := executil.TestContext("Test_FakeExe_Cowsay_ReturnsASCIIArt")
...
func TestTestContext_SingleFakeTest_CowsayFails_ReturnsError(t *testing.T) {
	unittest.SmallTest(t)
	ctx := executil.TestContext("Test_FakeExe_Cowsay_Crashes")
...
func TestTestContext_MultipleFakeTests_FirstSucceedsSecondReturnsError(t *testing.T) {
	unittest.SmallTest(t)
	ctx := executil.TestContext(
...
func TestTestContextFrom_ParentContextTimeoutRespected(t *testing.T) {
	unittest.SmallTest(t)

	ctx, cancel := context.WithTimeout(context.Background(), time.Second)
	defer cancel()
	ctx = executil.TestContextFrom(ctx, "Test_FakeExe_Cowsay_Hangs")
