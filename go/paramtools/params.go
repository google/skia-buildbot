...
// Check returns all the keys and their values that don't exist in the OrderedParamSet.
...
// Update adds all the key/value pairs from ParamSet, which is usually
// the ParamSet returned from Check().
