...
// the OrderedParamSet.
func (p *paramsEncoder) encode(params Params) (EncodedParams, error) {
	ret := EncodedParams{}
	for _, key := range p.keyOrder {
		value, ok := params[key]
		if !ok {
...
func (o *OrderedParamSet) EncodeParams(p Params) (EncodedParams, error) {
