...
func TestBasics(t *testing.T) {
	h := New([]string{}, "/projects/145247227042/global/backendServices/k8s-be-32071--e03569f20c11b77d", nil)
	ih := h.(*iapHandler)
...
func TestSigning(t *testing.T) {
	h := New([]string{}, "/projects/145247227042/global/backendServices/k8s-be-32071--e03569f20c11b77d", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		io.WriteString(w, "<html><body>Hello World!</body></html>")
	}))
	ih := h.(*iapHandler)
