...
// NewCondInt64Monitor creates a new monitor with the given number of
...
// MontorLock is returned by the Enter call.
...
// threads
func (m *CondMonitor) Enter(id int64) MonitorLock {
