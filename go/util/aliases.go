...
var (
	// The below aliases are from https://chromium.googlesource.com/infra/luci/luci-py/+/master/appengine/swarming/ui/res/js/alias.js

	// Android Aliases
	AndroidAliases = map[string]string{
		"angler":      "Nexus 6p",
		"athene":      "Moto G4",
		"bullhead":    "Nexus 5X",
		"dragon":      "Pixel C",
