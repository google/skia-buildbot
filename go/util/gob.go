...
// error. Caller must ensure t does not change until after the first call to
...
// its serialized bytes. If any comments remain, returns the item, the
// serialized bytes, nil. If all comments have been returned, returns nil, nil,
...
// NewGobDecoder returns a GobDecoder instance. The first argument is a function
// which returns a zero-valued instance of the type being decoded, eg.
//
// func() interface{} {
//	return &MyType{}
// }
