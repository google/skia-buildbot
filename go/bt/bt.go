...
func EnsureNotEmulator() {
	if emulators.GetEmulatorHost(emulators.BigTable) != "" {
		panic("BigTable Emulator detected. Be sure to unset the following environment variable: " + emulators.GetEmulatorHostEnvVar(emulators.BigTable))
	}
}
