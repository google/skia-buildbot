...
// StartAdHocEmulatorInstanceAndSetEmulatorHostEnvVarRBEOnly starts a new instance of the given
...
func StartAdHocEmulatorInstanceAndSetEmulatorHostEnvVarRBEOnly(emulator Emulator) error {
	if !bazel.InRBE() {
