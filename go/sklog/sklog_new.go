...
func Fatal(msg ...interface{}) {
	sklog_impl.LogAndDie(1, sklog_impl.Fatal, "", msg...)
}

func Fatalf(format string, v ...interface{}) {
	sklog_impl.LogAndDie(1, sklog_impl.Fatal, format, v...)
}

func FatalfWithDepth(depth int, format string, v ...interface{}) {
	sklog_impl.LogAndDie(1+depth, sklog_impl.Fatal, format, v...)
}
