...
// severityBytes stores pre-allocated byte slices of the severity strings.
var severityBytes = [5][]byte{
	[]byte("DEBUG"),
	[]byte("INFO"),
	[]byte("WARNING"),
	[]byte("ERROR"),
...
type Logger interface {
	...
	// when all implementations are able to log at Fatal level without dying.
