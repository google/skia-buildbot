...
type BuildBucketInterface interface {
	...
	ScheduleBuilds(ctx context.Context, builds []string, buildsToExperimental map[string]string, issue, patchset int64, gerritUrl, repo, bbProject, bbBucket string) ([]*buildbucketpb.Build, error)
...
// Needs tests.
func (c *Client) ScheduleBuilds(ctx context.Context, builds []string, buildsToExperimental map[string]string, issue, patchset int64, gerritURL, repo, bbProject, bbBucket string) ([]*buildbucketpb.Build, error) {
