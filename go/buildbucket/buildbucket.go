...
type BuildBucketInterface interface {
	...
	ScheduleBuilds(ctx context.Context, builds []string, issue, patchset int64, gerritUrl string) error
}
...
// Needs tests.
func (c *Client) ScheduleBuilds(ctx context.Context, builds []string, issue, patchset int64, gerritURL string) error {
