...
// InitBoth initializes metrics to be reported to both InfluxDB and Prometheus.
//
// port - string, The port on which to serve the metrics, e.g. ":10110".
func InitBoth(appName string, influxDbClient *influxdb.Client, port string) error {
	Init(appName, influxDbClient)
