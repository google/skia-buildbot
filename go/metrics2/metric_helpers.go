...
// GetInt64Metric returns an Int64Metric instance.
func (c *Client) GetInt64Metric(measurement string, tags ...map[string]string) Int64MetricI {
	return &Int64Metric{
		c.getRawMetric(measurement, tags, int64(0)),
	}
}
...
func (c *Client) GetFloat64Metric(measurement string, tags ...map[string]string) Float64MetricI {
...
func (c *Client) GetBoolMetric(measurement string, tags ...map[string]string) BoolMetricI {
	return &BoolMetric{
