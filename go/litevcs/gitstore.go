...
func buildGraph(rawGraph [][]string) (interface{}, error) {
	return nil, nil
}
...
func (c *CommitGraph) GetNode(hash string) *Node { return nil }

func (c *CommitGraph) GetBranch(head string) []string {
...
func (b *btGitStore) getIndexCommitsX(graph interface{}, head string) []*vcsinfo.IndexCommit {
	return nil
}
