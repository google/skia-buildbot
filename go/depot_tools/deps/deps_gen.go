...
var deps = deps_parser.DepsEntries{
	"chromium.googlesource.com/chromium/tools/depot_tools": {
		...
		Version: "838e4c6aa7b68d7a4de1c2f2cd516104d729eff3",
		Path:    "depot_tools",
	},
	...
	"infra/3pp/tools/git/linux-amd64": {
		...
		Version: "version:3@2.51.0.chromium.11",
	...
	"infra/tools/cipd/${os}-${arch}": {
		...
		Version: "git_revision:aaf80ec8202c91ad9c7aa20ee3841d00d4a7d51c",
		Path:    "",
	},
	"infra/tools/git": {
		Id:      "infra/tools/git",
	...
	"skia/tools/bazel_build_all": {
		...
		Version: "git_revision:00b2af652822bf187ec5b27e1979f126b255f9cd",
		Path:    "task_drivers",
	},
