...
var deps = deps_parser.DepsEntries{
	"chromium.googlesource.com/chromium/tools/depot_tools": {
		...
		Version: "ab387d1ddc530d405f662904f2df292f700e4b0f",
		Path:    "depot_tools",
	},
	...
	"infra/3pp/tools/git/linux-amd64": {
		...
		Version: "version:3@2.48.1.chromium.11",
	...
	"infra/tools/cipd/${os}-${arch}": {
		...
		Version: "git_revision:13127b173076f4f12a0c41fee30c0281cc71e58d",
		Path:    "",
	},
	"infra/tools/git": {
		Id:      "infra/tools/git",
	...
	"skia/tools/bazel_build_all": {
		...
		Version: "git_revision:dd753d8252ac993ebf2fa23bfecc2c1f0064446a",
		Path:    "task_drivers",
	},
