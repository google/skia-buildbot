...
var deps = deps_parser.DepsEntries{
	"chromium.googlesource.com/chromium/tools/depot_tools": {
		...
		Version: "8ebbd5189d8a9df51ee3dad42dc04651620424bb",
		Path:    "depot_tools",
	},
	...
	"infra/3pp/tools/git/linux-amd64": {
		...
		Version: "version:3@2.45.2.chromium.11",
	...
	"infra/tools/cipd/${os}-${arch}": {
		...
		Version: "git_revision:b09f6ef584c4a48d2501db644c3450ac7d8c132f",
		Path:    "",
	},
	"infra/tools/git": {
		Id:      "infra/tools/git",
	...
	"skia/tools/bazel_build_all": {
		...
		Version: "git_revision:67fb1a1b693f6e998601641b287054676018bb92",
		Path:    "task_drivers",
	},
