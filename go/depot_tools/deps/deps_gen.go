...
var deps = deps_parser.DepsEntries{
	"chromium.googlesource.com/chromium/tools/depot_tools": {
		...
		Version: "e5cd6f84f00d87af1a69e58d97ecccf66d48e284",
		Path:    "depot_tools",
	},
	...
	"infra/3pp/tools/git/linux-amd64": {
		...
		Version: "version:3@2.49.0.chromium.11",
	...
	"infra/tools/cipd/${os}-${arch}": {
		...
		Version: "git_revision:915e6c128020beb3b919619d51ec8750748a6599",
		Path:    "",
	},
	"infra/tools/git": {
		Id:      "infra/tools/git",
	...
	"skia/tools/bazel_build_all": {
		...
		Version: "git_revision:e91180f68c7c8391218c2999af19b5784d72f549",
		Path:    "task_drivers",
	},
