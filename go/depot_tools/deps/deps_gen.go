...
var deps = deps_parser.DepsEntries{
	"chromium.googlesource.com/chromium/tools/depot_tools": {
		...
		Version: "eddc72dce5e68bf04026070495a92650ac4948fe",
		Path:    "depot_tools",
	},
	...
	"infra/3pp/tools/git/linux-amd64": {
		...
		Version: "version:3@2.50.1.chromium.11",
	...
	"infra/tools/cipd/${os}-${arch}": {
		...
		Version: "git_revision:26e0caea23e77ba4c4d7be55e5d93781321efd20",
		Path:    "",
	},
	"infra/tools/git": {
		Id:      "infra/tools/git",
	...
	"skia/tools/bazel_build_all": {
		...
		Version: "git_revision:75e16bffe505349b63248855ed60567a08eb49f1",
		Path:    "task_drivers",
	},
