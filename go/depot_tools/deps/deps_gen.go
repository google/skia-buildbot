...
var deps = deps_parser.DepsEntries{
	"chromium.googlesource.com/chromium/tools/depot_tools": {
		...
		Version: "f818fb4b1b4ccc42c39349bb82b430ef7b47d1be",
		Path:    "depot_tools",
	},
	...
	"infra/3pp/tools/git/linux-amd64": {
		...
		Version: "version:3@2.47.0.chromium.11",
	...
	"infra/tools/cipd/${os}-${arch}": {
		...
		Version: "git_revision:9e987768ed42599aa80ce2c130ee8e912b417a18",
		Path:    "",
	},
	"infra/tools/git": {
		Id:      "infra/tools/git",
	...
	"skia/tools/bazel_build_all": {
		...
		Version: "git_revision:1d95b97862e5f26861deb605c9ff9fdce5c5cbdc",
		Path:    "task_drivers",
	},
