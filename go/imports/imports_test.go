...
var legacyTestImportExceptions = map[string][]string{
	"go.skia.org/infra/autoroll/go/autoroll-be": []string{
		"go.skia.org/infra/go/gcs/gcs_testutils",
	},
	"go.skia.org/infra/autoroll/go/migrate_roller": []string{
		"go.skia.org/infra/go/deepequal",
	},
	"go.skia.org/infra/task_driver/go/db": []string{
		"github.com/stretchr/testify/require",
		"go.skia.org/infra/go/deepequal",
		"go.skia.org/infra/go/gcs/gcs_testutils",
		"go.skia.org/infra/go/testutils",
	},
	"go.skia.org/infra/task_driver/go/td": []string{
		"github.com/stretchr/testify/require",
	},
	"go.skia.org/infra/task_scheduler/go/db": []string{
		"github.com/stretchr/testify/require",
		"go.skia.org/infra/go/deepequal",
		"go.skia.org/infra/go/git/testutils",
		"go.skia.org/infra/go/testutils",
	},
	"go.skia.org/infra/task_scheduler/go/isolate_cache": []string{
		"github.com/stretchr/testify/require",
		"go.skia.org/infra/go/bt/testutil",
	},
	"go.skia.org/infra/task_scheduler/go/task_scheduler": []string{
		"go.skia.org/infra/task_scheduler/go/testutils",
	},
	"go.skia.org/infra/task_scheduler/go/tryjobs": []string{
		"github.com/stretchr/testify/require",
