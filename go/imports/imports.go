...
// GetAllPackageData returns information about all packages in this repo.
func GetAllPackageData(ctx context.Context) (map[string]*Package, error) {
...
func FindImporters(ctx context.Context, findPkg string) ([]string, error) {
	allPkgs, err := GetAllPackageData(ctx)
	if err != nil {
		return nil, err
	}
	rv := []string{}
