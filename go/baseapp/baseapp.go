...
func securityMiddleware(salt []byte, domain string) mux.MiddlewareFunc {
...
func Serve(constructor Constructor, name string, domain string, usersMiddleware ...mux.MiddlewareFunc) {
	// Do common init.
	common.InitWithMust(
		name,
	...
	middleware := []mux.MiddlewareFunc{
		securityMiddleware(salt, domain),
		httputils.LoggingGzipRequestResponse,
	}
	middleware = append(middleware, usersMiddleware...)
	if !*Local {
