...
var RestrictAdmin = func(h http.Handler) http.Handler { return h }
...
var RestrictEditor = func(h http.Handler) http.Handler { return h }
...
var RestrictViewer = func(h http.Handler) http.Handler { return h }
