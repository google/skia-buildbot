...
// See also test_gcsclient.NewMemoryClientMockClient() for mocking this for unit tests.
// See also test_gcsclient.NewMemoryClientMemoryClient() for an alternative.
