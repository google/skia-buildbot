...
// The following tests go here (and not in the gcs pacakge) to avoid
// a dependency cycle between gcsclient, gcs and test_gcsclient
...
func TestWithWriteFileSimple(t *testing.T) {
	...
	c := &captureFileWriterGCSClient{
		MemoryGCSClient: test_gcsclient.New("compositions"),
	}
