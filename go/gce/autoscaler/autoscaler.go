...
// instances.
func NewAutoscaler(projectId, zone string, client *http.Client, instances []*gce.Instance) (*Autoscaler, error) {
	// Create the GCloud object.
	g, err := gce.NewGCloud(projectId, zone, client)
	if err != nil {
		return nil, err
	}
...
// Update determines which instances are online and caches that information.
...
// whether each instance is online as of the last Update().
...
// GetOnlineInstances returns a slice of all online instance names as of the
// last Update().
