...
func BaseConfig() *gce.Instance {
	...
	vm := &gce.Instance{
		BootDisk: &gce.Disk{
			Name:        INSTANCE_NAME,
			SourceImage: "projects/eip-images/global/images/debian-9-drawfork-v20180327",
			Type:        gce.DISK_TYPE_PERSISTENT_STANDARD,
		},
		MachineType:    gce.MACHINE_TYPE_STANDARD_4,
		Name:           INSTANCE_NAME,
		Os:             gce.OS_LINUX,
		ServiceAccount: "snap-shot-base-image@skia-buildbots.google.com.iam.gserviceaccount.com",
