...
set -x -e
export TERM=xterm
sudo apt --assume-yes -o Dpkg::Options::="--force-confdef" -o Dpkg::Options::="--force-confold" update
sudo apt --assume-yes -o Dpkg::Options::="--force-confdef" -o Dpkg::Options::="--force-confold" upgrade
...
do
  sudo apt --assume-yes -o Dpkg::Options::="--force-confdef" -o Dpkg::Options::="--force-confold"  update
  sudo apt --assume-yes -o Dpkg::Options::="--force-confdef" -o Dpkg::Options::="--force-confold"  full-upgrade
  sudo apt --assume-yes -o Dpkg::Options::="--force-confdef" -o Dpkg::Options::="--force-confold"  autoremove
done

# Now install the apps that we guarantee to appear.
sudo apt --assume-yes -o Dpkg::Options::="--force-confdef" -o Dpkg::Options::="--force-confold"  install git collectd unattended-upgrades
...
DEBCONF_DB_OVERRIDE="File{/tmp/override.dat readonly:true}" sudo dpkg-reconfigure --priority=low --frontend=readline  unattended-upgrades
