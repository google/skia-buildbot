...
func CTWindowsBuilderInstance(num int, setupScriptPath, startupScriptPath, chromebotScript string) *gce.Instance {
	// TODO(rmistry): This must be gce.MACHINE_TYPE_HIGHMEM_64.
	vm := skia_instance_types.Swarming20180406(fmt.Sprintf("ct-windows-builder-%03d", num), gce.MACHINE_TYPE_HIGHMEM_32, gce.SERVICE_ACCOUNT_CT_SWARMING, setupScriptPath, skia_instance_types.WIN_SOURCE_IMAGE)
