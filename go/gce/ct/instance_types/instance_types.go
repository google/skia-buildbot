...
func getCTWindowsInstance(name, machineType, diskType, setupScriptPath, startupScriptPath, chromebotScript string) *gce.Instance {
	vm := skia_instance_types.Swarming20180406(name, gce.MACHINE_TYPE_HIGHMEM_4, gce.SERVICE_ACCOUNT_CT_SWARMING, setupScriptPath, skia_instance_types.WIN_SOURCE_IMAGE)
