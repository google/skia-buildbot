...
documentation that it then servers over HTTP.
...
```
  ...
  -doc_path string
        The relative directory where the documents are located. (default "site")
  -doc_repo string
...
and Hugo installed. See the [Docsy
docs](https://www.docsy.dev/docs/getting-started/) for installation
instructions.
