...
This application is in res/imp/wasm-app.html and it's wasm code is in
experimental/wasm-skp-debugger in the skia repo.

Running locally
---------------

First build the wasm module and it's associated Javascript in the skia repository.
