...
func main() {
	...
	var (
		...
		workDir         = flag.String("workdir", "", "Working directory where directory where repos are cached. Use the same directory between calls to speed up checkout time.")
	...
	if *workDir == "" {
		sklog.Fatal("No work dir specified.")
	}
