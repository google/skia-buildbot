...
func main() {
	...
	ingester, err := ingestion.NewIngester("bench-ingester", &ingesterConf, nil, sources, processor)
	if err != nil {
...
func (b BenchProcessor) Process(resultsFile ingestion.ResultFileLocation) error {
