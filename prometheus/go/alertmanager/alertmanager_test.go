...
func TestEmailBody(t *testing.T) {
	...
	assert.Equal(t, "Alert(s): PerfAlert <br><br>\n\n\n  Alert: PerfAlert<br>\n  Severity: warning<br>\n  Status: firing<br>\n\tAt least one untriaged perf cluster has been found. Please visit https://perf.skia.org/t/ to triage.<br><br>\n", body)
}
