...
go_repository(
    ...
    sum = "h1:8TVrnPnSD7I+AmDp66xBUvS3K0J+jH09YXdrkJ34ey0=",
    version = "v1.33.2",
)
...
go_repository(
    ...
    sum = "h1:53CVzqOOfDOZLgwdbxktMY7FVcg+V7VbFIvz6TT6+x4=",
    version = "v1.4.0",
)
...
go_repository(
    ...
    sum = "h1:GwBqEsvRIHVfCQVXDHYi9LHec2yEkc3GNKh9WB8G/es=",
    version = "v5.0.85",
)
...
go_repository(
    ...
    sum = "h1:P9lJR5u5PNQQcyL4g7LVDsr6rsqtsPzxzJJfnTBxaKM=",
    version = "v0.0.0-20200707033358-8fb6a0ac9ee5",
)
...
go_repository(
    ...
    sum = "h1:JxpwOnW/RU5vsiwsDw3eqto/7ccehcv162Xma5/FHoI=",
    version = "v0.0.0-20200706234117-b22de6825cf7",
)
