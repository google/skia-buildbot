...
# "bazel build" command right after cleaning the cache with "bazel clean", or when the below
# npm_install rule changes, e.g. by changing an argument. Unfortunately running "npm install" or
# "npm ci" yields errors. lovisolo@ is working on a solution to bring this to a more reasonable
# state.
#
