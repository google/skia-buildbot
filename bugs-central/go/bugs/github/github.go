...
func (gh *Github) Search(ctx context.Context) ([]*types.Issue, *types.IssueCountsData, error) {
...
func (gh *Github) SearchClientAndPersist(ctx context.Context, dbClient *db.FirestoreDB, runId string) error {
