...
func (gh *Github) Search(ctx context.Context, config interface{}) ([]*Issue, *types.IssueCountsData, error) {
...
func (gh *Github) SearchClientAndPersist(ctx context.Context, config interface{}, dbClient *db.FirestoreDB) error {
	...
	// Put in DB.
	if err := dbClient.PutInDB(ctx, client, GithubSource, queryDesc, queryLink, countsData); err != nil {
