...
func (m *Monorail) Search(ctx context.Context, config interface{}) ([]*types.Issue, *types.IssueCountsData, error) {
	...
	for _, mi := range monorailIssues {
		...
		countsData.CalculateSLOViolations(mi.CreatedTime, mi.ModifiedTime, priority)
