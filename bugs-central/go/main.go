...
func New() (baseapp.App, error) {
	...
	// Initialize the different supported issue frameworks.
	...
	cleanup.Repeat(*pollInterval, func(_ context.Context) {
		...
		if err := dbClient.PutInDB(ctx, bugs.AndroidClient, bugs.IssueTrackerSource, "componentid:1346 status:open", "https://b/issues?q=componentid:1346%20status:open", len(issueTrackerIssues)); err != nil {
