...
func New() (baseapp.App, error) {
	...
	cleanup.Repeat(*pollInterval, func(_ context.Context) {
		...
		issueTrackerQueryConfig := bugs.IssueTrackerQueryConfig{QueryName: "c1346_total_open"}
		...
		githubQueryConfig := bugs.GithubQueryConfig{
			// Labels:     []string{"ask: skia"}, // flutter-native
			Labels:     []string{"e: web_canvaskit"}, // flutter-on-web
			Open:       true,
			UnAssigned: true,
		}
		...
		monorailQueryConfig := bugs.MonorailQueryConfig{
			Project: "chromium",
