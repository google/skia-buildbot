...
func (f *firestoreDB) queryDocId(client bugs.RecognizedClient, source bugs.IssueSource, queryShortDesc string, ts time.Time) string {
...
func (f *firestoreDB) queryCol(client bugs.RecognizedClient, source bugs.IssueSource, queryShortDesc string) *firestore_api.CollectionRef {
...
func (f *firestoreDB) GetFromDB(ctx context.Context, client bugs.RecognizedClient, source bugs.IssueSource, queryShortDesc string) (*QueryData, error) {
	mtx.RLock()
	defer mtx.RUnlock()
...
func (f *firestoreDB) PutInDB(ctx context.Context, client bugs.RecognizedClient, source bugs.IssueSource, queryShortDesc, queryLink string, count int) error {
	...
	if existingData != nil && existingData.Count == count {
