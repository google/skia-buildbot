...
func (f *FirestoreDB) PutInDB(ctx context.Context, client types.RecognizedClient, source types.IssueSource, query, queryLink string, countsData *types.IssueCountsData) error {
	if client == "" || source == "" || query == "" {
