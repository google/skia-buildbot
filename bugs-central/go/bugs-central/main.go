...
var (
	...
	// TODO(rmistry): This needs to be much higher (maybe 1 hour)?
	pollInterval = flag.Duration("poll_interval", 15*time.Minute, "How often the server will poll the different issue frameworks.")
)
...
func (srv *Server) getIssueCountsHandler(w http.ResponseWriter, r *http.Request) {
	...
	fmt.Println("RETURNING THIS COUNTS DATA")
	fmt.Printf("\n\n%+v", countsData)
