  ...
  private displayChart(type: string, title: string): TemplateResult {
    ...
    <div class="chart-div">
      ...
      <google-chart
        ...
        data="/_/get_issues_data?client=${this._state.client}&source=${this._state.source}&query=${this._state.query}&type=${type}">
      </google-chart>
    </div>
   `;
  }
      ...
      rowsHTML.push(html`
        <tr>
          ...
          <td>
            ...
            ${clientCounts.p0_slo_count + clientCounts.p0_slo_count > 0
          ? html`<span class="small"> [${clientCounts.p0_slo_count + clientCounts.p0_slo_count}]</span>`
          : ''}
          </td>
          <td>
