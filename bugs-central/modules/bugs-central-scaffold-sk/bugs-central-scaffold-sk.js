...
const template = (ele) => html`
  <nav>
    ...
    <nav-links-sk>
      <a href="/" tab-index=0 ><home-icon-sk></home-icon-sk><span>Skia Bugs Central</span></a>
      <a href="http://go/skia-bugs-central" tab-index=0 ><help-icon-sk></help-icon-sk><span>Help</span></a>
      <a href="https://github.com/google/skia-buildbot/tree/master/bugs-central" tab-index=0 ><folder-icon-sk></folder-icon-sk><span>Code</span></a>
    </nav-links-sk>
