  ...
  <aside>
    <nav class=surface-themes-sk>
      ...
      <a href="/?client=Android" tab-index=0 >
        <home-icon-sk></home-icon-sk><span>Android Client</span>
      </a>
      <a href="/?client=Chromium" tab-index=0 >
        <home-icon-sk></home-icon-sk><span>Chromium Client</span>
      </a>
      <a href="/?client=Flutter-native" tab-index=0 >
        <home-icon-sk></home-icon-sk><span>Flutter-native Client</span>
      </a>
      <a href="/?client=Flutter-on-web" tab-index=0 >
        <home-icon-sk></home-icon-sk><span>Flutter-on-web Client</span>
      </a>
      <a href="/?client=Skia" tab-index=0 >
        <home-icon-sk></home-icon-sk><span>Skia Client</span>
      </a>
