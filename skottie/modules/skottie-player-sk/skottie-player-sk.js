...
<div class=player-loading title="Loading animation  + engine."
...
window.customElements.define('skottie-player-sk', class extends HTMLElement {
  ...
  connectedCallback() {
    render(loadingTemplate(this), this, {eventContext: this});
  }
  ...
  _initializeSkottie(lottieJSON) {
    ...
    if (!this._engine.surface ||
        ...
        this._engine.surface.height != this.config.height) {

      render(runningTemplate(this), this, {eventContext: this});
