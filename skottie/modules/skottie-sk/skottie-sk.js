...
<button on-click=${(e) => ele._jumpBegin(e)}>|&lt;</button>
<button on-click=${(e) => ele._playpause(e)}>Pause</button>
<section class=figures>
  <figure>
    <video id=video on-loadeddata=${(e) => ele._videoLoaded(e)}title=lottie loop src='/_/i/${ele._hash}' width=${ele._state.width} height=${ele._state.height}>
...
//      this._video.currentTime = 0;
  ...
  _render() {
    ...
    // Listen for both loaded events before playing.
    //          video           lottie
    // events  loadeddata      data_ready
    // play    play()          play()
    // stop    pause()         stop()
    // rate    setSpeed(1.0)   playbackRate=1.0
  }
