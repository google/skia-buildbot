 ...
 * <link-icon-sk></link-icon-sk>
 * <check-icon-sk></check-icon-sk>
 * <warning-icon-sk></warning-icon-sk>
 * <create-icon-sk></create-icon-sk>
 * <alarm-icon-sk></alarm-icon-sk>
 *
 */
...
window.customElements.define('arrow-up-icon-sk', class extends IconSk {
  static get _path() { return "M7 14l5-5 5 5z"; }
});

window.customElements.define('arrow-down-icon-sk', class extends IconSk {
  static get _path() { return "M7 10l5 5 5-5z"; }
});
