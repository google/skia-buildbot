...
var SVG_FOLDERS = []string{"action", "av", "communication", "device", "file", "hardware",
	"image", "maps", "navigation", "notification", "places", "social", "toggle"}

var SVG_24PX = regexp.MustCompile("(ic_)?(?P<name>.+)_24px.svg")
var PATH_D = regexp.MustCompile(`<svg .+?>(.+)</svg>`)
...
%s`, d, err)
	...
	// TODO(kjlubick) Generate demo file with all icons, including non-generated ones
