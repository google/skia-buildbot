...
func indexHandler(w http.ResponseWriter, r *http.Request) {
	...
	unownedPendingTasks, ownedPendingTasks, err := GetPendingCompileTasks(false /* runByThisInstance */)
	if err != nil {
...
func main() {
	...
	go func() {
		_, ownedPendingTasks, err := GetPendingCompileTasks(true /* runByThisInstance */)
		if err != nil {
