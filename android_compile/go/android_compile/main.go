...
var (
	...
	// TODO(rmistr): Change this to a port that skia-swarming can access!
...
func getCompileTasks() ([]*CompileTask, error) {
	tasks := []*CompileTask{}
	it := GetPendingTasks()
	for {
		t := &CompileTask{}
...
// TODO(rmistry): This is only tryjob. Need support for no tryjob as well.
