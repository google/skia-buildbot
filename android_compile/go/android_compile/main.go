...
var (
	...
	instanceNum = flag.Int("instance_num", -1, "The number of this android compile server instance. Used for metrics and keeping track of different instances.")
...
func readGSAndTriggerCompileTask(ctx context.Context, g *gsFileLocation) error {
	...
	fmt.Println("DO NOT ACTUALLY TRIGGER ANYTHING!!!!!!!!!!!!!")
...
func triggerCompileTask(ctx context.Context, g *gsFileLocation, task *CompileTask, datastoreKey *datastore.Key) {
	go func() {
		...
		// rmistry: Should also move the available checkouts thing here from RunCompileTask.
