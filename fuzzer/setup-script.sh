...
sudo apt-get update
sudo apt-get install clang-3.8 lldb-3.8 make build-essential libfontconfig1-dev libfreetype6-dev libgif-dev libqt4-dev ninja-build python-dev python-imaging libosmesa6-dev -y
