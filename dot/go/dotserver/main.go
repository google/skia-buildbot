...
func (srv *server) transformHandler(w http.ResponseWriter, r *http.Request) {
	...
	// TODO(jcgregorio) Add filtering for referrers, e.g. only allow domains we
	// control like *.skia.org and skia.googlesource.com.
	//
	// Pass in by ENV variable and/or flag to create a regex to match against any URL.
	//
	// Such as https://regex101.com/r/ZARps6/1/
