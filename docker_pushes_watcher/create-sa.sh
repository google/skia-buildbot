...
SA_NAME="skia-docker-pushes-watcher"

cd /tmp/ramdisk

gcloud --project=${PROJECT_ID} iam service-accounts create "${SA_NAME}" --display-name="Service account for docker_pushes_watcher"
