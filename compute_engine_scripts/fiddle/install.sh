...
/tmp/format_and_mount.sh skia-fiddle3
...
sudo debootstrap --arch=amd64 --components main,restricted,universe,multiverse --include=${PACKAGES// /,} xenial /mnt/pd0/container
