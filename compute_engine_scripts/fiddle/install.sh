...
PACKAGES="git debootstrap build-essential libosmesa6-dev libfreetype6-dev libfontconfig1-dev libpng-dev libgif-dev libqt4-dev mesa-common-dev ffmpeg libglu1-mesa clinfo nvidia-driver nvidia-cuda-dev"
sudo apt-get update
