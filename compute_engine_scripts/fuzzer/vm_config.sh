...
FUZZER_SCOPES='https://www.googleapis.com/auth/devstorage.read_write,https://www.googleapis.com/auth/logging.write'
...
FUZZER_BE_IP_ADDRESSES=(104.154.112.171 104.154.112.172 104.154.112.173)
FUZZER_BE_INSTANCE_NAMES=(${VM_NAME_BASE}-fuzzer-be-1 ${VM_NAME_BASE}-fuzzer-be-2 ${VM_NAME_BASE}-fuzzer-be-3])
