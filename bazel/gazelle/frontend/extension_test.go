...
`,
		...
		{Path: "c/delta.scss"},
		{Path: "c/delta.ts"},
		{Path: "c/index.ts"},        // Empty file which may be imported as its parent folder's "main" module.
		{Path: "d_sass_lib/d.scss"}, // Will produce a sass_library with the same as its parent folder ("d_sass_lib").
		{Path: "d_ts_lib/d.ts"},     // Will produce a ts_library with the same as its parent folder ("d_ts_lib").
...
nodejs_test(
    ...
    deps = [
        ":alfa_ts_lib",
        "@infra-sk_npm//common-sk",  # Not imported from alfa_nodejs_test.ts. Gazelle should remove this dep.
...
sk_element(
    ...
    sk_element_deps = [
        "//myapp/modules/foxtrot-sk",  # Not imported from echo-sk.{scss,ts}. Gazelle should remove this dep.
        "//myapp/modules/golf-sk",
    ],
    ts_deps = [
        "@infra-sk_npm//common-sk",  # Not imported from echo-sk.ts. Gazelle should remove this dep.
        "@infra-sk_npm//elements-sk",
    ],
    ts_srcs = ["echo-sk.ts"],
    visibility = ["//visibility:public"],
...
sk_page(
    ...
    sk_element_deps = [
        ":echo-sk",
        "//myapp/modules/foxtrot-sk",  # Not imported from echo-sk-demo.{scss,ts}. Gazelle should remove this dep.
        "//myapp/modules/golf-sk",
    ],
    ts_deps = [
        "@infra-sk_npm//common-sk",  # Not imported from echo-sk-demo.ts. Gazelle should remove this dep.
        "@infra-sk_npm//elements-sk",
    ],
...
sk_element_puppeteer_test(
    ...
    deps = [
        ":echo-sk",
        "//myapp/modules/foxtrot-sk",  # Not imported from echo-sk_puppeteer_test.ts. Gazelle should remove this dep.
        "//myapp/modules/golf-sk",
        "@infra-sk_npm//common-sk",  # Not imported from echo-sk_puppeteer_test.ts. Gazelle should remove this dep.
        "@infra-sk_npm//elements-sk",
    ],
)
...
karma_test(
    ...
    deps = [
        ":echo-sk",
        "//myapp/modules/foxtrot-sk",  # Not imported from echo-sk_test.ts. Gazelle should remove this dep.
        "//myapp/modules/golf-sk",
        "@infra-sk_npm//common-sk",  # Not imported from echo-sk_test.ts. Gazelle should remove this dep.
        "@infra-sk_npm//elements-sk",
    ],
)
...
sk_element(
    name = "charlie-sk",
    sass_srcs = ["charlie-sk.scss"],  # This file does not exist anymore. Gazelle should remove it from sass_srcs.
    ts_srcs = [
        "charlie-sk.ts",
        "index.ts",  # This file does not exist anymore. Gazelle should remove it from ts_srcs.
    ],
    visibility = ["//visibility:public"],
)
...
sk_page(
    ...
    scss_entry_point = "charlie-sk-demo.scss",  # This file does not exist anymore. Gazelle should remove the scss_entry_point argument.
