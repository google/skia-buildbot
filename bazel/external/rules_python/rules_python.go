...
func FindPython3() (string, error) {
	...
	if runtime.GOOS == "linux" {
		...
		// @python3_11//:defs.bzl, e.g.:
		//
		//     $ cat $(bazel info output_base)/external/python3_11/defs.bzl
		//     # Generated by python/repositories.bzl
		//     host_platform = "x86_64-unknown-linux-gnu"
		//     interpreter = "@python3_11_x86_64-unknown-linux-gnu//:bin/python3"
		return filepath.Join(bazel.RunfilesDir(), "external", "rules_python~~python~python_3_11_x86_64-unknown-linux-gnu", "bin", "python3"), nil
	}
