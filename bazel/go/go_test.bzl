...
def go_test(name, srcs, tags = [], **kwargs):
    ...
    Example:
        ...
        go_test(
            name = "frobinator_test",
            srcs = [
                "frobinator_test.go",
                "frobinator_manual_test.go",
            ],
            ...
        )
        ...
        go_test(
            name = "frobinator_test",
            srcs = ["frobinator_test.go"],
            ... # Any other passed in arguments will be added to both go_test targets.
        )

        go_test(
            name = "frobinator_manual_test",
            srcs = ["frobinator_manual_test.go"],
            tags = ["manual"],
            ... # Any other passed in arguments will be added to both go_test targets.
        )
