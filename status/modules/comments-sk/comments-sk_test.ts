import './index';
import { CommentData, CommentsSk } from './comments-sk';

import { eventPromise, setUpElementUnderTest } from '../../../infra-sk/modules/test_util';
import { expect } from 'chai';
import { addCommentResponse0, taskspecComments } from './test_data';
import { $, $$ } from 'common-sk/modules/dom';
import { MockStatusService, SetupMocks } from '../rpc-mock';
import { AddCommentRequest } from '../rpc/status';
...
describe('comments-sk', () => {
  ...
  describe('comments-sk', () => {
    ...
    it('adds comments', async () => {
      ...
      element.showFlaky = true;
      element.allowAdd = true;
      clientMock.expectAddComment(addCommentResponse0, (req) => {
    ...
    it('deletes comments', async () => {
      element.allowDelete = true;
      clientMock.expectDeleteComment(addCommentResponse0, (req) => {
        expect(req).to.deep.equal({
