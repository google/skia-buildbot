...
export const taskspecComments = (() => {
  ...
  ret[0].timestamp = new Date('9/22/2020, 10:21:52 AM').toISOString();
  ret[0].flaky = true;
  ret.push(JSON.parse(JSON.stringify(commentTaskSpec)));
  ret[1].message = "Rewrite of widget's thingamabob in cl/123.";
  ret[1].user = 'bob@google.com';
  ret[1].timestamp = new Date('9/23/2020, 02:21:52 PM').toISOString();
  ret[1].ignoreFailure = true;
  return ret;
})();

export const addCommentResponse0: AddCommentResponse = {};
