...
import { StatusExperimentalSk } from './status-experimental-sk';
...
describe('status-experimental-sk', () => {
  const newInstance = setUpElementUnderTest<StatusExperimentalSk>('status-experimental-sk');

  let element: StatusExperimentalSk;
  beforeEach(async () => {
    SetTestSettings({
