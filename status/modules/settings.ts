...
// commitUrlTemplate: Returns the base url for a repo's commits. Can be
// concatenated with a commit hash to form a valid url.
export function commitUrlTemplate(repo: string) {
