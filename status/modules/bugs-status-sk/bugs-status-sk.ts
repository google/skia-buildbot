...
import { StatusResponse } from '../../../bugsen/modules/rpc_types';

const bugsUrl = 'https://bugs.skia.org';
...
export class GoldStatusSk extends ElementSk {
  ...
  private refresh() {
    fetch(`${bugsUrl}/json/v1/trstatus`, { method: 'GET' })
      .then(jsonOrThrow)
...
define('bugs-status-sk', GoldStatusSk);
