...
const task1: Task = { commits: ['parentofabc123'], id: '11111', name: 'Test-Some-Stuff', revision: 'parentofabc123', status: 'FAILURE', swarmingTaskId: 'swarmy' };
const task2: Task = { commits: ['acommitthatisnotlisted'], id: '77777', name: 'Upload-Some-Stuff', revision: 'acommitthatisnotlisted', status: 'SUCCESS', swarmingTaskId: 'swarmy' };
const multicommitTask: Task = { commits: ['abc123', 'parentofabc123'], id: '99999', name: 'Build-Some-Stuff', revision: 'abc123', status: 'FAILURE', swarmingTaskId: 'swarmy' };
...
const commit1: LongCommit = { hash: 'parentofabc123', author: 'bob@example.com', parents: ['grandparentofabc123'], subject: '2nd from HEAD', body: 'the commit that comes before the most recent commit', timestamp: '34613288' };
const branchCommit0: LongCommit = { hash: '456789', author: 'bob@example.com', parents: ['10111213'], subject: 'branch commit', body: 'commit on differnet branch', timestamp: '34613388' };
...
export const responseTasksToFilter = (() => {
  ...
  const tasks = [
    ...
    { name: 'Only-Failed-On-Commented-Commit-Spec', status: 'FAILURE', commits: ['parentofabc123'] },
  ];
  let i = 0;
  ...
  r.update!.comments!.push(Object.assign(
    copy(commentTaskSpec), { ignoreFailure: false, taskSpecName: 'Always-Red-Spec' }));
  return r;
})();