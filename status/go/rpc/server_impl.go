...
//go:generate protoc --proto_path=.:../../.. --twirp_typescript_out=../../modules/rpc statusFe.proto
//go:generate ../../node_modules/typescript-formatter/bin/tsfm -r ../../modules/rpc/status.ts ../../modules/rpc/twirp.ts
