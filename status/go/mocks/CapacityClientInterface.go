...
// CapacityClientInterface is an autogenerated mock type for the CapacityClientInterface type
type CapacityClientInterface struct {
	mock.Mock
}

// CapacityMetrics provides a mock function with given fields:
func (_m *CapacityClientInterface) CapacityMetrics() map[string]capacity.BotConfig {
	ret := _m.Called()
...
func (_m *CapacityClientInterface) QueryAll(ctx context.Context) error {
	ret := _m.Called(ctx)
...
func (_m *CapacityClientInterface) StartLoading(ctx context.Context, interval time.Duration) {
