...
// UpdateLoop provides a mock function with given fields: frequency, ctx
func (_m *IncrementalCache) UpdateLoop(frequency time.Duration, ctx context.Context) {
	_m.Called(frequency, ctx)
}
