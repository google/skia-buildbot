...
// flags
var (
	// TODO(borenet): Combine bigtableInstance, firestoreInstance, and
	// pubsubTopicSet.
...
func main() {
	...
	tasksPerCommit, err = newTasksPerCommitCache(ctx, *workdir, *recipesCfgFile, repos, 14*24*time.Hour, *bigtableInstance, ts)
	if err != nil {
