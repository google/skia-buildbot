// merge_envoy takes two Envoy config files, adds all the Virtual Hosts
// and Clusters from the second file to the first file and then serializes
// the results of the merge as JSON to stdout.
package main
