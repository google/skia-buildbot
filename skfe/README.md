...
will remain in this directory is /k8s/ and `build_nginx_redirect_release`, which
runs an instance of nginx in skia-public that just handles rewrite/redirect
rules.
