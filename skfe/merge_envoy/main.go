...
func main() {
	...
	file1.StaticResources.Listeners[0].FilterChains.Filters = append(file1.StaticResources.Listeners[0].FilterChains.Filters,
		file2.StaticResources.Listeners[0].FilterChains.Filters...)
