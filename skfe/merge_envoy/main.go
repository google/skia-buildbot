...
func main() {
	...
	file1.StaticResources.Listeners[0].FilterChains.Filters[0].Config.RouteConfig.VirtualHosts = append(file1.StaticResources.Listeners[0].FilterChains.Filters[0].Config.RouteConfig.VirtualHosts,
