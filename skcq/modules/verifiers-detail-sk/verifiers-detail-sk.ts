...
import {
  GetChangeAttemptsRequest, GetChangeAttemptsResponse, ChangeAttempts, ChangeAttempt,
} from '../json';
...
export class VerifiersDetailSk extends ElementSk {
  ...
  ${el.displayNotFoundMsg(el.noData)}
`;
  ...
  private displayNotFoundMsg(hidden: boolean): TemplateResult {
    if (hidden) {
