...
import {
  GetCurrentChangesRequest,
  GetCurrentChangesResponse,
...
export class ProcessingTableSk extends ElementSk {
  ...
  private fetchTasks() {
    ...
    doImpl<GetCurrentChangesRequest, GetCurrentChangesResponse>(
      '/_/get_current_changes',
      detail,
      (json: GetCurrentChangesResponse) => {
