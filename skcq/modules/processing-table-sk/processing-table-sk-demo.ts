...
customElements.whenDefined('processing-table-sk').then(() => {
  ...
  dryRunPage.setAttribute('is_dry_run', 'true');

  const cqRunPage = document.createElement('processing-table-sk');
  cqRunPage.setAttribute('is_dry_run', 'false');
