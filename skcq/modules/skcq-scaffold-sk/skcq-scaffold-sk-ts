...
export class SkCQScaffoldSk extends ElementSk {
  private _main: HTMLElement | null = null;

  constructor() {
    super(SkCQScaffoldSk.template);
  }

  private static template = (el: SkCQScaffoldSk) => html`
  <app-sk>
  ...
  <aside>
    <nav class=surface-themes-sk>
      ...
      <a href="http://go/skia-skcq" target="_blank" tab-index=0>
...
define('skcq-scaffold-sk', SkCQScaffoldSk);
