...
func (_m *CodeReview) AddComment(ctx context.Context, ci *gerrit.ChangeInfo, comment string, notify gerrit.NotifyOption) {
	_m.Called(ctx, ci, comment, notify)
}
...
// GetCommitMessage provides a mock function with given fields: ctx, ci
func (_m *CodeReview) GetCommitMessage(ctx context.Context, ci *gerrit.ChangeInfo) (string, error) {
...
// GetDetails provides a mock function with given fields: cl
func (_m *CodeReview) GetDetails(cl int) string {
	ret := _m.Called(cl)
