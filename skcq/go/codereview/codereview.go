...
type CodeReview interface {
	...
	AddComment(ctx context.Context, ci *gerrit.ChangeInfo, comment string)
...
func (gc *gerritCodeReview) AddComment(ctx context.Context, ci *gerrit.ChangeInfo, comment string) {
	if err := gc.gerritClient.SetReviewWithOptions(ctx, ci, comment, map[string]int{}, []string{}, "NONE", "autogenerated:skcq", 0); err != nil {
