...
func TestRemoveFromCQ(t *testing.T) {
	...
	g.On("SetReview", testutils.AnyContext, ci, reason, map[string]int{}, []string{}, gerrit.NotifyOwner, mock.Anything, AutogeneratedCommentTag, 0, mock.Anything).Return(nil).Once()
