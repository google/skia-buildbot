...
func AddToChangesCache(ctx context.Context, changeEquivalentPatchset, changeSubject, changeOwner, repo, branch string, dbClient *db.FirestoreDB, dryRun, internal bool, changeID, patchsetID int64) int64 {
