...
func setup(t *testing.T, treeMsg, treeState string) *TreeStatusVerifier {
...
func TestVerify_ClosedTree(t *testing.T) {
	...
	treeVerifier := setup(t, "Tree is closed", tree_status_types.ClosedState)
...
func TestVerify_CautionTree(t *testing.T) {
	ci := &gerrit.ChangeInfo{Issue: int64(123)}
	treeVerifier := setup(t, "Tree is caution", tree_status_types.CautionState)
...
func TestVerify_OpenTree(t *testing.T) {
	ci := &gerrit.ChangeInfo{Issue: int64(123)}
	treeVerifier := setup(t, "Tree is open", tree_status_types.OpenState)
