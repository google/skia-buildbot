...
type Verifier interface {
	...
	// when a change is removed from the CQ.
...
func GetVerifiers(ctx context.Context, httpClient *http.Client, cfg *config.SkCQCfg, cr codereview.CodeReview, ci *gerrit.ChangeInfo, isSubmittedTogetherChange bool, gitilesRepo *gitiles.Repo, configReader *config.GitilesConfigReader) ([]Verifier, error) {
