...
func TestGetVerifier(t *testing.T) {
	// httpClient
	//cfg
	//cr will need to mock this out
	// ci
	// isSubmittedTogetherChange
	// configReader what do I do about this??

	// How to test-
	// send in dry run, cq and then cq + submittedTogetherChagne
	// assert everything you get is in the order you expect.
