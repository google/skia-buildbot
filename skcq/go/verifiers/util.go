...
// GetAllowedVoters is a utility function that looks through the labels on a
// gerrit change to gather the email addresses of voters who voted the
// specified labelValue and who are in the allowedCRIA group.
