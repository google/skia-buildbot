...
func (cv *CQAccessListVerifier) Verify(ci *gerrit.ChangeInfo) (state VerifierState, reason string, err error) {
...
func (cv *CQAccessListVerifier) Cleanup(ci *gerrit.ChangeInfo) {
	return
}
