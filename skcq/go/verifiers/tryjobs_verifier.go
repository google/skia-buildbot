...
func (tv *TryJobsVerifier) Cleanup(ctx context.Context, ci *gerrit.ChangeInfo, patchSetID int64) {

	// Find all bots TRIGGERD ONLY BY SkCQ (using a tag).
	// We only want to cleanup here if there is a newer CODE_CHANGE patchset.

	// Look at the NonTrivial patchsets, this patchset should be different!
