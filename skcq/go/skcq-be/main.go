...
func main() {
	...
	ts, err := auth.NewDefaultTokenSource(*baseapp.Local, auth.SCOPE_USERINFO_EMAIL, auth.SCOPE_GERRIT, auth.SCOPE_READ_WRITE, datastore.ScopeDatastore, compute.CloudPlatformScope)
	if err != nil {
