...
var (
	...
	// TODO(rmistry): When all Skia repositories use SkCQ remove this flag.
...
func main() {
	...
	g, err := codereview.NewGerrit(httpClient, gerrit.ConfigSkia, gerrit.GerritSkiaURL, *supportedReposAllowlist)
	if err != nil {
