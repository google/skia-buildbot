...
func (f *FirestoreDB) GetCurrentChanges(ctx context.Context) (*CurrentChangesSnapshot, error) {
	...
	docRef := f.client.Doc("CurrentChangesSnapshot")
	if docRef == nil {
...
func (f *FirestoreDB) PutCurrentChanges(ctx context.Context, data []byte) error {
	...
	if _, setErr := f.client.Set(ctx, f.client.Doc("CurrentChangesSnapshot"), currentChanges, defaultAttempts, putSingleTimeout); setErr != nil {
