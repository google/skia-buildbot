...
type CurrentChangesCache interface {
	...
	// Add creates an entry in the changes cache if it does not already exist.
	// It returns the cqStartTime of this attempt and a boolean indicating whether this is a
	// new CQ attempt.
	Add(ctx context.Context, changeEquivalentPatchset, changeSubject, changeOwner, repo, branch string, dryRun, internal bool, changeID, equivalentPatchsetID int64) (int64, bool, error)
