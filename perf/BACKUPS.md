...
- `perf-tool database restore alerts --config=$config --in=alerts.dat`
- `perf-tool database restore regressions --config=$config --in=regressions.dat`
- `perf-tool database restore shortcuts --config=$config --in=regressions.dat`
