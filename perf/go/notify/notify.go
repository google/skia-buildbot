...
type Email interface {
	Send(from string, to []string, subject string, body string, threadId string) (string, error)
}
...
func (n NoEmail) Send(from string, to []string, subject string, body string, threadId string) (string, error) {
	sklog.Infof("Not sending email: From: %q To: %q Subject: %q Body: %q ThreadId: %q", from, to, subject, body, threadId)
	return "", nil
}
