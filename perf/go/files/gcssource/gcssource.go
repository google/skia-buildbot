...
// receiveSingleEvent does all the work of receiving the event and return true
// if the message should be ack'd, or false if it should be nack'd.
...
func (s *GCSSource) Start() (<-chan files.File, error) {
	if s.started {
