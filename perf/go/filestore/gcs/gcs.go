...
func (f *filesystem) parseNameIntoBucketAndPath(name string) (string, string, error) {
...
// Stat implements fs.File, but we don't need to actually implement it as that
...
func (f *filesystem) Open(name string) (fs.File, error) {
	bucket, path, err := f.parseNameIntoBucketAndPath(name)
	if err != nil {
