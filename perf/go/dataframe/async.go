...
// NewProcess starts processing a FrameRequest.
func NewProcess(ctx context.Context, req *FrameRequest, perfGit *perfgit.Git, dfBuilder DataFrameBuilder, shortcutStore shortcut.Store) {
	numKeys := 0
	if req.Keys != "" {
		numKeys = 1
	}
