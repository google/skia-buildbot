...
type DataFrameBuilder interface {
	...
	NewNFromQuery(progress types.Progress, n int, end time.Time) (*DataFrame, error)
...
// See DataFrameBuilder.
func (p *ptracestoreDataFrameBuilder) NewNFromQuery(progress types.Progress, n int, end time.Time) (*DataFrame, error) {
