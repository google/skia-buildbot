...
func TestStepFit_Absolute_NoStep(t *testing.T) {
	unittest.SmallTest(t)
	assert.Equal(t,
		&StepFit{TurningPoint: 2, StepSize: 0, Status: UNINTERESTING, Regression: 0, LeastSquares: -1},
...
func TestStepFit_Absolute_StepExactMatch(t *testing.T) {
	unittest.SmallTest(t)
	assert.Equal(t,
		&StepFit{TurningPoint: 2, StepSize: -1, Status: HIGH, Regression: -1, LeastSquares: -1},
...
func TestStepFit_Absolute_StepTooSmall(t *testing.T) {
	unittest.SmallTest(t)
	assert.Equal(t,
		&StepFit{TurningPoint: 2, StepSize: -0.5, Status: UNINTERESTING, Regression: -0.5, LeastSquares: -1},
...
func TestStepFit_Percent_StepExactMatch(t *testing.T) {
	unittest.SmallTest(t)
	assert.Equal(t,
		&StepFit{TurningPoint: 1, StepSize: -1, Status: HIGH, Regression: -1, LeastSquares: -1},
...
func TestStepFit_Percent_StepTooSmall(t *testing.T) {
	unittest.SmallTest(t)
	assert.Equal(t,
		&StepFit{TurningPoint: 1, StepSize: -0.5, Status: UNINTERESTING, Regression: -0.5, LeastSquares: -1},
...
func TestStepFit_Cohen_NoStep(t *testing.T) {
	unittest.SmallTest(t)
	assert.Equal(t,
		&StepFit{TurningPoint: 3, StepSize: -0.1999998, Status: UNINTERESTING, Regression: -0.1999998, LeastSquares: -1},
...
func TestStepFit_Cohen_Step(t *testing.T) {
	unittest.SmallTest(t)
	assert.Equal(t,
		&StepFit{TurningPoint: 3, StepSize: -0.1999998, Status: HIGH, Regression: -0.1999998, LeastSquares: -1},
...
func TestStepFit_Cohen_StepWithZeroStandardDeviation(t *testing.T) {
	unittest.SmallTest(t)
	assert.Equal(t,
		&StepFit{TurningPoint: 2, StepSize: -10, Status: HIGH, Regression: -10, LeastSquares: -1},
...
func TestStepFit_Cohen_StepWithLargeStandardDeviation(t *testing.T) {
	unittest.SmallTest(t)
	assert.Equal(t,
		&StepFit{LeastSquares: -1, TurningPoint: 2, StepSize: -2.828427, Regression: -2.828427, Status: "High"},
