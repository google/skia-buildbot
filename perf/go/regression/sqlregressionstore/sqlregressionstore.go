...
func (s *SQLRegressionStore) Range(ctx context.Context, begin int64, end int64) (map[string]*regression.AllRegressionsForCommit, error) {
...
func (s *SQLRegressionStore) Write(ctx context.Context, regressions map[string]*regression.AllRegressionsForCommit, lookup regression.DetailLookup) error {
	panic("not implemented") // TODO: Implement
}
