...
var ErrNoClusterForQuery = errors.New("No Cluster.")
...
// Untriaged returns true if there are any untriaged clusters.
func (r *Regressions) Untriaged() bool {
	ret := false
