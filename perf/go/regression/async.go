...
// TODO Also move this to regression since it handles a ClusterRequest which has non-cluster specific
// info in it.
...
func (p *ClusterRequestProcess) Run(ctx context.Context) {
	...
	if err := clustering2.ShortcutFromKeys(summary); err != nil {
