...
func TestCloseOnCancel(t *testing.T) {
	...
	// Start the querying.
	out := ParamIndex(ctx, b.getTable(), tileKey, key, value)
...
func TestParamIndex(t *testing.T) {
	...
	// Start the query.
	out := ParamIndex(context.Background(), b.getTable(), tileKey, key, value)
	...
	out = ParamIndex(context.Background(), b.getTable(), tileKey, "unknown", "unknown")
