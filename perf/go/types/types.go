...
type TraceStore interface {
	...
	// GetSource returns the full URL of the file that contained the point at 'index' of trace 'traceId'.
	...
	// QueryTracesByIndex returns a map of trace keys to a slice of floats for all
	...
	// Returns the TileNumber that the commit is stored in.
