...
import (
	...
	culpritprotov1 "go.skia.org/infra/perf/go/culprit/proto/v1"
...
func (_m *CulpritNotifier) NotifyAnomaliesFound(ctx context.Context, anomalyGroup *v1.AnomalyGroup, subscription *protov1.Subscription, anomalyList []*culpritprotov1.Anomaly) (string, error) {
	...
	var r0 string
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *v1.AnomalyGroup, *protov1.Subscription, []*culpritprotov1.Anomaly) (string, error)); ok {
		return rf(ctx, anomalyGroup, subscription, anomalyList)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *v1.AnomalyGroup, *protov1.Subscription, []*culpritprotov1.Anomaly) string); ok {
		r0 = rf(ctx, anomalyGroup, subscription, anomalyList)
	} else {
		r0 = ret.Get(0).(string)
	}

	if rf, ok := ret.Get(1).(func(context.Context, *v1.AnomalyGroup, *protov1.Subscription, []*culpritprotov1.Anomaly) error); ok {
...
func (_m *CulpritNotifier) NotifyCulpritFound(ctx context.Context, culprit *culpritprotov1.Culprit, subscription *protov1.Subscription) (string, error) {
	...
	var r0 string
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *culpritprotov1.Culprit, *protov1.Subscription) (string, error)); ok {
		return rf(ctx, culprit, subscription)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *culpritprotov1.Culprit, *protov1.Subscription) string); ok {
		r0 = rf(ctx, culprit, subscription)
	} else {
		r0 = ret.Get(0).(string)
	}

	if rf, ok := ret.Get(1).(func(context.Context, *culpritprotov1.Culprit, *protov1.Subscription) error); ok {
