...
var subTests = map[string]subTestFunction{
	...
	"testCommitNumbersWhenFileChangesInCommitNumberRange_RangeIsExclusiveOfBegin":     testCommitNumbersWhenFileChangesInCommitNumberRange_RangeIsExclusiveOfBegin,
	...
	"testCommitNumbersWhenFileChangesInCommitNumberRange_NoResultsWhenBeginEqualsEnd": testCommitNumbersWhenFileChangesInCommitNumberRange_NoResultsWhenBeginEqualsEnd,
}
...
func testCommitNumbersWhenFileChangesInCommitNumberRange_Success(t *testing.T, ctx context.Context, g *Git, gb *testutils.GitBuilder, hashes []string, cleanup gittest.CleanupFunc) {
	...
	commits, err := g.CommitNumbersWhenFileChangesInCommitNumberRange(ctx, types.CommitNumber(0), types.CommitNumber(7), "bar.txt")
	require.NoError(t, err)
...
func testCommitNumbersWhenFileChangesInCommitNumberRange_EmptySliceIfFileDoesntExist(t *testing.T, ctx context.Context, g *Git, gb *testutils.GitBuilder, hashes []string, cleanup gittest.CleanupFunc) {
	...
	commits, err := g.CommitNumbersWhenFileChangesInCommitNumberRange(ctx, types.CommitNumber(0), types.CommitNumber(7), "this-file-doesnt-exist.txt")
	require.NoError(t, err)
	assert.Equal(t, []types.CommitNumber{}, commits)
}

func testCommitNumbersWhenFileChangesInCommitNumberRange_RangeIsExclusiveOfBegin(t *testing.T, ctx context.Context, g *Git, gb *testutils.GitBuilder, hashes []string, cleanup gittest.CleanupFunc) {
	unittest.LargeTest(t)
	defer cleanup()
...
func testCommitNumbersWhenFileChangesInCommitNumberRange_NoResultsWhenBeginEqualsEnd(t *testing.T, ctx context.Context, g *Git, gb *testutils.GitBuilder, hashes []string, cleanup gittest.CleanupFunc) {
	unittest.LargeTest(t)
	defer cleanup()
