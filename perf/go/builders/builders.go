...
// migrations applied.
func newCockroachDBFromConfig(ctx context.Context, instanceConfig *config.InstanceConfig) (*pgx.Conn, error) {
	...
	return pgx.Connect(ctx, instanceConfig.DataStoreConfig.ConnectionString)
}
