...
// NewSQLite3DBForTests opens an existing, or creates a new, sqlite3 database with all migrations
// applied.
...
// newCockroachDBForTests opens an existing CockroachDB database with all
// migrations applied.
