...
type PTraceStore interface {
	...
	Match(commitIDs []*cid.CommitID, matches KeyMatches, progress Progress) (types.TraceSet, error)
}
...
func (b *BoltTraceStore) Match(commitIDs []*cid.CommitID, matches KeyMatches, progress Progress) (types.TraceSet, error) {
	ret := types.TraceSet{}
