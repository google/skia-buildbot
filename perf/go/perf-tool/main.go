...
const (
	...
	connectionStringFlag = "connection_string"
	localFlag            = "local"
	outputFilenameFlag   = "out"
)
...
func main() {
	...
	cliApp := &cli.App{
		...
		Before: func(c *cli.Context) error {
			return app.Init(c.String(configFilenameFlag), c.Bool(localFlag))
		},
		Commands: []*cli.Command{
				...
				Subcommands: []*cli.Command{
					{
						...
						Action: func(c *cli.Context) error {
							return app.ConfigCreatePubSubTopicsAction()
						},
					},
				},
			},
			{
				Name: "database",
				Before: func(c *cli.Context) error {
					app.OverrideConnectionString(c.String(connectionStringFlag))
					return nil
				},
						...
						Subcommands: []*cli.Command{
							{
								Name: "alerts",
								Action: func(c *cli.Context) error {
									return app.DatabaseDatabaseBackupAlertsSubAction(c.String(outputFilenameFlag))
								},
							},
						},
					},
