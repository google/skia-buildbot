						...
						Subcommands: []*cli.Command{
							{
								...
								Action: func(c *cli.Context) error {
									...
									return app.DatabaseDatabaseBackupAlerts(c.Bool(localFlagName), instanceConfig, c.String(outputFilenameFlagName))
								},
							},
							{
								Name: "shortcuts",
								...
								Action: func(c *cli.Context) error {
									...
									return app.DatabaseDatabaseBackupShortcuts(c.Bool(localFlagName), instanceConfig, c.String(outputFilenameFlagName))
								},
							},
							{
								Name: "regressions",
...
using the same input file for both restores.
								...
								Action: func(c *cli.Context) error {
									...
									return app.DatabaseDatabaseBackupRegressions(c.Bool(localFlagName), instanceConfig, c.String(outputFilenameFlagName), c.String(backupToDateFlagName))
								},
							},
						},
					},
