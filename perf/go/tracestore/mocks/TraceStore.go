...
func (_m *TraceStore) GetLastNSources(ctx context.Context, traceID string, n int) ([]tracestore.SourceAndCommitNumber, error) {
	ret := _m.Called(ctx, traceID, n)

	var r0 []tracestore.SourceAndCommitNumber
	if rf, ok := ret.Get(0).(func(context.Context, string, int) []tracestore.SourceAndCommitNumber); ok {
		r0 = rf(ctx, traceID, n)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]tracestore.SourceAndCommitNumber)
		}
	}
