...
// SourceAndCommitNumber is returned from GetLastNSources.
type SourceAndCommitNumber struct {
	// Source is the filename of the file that was ingested.
	Source string
...
type TraceStore interface {
	...
	// to the given trace.
	GetLastNSources(ctx context.Context, traceID string, n int) ([]SourceAndCommitNumber, error)
