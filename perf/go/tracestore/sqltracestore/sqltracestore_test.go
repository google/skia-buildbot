...
func Test_traceIDForSQLFromTraceName_Success(t *testing.T) {
	...
	*/
	assert.Equal(t, traceIDForSQL([]byte{0xfe, 0x38, 0x5b, 0x15, 0x9f, 0xf5, 0x5d, 0xca, 0x48, 0x10, 0x69, 0x80, 0x5e, 0x5f, 0xf0, 0x50}), traceIDForSQLFromTraceName(",arch=x86,config=8888,"))
}
