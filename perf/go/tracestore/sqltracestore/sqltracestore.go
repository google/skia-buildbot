...
func (s *SQLTraceStore) updatePostings(p paramtools.Params, tileNumber types.TileNumber, traceID int64) error {
	...
	// The ingester may have just restarted, so we also check the database and
	// see if postings have been written use that to update
	// postingsWrittenCache.
	var count int
