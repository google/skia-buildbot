...
func (s *SQLTraceStore) updateParamSetMetricsForTile(ctx context.Context, tileNumber types.TileNumber) {
	...
	metrics2.GetInt64Metric("perfserver_sqltracestore_ordered_paramset_cache_len", map[string]string{"tileNumber": fmt.Sprintf("%d", tileNumber)}).Update(int64(ops.ParamSet.Size()))
}
