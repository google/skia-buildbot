...
// NotNil is a utitlity that allows specify which structs shoud have
// go2ts:"ignorenil" applied.
type NotNil struct {
...
func main() {
	...
	err := generator.AddMultiple(generator,
		NotNil{}, // Goes first to ensure the ignorenil version of structs are seen first.
		alerts.Alert{},
		alerts.AlertsStatus{},
