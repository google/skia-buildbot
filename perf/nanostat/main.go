...
var (
	flagAlpha = flag.Float64("alpha", 0.05, "Consider a change significant if p < α.")
	...
	flagTest  = flag.String("test", string(samplestats.UTest), "The type of test to do, 'utest' for Mann-Whitney U test, and 'ttest' for a Two Sample Welch T test.")
)
