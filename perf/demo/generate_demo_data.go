// Generates dummy data to go along with the dummy repo at https://github.com/skia-dev/perf-demo-repo.
package main
...
func main() {
	hashes := []string{
		"4a1c193118d1600603150e515682a8d57605109d",
	...
	for i, hash := range hashes {
			...
			Results: []format.Result{
				format.Result{
					...
					Measurements: map[string][]format.SingleMeasurement{
						"ns": []format.SingleMeasurement{
							format.SingleMeasurement{
								Value:       "min",
						...
						"alloc": []format.SingleMeasurement{
							format.SingleMeasurement{
								Value:       "kb",
								Measurement: 120,
							},
		...
		ioutil.WriteFile(fmt.Sprintf("./data/demo_data_commit_%d.json", i), b, 0644)
	}
}
