...
cbt --instance production createtable perf-android-x families=V:maxversions=1,S:maxversions=1,D:maxversions=1,H:maxversions=1,I:maxversions=1
cbt --instance production createtable perf-android-x2 families=V:maxversions=1,S:maxversions=1,D:maxversions=1,H:maxversions=1,I:maxversions=1
cbt --instance production createtable perf-flutter families=V:maxversions=1,S:maxversions=1,D:maxversions=1,H:maxversions=1,I:maxversions=1
