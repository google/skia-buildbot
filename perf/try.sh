...
# Medium regression at 50654
perf-tool traces export --config_filename=./configs/cdb-nano.json --connection_string=postgresql://root@localhost:26257/skia?sslmode=disable --begin=50653 --end=50654 --filename=$HOME/regression-traces.json --query='sub_result=min_ms&source_type=skp'
