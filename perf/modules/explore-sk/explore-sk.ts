...
class State {
  ...
  noDots: boolean = false; // Whether to show dots when plotting traces.
...
export class ExploreSk extends ElementSk {
  ...
  private startStateReflector() {
    this._stateHasChanged = stateReflector(
      ...
      (hintableState) => {
        ...
        this._render();
        this.plot!.nodots = this.state.noDots;
  ...
  private toggleDotsHandler() {
    this.state.noDots = !this.state.noDots;
    this._stateHasChanged();
    this.plot!.nodots = this.state.noDots;
  }
