...
define('explore-sk', class extends ElementSk {
  ...
  _rangeChange(e) {
    ...
    // Need to keep a copy of state when query dialog is shown so we can
    // determine if range really changed, in which case we need to re-load all
    // data.

    // Also, don't do this based on event, do it on _add or _addFormula.
