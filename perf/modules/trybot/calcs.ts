...
export interface KeyValueAverageStdDevRatio {
    keyValue: string;
...
export function byParams(res: TryBotResponse): KeyValueAverageStdDevRatio[] {
  ...
  const ret: KeyValueAverageStdDevRatio[] = [];
  ...
  ret.sort((a: KeyValueAverageStdDevRatio, b: KeyValueAverageStdDevRatio) => b.aveStdDevRatio - a.aveStdDevRatio);
