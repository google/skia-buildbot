...
class DomainPickerSk extends ElementSk {
  ...
  _isInvalid() {
    if (
      this._state.request_type === RANGE &&
      this._state.end < this._state.begin
    ) {
      return true;
    }
    return false;
