...
const template = (ele) => html`
  ...
  <dialog-sk>
    <commit-detail-panel-sk @commit-selected='${ele._panelSelect}' .details='${ele._details}' selectable></commit-detail-panel-sk>
...
window.customElements.define('commit-detail-picker-sk', class extends ElementSk {
  ...
  connectedCallback() {
    ...
    this.querySelector('#close').addEventListener('click', (e) => { this._close(); });
  }
