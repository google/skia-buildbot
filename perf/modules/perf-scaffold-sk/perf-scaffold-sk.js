...
// The class appliedd to perf-scaffold-sk that hides the sidebar. It is also
// used as the key for localStorage, which is used to remember the user's preference.
