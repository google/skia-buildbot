...
import { addParamsToParamSet, fromKey, makeKey } from '../structuredkey';
...
export class TrybotPageSk extends ElementSk {
      ...
      <tabs-panel-sk>
        ...
        <div>
          ...
          <div
            ?hidden=${!ele.displayedByParamsTrace}
          >
            <div></p><b>TraceID:</b><span id=by-params-traceid></span></div>
            <paramset-sk
  ...
  private plotByParamsTraces(e: MouseEvent, i: number) {
    ...
    this.byParamsParamSet!.paramsets = [ps as unknown as CommonSkParamSet];
