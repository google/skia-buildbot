...
const template = (ele) => html`
  ...
  <query-chooser-sk id=querychooser .paramset=${paramset} .key_order=${ele.key_order} current_query=${ele.config.query} count_url='/_/count/' @query-change=${(e) => ele.congfig.query=e.detail.q}></query-chooser-sk>
  ...
  <multi-select-sk
    .selection=${ele.config.group_by.split(',').map((param) => ele._paramkeys.indexOf(param))}
