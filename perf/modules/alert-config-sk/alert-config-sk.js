...
const template = (ele) => html`
  ...
  <query-chooser-sk id=querychooser paramset=${paramset} current_query=${ele.config.query} count_url='/_/count/' @query-change=${(e) => ele.congfig.query=e.detail.q}></query-chooser-sk>
