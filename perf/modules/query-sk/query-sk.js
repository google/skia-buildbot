...
import { fromParamSet } from 'common-sk/modules/query'
...
window.customElements.define('query-sk', class extends ElementSk {
  constructor() {
    ...
    // The id of a pending timout func that will send a delayed query-change event.
  ...
  _keyChange(e) {
    const key = this._keys[e.detail.selection];
