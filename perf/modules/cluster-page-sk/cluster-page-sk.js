...
const template = (ele) => html`
  ...
  <h2>Algorithm</h2>
  <algo-select-sk algo=${ele._state.algo} @algo-change=${(e) => ele._state.algo = e.detail.algo}></algo-select-sk>

  <h2>Query</h2>
  <div class=query-action>
    <query-sk
      @query-change=${(e) => ele._state.query = e.detail.q}
    ...
    <div id=selections>
      ...
      <div>
        Matches: <query-count-sk url='/_/count/' current_query=${ele._state.query} @paramset-changed=${ele._paramsetChanged}></query-count-sk>
      </div>
  ...
  <details>
    ...
    <div id=inputs>
      ...
      <label>
        ...
        <input type=number min=1 max=25  .value=${ele._state.radius} @input=${(e) => ele._state.radius = e.target.value}>
      </label>
      <label>
        Clusters are interesting if regression score &gt;= this.
        <input type=number min=0 max=500 .value=${ele._state.interesting} @input=${(e) => ele._state.interesting = e.target.value}>
      </label>
      <checkbox-sk
