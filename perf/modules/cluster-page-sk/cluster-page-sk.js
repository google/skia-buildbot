...
const template = (ele) => html`
  ...
  <h2>Algorithm</h2>
  <algo-select-sk @algo-change=${ele._algoChange} algo=${ele._state.algo}></algo-select-sk>
  ...
  <div class=query-action>
    ...
    <div id=selections>
      ...
      <div>
        Matches: <query-count-sk url='/_/count/' current_query=${ele._state.query}></query-count-sk>
      </div>
