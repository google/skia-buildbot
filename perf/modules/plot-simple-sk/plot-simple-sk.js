  ...
  */
  ...
  _drawOverlayCanvas() {
    ...
    { // Block to scope save/restore.
      ...
      // Draw the xbar.
      this._drawXBar(ctx, this._summary, 2);

      // Draw the bands.
      this._drawBands(ctx, this._summary, 2);
    ...
    { // Block to scope save/restore.
      ...
      // Draw the xbar.
      this._drawXBar(ctx, this._detail, 3);

      // Draw the bands.
      this._drawBands(ctx, this._detail, 3);
      ...
      if (!this._inZoomDrag) {
        ...
        if (this._crosshair.shift) {
          ...
          if (y < this._detail.rect.y + this._detail.rect.height / 2) {
            ctx.textBaseline = 'top'; // Draw the text below the crosshair.
