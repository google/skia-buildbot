  ...
  _drawOverlay() {
    ...
    if (!this._inZoomDrag) {
      ...
      if (this._crosshair.shift) {
        ...
        ctx.fillStyle = "#fff"
        ctx.fillText('' + this._hoverPt.y, this._crosshair.x + MARGIN + 2, this._crosshair.y - MARGIN - 2);
        ctx.fillText('' + this._hoverPt.y, this._crosshair.x + MARGIN - 2, this._crosshair.y - MARGIN + 2);
        ctx.fillStyle = "#000"
        ctx.fillText('' + this._hoverPt.y, this._crosshair.x + MARGIN, this._crosshair.y - MARGIN);
      }
    }
