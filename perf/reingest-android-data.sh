...
gsutil ls "gs://skia-perf/android-master-ingest/tx_log/2021/02/18/**" | xargs -L 1 -P 10 -I {} sh -c "echo {}; gsutil cp {} - | curl --include  --data @- https://android-metric-ingest.skia.org/upload"