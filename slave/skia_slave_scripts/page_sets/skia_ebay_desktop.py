...
class SkiaBuildbotPageSet(page_set_module.PageSet):
  ...
  def __init__(self):
    ...
    urls_list = [
      ...
      'http://www.ebay.com/ctg/Harry-Potter-and-Deathly-Hallows-Year-7-J-K-Rowling-2007-Cassette-Unabridged-/123341182?_dmpt=US_Childrens_Books&_pcategid=279&_pcatid=4&_refkw=harry+potter+and+the+deathly+hallows',
    ]
