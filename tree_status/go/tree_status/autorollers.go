...
var (
	// Map of Autoroller display names to their ID and hosts.
	AUTOROLLERS = map[string]*Autoroller{
		"ANGLE":       &Autoroller{ID: "angle-skia-autoroll", Host: "autoroll.skia.org"},
		"Android":     &Autoroller{ID: "android-master-autoroll", Host: "skia-autoroll.corp.goog"},
		"Chrome":      &Autoroller{ID: "skia-autoroll", Host: "autoroll.skia.org"},
		"Google3":     &Autoroller{ID: "google3-autoroll", Host: "skia-autoroll.corp.goog"},
		"Flutter":     &Autoroller{ID: "skia-flutter-autoroll", Host: "autoroll.skia.org"},
		"Skcms":       &Autoroller{ID: "skcms-skia-autoroll", Host: "autoroll.skia.org"},
		"SwiftShader": &Autoroller{ID: "swiftshader-skia-autoroll", Host: "autoroll.skia.org"},
	}
...
func getAutorollersSnapshot(ctx context.Context) ([]*AutorollerSnapshot, error) {
	...
	for name, autoroller := range AUTOROLLERS {
