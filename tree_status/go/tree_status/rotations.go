...
func (srv *Server) getCurrentSheriffHandler(w http.ResponseWriter, r *http.Request) {
	srv.currentRotationHandler(w, r, "Sheriffs")
}

func (srv *Server) getCurrentWranglerHandler(w http.ResponseWriter, r *http.Request) {
	srv.currentRotationHandler(w, r, "GpuSheriffs")
}

func (srv *Server) getCurrentTrooperHandler(w http.ResponseWriter, r *http.Request) {
	srv.currentRotationHandler(w, r, "Troopers")
}

func (srv *Server) getCurrentRobocopHandler(w http.ResponseWriter, r *http.Request) {
	srv.currentRotationHandler(w, r, "Robocops")
}

func (srv *Server) getNextSheriffHandler(w http.ResponseWriter, r *http.Request) {
	srv.nextRotationHandler(w, r, "Sheriffs")
}

func (srv *Server) getNextWranglerHandler(w http.ResponseWriter, r *http.Request) {
	srv.nextRotationHandler(w, r, "GpuSheriffs")
}

func (srv *Server) getNextTrooperHandler(w http.ResponseWriter, r *http.Request) {
	srv.nextRotationHandler(w, r, "Troopers")
}

func (srv *Server) getNextRobocopHandler(w http.ResponseWriter, r *http.Request) {
	srv.nextRotationHandler(w, r, "Robocops")
}
...
func (srv *Server) updateWranglerRotationsHandler(w http.ResponseWriter, r *http.Request) {
	srv.updateRotationsHandler(w, r, "GpuSheriffs", srv.wranglerHandler)
}
...
func (srv *Server) currentRotationHandler(w http.ResponseWriter, r *http.Request, rotationType string) {
	w.Header().Set("Content-Type", "application/json")

	rotations, err := GetUpcomingRotations(RotationTypeToKind[rotationType], time.Now().UTC())
	if err != nil {
		httputils.ReportError(w, err, "Failed to get sheriff rotations.", http.StatusInternalServerError)
		return
	}
...
func (srv *Server) nextRotationHandler(w http.ResponseWriter, r *http.Request, rotationType string) {
	w.Header().Set("Content-Type", "application/json")
