...
func (srv *Server) loadTemplates() {
	srv.templates = template.Must(template.New("").Delims("{%", "%}").ParseFiles(
		...
		filepath.Join(*baseapp.ResourcesDir, "sheriff.html"),
		filepath.Join(*baseapp.ResourcesDir, "trooper.html"),
		filepath.Join(*baseapp.ResourcesDir, "wrangler.html"),
		filepath.Join(*baseapp.ResourcesDir, "robocop.html"),
	))
}

func (srv *Server) mainHandler(w http.ResponseWriter, r *http.Request) {
	srv.commonHandler(w, r, "index.html")
}
func (srv *Server) sheriffHandler(w http.ResponseWriter, r *http.Request) {
	srv.commonHandler(w, r, "sheriff.html")
}
func (srv *Server) robocopHandler(w http.ResponseWriter, r *http.Request) {
	srv.commonHandler(w, r, "robocop.html")
}
func (srv *Server) trooperHandler(w http.ResponseWriter, r *http.Request) {
	srv.commonHandler(w, r, "trooper.html")
}
func (srv *Server) wranglerHandler(w http.ResponseWriter, r *http.Request) {
	srv.commonHandler(w, r, "wrangler.html")
}

func (srv *Server) commonHandler(w http.ResponseWriter, r *http.Request, htmlFile string) {
	w.Header().Set("Content-Type", "text/html")
	if *baseapp.Local {
		srv.loadTemplates()
	}
	if err := srv.templates.ExecuteTemplate(w, htmlFile, map[string]string{
