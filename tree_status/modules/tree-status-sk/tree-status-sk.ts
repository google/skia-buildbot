...
`;
  ...
  private doImpl(url, detail, action) {
    fetch(url, {
  ...
  private saveStatus(e: CustomEvent) {
    this.doImpl('/_/add_tree_status', e.detail, (json: Status[]) => { this.statuses = json; });
  }
  ...
  private setTreeStatus(e: CustomEvent) {
