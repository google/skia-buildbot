...
HERE HERE HERE
<enter-tree-status-sk></enter-tree-status-sk>
...
define('tree-status-sk', class extends ElementSk {
  ...
  connectedCallback() {
    ...
    this.addEventListener('new-tree-status', e => this._saveStatus(e.detail.message));
    // this.addEventListener('close-tree-with-dep', e => this._saveStatus(e.detail.message));
