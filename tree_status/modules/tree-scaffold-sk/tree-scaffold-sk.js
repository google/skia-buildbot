...
import '../tree-icon-sk/trooper-icon-sk'

const template = (ele) => html`
  <nav>
    <nav-button-sk></nav-button-sk>
    <nav-links-sk>
      <a href="/e/" tab-index=0 ><home-icon-sk></home-icon-sk><span>Skia Tree Status</span></a>
      <a href="/c/" tab-index=0 ><star-icon-sk></star-icon-sk><span>Sheriff Schedule<span></a>
      <a href="/c/" tab-index=0 ><gesture-icon-sk></gesture-icon-sk><span>Wrangler Schedule<span></a>
      <a href="/c/" tab-index=0 ><android-icon-sk></android-icon-sk><span>Robocop Schedule<span></a>
      <a href="/c/" tab-index=0 ><trooper-icon-sk></trooper-icon-sk><span>Trooper Schedule<span></a>
      <a href="/activitylog/" tab-index=0 ><event-icon-sk></event-icon-sk><span>Admin Access</span></a>
      <a href="http://go/tree-user-doc" tab-index=0 ><help-icon-sk></help-icon-sk><span>Help</span></a>
