...
// the resulst from our LLVM-based coverage tasks
...
// IngestCommits fulfils the Ingester interface.
...
// getIngestableFilesFromGCS retunrs the list of files to (possibly) ingest from GCS.
...
// GetResults fulfils the Ingester interface
