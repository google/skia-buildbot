...
var (
	...
	silenceRecentlyExpiredDuration = flag.Duration("recently_expired_duration", 15*time.Minute, "Incidents with silences that recently expired within this duration are shown with an icon.")
