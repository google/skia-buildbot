...
func New() (baseapp.App, error) {
	...
	srv := &Server{
		incidentStore: incident.NewStore(ds.DS, []string{incident.K8S_POD_NAME, incident.INSTANCE, incident.POD_TEMPLATE_HASH}),
		silenceStore:  silence.NewStore(ds.DS, []string{incident.K8S_POD_NAME, incident.INSTANCE, incident.POD_TEMPLATE_HASH}),
		allow:         allow,
		assign:        assign,
	}
	srv.loadTemplates()
