...
// getOwnerFromDockerImage returns the owner from a dirty committed image if it matches the
// DockerImageRegex else an empty string is returned. The full email address is returned.
