...
func TestGetOwnerFromDockerImage(t *testing.T) {
	...
	tests := []struct {
		...
		{dockerImage: "gcr.io/skia-public/autoroll-be:2021-04-30T14_04_37Z-rmistry-c3ecfbb-dirty", expectedOwner: "rmistry"},
		{dockerImage: "gcr.io/skia-public/autoroll-be:2021-04-30T14_04_37Z-rmistry-c3ecfbb-clean", expectedOwner: "rmistry"},
	}
