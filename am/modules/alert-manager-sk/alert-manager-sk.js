...
<main>
  <section class=incidents>
    ${ele._incidents.map(i => html`<h2 class$=${classOfH2(i)} on-click=${e => ele._select(i)}>${i.params.alertname} ${abbr(i)}</h2>`)}
    ${ele._recents.map(i => html`<h2 class$=${classOfH2(i)} on-click=${e => ele._select(i)}>${i.params.alertname} ${abbr(i)}</h2>`)}
  </section>
  <section class=edit>
    ${editIncident(ele)}
  </section>
