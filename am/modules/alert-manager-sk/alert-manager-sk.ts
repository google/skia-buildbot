...
import {
  Silence, Incident, StatsRequest, StatsResponse, Stat, IncidentsResponse, ParamSet, IncidentsInRangeRequest,
} from '../json';
...
`;
  ...
  connectedCallback(): void {
    ...
    this.addEventListener('bot-chooser', (e) => this._botChooser(e as CustomEvent));
  ...
  _botChooser(e: CustomEvent): void {
    this.populateBotsToIncidents(this._incidents);
