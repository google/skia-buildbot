...
export class AlertManagerSk extends HTMLElement {
  ...
  private _bots_to_incidents = {}; // Bot names to their incidents. Used in bot-centric view.
  ...
  private _incidentsToRecentlyExpired = {}; // Map of incident IDs to whether their silences recently expired.
...
`;
  ...
  hasRecentlyExpiredSilence(incident, idsToExpiredRecently) {
  ...
  populateBotsToIncidents(incidents) {
