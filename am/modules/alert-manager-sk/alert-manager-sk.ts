...
import {
  Silence, Incident, StatsRequest, StatsResponse, Stat, IncidentsResponse, ParamSet, Params, IncidentsInRangeRequest,
} from '../json';
import { BotChooserSk } from '../bot-chooser-sk/bot-chooser-sk';
...
`;
  ...
  connectedCallback(): void {
    ...
    this.addEventListener('bot-chooser', (e) => this._botChooser());
