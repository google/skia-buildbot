...
func main() {
	...
	*workdir, err = filepath.Abs(*workdir)
	...
	cipdPkgs := &swarming_api.SwarmingRpcsCipdInput{
		Packages: []*swarming_api.SwarmingRpcsCipdPackage{},
	}
	for _, pkg := range cipd.PkgsPython {
		cipdPkgs.Packages = append(cipdPkgs.Packages, &swarming_api.SwarmingRpcsCipdPackage{
