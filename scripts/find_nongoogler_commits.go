...
// Use to check that a google.com address is present as the committer, author,
// or reviewer.
...
var (
	exclude_pattern = flag.String("exclude_pattern", `autoroll|create-skp`,
		"Regex for commiter/author/reviewer that will be bucketed separately if no google address is present.")
