...
func rollOnce(cwd string) (map[string][]string, error) {
	...
	if _, err := exec.RunCwd(cwd, "python", "recipes.py", "autoroll", "--output-json", outJson); err != nil {
		return nil, err
	}
