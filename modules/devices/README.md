...
from https://github.com/luci/luci-py/blob/master/appengine/swarming/ui2/modules/alias.js#L33
...
The following line needs to be added to `tsconfig.json` for this to work:
