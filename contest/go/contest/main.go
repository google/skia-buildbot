...
<body>
  <h2>Create your entry at <a href="https://fiddle.skia.org">https://fiddle.skia.org</a>.</h2>
	<h3>Submit entries <a href="http://goo.gl/forms/pRfo39hTND">here</a>.</h3>
  {{range .}}
	  <div id=entries>
			<div style='text-align: center; border: solid lightgray 1px; padding: 1em; margin: 1em; float: left;'>
				...
				</a> <div style='padding-top: 1em;'><b>{{.Name}}</b></div>
			</div>
	  </div>
	{{end}}
