...
export const pageSets: PageSet[] = [
  ...
  { key: 'Mobile10k', description: 'Top 10K (with mobile user-agent)' },
  {
    key: 'Dummy1k',
    description:
      'Top 1K (with desktop user-agent, for testing, hidden from Runs History by default)',
  },
  {
    key: 'DummyMobile1k',
    description:
      'Top 1K (with mobile user-agent, for testing, hidden from Runs History by default)',
  },
