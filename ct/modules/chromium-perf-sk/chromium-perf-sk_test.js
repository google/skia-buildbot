...
describe('chromium-perf-sk', () => {
  ...
  it('triggers a new task', async () => {
    ...
    expect(taskJson.body).to.equal({
      benchmark: 'a benchmark',
      platform: 'Linux (Ubuntu18.04 machines)',
      page_sets: '10k',
      custom_webpages: '',
      repeat_runs: '1',
    ...
    // Problem: platform needs to be key-value, not just desc.
    /*
...
browser_args_withpatch: ""
chromium_hash: ""
desc: "Testing https://skia-review.googlesource.com/c/281157/1 ([infra] Upgrade to Debian 10 for GCE tasks - skqp/release branch.)"
page_sets: "Dummy1k"
platform: "Linux"
repeat_after_days: "0"
repeat_runs: "1"
run_in_parallel: "False"
run_on_gce: "false"
skia_patch: "↵↵diff --git a/infra/bots/gen_tasks.go b/infra/bot"
task_priority: "100"
value_column_name: "avg"
     */
  });
