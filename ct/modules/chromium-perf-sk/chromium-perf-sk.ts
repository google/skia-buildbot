...
`;
  ...
  _queueTask(): void {
    ...
    params.browser_args_nopatch = ($$('#browser_args_nopatch', this) as HTMLInputElement).value;
    params.browser_args_withpatch = ($$('#browser_args_withpatch', this) as HTMLInputElement).value;
  ...
  _getRepeatValue(): string {
    ...
    const m = rx.exec(($$('#benchmark_args', this) as HTMLInputElement).value);
    if (m) {
      return m[1];
    }
    return '1';
