...
import {
  combineClDescriptions, missingLiveSitesWithCustomWebpages, moreThanThreeActiveTasksChecker,
} from '../ctfe_utils';
...
<table class="options panel">
  ...
  <tr>
    <td colspan="2" class="center">
      ...
      <button ?disabled=${el._triggeringTask} @click=${el._validateTask}>Queue Task</button>
    </td>
  </tr>
  <tr>
    <td colspan="2" class="center">
...
define('chromium-perf-sk', class extends ElementSk {
  ...
  _validateTask() {
    ...
    $$('#confirm_dialog', this).open('Proceed with queueing task?')
      ...
      .catch((e) => {
        console.log(e);
        errorMessage('Did not queue');
      });
  }

  _queueTask() {
    console.log('queuing that task.');
    ...
    console.log('foo');
    params.platform = this.platforms[$$('#platform_selector', this).selection];
