...
<table class=options>
  ...
  <tr>
    ...
    <td>
      <input-sk value="" id=text_output class=long-field></input-sk>
  ...
  <tr>
    ...
    <td>
      <input-sk value="" id=custom_apk label="Eg: gs://chrome-unsigned/android-B0urB0N/73.0.3655.0/arm_64/ChromeModern.apk" class=long-field></input-sk>
    </td>
  </tr>
  <tr>
    <td>
    ...
    <td>
      <input-sk value="" id=isolate_hash class=long-field></input-sk>
    </td>
  </tr>
  <tr>
...
define('chromium-analysis-sk', class extends ElementSk {
  ...
  connectedCallback() {
    ...
    // TODO DO NOT SUBMIT: when this fires selection-changed or w/e, fir the first time only, we need to set to 10k. then remove the handler.
    $$('#pageset_selector', this).
  }
