...
export class ChromiumAnalysisSk extends ElementSk {
  ...
  private _platforms: [string, unknown][] = [];
...
`;
  ...
  _patchChanged(): void {
    ($$('#description', this)! as HTMLInputElement).value = combineClDescriptions(
  ...
  _validateTask(): void {
    ...
    if (!($$('#description', this) as HTMLInputElement).value) {
      errorMessage('Please specify a description');
      ($$('#description', this) as HTMLInputElement).focus();
      return;
    }
    if (!($$('#benchmark_name', this) as HTMLInputElement).value) {
      errorMessage('Please specify a benchmark');
      ($$('#benchmark_name', this) as HTMLInputElement).focus();
      return;
    }
    if (missingLiveSitesWithCustomWebpages(
      ($$('#pageset_selector', this) as PagesetSelectorSk).customPages,
      ($$('#benchmark_args', this) as HTMLInputElement).value,
    )) {
      ($$('#benchmark_args', this) as HTMLInputElement).focus();
      return;
    }
  ...
  _queueTask(): void {
    ...
    params.benchmark = ($$('#benchmark_name', this)! as HTMLInputElement).value;
    ...
    params.match_stdout_txt = ($$('#match_stdout_txt', this) as HTMLInputElement).value;
    params.apk_gs_path = ($$('#apk_gs_path', this) as HTMLInputElement).value;
    params.telemetry_isolate_hash = ($$('#telemetry_isolate_hash', this) as HTMLInputElement).value;
    ...
    params.benchmark_args = ($$('#benchmark_args', this) as HTMLInputElement).value;
    params.browser_args = ($$('#browser_args', this) as HTMLInputElement).value;
    params.value_column_name = ($$('#value_column_name', this) as HTMLInputElement).value;
    params.desc = ($$('#description', this) as HTMLInputElement).value;
    ...
    params.chromium_hash = ($$('#chromium_hash', this) as HTMLInputElement).value;
    ...
    if (($$('#cc_list', this) as HTMLInputElement).value) {
      params.cc_list = ($$('#cc_list', this) as HTMLInputElement).value.split(',');
    }
    if (($$('#group_name', this) as HTMLInputElement).value) {
      params.group_name = ($$('#group_name', this) as HTMLInputElement).value;
    }
