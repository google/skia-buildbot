...
describe('expandable-textarea-sk', () => {
  ...
  beforeEach(async () => {
    await testBed.page.goto(`${testBed.baseUrl}/dist/expandable-textarea-sk.html`);
  ...
  describe('screenshots', () => {
    it('shows the default view', async () => {
      await takeScreenshot(testBed.page, 'ct', 'expandable-textarea-sk');
    });

    it('shows the suggestions', async () => {
      await testBed.page.click('input');
      await takeScreenshot(testBed.page, 'ct', 'expandable-textarea-sk_suggestions');
    });
  });
});
