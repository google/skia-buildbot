...
const (
	...
	// REMOVE
	// Use lower priority for admin tasks because they can be long runned and we do not want to starve user jobs.
	TASKS_PRIORITY_MEDIUM = swarming.RECOMMENDED_PRIORITY + 10
	// REMOVE
	// To prevent long running tasks from starving user jobs.
