...
var (
	...
	// id here for HACK
	GCE_WINDOWS_BUILDER_DIMENSIONS       = map[string]string{"pool": "CTBuilder", "os": "Windows", "id": "ct-windows-builder-003"}
	CHROME_GCE_WINDOWS_WORKER_DIMENSIONS = map[string]string{"pool": "Chrome", "os": "Windows", "id": "chrome-win10-4-jzn4"}
