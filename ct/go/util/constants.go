...
const (
	...
	WORKERS_SERVICE_ACCOUNT = "ct-golo@ct-swarming-bots.iam.gserviceaccount.com"
	...
	LUCI_AUTH_CIPD_PACKAGE_WIN   = "cipd_bin_packages:infra/tools/luci-auth/win-amd64:git_revision:41a7e9bcbf18718dcda83dd5c6188cfc44271e70"
)
