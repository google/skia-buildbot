...
class TypicalAlexaPage(page_module.Page):
  ...
  def __init__(self, url, page_set):
    ...
    self.archive_data_file = '/b/storage/webpages_archive/10k/alexa2-2.json'
...
class TypicalAlexaPageSet(page_set_module.PageSet):
  ...
  def __init__(self):
    super(TypicalAlexaPageSet, self).__init__(
      ...
      archive_data_file='/b/storage/webpages_archive/10k/alexa2-2.json')

    urls_list = ['http://www.facebook.com']
