...
// pageset type and deletes the archives which are found to deliver
...
var (
	...
	benchmarkArgs                 = flag.String("benchmark_args", "--output-format=csv-pivot-table", "The arguments that are passed to the specified benchmark.")
	...
	deletePageset                 = flag.Bool("delete_pageset", true, "If an archive is found to be inconsistent then delete its corresponding pageset.")
