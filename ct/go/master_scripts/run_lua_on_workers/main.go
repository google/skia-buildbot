...
func updateTaskInDatastore(ctx context.Context, luaOutputRemoteLink, luaAggregatorOutputRemoteLink string) error {
...
func runLuaOnWorkers() error {
	...
	if err := updateTaskInDatastore(ctx, luaOutputRemoteLink, luaAggregatorOutputRemoteLink); err != nil {
