...
func runChromiumPerfOnWorkers() error {
	...
	// HACK HACK HACK
	isolateDeps = append(isolateDeps, "6170d645da928f2964fc9452f4536e9d7def31a8")
	// try-93c126ae0a51fe---ChromiumPerf-71-withpatch (both of them)
	chromiumBuildNoPatch = "try-93c126ae0a51fe---ChromiumPerf-71-withpatch"
	chromiumBuildWithPatch = "try-93c126ae0a51fe---ChromiumPerf-71-withpatch"
	// HACK HACK HACK
