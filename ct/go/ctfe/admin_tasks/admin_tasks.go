...
func (vars *RecreatePageSetsUpdateVars) SetCompleted(success bool, runID string) {
...
func (vars *RecreateWebpageArchivesUpdateVars) SetCompleted(success bool, runID string) {
	vars.TsCompleted = ctutil.GetCurrentTs()
	vars.Failure = !success
	vars.TaskDone = true
}
