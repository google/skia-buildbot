...
func (task *AddTaskVars) GetInsertQueryAndBinds() (string, []interface{}, error) {
	...
	if err := ctfeutil.CheckLengths([]ctfeutil.LengthCheck{
		...
		{"custom_webpages", task.CustomWebpages, db.LONG_TEXT_MAX_LENGTH},
	...
	fmt.Println("HERE HERE HERE HERE HERE HERE HERE HERE HERE HERE HERE HERE HERE")
	fmt.Println("HERE HERE HERE HERE HERE HERE HERE HERE HERE HERE HERE HERE HERE")
	fmt.Println("HERE HERE HERE HERE HERE HERE HERE HERE HERE HERE HERE HERE HERE")
	fmt.Println("HERE HERE HERE HERE HERE HERE HERE HERE HERE HERE HERE HERE HERE")
	fmt.Println(customWebpages)
	runInParallel := 0
