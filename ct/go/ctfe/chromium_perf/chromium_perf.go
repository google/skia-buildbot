...
func (task *AddTaskVars) TriggerSwarmingTask(ctx context.Context, t task_common.Task) error {
	...
	if err := ctutil.TriggerMasterScriptSwarmingTask(ctx, runID, "run_chromium_perf_on_workers", ctutil.CHROMIUM_PERF_MASTER_ISOLATE, ctfeutil.GetServiceAccountFileFlagVal(), false, isolateArgs); err != nil {
