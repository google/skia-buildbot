...
// TODO(nifong): draw the crosshair, change the point when it's activated,
// receive the zoom-point event and move the crosshair if it's active
// in zoom-sk show the selected color