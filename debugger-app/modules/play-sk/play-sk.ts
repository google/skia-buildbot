...
export class PlaySk extends ElementSk {
  private static template = (ele: PlaySk) =>
    ...
    <div class="horizontal-flex">
      ...
      <input value="${ele._playbackDelay}" class=delay-input @change=${ele._delayChanged}></input>
    </div>`;
  ...
  private _playPauseIcon(ele: PlaySk) {
    if (this._mode === 'pause') {
      return html`<play-arrow-icon-sk title="Play/Pause" @click=${ele._togglePlay} id='play-button'></play-arrow-icon-sk>`;
    } else {
