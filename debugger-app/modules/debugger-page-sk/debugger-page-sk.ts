...
export class DebuggerPageSk extends ElementSk {
 ...
 Command labeled AndroidDeviceClipRestriction"
  ...
  private _setCommands() {
    ...
    // layer list dicts for this frame now available. Pull the layer summaries from player
    // send it all off to the layer 
  }
  ...
  private _inspectLayer(layerId: number, frame: number) {
    ...
    // TODO(nifong): make timeline have some kind of mode for this
    //this._timelineSk!.disabled = layerId != -1;
