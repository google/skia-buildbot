...
import 'elements-sk/checkbox-sk'; // Import the checkbox element used in in the template
import { CheckOrRadio } from 'elements-sk/checkbox-sk/checkbox-sk'; // import the type of the chckbox element
