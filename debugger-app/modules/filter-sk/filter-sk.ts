...
Command types can also be filted by clicking on their names in the histogram">Filter</label>
      <input id="fast" @change=${ele._textFilter} value="!DrawAnnotation"></input>&nbsp;
      <label>Range</label>
      <input id="rangeLow" @change=${ele._rangeFilter} class=range-input value="0"></input>
      <b>:</b>
      <input id="rangeHigh" @change=${ele._rangeFilter} class=range-input value="100"></input>
