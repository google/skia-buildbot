...
At the time of this writing, there is also `debugger-assets`, a polymer-based version of debugger which also
embeds the wasm module, and prior to that `debugger` which fetched images from a backend server and did not involve wasm.
