...
type Gatherer interface {
	// Get the cached DownBots. This will be empty until CycleEvery is called.
	GetDownBots() []DownBot
	// CycleEvery begins updating the cached list using the given period.
...
// update writes to the underlying downBots slice in a thread safe way.
...
// cycle is the "inner loop" of the gatherer. It polls swarming for a list of
