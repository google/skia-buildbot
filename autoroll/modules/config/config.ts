...
export interface ParentChildRepoManagerConfig {
  ...
  depsLocalParent?: DEPSLocalParentConfig;
  gitCheckoutParent?: GitCheckoutParentConfig;
...
interface ParentChildRepoManagerConfigJSON {
  ...
  deps_local_parent?: DEPSLocalParentConfigJSON;
  git_checkout_parent?: GitCheckoutParentConfigJSON;
