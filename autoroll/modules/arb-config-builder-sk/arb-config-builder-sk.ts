...
class SlideData {
  ...
  private _parent: ARBSlidesSk | null = null;
...
class ARBSlidesSk extends ElementSk {
  ...
  constructor() {
    ...
    this.slides = [
      ...
      new Slide("Child Project", [
        // TODO: Filter
        new EnumSlideData("Child Project Type", "Type of project being rolled.", true, Object.values(childType)),
      ]),
    ];
