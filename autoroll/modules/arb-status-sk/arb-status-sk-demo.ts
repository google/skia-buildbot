...
fetchMock.get("/json/status", fakeStatus);
...
fetchMock.post("/json/mode", function(url: string, opts: fetchMock.MockOptions) {
  var res = <Mode>JSON.parse(<string>opts.body);
...
fetchMock.post("/json/strategy", function(url: string, opts: fetchMock.MockOptions) {
  var res = <Strategy>JSON.parse(<string>opts.body);
  res["user"] = "you@google.com";
...
fetchMock.post("/json/unthrottle", {});
fetchMock.post("/json/manual", function(url: string, opts: fetchMock.MockOptions) {
  var req = <ManualRollRequest>JSON.parse(<string>opts.body);
