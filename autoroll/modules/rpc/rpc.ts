...
const JSONToAndroidRepoManagerConfig = (m: AndroidRepoManagerConfigJSON): AndroidRepoManagerConfig => {
  return {
    ...
    preUploadSteps: (m.pre_upload_steps || Object.keys(PreUploadStep[])[0]) as PreUploadStep[],
...
const JSONToNotifierConfig = (m: NotifierConfigJSON): NotifierConfig => {
  return {
    ...
    msgType: (m.msg_type || Object.keys(NotifierConfig_MsgType[])[0]) as NotifierConfig_MsgType[],
