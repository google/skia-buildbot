...
export interface AutoRollRPCs {
  getRollers: (getRollersRequest: GetRollersRequest) => Promise<AutoRollMiniStatuses>;
  getMiniStatus: (getMiniStatusRequest: GetMiniStatusRequest) => Promise<AutoRollMiniStatus>;
  getStatus: (getStatusRequest: GetStatusRequest) => Promise<AutoRollStatus>;
  setMode: (setModeRequest: SetModeRequest) => Promise<AutoRollStatus>;
  setStrategy: (setStrategyRequest: SetStrategyRequest) => Promise<AutoRollStatus>;
  createManualRoll: (createManualRollRequest: CreateManualRollRequest) => Promise<ManualRollRequest>;
