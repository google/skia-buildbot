...
type CIPDChildConfig struct {
	...
	// tag_as_id optionally refers to a tag key which should be used as the
	// revision ID instead of the package ID. If provided, any package versions
	// which are missing this tag are ignored, and in cases where multiple
	// matching tags are present one is chosen arbitrarily.
	TagAsId string `protobuf:"bytes,3,opt,name=tag_as_id,json=tagAsId,proto3" json:"tag_as_id,omitempty"`
}
...
func (x *CIPDChildConfig) GetTagAsId() string {
	if x != nil {
		return x.TagAsId
	}
	return ""
...
var file_config_proto_rawDesc = []byte{
	...
	0x67, 0x69, 0x74, 0x69, 0x6c, 0x65, 0x73, 0x22, 0x53, 0x0a, 0x0f, 0x43, 0x49, 0x50, 0x44, 0x43,
	...
	0x12, 0x1a, 0x0a, 0x09, 0x74, 0x61, 0x67, 0x5f, 0x61, 0x73, 0x5f, 0x69, 0x64, 0x18, 0x03, 0x20,
	0x01, 0x28, 0x09, 0x52, 0x07, 0x74, 0x61, 0x67, 0x41, 0x73, 0x49, 0x64, 0x22, 0x3f, 0x0a, 0x15,
	...
	0x65, 0x73, 0x22, 0x53, 0x0a, 0x1f, 0x42, 0x75, 0x69, 0x6c, 0x64, 0x62, 0x75, 0x63, 0x6b, 0x65,
	...
	0x06, 0x62, 0x75, 0x63, 0x6b, 0x65, 0x74, 0x2a, 0xc6, 0x02, 0x0a, 0x0d, 0x50, 0x72, 0x65, 0x55,
