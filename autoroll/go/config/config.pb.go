...
func (NotifierConfig_MsgType) EnumDescriptor() ([]byte, []int) {
	return file_config_proto_rawDescGZIP(), []int{25, 1}
}
...
type Config struct {
	...
	// sheriff are the email addresses to add as reviewers on rolls, or URL(s)
	// from which to obtain those email addresses.
	Sheriff []string `protobuf:"bytes,9,rep,name=sheriff,proto3" json:"sheriff,omitempty"`
	// sheriff_backup are backup email addresses to add as reviewers on rolls,
	// in case obtaining the email addresses from the URL fails. Only required
	// if a URL is specified for the sheriff.
	SheriffBackup []string `protobuf:"bytes,10,rep,name=sheriff_backup,json=sheriffBackup,proto3" json:"sheriff_backup,omitempty"`
...
func (x *Config) GetSheriff() []string {
	if x != nil {
		return x.Sheriff
	}
	return nil
...
func (x *Config) GetSheriffBackup() []string {
	if x != nil {
		return x.SheriffBackup
	}
	return nil
}
...
type ParentChildRepoManagerConfig struct {
	...
	//	*ParentChildRepoManagerConfig_DepsLocalParent
	//	*ParentChildRepoManagerConfig_GitCheckoutParent
...
func (x *ParentChildRepoManagerConfig) GetDepsLocalParent() *DEPSLocalParentConfig {
	if x, ok := x.GetParent().(*ParentChildRepoManagerConfig_DepsLocalParent); ok {
		return x.DepsLocalParent
	}
	return nil
}

func (x *ParentChildRepoManagerConfig) GetGitCheckoutParent() *GitCheckoutParentConfig {
	if x, ok := x.GetParent().(*ParentChildRepoManagerConfig_GitCheckoutParent); ok {
		return x.GitCheckoutParent
	}
	return nil
}
...
type ParentChildRepoManagerConfig_DepsLocalParent struct {
	DepsLocalParent *DEPSLocalParentConfig `protobuf:"bytes,2,opt,name=deps_local_parent,json=depsLocalParent,proto3,oneof"`
}

type ParentChildRepoManagerConfig_GitCheckoutParent struct {
	GitCheckoutParent *GitCheckoutParentConfig `protobuf:"bytes,3,opt,name=git_checkout_parent,json=gitCheckoutParent,proto3,oneof"`
}

type ParentChildRepoManagerConfig_GitilesParent struct {
	GitilesParent *GitilesParentConfig `protobuf:"bytes,4,opt,name=gitiles_parent,json=gitilesParent,proto3,oneof"`
}

func (*ParentChildRepoManagerConfig_CopyParent) isParentChildRepoManagerConfig_Parent() {}

func (*ParentChildRepoManagerConfig_DepsLocalParent) isParentChildRepoManagerConfig_Parent() {}

func (*ParentChildRepoManagerConfig_GitCheckoutParent) isParentChildRepoManagerConfig_Parent() {}
...
type ParentChildRepoManagerConfig_CipdChild struct {
	CipdChild *CIPDChildConfig `protobuf:"bytes,5,opt,name=cipd_child,json=cipdChild,proto3,oneof"`
}

type ParentChildRepoManagerConfig_FuchsiaSdkChild struct {
	FuchsiaSdkChild *FuchsiaSDKChildConfig `protobuf:"bytes,6,opt,name=fuchsia_sdk_child,json=fuchsiaSdkChild,proto3,oneof"`
}

type ParentChildRepoManagerConfig_GitCheckoutChild struct {
	GitCheckoutChild *GitCheckoutChildConfig `protobuf:"bytes,7,opt,name=git_checkout_child,json=gitCheckoutChild,proto3,oneof"`
}

type ParentChildRepoManagerConfig_GitilesChild struct {
	GitilesChild *GitilesChildConfig `protobuf:"bytes,8,opt,name=gitiles_child,json=gitilesChild,proto3,oneof"`
}

type ParentChildRepoManagerConfig_SemverGcsChild struct {
	SemverGcsChild *SemVerGCSChildConfig `protobuf:"bytes,9,opt,name=semver_gcs_child,json=semverGcsChild,proto3,oneof"`
}
...
func (x *DEPSLocalParentConfig) GetGitCheckout() *GitCheckoutConfig {
	if x != nil {
		return x.GitCheckout
	}
	return nil
...
type NotifierConfig struct {
	...
	// filter controls which messages are sent.
	//
	// Types that are assignable to Filter:
	//	*NotifierConfig_LogLevel_
	//	*NotifierConfig_MsgType_
	Filter isNotifierConfig_Filter `protobuf_oneof:"filter"`
...
func (m *NotifierConfig) GetFilter() isNotifierConfig_Filter {
	if m != nil {
		return m.Filter
	}
	return nil
...
func (x *NotifierConfig) GetLogLevel() NotifierConfig_LogLevel {
	if x, ok := x.GetFilter().(*NotifierConfig_LogLevel_); ok {
		return x.LogLevel
	}
...
func (x *NotifierConfig) GetMsgType() NotifierConfig_MsgType {
	if x, ok := x.GetFilter().(*NotifierConfig_MsgType_); ok {
		return x.MsgType
	}
	return NotifierConfig_ISSUE_UPDATE
}
...
type isNotifierConfig_Filter interface {
	isNotifierConfig_Filter()
}

type NotifierConfig_LogLevel_ struct {
	// log_level allows all messages at and above the given severity to be
	// sent.
	LogLevel NotifierConfig_LogLevel `protobuf:"varint,1,opt,name=log_level,json=logLevel,proto3,enum=autoroll.config.NotifierConfig_LogLevel,oneof"`
}

type NotifierConfig_MsgType_ struct {
	// msg_type limits the notifier to only send messages of the given
	// types.
	MsgType NotifierConfig_MsgType `protobuf:"varint,2,opt,name=msg_type,json=msgType,proto3,enum=autoroll.config.NotifierConfig_MsgType,oneof"`
}

func (*NotifierConfig_LogLevel_) isNotifierConfig_Filter() {}

func (*NotifierConfig_MsgType_) isNotifierConfig_Filter() {}
...
var file_config_proto_rawDesc = []byte{
	...
	0x89, 0x0d, 0x0a, 0x06, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x12, 0x1f, 0x0a, 0x0b, 0x72, 0x6f,
	...
	,
	...
	0x69, 0x74, 0x12, 0x37, 0x0a, 0x06, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x18, 0x10, 0x20, 0x01,
	...
	,
	...
	,
	...
	,
	...
	0x69, 0x67, 0x22, 0x54, 0x0a, 0x06, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x12, 0x0b, 0x0a, 0x07,
	...
	0x49, 0x53, 0x54, 0x41, 0x4e, 0x54, 0x10, 0x04, 0x22, 0x72, 0x0a, 0x0c, 0x47, 0x69, 0x74, 0x48,
	...
	0x74, 0x50, 0x61, 0x74, 0x68, 0x22, 0x96, 0x05, 0x0a, 0x18, 0x41, 0x6e, 0x64, 0x72, 0x6f, 0x69,
	...
	0x64, 0x61, 0x74, 0x61, 0x1a, 0xc7, 0x01, 0x0a, 0x19, 0x50, 0x72, 0x6f, 0x6a, 0x65, 0x63, 0x74,
	...
	0x09, 0x52, 0x0b, 0x6c, 0x69, 0x63, 0x65, 0x6e, 0x73, 0x65, 0x54, 0x79, 0x70, 0x65, 0x22, 0xea,
	0x04, 0x0a, 0x18, 0x43, 0x6f, 0x6d, 0x6d, 0x61, 0x6e, 0x64, 0x52, 0x65, 0x70, 0x6f, 0x4d, 0x61,
	...
	0x76, 0x1a, 0xc7, 0x01, 0x0a, 0x0d, 0x43, 0x6f, 0x6d, 0x6d, 0x61, 0x6e, 0x64, 0x43, 0x6f, 0x6e,
	...
	0x52, 0x0a, 0x03, 0x65, 0x6e, 0x76, 0x18, 0x03, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x40, 0x2e, 0x61,
	0x75, 0x74, 0x6f, 0x72, 0x6f, 0x6c, 0x6c, 0x2e, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x2e, 0x43,
	...
	0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0x95, 0x01, 0x0a, 0x19,
	...
	0x69, 0x6c, 0x64, 0x22, 0xf2, 0x01, 0x0a, 0x22, 0x46, 0x75, 0x63, 0x68, 0x73, 0x69, 0x61, 0x53,
	0x44, 0x4b, 0x41, 0x6e, 0x64, 0x72, 0x6f, 0x69, 0x64, 0x52, 0x65, 0x70, 0x6f, 0x4d, 0x61, 0x6e,
	0x61, 0x67, 0x65, 0x72, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x12, 0x3c, 0x0a, 0x06, 0x70, 0x61,
	0x72, 0x65, 0x6e, 0x74, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x24, 0x2e, 0x61, 0x75, 0x74,
	...
	0x6c, 0x64, 0x52, 0x65, 0x70, 0x6f, 0x22, 0x89, 0x06, 0x0a, 0x1c, 0x50, 0x61, 0x72, 0x65, 0x6e,
	...
	0x00, 0x52, 0x0a, 0x63, 0x6f, 0x70, 0x79, 0x50, 0x61, 0x72, 0x65, 0x6e, 0x74, 0x12, 0x54, 0x0a,
	0x11, 0x64, 0x65, 0x70, 0x73, 0x5f, 0x6c, 0x6f, 0x63, 0x61, 0x6c, 0x5f, 0x70, 0x61, 0x72, 0x65,
	0x6e, 0x74, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x26, 0x2e, 0x61, 0x75, 0x74, 0x6f, 0x72,
	...
	0x48, 0x00, 0x52, 0x0f, 0x64, 0x65, 0x70, 0x73, 0x4c, 0x6f, 0x63, 0x61, 0x6c, 0x50, 0x61, 0x72,
	0x65, 0x6e, 0x74, 0x12, 0x5a, 0x0a, 0x13, 0x67, 0x69, 0x74, 0x5f, 0x63, 0x68, 0x65, 0x63, 0x6b,
	0x6f, 0x75, 0x74, 0x5f, 0x70, 0x61, 0x72, 0x65, 0x6e, 0x74, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b,
	...
	0x72, 0x65, 0x6e, 0x74, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x48, 0x00, 0x52, 0x11, 0x67, 0x69,
	0x74, 0x43, 0x68, 0x65, 0x63, 0x6b, 0x6f, 0x75, 0x74, 0x50, 0x61, 0x72, 0x65, 0x6e, 0x74, 0x12,
	0x4d, 0x0a, 0x0e, 0x67, 0x69, 0x74, 0x69, 0x6c, 0x65, 0x73, 0x5f, 0x70, 0x61, 0x72, 0x65, 0x6e,
	0x74, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x24, 0x2e, 0x61, 0x75, 0x74, 0x6f, 0x72, 0x6f,
	0x6c, 0x6c, 0x2e, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x2e, 0x47, 0x69, 0x74, 0x69, 0x6c, 0x65,
	...
	0x0a, 0x0a, 0x63, 0x69, 0x70, 0x64, 0x5f, 0x63, 0x68, 0x69, 0x6c, 0x64, 0x18, 0x05, 0x20, 0x01,
	...
	0x5f, 0x63, 0x68, 0x69, 0x6c, 0x64, 0x18, 0x06, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x26, 0x2e, 0x61,
	...
	0x68, 0x65, 0x63, 0x6b, 0x6f, 0x75, 0x74, 0x5f, 0x63, 0x68, 0x69, 0x6c, 0x64, 0x18, 0x07, 0x20,
	...
	0x64, 0x18, 0x08, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x23, 0x2e, 0x61, 0x75, 0x74, 0x6f, 0x72, 0x6f,
	0x6c, 0x6c, 0x2e, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x2e, 0x47, 0x69, 0x74, 0x69, 0x6c, 0x65,
	...
	0x18, 0x09, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x25, 0x2e, 0x61, 0x75, 0x74, 0x6f, 0x72, 0x6f, 0x6c,
	...
	0x0e, 0x73, 0x65, 0x6d, 0x76, 0x65, 0x72, 0x47, 0x63, 0x73, 0x43, 0x68, 0x69, 0x6c, 0x64, 0x42,
	0x08, 0x0a, 0x06, 0x70, 0x61, 0x72, 0x65, 0x6e, 0x74, 0x42, 0x07, 0x0a, 0x05, 0x63, 0x68, 0x69,
	0x6c, 0x64, 0x22, 0xe8, 0x01, 0x0a, 0x10, 0x43, 0x6f, 0x70, 0x79, 0x50, 0x61, 0x72, 0x65, 0x6e,
	...
	0x09, 0x52, 0x0a, 0x64, 0x73, 0x74, 0x52, 0x65, 0x6c, 0x50, 0x61, 0x74, 0x68, 0x22, 0xbb, 0x01,
	...
	0x6e, 0x64, 0x65, 0x6e, 0x63, 0x69, 0x65, 0x73, 0x22, 0x83, 0x01, 0x0a, 0x15, 0x44, 0x45, 0x50,
	...
	0x74, 0x43, 0x68, 0x65, 0x63, 0x6b, 0x6f, 0x75, 0x74, 0x12, 0x23, 0x0a, 0x0d, 0x63, 0x68, 0x65,
	0x63, 0x6b, 0x6f, 0x75, 0x74, 0x5f, 0x70, 0x61, 0x74, 0x68, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09,
	0x52, 0x0c, 0x63, 0x68, 0x65, 0x63, 0x6b, 0x6f, 0x75, 0x74, 0x50, 0x61, 0x74, 0x68, 0x22, 0x95,
	...
	0x6f, 0x6e, 0x66, 0x69, 0x67, 0x52, 0x07, 0x67, 0x69, 0x74, 0x69, 0x6c, 0x65, 0x73, 0x22, 0x37,
	...
	0x28, 0x09, 0x52, 0x03, 0x74, 0x61, 0x67, 0x22, 0x3f, 0x0a, 0x15, 0x46, 0x75, 0x63, 0x68, 0x73,
	...
	0x64, 0x65, 0x4d, 0x61, 0x63, 0x53, 0x64, 0x6b, 0x22, 0x96, 0x01, 0x0a, 0x14, 0x53, 0x65, 0x6d,
	...
	0x78, 0x22, 0x4a, 0x0a, 0x0e, 0x47, 0x43, 0x53, 0x43, 0x68, 0x69, 0x6c, 0x64, 0x43, 0x6f, 0x6e,
	...
	0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x67, 0x63, 0x73, 0x50, 0x61, 0x74, 0x68, 0x22, 0x5f, 0x0a,
	...
	0x67, 0x52, 0x0b, 0x67, 0x69, 0x74, 0x43, 0x68, 0x65, 0x63, 0x6b, 0x6f, 0x75, 0x74, 0x22, 0x62,
	...
	0x74, 0x68, 0x22, 0xd1, 0x05, 0x0a, 0x0e, 0x4e, 0x6f, 0x74, 0x69, 0x66, 0x69, 0x65, 0x72, 0x43,
	0x6f, 0x6e, 0x66, 0x69, 0x67, 0x12, 0x47, 0x0a, 0x09, 0x6c, 0x6f, 0x67, 0x5f, 0x6c, 0x65, 0x76,
	...
	0x65, 0x6c, 0x48, 0x00, 0x52, 0x08, 0x6c, 0x6f, 0x67, 0x4c, 0x65, 0x76, 0x65, 0x6c, 0x12, 0x44,
	...
	0x67, 0x2e, 0x4d, 0x73, 0x67, 0x54, 0x79, 0x70, 0x65, 0x48, 0x00, 0x52, 0x07, 0x6d, 0x73, 0x67,
	...
	0x69, 0x65, 0x72, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x48, 0x01, 0x52, 0x05, 0x65, 0x6d, 0x61,
	...
	0x6f, 0x6e, 0x66, 0x69, 0x67, 0x48, 0x01, 0x52, 0x04, 0x63, 0x68, 0x61, 0x74, 0x12, 0x45, 0x0a,
	...
	0x65, 0x72, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x48, 0x01, 0x52, 0x08, 0x6d, 0x6f, 0x6e, 0x6f,
	...
	0x69, 0x66, 0x69, 0x65, 0x72, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x48, 0x01, 0x52, 0x06, 0x70,
	...
	0x10, 0x08, 0x42, 0x08, 0x0a, 0x06, 0x66, 0x69, 0x6c, 0x74, 0x65, 0x72, 0x42, 0x08, 0x0a, 0x06,
...
var file_config_proto_goTypes = []interface{}{
	...
	(*GitilesParentConfig)(nil),                                // 19: autoroll.config.GitilesParentConfig
	(*GitilesConfig)(nil),                                      // 20: autoroll.config.GitilesConfig
	(*DEPSLocalParentConfig)(nil),                              // 21: autoroll.config.DEPSLocalParentConfig
	(*GitCheckoutParentConfig)(nil),                            // 22: autoroll.config.GitCheckoutParentConfig
	(*FreeTypeParentConfig)(nil),                               // 23: autoroll.config.FreeTypeParentConfig
	(*CIPDChildConfig)(nil),                                    // 24: autoroll.config.CIPDChildConfig
	(*FuchsiaSDKChildConfig)(nil),                              // 25: autoroll.config.FuchsiaSDKChildConfig
	(*SemVerGCSChildConfig)(nil),                               // 26: autoroll.config.SemVerGCSChildConfig
	(*GCSChildConfig)(nil),                                     // 27: autoroll.config.GCSChildConfig
	(*GitCheckoutChildConfig)(nil),                             // 28: autoroll.config.GitCheckoutChildConfig
	(*GitilesChildConfig)(nil),                                 // 29: autoroll.config.GitilesChildConfig
	(*NotifierConfig)(nil),                                     // 30: autoroll.config.NotifierConfig
	(*EmailNotifierConfig)(nil),                                // 31: autoroll.config.EmailNotifierConfig
	(*ChatNotifierConfig)(nil),                                 // 32: autoroll.config.ChatNotifierConfig
	(*MonorailNotifierConfig)(nil),                             // 33: autoroll.config.MonorailNotifierConfig
	(*PubSubNotifierConfig)(nil),                               // 34: autoroll.config.PubSubNotifierConfig
	(*ThrottleConfig)(nil),                                     // 35: autoroll.config.ThrottleConfig
	(*TransitiveDepConfig)(nil),                                // 36: autoroll.config.TransitiveDepConfig
	(*VersionFileConfig)(nil),                                  // 37: autoroll.config.VersionFileConfig
	(*DependencyConfig)(nil),                                   // 38: autoroll.config.DependencyConfig
	(*GitCheckoutConfig)(nil),                                  // 39: autoroll.config.GitCheckoutConfig
	(*AndroidRepoManagerConfig_ProjectMetadataFileConfig)(nil), // 40: autoroll.config.AndroidRepoManagerConfig.ProjectMetadataFileConfig
	(*CommandRepoManagerConfig_CommandConfig)(nil),             // 41: autoroll.config.CommandRepoManagerConfig.CommandConfig
	nil,                                // 42: autoroll.config.CommandRepoManagerConfig.CommandConfig.EnvEntry
	(*CopyParentConfig_CopyEntry)(nil), // 43: autoroll.config.CopyParentConfig.CopyEntry
...
var file_config_proto_depIdxs = []int32{
	...
	30, // 11: autoroll.config.Config.notifiers:type_name -> autoroll.config.NotifierConfig
	35, // 12: autoroll.config.Config.safety_throttle:type_name -> autoroll.config.ThrottleConfig
	36, // 13: autoroll.config.Config.transitive_deps:type_name -> autoroll.config.TransitiveDepConfig
	...
	40, // 18: autoroll.config.AndroidRepoManagerConfig.metadata:type_name -> autoroll.config.AndroidRepoManagerConfig.ProjectMetadataFileConfig
	39, // 19: autoroll.config.CommandRepoManagerConfig.git_checkout:type_name -> autoroll.config.GitCheckoutConfig
	41, // 20: autoroll.config.CommandRepoManagerConfig.get_tip_rev:type_name -> autoroll.config.CommandRepoManagerConfig.CommandConfig
	41, // 21: autoroll.config.CommandRepoManagerConfig.get_pinned_rev:type_name -> autoroll.config.CommandRepoManagerConfig.CommandConfig
	41, // 22: autoroll.config.CommandRepoManagerConfig.set_pinned_rev:type_name -> autoroll.config.CommandRepoManagerConfig.CommandConfig
	23, // 23: autoroll.config.FreeTypeRepoManagerConfig.parent:type_name -> autoroll.config.FreeTypeParentConfig
	29, // 24: autoroll.config.FreeTypeRepoManagerConfig.child:type_name -> autoroll.config.GitilesChildConfig
	19, // 25: autoroll.config.FuchsiaSDKAndroidRepoManagerConfig.parent:type_name -> autoroll.config.GitilesParentConfig
	25, // 26: autoroll.config.FuchsiaSDKAndroidRepoManagerConfig.child:type_name -> autoroll.config.FuchsiaSDKChildConfig
	18, // 27: autoroll.config.ParentChildRepoManagerConfig.copy_parent:type_name -> autoroll.config.CopyParentConfig
	21, // 28: autoroll.config.ParentChildRepoManagerConfig.deps_local_parent:type_name -> autoroll.config.DEPSLocalParentConfig
	22, // 29: autoroll.config.ParentChildRepoManagerConfig.git_checkout_parent:type_name -> autoroll.config.GitCheckoutParentConfig
	19, // 30: autoroll.config.ParentChildRepoManagerConfig.gitiles_parent:type_name -> autoroll.config.GitilesParentConfig
	24, // 31: autoroll.config.ParentChildRepoManagerConfig.cipd_child:type_name -> autoroll.config.CIPDChildConfig
	25, // 32: autoroll.config.ParentChildRepoManagerConfig.fuchsia_sdk_child:type_name -> autoroll.config.FuchsiaSDKChildConfig
	28, // 33: autoroll.config.ParentChildRepoManagerConfig.git_checkout_child:type_name -> autoroll.config.GitCheckoutChildConfig
	29, // 34: autoroll.config.ParentChildRepoManagerConfig.gitiles_child:type_name -> autoroll.config.GitilesChildConfig
	26, // 35: autoroll.config.ParentChildRepoManagerConfig.semver_gcs_child:type_name -> autoroll.config.SemVerGCSChildConfig
	19, // 36: autoroll.config.CopyParentConfig.gitiles:type_name -> autoroll.config.GitilesParentConfig
	43, // 37: autoroll.config.CopyParentConfig.copies:type_name -> autoroll.config.CopyParentConfig.CopyEntry
	20, // 38: autoroll.config.GitilesParentConfig.gitiles:type_name -> autoroll.config.GitilesConfig
	38, // 39: autoroll.config.GitilesParentConfig.dep:type_name -> autoroll.config.DependencyConfig
	7,  // 40: autoroll.config.GitilesParentConfig.gerrit:type_name -> autoroll.config.GerritConfig
	37, // 41: autoroll.config.GitilesConfig.dependencies:type_name -> autoroll.config.VersionFileConfig
	39, // 42: autoroll.config.DEPSLocalParentConfig.git_checkout:type_name -> autoroll.config.GitCheckoutConfig
	39, // 43: autoroll.config.GitCheckoutParentConfig.git_checkout:type_name -> autoroll.config.GitCheckoutConfig
	38, // 44: autoroll.config.GitCheckoutParentConfig.dep:type_name -> autoroll.config.DependencyConfig
	19, // 45: autoroll.config.FreeTypeParentConfig.gitiles:type_name -> autoroll.config.GitilesParentConfig
	27, // 46: autoroll.config.SemVerGCSChildConfig.gcs:type_name -> autoroll.config.GCSChildConfig
	39, // 47: autoroll.config.GitCheckoutChildConfig.git_checkout:type_name -> autoroll.config.GitCheckoutConfig
	20, // 48: autoroll.config.GitilesChildConfig.gitiles:type_name -> autoroll.config.GitilesConfig
	3,  // 49: autoroll.config.NotifierConfig.log_level:type_name -> autoroll.config.NotifierConfig.LogLevel
	4,  // 50: autoroll.config.NotifierConfig.msg_type:type_name -> autoroll.config.NotifierConfig.MsgType
	31, // 51: autoroll.config.NotifierConfig.email:type_name -> autoroll.config.EmailNotifierConfig
	32, // 52: autoroll.config.NotifierConfig.chat:type_name -> autoroll.config.ChatNotifierConfig
	33, // 53: autoroll.config.NotifierConfig.monorail:type_name -> autoroll.config.MonorailNotifierConfig
	34, // 54: autoroll.config.NotifierConfig.pubsub:type_name -> autoroll.config.PubSubNotifierConfig
	44, // 55: autoroll.config.ThrottleConfig.time_window:type_name -> google.protobuf.Duration
	37, // 56: autoroll.config.TransitiveDepConfig.child:type_name -> autoroll.config.VersionFileConfig
	37, // 57: autoroll.config.TransitiveDepConfig.parent:type_name -> autoroll.config.VersionFileConfig
	37, // 58: autoroll.config.DependencyConfig.primary:type_name -> autoroll.config.VersionFileConfig
	36, // 59: autoroll.config.DependencyConfig.transitive:type_name -> autoroll.config.TransitiveDepConfig
	37, // 60: autoroll.config.GitCheckoutConfig.dependencies:type_name -> autoroll.config.VersionFileConfig
	42, // 61: autoroll.config.CommandRepoManagerConfig.CommandConfig.env:type_name -> autoroll.config.CommandRepoManagerConfig.CommandConfig.EnvEntry
...
func file_config_proto_init() {
	...
	file_config_proto_msgTypes[12].OneofWrappers = []interface{}{
		...
		(*ParentChildRepoManagerConfig_DepsLocalParent)(nil),
		(*ParentChildRepoManagerConfig_GitCheckoutParent)(nil),
	...
	file_config_proto_msgTypes[25].OneofWrappers = []interface{}{
		(*NotifierConfig_LogLevel_)(nil),
		(*NotifierConfig_MsgType_)(nil),
