...
var file_config_proto_rawDesc = []byte{
	...
	0x52, 0x0c, 0x64, 0x65, 0x70, 0x65, 0x6e, 0x64, 0x65, 0x6e, 0x63, 0x69, 0x65, 0x73, 0x22, 0x83,
	0x01, 0x0a, 0x15, 0x44, 0x45, 0x50, 0x53, 0x4c, 0x6f, 0x63, 0x61, 0x6c, 0x50, 0x61, 0x72, 0x65,
	...
	0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0c, 0x63, 0x68, 0x65, 0x63, 0x6b, 0x6f, 0x75, 0x74,
	0x50, 0x61, 0x74, 0x68, 0x22, 0x95, 0x01, 0x0a, 0x17, 0x47, 0x69, 0x74, 0x43, 0x68, 0x65, 0x63,
...
var file_config_proto_depIdxs = []int32{
	...
	42, // 49: autoroll.config.DEPSLocalParentConfig.git_checkout:type_name -> autoroll.config.GitCheckoutConfig
	42, // 50: autoroll.config.GitCheckoutParentConfig.git_checkout:type_name -> autoroll.config.GitCheckoutConfig
	41, // 51: autoroll.config.GitCheckoutParentConfig.dep:type_name -> autoroll.config.DependencyConfig
	22, // 52: autoroll.config.FreeTypeParentConfig.gitiles:type_name -> autoroll.config.GitilesParentConfig
	30, // 53: autoroll.config.SemVerGCSChildConfig.gcs:type_name -> autoroll.config.GCSChildConfig
	42, // 54: autoroll.config.GitCheckoutChildConfig.git_checkout:type_name -> autoroll.config.GitCheckoutConfig
	23, // 55: autoroll.config.GitilesChildConfig.gitiles:type_name -> autoroll.config.GitilesConfig
	3,  // 56: autoroll.config.NotifierConfig.log_level:type_name -> autoroll.config.NotifierConfig.LogLevel
	4,  // 57: autoroll.config.NotifierConfig.msg_type:type_name -> autoroll.config.NotifierConfig.MsgType
	34, // 58: autoroll.config.NotifierConfig.email:type_name -> autoroll.config.EmailNotifierConfig
	35, // 59: autoroll.config.NotifierConfig.chat:type_name -> autoroll.config.ChatNotifierConfig
	36, // 60: autoroll.config.NotifierConfig.monorail:type_name -> autoroll.config.MonorailNotifierConfig
	37, // 61: autoroll.config.NotifierConfig.pubsub:type_name -> autoroll.config.PubSubNotifierConfig
	47, // 62: autoroll.config.ThrottleConfig.time_window:type_name -> google.protobuf.Duration
	40, // 63: autoroll.config.TransitiveDepConfig.child:type_name -> autoroll.config.VersionFileConfig
	40, // 64: autoroll.config.TransitiveDepConfig.parent:type_name -> autoroll.config.VersionFileConfig
	40, // 65: autoroll.config.DependencyConfig.primary:type_name -> autoroll.config.VersionFileConfig
	39, // 66: autoroll.config.DependencyConfig.transitive:type_name -> autoroll.config.TransitiveDepConfig
	40, // 67: autoroll.config.GitCheckoutConfig.dependencies:type_name -> autoroll.config.VersionFileConfig
	45, // 68: autoroll.config.CommandRepoManagerConfig.CommandConfig.env:type_name -> autoroll.config.CommandRepoManagerConfig.CommandConfig.EnvEntry
