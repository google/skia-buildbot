...
func TestStatus(t *testing.T) {
	...
	deepequal_testutils.AssertDeepEqual(t, issue1, status.LastRoll)
	deepequal_testutils.AssertDeepEqual(t, []*autoroll.AutoRollIssue{issue1}, status.Recent)
	...
	deepequal_testutils.AssertDeepEqual(t, issue4, status.CurrentRoll)
	deepequal_testutils.AssertDeepEqual(t, issue3, status.LastRoll)
	deepequal_testutils.AssertDeepEqual(t, recent, status.Recent)
	...
	require.Equal(t, "error message", status.Error)
	require.Nil(t, status.CurrentRoll)
	deepequal_testutils.AssertDeepEqual(t, recent[0], status.LastRoll)
	deepequal_testutils.AssertDeepEqual(t, recent, status.Recent)
}
...
func TestAddOrUpdateIssue(t *testing.T) {
	...
	require.NoError(t, a.UpdateStatus(ctx, "", true))
	deepequal_testutils.AssertDeepEqual(t, []*autoroll.AutoRollIssue{issue2, issue1}, a.status.Get().Recent)
	...
	deepequal_testutils.AssertDeepEqual(t, []*autoroll.AutoRollIssue{issue4, issue3, issue2, issue1}, a.status.Get().Recent)
	...
	deepequal_testutils.AssertDeepEqual(t, []*autoroll.AutoRollIssue{issue5, issue4, issue3, issue2, issue1}, a.status.Get().Recent)
}
...
func TestRollAsIssue(t *testing.T) {
	...
	require.NoError(t, err)
	deepequal_testutils.AssertDeepEqual(t, expected, actual)
