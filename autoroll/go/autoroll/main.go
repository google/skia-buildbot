...
func main() {
	...
	arb, err = autoroller.NewAutoRoller(*workdir, *parentRepo, *parentBranch, *childPath, *childBranch, cqExtraTrybots, emails, g, time.Minute, 15*time.Minute, depotTools, *rollIntoAndroid, *useManifest, *strategy)
	if err != nil {
		sklog.Fatal(err)
	}
