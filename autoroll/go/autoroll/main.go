...
var (
	...
	childBranch     = flag.String("childBranch", "master", "Branch of the project we want to roll.")
	...
	parentBranch    = flag.String("parentBranch", "master", "Branch of the parent repo we want to roll into.")
