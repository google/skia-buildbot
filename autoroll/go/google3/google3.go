...
func (a *AutoRoller) UpdateStatus(ctx context.Context, errorMsg string, preserveLastError bool) error {
	...
	if err := status.Set(ctx, a.roller, &status.AutoRollStatus{
		...
		ChildName:      "Skia", // TODO(borenet): Okay to hard-code?
		...
		ParentName:      "Google3", // TODO(borenet): Okay to hard-code?
		ParentWaterfall: "",        // TODO(borenet): Is there a good waterfall to link?
		Recent:          recent,
