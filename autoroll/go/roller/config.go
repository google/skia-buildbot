...
type AutoRollerConfig struct {
	...
	TravisCiToken   string `json:"travisCiToken"`
...
func (c *AutoRollerConfig) Validate() error {
	...
	if c.GerritURL == "" && (c.GithubToken == "" || c.TravisCiToken == "" || c.GithubRepoOwner == "" || c.GithubRepoName == "") {
		return errors.New("Either GerritURL OR all of GithubToken/TravisCiToken/GithubRepoOwner/GithubRepoName is required.")
	}
	if c.ParentName == "" {
