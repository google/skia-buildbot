...
type AutoRollerConfig struct {
	...
	// The parent repo is internal-only. If true, the issues uploaded by the
	// roller will be stripped of their information before displaying to
	// non-googlers.
	ParentIsInternalOnly bool `json:"parentIsInternalOnly"`
