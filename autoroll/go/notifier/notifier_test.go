...
func TestNotifier(t *testing.T) {
	...
	assert.NoError(t, n.SendIssueUpdate(ctx, "123", "https://codereview/123", "uploaded a CL!"))
	...
	assert.NoError(t, n.SendModeChange(ctx, "test@skia.org", "STOPPED", "<b>Staaahhp!</b>"))
	...
	assert.NoError(t, n.SendSafetyThrottled(ctx, now))
