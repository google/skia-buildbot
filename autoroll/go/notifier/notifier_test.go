...
func TestNotifier(t *testing.T) {
	...
	assert.Equal(t, fmt.Sprintf("The roller is throttled because it attempted to upload too many CLs in too short a time.  Unthrottles at %s.", now), t1.msgs[2].m.Body)
