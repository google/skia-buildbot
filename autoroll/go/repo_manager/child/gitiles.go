...
func (c *gitilesChild) ReadFile(ctx context.Context, rev *revision.Revision, path string) (string, error) {
	return "", skerr.Fmt("NOT IMPLEMENTED")
}

// ReadDir implements Reader.
func (c *gitilesChild) ReadDir(ctx context.Context, rev *revision.Revision, path string) ([]os.FileInfo, error) {
	return nil, skerr.Fmt("NOT IMPLEMENTED")
}

// Stat implements Reader.
func (c *gitilesChild) Stat(ctx context.Context, rev *revision.Revision, path string) (os.FileInfo, error) {
	return nil, skerr.Fmt("NOT IMPLEMENTED")
}
