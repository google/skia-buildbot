...
// If the caller calls CIPDChild.Sync, the destination must be a descendant of
...
func (c *CIPDChild) Sync(ctx context.Context, rev *revision.Revision, dest string) error {
	var err error
