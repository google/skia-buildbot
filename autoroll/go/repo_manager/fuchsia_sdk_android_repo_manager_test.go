...
func setupFuchsiaSDKAndroid(t *testing.T) (context.Context, string, RepoManager, *mockhttpclient.URLMock, *gitiles_testutils.MockRepo, *git_testutils.GitBuilder, func()) {
	...
	mockGSList(t, urlmock, FUCHSIA_SDK_GS_BUCKET, "sdk/core", map[string]string{
		fuchsiaSDKRevBase: fuchsiaSDKTimeBase,
		fuchsiaSDKRevPrev: fuchsiaSDKTimePrev,
	})
	mockGetLatestSDK(urlmock, "sdk/core/linux-amd64/LATEST_ARCHIVE", "sdk/core/mac-amd64/LATEST_ARCHIVE", fuchsiaSDKRevBase, "mac-base")
...
func mockDownloadSDK(t *testing.T, urlmock *mockhttpclient.URLMock, rev, wd string) {
	...
	assert.NoError(t, err)
	url := fmt.Sprintf("https://storage.googleapis.com/fuchsia/sdk/core/linux-amd64/%s", rev)
...
func TestFuchsiaSDKAndroidRepoManager(t *testing.T) {
	...
	mockGetLatestSDK(urlmock, "sdk/core/linux-amd64/LATEST_ARCHIVE", "sdk/core/mac-amd64/LATEST_ARCHIVE", fuchsiaSDKRevNext, "mac-next")
