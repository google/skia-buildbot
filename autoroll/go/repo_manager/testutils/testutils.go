...
func MockDEPSRepoManager(t *testing.T) {
	repo_manager.NewDEPSRepoManager = func(context.Context, *repo_manager.DEPSRepoManagerConfig, string, *gerrit.Gerrit, string) (repo_manager.RepoManager, error) {
	...
	repo_manager.NewManifestRepoManager = func(context.Context, *repo_manager.ManifestRepoManagerConfig, string, *gerrit.Gerrit, string) (repo_manager.RepoManager, error) {
		return NewRepoManager(t, false), nil
	}
}
