...
func MockDEPSRepoManager(t *testing.T) {
	...
	repo_manager.NewAndroidRepoManager = func(context.Context, *repo_manager.AndroidRepoManagerConfig, string, gerrit.GerritInterface, string, *http.Client) (repo_manager.RepoManager, error) {
