...
var (
	...
	NewNoCheckoutRepoManager func(context.Context, *NoCheckoutRepoManagerConfig, string, gerrit.GerritInterface, string, string, *http.Client) (RepoManager, error) = newNoCheckoutRepoManager
)
...
// newNoCheckoutRepoManager returns a RepoManager instance which does not use
// a local checkout.
func newNoCheckoutRepoManager(ctx context.Context, c *NoCheckoutRepoManagerConfig, workdir string, g gerrit.GerritInterface, recipeCfgFile, serverURL string, client *http.Client) (RepoManager, error) {
...
func (rm *noCheckoutRepoManager) CommitsNotRolled() int {
	rm.infoMtx.RLock()
...
// See documentation for RepoManager interface.
func (rm *noCheckoutRepoManager) FullChildHash(ctx context.Context, ref string) (string, error) {
...
// See documentation for RepoManager interface.
func (rm *noCheckoutRepoManager) LastRollRev() string {
	rm.infoMtx.RLock()
	defer rm.infoMtx.RUnlock()
...
// See documentation for RepoManager interface.
func (rm *noCheckoutRepoManager) NextRollRev() string {
	rm.infoMtx.RLock()
	defer rm.infoMtx.RUnlock()
...
// See documentation for RepoManager interface.
func (rm *noCheckoutRepoManager) PreUploadSteps() []PreUploadStep {
	return rm.preUploadSteps
}

// See documentation for RepoManager interface.
func (rm *noCheckoutRepoManager) RolledPast(ctx context.Context, hash string) (bool, error) {
	rm.infoMtx.RLock()
	defer rm.infoMtx.RUnlock()
...
func (rm *noCheckoutRepoManager) getLastRollRev(ctx context.Context, wd string) (string, error) {
	// Download the DEPS file from the parent repo.
