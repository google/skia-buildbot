...
var (
	...
	NewNoCheckoutDEPSRepoManager func(context.Context, *NoCheckoutDEPSRepoManagerConfig, string, gerrit.GerritInterface, string, string, string, *http.Client, *codereview.GerritConfig, bool) (RepoManager, error) = newNoCheckoutDEPSRepoManager
)
...
// a local checkout.
func newNoCheckoutDEPSRepoManager(ctx context.Context, c *NoCheckoutDEPSRepoManagerConfig, workdir string, g gerrit.GerritInterface, recipeCfgFile, serverURL, gitcookiesPath string, client *http.Client, gerritConfig *codereview.GerritConfig, local bool) (RepoManager, error) {
...
// See documentation for RepoManager interface.
func (r *noCheckoutDEPSRepoManager) RetrieveRoll(ctx context.Context, recent *recent_rolls.RecentRolls, issue int64, cb func(context.Context, roll.RollImpl) error) (roll.RollImpl, error) {
