...
func CopyRepoManagerConfigToProto(cfg *CopyRepoManagerConfig) (*config.ParentChildRepoManagerConfig, error) {
...
func ProtoToCopyRepoManagerConfig(cfg *config.ParentChildRepoManagerConfig) (*CopyRepoManagerConfig, error) {
