...
var (
	...
	NewGithubCipdDEPSRepoManager func(context.Context, *GithubCipdDEPSRepoManagerConfig, string, string, *github.GitHub, string, string, *http.Client, cipd.CIPDClient, codereview.CodeReview, bool) (RepoManager, error) = newGithubCipdDEPSRepoManager
)
...
func newGithubCipdDEPSRepoManager(ctx context.Context, c *GithubCipdDEPSRepoManagerConfig, workdir, rollerName string, githubClient *github.GitHub, recipeCfgFile, serverURL string, httpClient *http.Client, cipdClient cipd.CIPDClient, cr codereview.CodeReview, local bool) (RepoManager, error) {
