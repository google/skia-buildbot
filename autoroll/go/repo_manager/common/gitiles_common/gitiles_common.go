...
func (r *GitilesRepo) LogFirstParent(ctx context.Context, from, to *revision.Revision, b *gitiles.URLBuilder) ([]*revision.Revision, error) {
	commits, err := r.Repo.LogFirstParent(ctx, from.Id, to.Id, b)
	if err != nil {
		return nil, err
	}
