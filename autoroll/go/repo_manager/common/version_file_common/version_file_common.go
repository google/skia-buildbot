...
func GetPinnedRev(dep *proto.VersionFileConfig, contents string) (string, error) {
...
func GetPinnedRevs(ctx context.Context, deps []*proto.VersionFileConfig, getFile GetFileFunc) (map[string]string, error) {
...
// the new contents.
func SetPinnedRev(dep *proto.VersionFileConfig, newVersion, oldContents string) (string, error) {
	if dep.Path == deps_parser.DepsFileName {
...
func updateSingleDep(ctx context.Context, dep *proto.VersionFileConfig, newVersion string, changes map[string]string, getFile GetFileFunc) error {
...
func UpdateDep(ctx context.Context, primaryDep *proto.DependencyConfig, rev *revision.Revision, getFile GetFileFunc) (map[string]string, error) {
