...
func GitilesCIPDDEPSRepoManagerConfigToProto(cfg *GitilesCIPDDEPSRepoManagerConfig) *config.ParentChildRepoManagerConfig {
...
func ProtoToGitilesCIPDDEPSRepoManagerConfig(parentCfg *config.GitilesParentConfig, childCfg *config.CIPDChildConfig) *GitilesCIPDDEPSRepoManagerConfig {
