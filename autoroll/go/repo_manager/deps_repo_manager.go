...
var (
	...
	NewDEPSRepoManager func(context.Context, *DEPSRepoManagerConfig, string, *gerrit.Gerrit, string) (RepoManager, error) = newDEPSRepoManager
)
...
func newDEPSRepoManager(ctx context.Context, c *DEPSRepoManagerConfig, workdir string, g *gerrit.Gerrit, serverURL string) (RepoManager, error) {
