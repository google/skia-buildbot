...
func ProtoToGitCheckoutGithubFileConfig(cfg *config.GitCheckoutGitHubFileParentConfig) *GitCheckoutGithubFileConfig {
	return &GitCheckoutGithubFileConfig{
		GitCheckoutGithubConfig: *ProtoToGitCheckoutGithubConfig(cfg.GitCheckout),
