...
func newGitiles(ctx context.Context, c GitilesConfig, reg *config_vars.Registry, client *http.Client, serverURL string, update gitilesUpdateFunc, getChangesForRoll gitilesGetChangesForRollFunc) (Parent, error) {
