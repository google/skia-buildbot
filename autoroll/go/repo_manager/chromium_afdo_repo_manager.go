...
var (
	...
	NewAFDORepoManager func(context.Context, *AFDORepoManagerConfig, string, *gerrit.Gerrit, string, *http.Client) (RepoManager, error) = newAfdoRepoManager
...
func newAfdoRepoManager(ctx context.Context, c *AFDORepoManagerConfig, workdir string, g *gerrit.Gerrit, serverURL string, authClient *http.Client) (RepoManager, error) {
