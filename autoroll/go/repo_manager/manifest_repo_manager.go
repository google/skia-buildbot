...
var (
	...
	NewManifestRepoManager func(context.Context, *ManifestRepoManagerConfig, string, *gerrit.Gerrit, string) (RepoManager, error) = newManifestRepoManager
...
func newManifestRepoManager(ctx context.Context, c *ManifestRepoManagerConfig, workdir string, g *gerrit.Gerrit, serverURL string) (RepoManager, error) {
