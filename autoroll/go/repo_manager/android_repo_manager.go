...
func AndroidRepoManagerConfigToProto(cfg *AndroidRepoManagerConfig) *config.AndroidRepoManagerConfig {
	return &config.AndroidRepoManagerConfig{
		...
		ChildBranch:      cfg.ChildBranch.String(), // TODO(borenet): How to handle config templates?
		ChildPath:        cfg.ChildPath,
		ParentRepoUrl:    cfg.ParentRepo,
		ParentBranch:     cfg.ParentBranch.String(), // TODO(borenet)
...
func ProtoToAndroidRepoManagerConfig(cfg *config.AndroidRepoManagerConfig) *AndroidRepoManagerConfig {
