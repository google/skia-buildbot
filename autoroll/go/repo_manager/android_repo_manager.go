...
var (
	...
	NewAndroidRepoManager func(string, string, string, string, time.Duration, gerrit.GerritInterface, *skexec.Exec) (RepoManager, error) = newAndroidRepoManager
...
func newAndroidRepoManager(workdir, parentBranch, childPath, childBranch string, frequency time.Duration, g gerrit.GerritInterface, exec *skexec.Exec) (RepoManager, error) {
