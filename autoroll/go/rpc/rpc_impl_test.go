...
func TestGetStatus(t *testing.T) {
	...
	expect := convertStatus(st, roller.Cfg, roller.Mode.CurrentMode(), roller.Strategy.CurrentStrategy(), roller.Cfg.RollerName, roller.Cfg.ChildDisplayName, roller.Cfg.ParentDisplayName, manualReqs)
