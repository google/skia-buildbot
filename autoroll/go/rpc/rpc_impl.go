...
func NewAutoRollServer(ctx context.Context, rollers map[string]*AutoRoller, manualRollDB manual.DB, viewers, editors, admins allowed.Allow) http.Handler {
	impl := newAutoRollServerImpl(rollers, manualRollDB, viewers, editors, admins)
...
func newAutoRollServerImpl(rollers map[string]*AutoRoller, manualRollDB manual.DB, viewers, editors, admins allowed.Allow) *autoRollServerImpl {
...
type AutoRoller struct {
	...
	Status   *status.Cache
	Strategy *strategy.DatastoreStrategyHistory
}
