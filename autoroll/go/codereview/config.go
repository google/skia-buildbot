...
func (c *GithubConfig) Validate() error {
	...
	if (c.ChecksNumPyScriptURL == "" && c.ChecksNum == 0) || (c.ChecksNumPyScriptURL != "" && c.ChecksNum > 0) {
		return errors.New("Exactly one of checksNumPyScriptURL or checksNum must be specified.")
	}
	return nil
}
