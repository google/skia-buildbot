...
type AutoRoller struct {
	...
	retrieveRoll    func(int64) (asm.RollCLImpl, error)
...
func newAutoRoller(workdir, childPath, cqExtraTrybots string, emails []string, gerrit *gerrit.Gerrit, rm repo_manager.RepoManager, retrieveRoll func(int64) (asm.RollCLImpl, error)) (*AutoRoller, error) {
...
func NewAndroidAutoRoller(workdir, parentBranch, childPath, childBranch, cqExtraTrybots string, emails []string, gerrit *gerrit.Gerrit, strategy string) (*AutoRoller, error) {
	...
	var arb *AutoRoller
	retrieveRoll := func(issue int64) (asm.RollCLImpl, error) {
...
func (r *AutoRoller) GetActiveRoll() asm.RollCLImpl {
