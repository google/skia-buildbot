...
import (
	...
	asm "go.skia.org/infra/autoroll/go/state_machine"
...
type AutoRoller struct {
	...
	retrieveRoll    func(int64) (asm.AutoRollImpl, error)
	rm              repo_manager.RepoManager
	runningMtx      sync.Mutex
	sm              *state_machine.PersistentStateMachine
	status          *autoroller.AutoRollStatusCache
	rollIntoAndroid bool
}

// newAutoRoller returns an AutoRoller instance.
func newAutoRoller(workdir, childPath, cqExtraTrybots string, emails []string, gerrit *gerrit.Gerrit, rm repo_manager.RepoManager, retrieveRoll func(int64) (asm.AutoRollImpl, error)) (*AutoRoller, error) {
...
func NewAndroidAutoRoller(workdir, parentBranch, childPath, childBranch, cqExtraTrybots string, emails []string, gerrit *gerrit.Gerrit, strategy string) (*AutoRoller, error) {
	...
	var arb *AutoRoller
	retrieveRoll := func(issue int64) (asm.AutoRollImpl, error) {
...
func (r *AutoRoller) GetActiveRoll() asm.AutoRollImpl {
