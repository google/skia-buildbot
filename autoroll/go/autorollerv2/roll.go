...
// gerritRoll is an implementation of state_machine.AutoRollImpl.
...
func newGerritRoll(g *gerrit.Gerrit, rm repo_manager.RepoManager, recent *recent_rolls.RecentRolls, issueNum int64) (state_machine.AutoRollImpl, error) {
...
// See documentation for state_machine.AutoRollImpl interface.
...
func newGerritAndroidRoll(g *gerrit.Gerrit, rm repo_manager.RepoManager, recent *recent_rolls.RecentRolls, issueNum int64) (state_machine.AutoRollImpl, error) {
