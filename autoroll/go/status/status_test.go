...
func TestStatus(t *testing.T) {
	...
	deepequal_testutils.AssertDeepEqual(t, &AutoRollStatus{}, c.Get())
	deepequal_testutils.AssertDeepEqual(t, &AutoRollMiniStatus{}, c.GetMini())
	...
	require.NoError(t, err)
	deepequal_testutils.AssertDeepEqual(t, s, actual)
	...
	deepequal_testutils.AssertDeepEqual(t, s, c.Get())
