...
func New(impl AutoRollerImpl, workdir string) (*AutoRollStateMachine, error) {
	...
	b.T(S_NORMAL_ACTIVE, S_NORMAL_FAILURE, F_CLOSE_FAILED)
	b.T(S_NORMAL_ACTIVE, S_STOPPED, F_CLOSE_STOPPED)
	b.T(S_NORMAL_SUCCESS, S_NORMAL_IDLE, F_WAIT_FOR_LAND)
	b.T(S_NORMAL_FAILURE, S_NORMAL_IDLE, F_NOOP)
	b.T(S_NORMAL_THROTTLED, S_NORMAL_IDLE, F_NOOP)
	b.T(S_NORMAL_THROTTLED, S_NORMAL_THROTTLED, F_NOOP)
	...
	b.T(S_DRY_RUN_ACTIVE, S_DRY_RUN_FAILURE, F_CLOSE_DRY_RUN_FAILED)
	...
	b.T(S_DRY_RUN_FAILURE, S_DRY_RUN_IDLE, F_NOOP)
	b.T(S_DRY_RUN_THROTTLED, S_DRY_RUN_IDLE, F_NOOP)
	b.T(S_DRY_RUN_THROTTLED, S_DRY_RUN_THROTTLED, F_NOOP)
...
// no-ops.
func (s *AutoRollStateMachine) NextTransitionSet() error {
