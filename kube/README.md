...
================================================
  ...
  1. Create the `config-NNN.sh` file.
  1. Copy and modify the `create-cluster-corp.sh` script.
  1. Add a node pool if necessary using the web UI.
  1. Create a new config repo of the form https://skia.googlesource.com/skia-NNNNN-config/.
