...
image. Prints the kubectl command to run to apply the changes, or actually runs
them if --apply is supplied.
...
func main() {
	...
	for _, filename := range filenames {
		...
		if changed[filename] {
			util.WithWriteFile(filename, func(w io.Writer) error {
