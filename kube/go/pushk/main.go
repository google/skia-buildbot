...
func findAllImageNames(kubeDir, server, project string) ([]string, error) {
...
func main() {
	...
	if len(imageNames) == 0 {
		var err error
		imageNames, err = findAllImageNames(*kubeDir, gcr.SERVER, *project)
